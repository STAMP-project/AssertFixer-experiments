...
public class AlertUtilsTest extends AbstractTest {
	...
	public void testDetectDCFromExpression() {
		...
		ArrayList<String> expressionList = new ArrayList<>(Arrays.asList(
				"-2h:imtcentral.watchdogreports.PRD.SP1.na1:service-discovery{device=sd_acd42925-b519-4af8-a09b-643a9a676d19_health.non-estates.sfdcsd-itest.net}:min",
				"-1h:imtcentral.watchdogreports.DFW.SP1.na45:hammer-htgapp-checks-1:avg",
				"-30m:sam.SYD.NONE.syd-universalsearch_svc:deployment.AvailabilityPct{Namespace/DeploymentName=universal-search/universal-search-synthetics}:min",
				"DIVIDE(-15m:sam.PRD.NONE.prd-sam:deployment.DesiredPodCount{Namespace/DeploymentName=sam-system/slb-ipvs}:avg, -15m:sam.PRD.NONE.prd-sam:deployment.AvailablePodCount{Namespace/DeploymentName=sam-system/slb-ipvs}:avg)",
				"COUNT(-4m:-0m:sfstore.salesforce.com.DFW.SP1.none:bookkeeper_server.ADD_ENTRY_REQUEST.p99{device=SHARED1-SFSTORE1-122-DFW.OPS.SFDC.NET}:avg:4m-avg)",
				"-75m:logbus.was.SP3.na23:Logstash.rate_15m:sum",
				"-5m:argus.core:alerts.kpi{host=shared2-arguswsdev2-2-prd.eng.sfdc.net}:avg"));
		String [][] actualOutput =  new String[][]{{"PRD"},{"DFW"},{"SYD"},{"PRD"},{"DFW"},{"WAS"},{"PRD"}};

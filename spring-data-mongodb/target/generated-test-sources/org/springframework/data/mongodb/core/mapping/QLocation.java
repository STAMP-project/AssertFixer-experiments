...
public class QLocation extends EntityPathBase<Location> {
    ...
    private static final long serialVersionUID = -120483989L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QLocation location = new QLocation("location");

    public final ArrayPath<float[], Float> amounts = createArray("amounts", float[].class);

    public final org.bson.types.QObjectId id;

    public final ArrayPath<double[], Double> latlong = createArray("latlong", double[].class);

    public final ArrayPath<int[], Integer> numbers = createArray("numbers", int[].class);

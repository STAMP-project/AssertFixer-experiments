...
public class ProcessInstanceMigrationDocumentTest extends PluggableFlowableTestCase {
    ...
    public void testDeSerializeCompleteProcessInstanceMigrationDocument() {
        ...
        ProcessInstanceActivityMigrationMapping.OneToOneMapping oneToOneMapping = ProcessInstanceActivityMigrationMapping.getMappingFor("originalActivity1", "newActivity1");
        ProcessInstanceActivityMigrationMapping.OneToManyMapping oneToManyMapping = ProcessInstanceActivityMigrationMapping.getMappingFor("originalActivity2", Arrays.asList("newActivity2.1", "newActivity2.2"));
        ProcessInstanceActivityMigrationMapping.ManyToOneMapping manyToOneMapping = ProcessInstanceActivityMigrationMapping.getMappingFor(Arrays.asList("originalActivity3", "originalActivity4"), "newActivity3");
    ...
    public void testDeSerializeProcessInstanceMigrationDocumentWithVariables() {
        ...
        ProcessInstanceActivityMigrationMapping.OneToOneMapping oneToOne1 = ProcessInstanceActivityMigrationMapping.getMappingFor("originalActivity1", "newActivity1");
        ProcessInstanceActivityMigrationMapping.OneToOneMapping oneToOne2 = ProcessInstanceActivityMigrationMapping.getMappingFor("originalActivity2", "newActivity2");
    ...
    public void testSerializeDeSerializeProcessInstanceMigrationDocumentForDefinitionId() {
        ...
        activityMappings.add(ProcessInstanceActivityMigrationMapping.getMappingFor("originalActivity1", "newActivity1"));
        activityMappings.add(ProcessInstanceActivityMigrationMapping.getMappingFor("originalActivity2", "newActivity2"));

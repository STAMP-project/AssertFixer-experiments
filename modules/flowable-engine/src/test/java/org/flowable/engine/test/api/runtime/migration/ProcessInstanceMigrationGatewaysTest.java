...
public class ProcessInstanceMigrationGatewaysTest extends PluggableFlowableTestCase {
    ...
    //-- Exclusive Gateway
    @Test
    public void testMigrateActivityToExclusiveGatewayStartDefaultFlow() {
        ...
        runtimeService.createProcessInstanceMigrationBuilder()
            ...
            .addActivityMigrationMapping("userTask1Id", "exclusiveGw", "input", null)
    ...
    @Test
    public void testMigrateActivityToExclusiveGatewayStart() {
        ProcessDefinition procDefOneTask = deployProcessDefinition("my deploy", "org/flowable/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ProcessDefinition procWithExcGtw = deployProcessDefinition("my deploy", "org/flowable/engine/test/api/runtime/migration/exclusive-gateway-with-default-sequence.bpmn20.xml");
        ...
        runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procWithExcGtw.getId())
            .addActivityMigrationMapping("userTask1Id", "exclusiveGw", "input", Integer.valueOf(1))
            .migrate(processInstance.getId());
    ...
    @Test
    public void testMigrateActivityToExclusiveGatewayStartFromProcessVariable() {
        ProcessDefinition procDefOneTask = deployProcessDefinition("my deploy", "org/flowable/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ProcessDefinition procWithExcGtw = deployProcessDefinition("my deploy", "org/flowable/engine/test/api/runtime/migration/exclusive-gateway-with-default-sequence.bpmn20.xml");
        ...
        runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procWithExcGtw.getId())
            .addActivityMigrationMapping("userTask1Id", "exclusiveGw")
    ...
    @Test
    public void testMigrateActivityToExclusiveGatewayStartDefiningVariableOnExecution() {
        ProcessDefinition procDefOneTask = deployProcessDefinition("my deploy", "org/flowable/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ProcessDefinition procWithExcGtw = deployProcessDefinition("my deploy", "org/flowable/engine/test/api/runtime/migration/exclusive-gateway-with-default-sequence.bpmn20.xml");
    ...
    public void testMigrateActivityToActivityInsideExclusiveGateway() {
        ...
        runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procWithExcGtw.getId())
            .addActivityMigrationMapping("userTask1Id", "theTask2")
            .migrate(processInstance.getId());
    ...
    public void testMigrateActivityInsideExclusiveGatewayToActivityOutside() {
        ...
        runtimeService.createProcessInstanceMigrationBuilder()
            ...
            .addActivityMigrationMapping("theTask2", "userTask1Id")
            .migrate(processInstance.getId());
    ...
    public void testMigrateActivityToExclusiveGatewayStartInsideEmbeddedSubProcessDefaultFlow() {
        ...
        runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procWithExcGtw.getId())
            .addActivityMigrationMapping("userTask1Id", "exclusiveGw", Collections.singletonMap("input", null))
            .migrate(processInstance.getId());
        ...
        if (HistoryTestHelper.isHistoryLevelAtLeast(HistoryLevel.ACTIVITY, processEngineConfiguration)) {
            ...
            if (HistoryTestHelper.isHistoryLevelAtLeast(HistoryLevel.AUDIT, processEngineConfiguration)) {
                List<HistoricTaskInstance> historicTasks = historyService.createHistoricTaskInstanceQuery()
                    .processInstanceId(processInstance.getId())
                    .list();
                assertThat(historicTasks).extracting(HistoricTaskInstance::getTaskDefinitionKey).containsExactly("userTask1Id", "defaultFlowTask", "afterSubProcessTask");
                assertThat(historicTasks).extracting(HistoricTaskInstance::getProcessDefinitionId).containsOnly(procWithExcGtw.getId());
            }
        }
    ...
    public void testMigrateActivityToExclusiveGatewayStartInsideEmbeddedSubProcess() {
        ...
        runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procWithExcGtw.getId())
            .addActivityMigrationMapping("userTask1Id", "exclusiveGw", Collections.singletonMap("input", Integer.valueOf(1)))
            .migrate(processInstance.getId());
    ...
    //-- Parallel Gateway
    @Test
    public void testMigrateActivityToParallelGatewaySplit() {
        ProcessDefinition procDefOneTask = deployProcessDefinition("my deploy", "org/flowable/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ...
        runtimeService.createProcessInstanceMigrationBuilder()
            ...
            .addActivityMigrationMapping("userTask1Id", "parallelFork")
            .migrate(processInstance.getId());
    ...
    public void testMigrateParallelActivitiesToParallelGatewayActivities() {
        ...
        runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procParallelGtw.getId())
            .addActivityMigrationMapping("processTask", "oddFlowTask1")
            .addActivityMigrationMapping("parallelTask", "evenFlowTask4")
            .migrate(processInstance.getId());
    ...
    public void testMigrateActivityToParallelGatewayActivities() {
        ...
        runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procParallelGtw.getId())
            .addActivityMigrationMapping("userTask1Id", Arrays.asList("oddFlowTask3", "evenFlowTask2"))
            .migrate(processInstance.getId());
    ...
    public void testMigrateActivityToParallelGatewayActivitiesIncompleteActivityMapping() {
        ...
        runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procParallelGtw.getId())
            .addActivityMigrationMapping("userTask1Id", Arrays.asList("task1", "task3"))
            .migrate(processInstance.getId());

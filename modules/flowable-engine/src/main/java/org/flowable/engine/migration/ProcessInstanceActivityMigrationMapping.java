...
public abstract class ProcessInstanceActivityMigrationMapping {
    ...
    public static ProcessInstanceActivityMigrationMapping.OneToOneMapping getMappingFor(String fromActivityId, String toActivityId) {
        return new OneToOneMapping(fromActivityId, toActivityId);
    }

    public static ProcessInstanceActivityMigrationMapping.OneToManyMapping getMappingFor(String fromActivityId, List<String> toActivityIds) {
        return new OneToManyMapping(fromActivityId, toActivityIds);
    }

    public static ProcessInstanceActivityMigrationMapping.ManyToOneMapping getMappingFor(List<String> fromActivityIds, String toActivityId) {

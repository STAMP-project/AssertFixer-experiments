...
import static fr.ird.osmose.web.api.process.TraitFinderFishbaseAPI.findUsedTablesStatic;
        ...
        if (valuesForGroup == null) {
            try {
                ...
                for (Taxon taxon : taxa) {
                    ...
                    List<String> tables = TraitFinderFishbaseAPI.findUsedTablesStatic(getMappingInputStream(), availableNames);

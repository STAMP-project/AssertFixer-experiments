...
public class Decision implements Serializable {
    ...
    public static final class Builder extends AbstractBuilder<Decision> {
        ...
        public Builder withInputs(final Consumer<ElementBuilder<Input.Builder>> inputBuilderConsumer) {
            inputBuilderConsumer.accept(
                    () -> Input.builder(
                            this,
                            input -> this.product.inputs.add(input)
                    )
            );
        ...
        public Builder withOutputs(final Consumer<ElementBuilder<Output.Builder>> outputBuilderConsumer) {
            outputBuilderConsumer.accept(
                    () -> Output.builder(
                            this,
                            output -> this.product.outputs.add(output)
                    )
            );
        ...
        public Builder withRules(final Consumer<ElementBuilder<Rule.Builder>> ruleBuilderConsumer) {
            ruleBuilderConsumer.accept(
                    () -> Rule.builder(
                            this,
                            rule -> this.product.rules.add(rule)
                    )
            );

...
public final class MetadataConstants {
  ...
  public static final int CLUSTER_SIZE_OFFSET = NUMBER_OF_CLUSTERS_OFFSET + NUMBER_OF_CLUSTERS_LENGTH;
  public static final int CLUSTER_SIZE_LENGTH = Integer.BYTES;
  public static final int NUMBER_OF_ROOT_DIRECTORY_ENTRIES_OFFSET = CLUSTER_SIZE_OFFSET + CLUSTER_SIZE_LENGTH;
  ...
  public static final int CHECKSUM_OFFSET = ROOT_DIRECTORY_MODIFICATION_TS_OFFSET + ROOT_DIRECTORY_MODIFICATION_TS_LENGTH_IN_BYTES;
  ...
  static {
    ...
    assert CHECKSUM_OFFSET + CHECKSUM_LENGTH <= LENGTH;
  }

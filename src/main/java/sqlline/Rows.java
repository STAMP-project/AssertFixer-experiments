...
abstract class Rows implements Iterator<Rows.Row> {
  ...
  Rows(SqlLine sqlLine, ResultSet rs) throws SQLException {
    ...
    escapeNewLines = sqlLine.getOpts().getEscapeNewLines();
  }
  ...
  /**
   * Escapes newline symbols \n, \r
   * @param value String to be escaped
   * @return escaped string if input value contains \r, \n
   * otherwise returns the input value
   */
  private String escapeNewLineSymbols(String value) {

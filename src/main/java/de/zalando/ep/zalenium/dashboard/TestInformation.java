...
public class TestInformation {
    ...
    public String getSeleniumLogFileName() {
        String seleniumLogFileName = LocalDashboard.LOGS_FOLDER_NAME + "/" + testNameNoExtension + "/";
    ...
    public String getBrowserDriverLogFileName() {
        String browserDriverLogFileName = LocalDashboard.LOGS_FOLDER_NAME + "/" + testNameNoExtension + "/";
        if (ZALENIUM_PROXY_NAME.equalsIgnoreCase(proxyName)) {
    ...
    public void buildVideoFileName() {
        ...
        this.videoFolderPath = commonProxyUtilities.currentLocalPath() + "/" + LocalDashboard.VIDEOS_FOLDER_NAME;
        this.logsFolderPath = commonProxyUtilities.currentLocalPath() + "/" + LocalDashboard.VIDEOS_FOLDER_NAME + "/" +
                LocalDashboard.LOGS_FOLDER_NAME + "/" + testNameNoExtension;
    }

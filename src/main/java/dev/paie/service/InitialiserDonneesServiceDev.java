...
public class InitialiserDonneesServiceDev implements InitialiserDonneesService {
	...
	public void initialiser() {
		...
		Map<String, Utilisateur> util = context.getBeansOfType(Utilisateur.class);
		Collection<Utilisateur> utilis = util.values();

		for (Utilisateur utilisateur : utilis) {
			String mdp = utilisateur.getMotDePasse();
			String mdpHashe = this.passwordEncoder.encode(mdp);

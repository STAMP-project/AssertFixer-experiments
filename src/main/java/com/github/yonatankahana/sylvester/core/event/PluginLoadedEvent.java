 ...
 */
public class PluginLoadedEvent extends SystemEvent {

    final String pluginUID;

    public PluginLoadedEvent(String pluginUID, Console console) {
        super(console);
    ...
    public String eventName() {
        return "sylvester.core.event.PluginLoadedEvent";
    }

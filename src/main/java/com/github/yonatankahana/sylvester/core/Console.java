...
public interface Console {
    ...
    boolean loadPlugin(String pluginUID);

    boolean unloadPlugin(String pluginUID);

    boolean reloadPlugin(String pluginUID);
    
    void broadcast(Event event);
    
    Client getClientFactory(String clientType);

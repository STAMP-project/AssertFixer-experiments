 ...
 */
public class PluginUnloadedEvent extends SystemEvent {

    final String pluginUID;

    public PluginUnloadedEvent(String pluginUID, Console console) {
        super(console);
    ...
    public String eventName() {
        return "sylvester.core.event.PluginUnloadedEvent";
    }

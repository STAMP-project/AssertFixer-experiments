...
public class CadastroPJController {
    ...
    private void validarDadosExistentes(CadastroPJDto cadastroPJDto, BindingResult result) {
        ...
        this.funcionarioService.buscarPorEmail(cadastroPJDto.getEmail())
                .ifPresent(funcionario -> result.addError(new ObjectError("funcionario", "E-mail já existente.")));
    }
     ...
     * @throws NoSuchAlgorithmException { @link NoSuchAlgorithmException }
     */
    private Funcionario converteDtoParaFuncionario(CadastroPJDto cadastroPJDto, BindingResult result) throws NoSuchAlgorithmException {

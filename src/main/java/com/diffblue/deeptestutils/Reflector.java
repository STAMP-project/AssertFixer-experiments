...
public final class Reflector {
  ...
  public static void setField(
      ...
      final Object newVal) {
        try {
          ...
          throw new DeeptestUtilsException(e.getMessage(), e.getCause());
  ...
  public static <T> Object getInstanceField(
      ...
      final String fieldName) {
    if (c == null) {
      throw new DeeptestUtilsException(fieldName + " is not a field");
    }
      Field field = null;
      for (Field f : c.getDeclaredFields()) {
        if (f.getName().equals(fieldName)) {
  ...
  public static Class<? extends Throwable> toThrowableClass(
    ...
    if (cl.isAssignableFrom(throwableClass)) {
      ...
      throw
        new DeeptestUtilsException("cannot cast " + className
            + " to Throwable");
    }
  }
          ...
          if (!cl.isInterface()) {
            try {
              ...
              if (ctors.length > 0) {
                ...
                throw new DeeptestUtilsException(

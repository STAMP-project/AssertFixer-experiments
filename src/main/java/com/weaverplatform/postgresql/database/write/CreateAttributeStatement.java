...
import com.weaverplatform.protocol.model.AttributeValue;
...
public class CreateAttributeStatement  implements WriteStatement  {
  ...
  public void addToBatch(PreparedStatement statement) throws SQLException, WeaverDatabaseException {
    ...
    AttributeValue value = operation.getValue();
    ...
    switch (DataTypeUtil.primitiveDataType(operation.getDatatype())) {
      ...
      case DOUBLE:
        statement.setDouble(6, value.asDouble());
        break;

      case STRING:
        statement.setString(7, value.asString());
        break;

      case BOOLEAN:
        statement.setBoolean(8, value.asBoolean());
        break;

...
public class File {
  ...
  static {
    MAX_FILE_SIZE           = Long.parseLong(Props.get("MAX_FILE_SIZE","file.max_file_size"));    // the maximum size allowed for uploaded files
    MAX_REQUEST_SIZE        = Long.parseLong(Props.get("MAX_REQUEST_SIZE", "file.max_request_size")); // the maximum size allowed for multipart/form-data requests

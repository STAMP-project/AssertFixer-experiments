package com.brave.tradebravely.config;
...
@Configuration
@EnableMongoRepositories("com.brave.tradebravely.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.brave.tradebravely.config.dbmigrations");

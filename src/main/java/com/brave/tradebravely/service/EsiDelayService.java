...
@Service
public class EsiDelayService {

    static final String LIMIT_RESET = "x-esi-error-limit-reset";
    static final String LIMIT_REMAIN = "x-esi-error-limit-remain";

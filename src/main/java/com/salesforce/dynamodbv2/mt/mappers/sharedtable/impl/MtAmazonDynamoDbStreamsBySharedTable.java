...
public class MtAmazonDynamoDbStreamsBySharedTable extends MtAmazonDynamoDbStreamsBase<MtAmazonDynamoDbBySharedTable> {
    ...
    protected GetRecordsResult getRecords(StreamArn arn, Function<Record, MtRecord> recordMapper,
        ...
        GetRecordsResult mtResult = mapResult(arn, recordMapper, result);
        ...
        while (mtResult.getRecords().size() < limit
            ...
            GetRecordsResult nextMtResult = mapResult(arn, recordMapper, nextResult);

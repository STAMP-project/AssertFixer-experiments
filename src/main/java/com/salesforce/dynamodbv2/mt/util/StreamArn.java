...
public class StreamArn {
    ...
    public static class MtStreamArn extends StreamArn {
        ...
        public static String toMtStreamArnString(String arn, String context, String virtualTableName) {
            return String.format(VIRTUAL_FORMAT, arn, context, virtualTableName);
        }
        ...
        public String toString() {
            return toMtStreamArnString(super.toString(), context, mtTableName);
        }
    }
    ...
    public static StreamArn fromString(String arn) {
        ...
        checkArgument(context.isPresent() == virtualTableName.isPresent());

 ...
 */
package com.helger.validator.secure;
...
import com.helger.validator.secure.page.PageSecureAdminAddons;
...
public final class MenuSecure
{
  ...
  public static void init (@Nonnull final IMenuTree aMenuTree)
  {
    ...
    // statically!
    final MenuObjectFilterUserAssignedToUserGroup aFilterAdministrators = new MenuObjectFilterUserAssignedToUserGroup (CPVApp.USERGROUP_ADMINISTRATORS_ID);
    ...
    // Administrator
    {
      ...
      BootstrapPagesMenuConfigurator.addAllItems (aMenuTree, aAdmin, aFilterAdministrators, CPVApp.DEFAULT_LOCALE);
    }

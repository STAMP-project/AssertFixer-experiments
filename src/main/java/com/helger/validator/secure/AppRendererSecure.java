...
import com.helger.validator.pub.AppRendererPublic;
...
public final class AppRendererSecure
{
  ...
  private static IHCNode _getNavbar (@Nonnull final LayoutExecutionContext aLEC)
  {
    ...
    aNavbar.addBrand (new HCNodeList ().addChild (new HCSpan ().addClass (CAppCSS.CSS_CLASS_LOGO1)
                                                               .addChild (PVHelper.getApplicationTitle ()))
                                       .addChild (new HCSpan ().addClass (CAppCSS.CSS_CLASS_LOGO2)
                                                               .addChild (" Administration")),
                      aLinkToStartPage);

    final BootstrapNav aNav = new BootstrapNav ();
    aNav.addButton (new BootstrapButton ().setOnClick (LinkHelper.getURLWithContext (AbstractPublicApplicationServlet.SERVLET_DEFAULT_PATH))

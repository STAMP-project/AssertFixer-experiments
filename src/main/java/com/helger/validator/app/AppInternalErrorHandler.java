...
public final class AppInternalErrorHandler extends AbstractErrorCallback
{
  ...
  public static void doSetup ()
  {
    ...
    InternalErrorSettings.setSMTPSenderAddress (new EmailAddress ("phoss-validator@helger.com",
                                                                  "phoss-validator application"));
    ...
    InternalErrorSettings.setFallbackLocale (CPVApp.DEFAULT_LOCALE);
  }
}

...
import com.helger.validator.ui.PVLoginManager;
...
{
  private PVLoginManager m_aLogin;
                                     ...
                                     @Nonnull final UnifiedResponse aUnifiedResponse) throws ServletException
  {
    ...
    if (!SecurityHelper.hasUserAllRoles (sCurrentUserID, CPVApp.REQUIRED_ROLE_IDS_CONFIG))
    {

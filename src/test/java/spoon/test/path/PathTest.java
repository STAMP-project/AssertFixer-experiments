...
public class PathTest {
	...
	public void testRoles() {
		...
		assertEquals("#subPackage[name=spoon]#subPackage[name=test]#subPackage[name=path]#subPackage[name=testclasses]#containedType[name=Foo]#method[name=foo()]#body#statement[index=2]#else", absPath.toString());

...
class SimpleObjectHolderTest {
  ...
  @Test
  void computeAndSetNewValue_ReturnsCorrectValue() {
    final SimpleObjectHolder<String> holder = new SimpleObjectHolder<>("Hello");
    holder.computeAndSetNewValue(s -> s + ", world!");
    assertThat(holder.getValue()).isEqualTo("Hello, world!");
  }

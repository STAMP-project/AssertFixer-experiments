...
public class SqlLineArgsTest {
  ...
  public void testManual() throws Throwable {
    final String expectedLine0 = "Installing SQLLine";
    final String expectedLine1 = "Using SQLLine";
    final String expectedLine2 = "Running SQLLine";
    final String expectedLine3 = "Connecting to a database";
    ...
    // -e option here to make SqlLine#exit = true to skip prompt output.
    // The command could be any
    ...
    beeLine.runCommands(Collections.singletonList("!manual"), dc);

    String output = os.toString("UTF8");

    assertThat(output, CoreMatchers.allOf(
        containsString(expectedLine0),
        containsString(expectedLine1),
        containsString(expectedLine2),
        containsString(expectedLine3)));
  }
  ...
  public void testRerun() throws Throwable {
    // nulls are displayed as custom_null
    final String script1 = "!/ " + Integer.MAX_VALUE + "\n";
    checkScriptFile(script1, true, not(equalTo(SqlLine.Status.OK)),
        containsString("Usage: rerun <offset>, max offset is"));
    final String script2 = "!/ wrongnumber\n";
    checkScriptFile(script2, true, not(equalTo(SqlLine.Status.OK)),
        containsString("Usage: rerun <offset>, max offset is"));
  }

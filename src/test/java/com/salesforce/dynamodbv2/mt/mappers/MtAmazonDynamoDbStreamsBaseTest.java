...
public class MtAmazonDynamoDbStreamsBaseTest {
    ...
    private static String getShardIterator(AmazonDynamoDBStreams mtDynamoDbStreams, String streamArn) {
    ...
    void testTableStream(MtAmazonDynamoDbBase mtDynamoDb) {
        ...
        try {
            ...
            MT_CONTEXT.withContext(TENANTS[0], () -> {
                ...
                String iterator = getShardIterator(mtDynamoDbStreams, streamArn);

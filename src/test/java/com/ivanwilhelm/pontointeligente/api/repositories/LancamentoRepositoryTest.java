...
import com.ivanwilhelm.pontointeligente.api.enums.TipoEnum;
...
public class LancamentoRepositoryTest {
    ...
    public void testBuscarLancamentosPorFuncionarioId() {
        ...
        Assertions.assertThat(lancamentos.size()).isEqualTo(2);
    }
    ...
    public void testBuscarLancamentosPorFuncionarioIdPaginado() {
        ...
        Assertions.assertThat(lancamentos.getTotalElements()).isEqualTo(2);
        Assertions.assertThat(lancamentos.getTotalPages()).isEqualTo(1);
        Assertions.assertThat(lancamentos.getNumber()).isEqualTo(0);
    }

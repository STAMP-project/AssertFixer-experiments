...
import com.ericsson.ei.controller.TestAuthControllerImpl;
import com.ericsson.ei.controller.TestDownloadControllerImpl;
import com.ericsson.ei.controller.TestQueryControllerImpl;
import com.ericsson.ei.handlers.test.ObjectHandlerTest;
import com.ericsson.ei.handlers.test.UpStreamEventHandlerTest;
...
import com.ericsson.ei.rmqhandler.RmqHandlerTest;
import com.ericsson.ei.rules.test.TestRulesRestAPI;
...
@Suite.SuiteClasses({TestRulesService.class,
        ...
        TestRulesRestAPI.class,
        RmqHandlerTest.class,
        UpStreamEventHandlerTest.class,
        TestQueryControllerImpl.class,
        TestDownloadControllerImpl.class,
        TestAuthControllerImpl.class})

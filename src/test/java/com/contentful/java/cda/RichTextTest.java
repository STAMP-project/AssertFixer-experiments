...
public class RichTextTest extends BaseTest {
  ...
  @Test
  @Enqueue(value = "rich_text/simple_quote.json", defaults = {"rich_text/locales.json", "rich_text/content_types.json"})
  public void simple_quote_test() {
    ...
    final CDARichText text = (CDARichText) block.getContent().get(0);
    assertThat(text.getText()).isEqualTo("This is some simple quote");
  }

...
/*    @Test
    ...
    public void testCreateOrder() throws Exception
    {
        for (int i = 0; i < 4; i++)
        {
            ...
            actionwords.iClickButtonButtonXpath("//*[@id=\"app\"]/div[3]/div[2]/div[3]/div[3]/div/div[2]/button");
            // And I enter contact info "null" "null" "null"
            //actionwords.iEnterContactInfo("test", "atwinta", "");

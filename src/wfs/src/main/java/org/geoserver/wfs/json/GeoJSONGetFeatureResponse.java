...
public class GeoJSONGetFeatureResponse extends WFSGetFeatureOutputFormat {
    ...
    protected GeoJSONBuilder getGeoJSONBuilder(
        ...
        int[] numDecimalsEncodeMeasures =
                getNumDecimalsEncodeMeasures(featureCollection.getFeature(), gs, gs.getCatalog());
        jsonWriter.setNumberOfDecimals(numDecimalsEncodeMeasures[0]);
        jsonWriter.setEncodeMeasures(numDecimalsEncodeMeasures[1] == 1);
        return jsonWriter;
    }

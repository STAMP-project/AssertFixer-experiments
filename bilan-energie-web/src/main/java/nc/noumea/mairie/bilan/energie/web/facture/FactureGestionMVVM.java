...
public class FactureGestionMVVM extends AbstractMVVM {
	...
	private boolean onlyATraiter = true;
	...
	public void init() throws TechnicalException {
		loadFichierFactureList();
		this.onlyATraiter = true;
	}

	@NotifyChange({"dataSet","onlyATraiter"})
	@Command
	public void loadFichierFactureList() throws TechnicalException {
		try {
			if (onlyATraiter)
				dataSet = fichierFactureService.getAllATraiter();
			else
	...
	public boolean getOnlyATraiter() {
		return onlyATraiter;
	}


	public boolean isOnlyATraiter() {
		return onlyATraiter;
	}

	public void setOnlyATraiter(boolean onlyATraiter) {
		this.onlyATraiter = onlyATraiter;
	}
}

...
import nc.noumea.mairie.bilan.energie.business.entities.*;
...
public class IntegrationFactureServiceTest extends BilanBusinessTestNG {
    ...
    private void deleteAllEntity() {
        try {
            ...
            List<Parametrage> parametrageList = parametrageService.getAll();
            for (Parametrage parametrage : parametrageList) {
                getCurrentSession().delete(getCurrentSession().get(ParametrageEntity.class, parametrage.getId()));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public FichierFactureSimple createFichierFacture(String nom, String md5, EtatFichier etatFichier) throws TechnicalException, BusinessException {
    ...
    public void testIntegrerFichierFacture() throws TechnicalException, BusinessException, IOException {
        ...
        assertEquals(fichierFactureService.getAll().size(), 1);
        ...
        assertEquals(fichierFactureSimpleList.size(), 2);

...
public class PoliceBusiness extends AbstractCrudBusiness<Police, PoliceEntity>
	...
	public void validate(Police police) throws BusinessException, TechnicalException {
		...
		validateNumeroDoublon(police);
		validateDates(police);
	}

	private void validateNumeroDoublon(Police police) throws BusinessException, TechnicalException {
	...
	public void validateListeCompteur(Police police) throws BusinessException, TechnicalException{
		if (police.getListeCompteur() != null){
			for (Compteur compteur : police.getListeCompteur()){
				try {
					compteurService.validateFromPolice(compteur, police);
	...
	@Override
	public Police create(Police police) throws ValidatorException, TechnicalException, BusinessException {
		if (police.getNumPolice() !=  null){
			police.setNumPolice(police.getNumPolice().trim());
		}
		if (police.getListeCompteur() != null){
			for (Compteur compteur:police.getListeCompteur()){
				if (compteur.getNumCompteur() !=  null){
					compteur.setNumCompteur(compteur.getNumCompteur().trim());
				}
			}
		}
		return super.create(police);
	}

	@Override
	public Police update(Police police) throws ValidatorException, TechnicalException, BusinessException {
		if (police.getNumPolice() !=  null){
			police.setNumPolice(police.getNumPolice().trim());
		}
		if (police.getListeCompteur() != null){

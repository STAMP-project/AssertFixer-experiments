...
public class JournalCompatibilityTest extends VersionedBaseTest {
   ...
   public void testSendReceive() throws Throwable {
      ...
      startServer(serverFolder.getRoot(), senderClassloader, "journalTest",  true,null, true);
      evaluate(senderClassloader, "meshTest/sendMessages.groovy", server, sender, "sendAckMessages");
      stopServer(senderClassloader);

      startServer(serverFolder.getRoot(), receiverClassloader, "journalTest",  true,null, false);
   ...
   public void testSendReceiveSizeQueueMetricsPaging() throws Throwable {
      ...
      startServer(serverFolder.getRoot(), senderClassloader, "journalTest", true, Long.toString(1), true);
      ...
      startServer(serverFolder.getRoot(), receiverClassloader, "journalTest", true, Long.toString(1), false);

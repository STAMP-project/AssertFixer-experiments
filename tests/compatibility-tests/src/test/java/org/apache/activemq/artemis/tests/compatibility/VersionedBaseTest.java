...
public abstract class VersionedBaseTest {
   ...
   public void startServer(File folder, ClassLoader loader, String serverName, boolean persist) throws Throwable {
      startServer(folder, loader, serverName, persist, null);
   }

   public void startServer(File folder, ClassLoader loader, String serverName, boolean persist, String globalMaxSize) throws Throwable {
      startServer(folder, loader, serverName, persist, globalMaxSize, false);

   }
   public void startServer(File folder, ClassLoader loader, String serverName, boolean persist, String globalMaxSize, boolean setAddressSettings) throws Throwable {
      folder.mkdirs();
      ...
      startServer(scriptToUse, folder, loader, serverName, persist, globalMaxSize, setAddressSettings);
   }

   public void startServer(String scriptToUse,
                            File folder,
                            ClassLoader loader,
                            String serverName,
                            boolean persist,
                            String globalMaxSize,
                            boolean setAddressSettings) throws Exception {
      setVariable(loader, "persistent", true);

...
serverA = new EmbeddedActiveMQ();
serverA.setConfiguration(configuration);
serverA.start();

serverA.getActiveMQServer().createQueue(new SimpleString("jms.queue.sourceQueue"), new SimpleString("jms.queue.sourceQueue"), null, true, false);

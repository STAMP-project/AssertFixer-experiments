...
public class ActiveMQDestinationTest extends ActiveMQTestBase {
   ...
   @Test
   public void test1XPrefixSystemProperty() throws Exception {
      try {
         System.setProperty("org.apache.activemq.artemis.api.jms.ActiveMQJMSClient.enable1xPrefixes", "true");
         ActiveMQJMSClient.init();
         internal1XTest();
      } finally {
         System.clearProperty("org.apache.activemq.artemis.api.jms.ActiveMQJMSClient.enable1xPrefixes");
         ActiveMQJMSClient.init();
      }
   }

   private void internal1XTest() {
   ...
   @Test
   public void test1XPrefixPropertiesFile() throws Exception {
      try {
         ActiveMQJMSClient.init("ActiveMQDestinationTest.properties");
         internal1XTest();
      } finally {

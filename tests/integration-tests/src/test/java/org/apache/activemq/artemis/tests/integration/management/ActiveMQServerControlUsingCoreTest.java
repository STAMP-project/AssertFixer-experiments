...
public class ActiveMQServerControlUsingCoreTest extends ActiveMQServerControlTest {
   ...
   protected ActiveMQServerControl createManagementControl() throws Exception {
      return new ActiveMQServerControl() {
         ...
         @Override
         public String updateQueue(String name, String routingType, Integer maxConsumers, Boolean purgeOnNoConsumers, Boolean exclusive, Integer consumersBeforeDispatch, Long delayBeforeDispatch, String filter, String user) throws Exception {
            return null;
         }

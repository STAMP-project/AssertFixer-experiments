...
public class ArrayRealVector implements Serializable , RealVector {
	...
	public ArrayRealVector(double[] d, boolean copyArray) throws IllegalArgumentException, NullPointerException {
		if (d == null) {

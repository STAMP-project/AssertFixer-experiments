...
class InsuranceEndorsementEntityTest {

    @Test
    fun insuranceEndorsementEntityEqualsTest() {

        var objectOne = InsuranceEndorsementEntity()
    ...
    @Test
    fun insuranceEndorsementEntityHashCodeTest() {

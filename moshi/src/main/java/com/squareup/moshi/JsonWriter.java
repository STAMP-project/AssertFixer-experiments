...
public abstract class JsonWriter implements Closeable, Flushable {
   ...
   *
   * <ul>
   *     <li>If 0, no begin/end pairs are being suppressed.
   ...
   * }</pre>
   *
   * <p>This method supports flattening arrays within arrays and objects within objects. Other
   * combinations are allowed but do not participate in flattening.
   *

...
/**
 * AuthenticationScriptConfig.java
 *
 ...
 */
                ...
                package org.wso2.carbon.identity.application.common.model.script.xsd;
            

            /**
            *  AuthenticationScriptConfig bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AuthenticationScriptConfig
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = AuthenticationScriptConfig
                Namespace URI = http://script.model.common.application.identity.carbon.wso2.org/xsd
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://script.model.common.application.identity.carbon.wso2.org/xsd");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AuthenticationScriptConfig",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localContentTracker){
                                    namespace = "http://script.model.common.application.identity.carbon.wso2.org/xsd";
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://script.model.common.application.identity.carbon.wso2.org/xsd")){
                return "ns2";
            }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localContentTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://script.model.common.application.identity.carbon.wso2.org/xsd",
                                                                      "content"));
    ...
    public static class Factory{
        ...
        */
        public static AuthenticationScriptConfig parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AuthenticationScriptConfig object =
                new AuthenticationScriptConfig();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AuthenticationScriptConfig".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AuthenticationScriptConfig)org.wso2.carbon.identity.application.common.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://script.model.common.application.identity.carbon.wso2.org/xsd","content").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://script.model.common.application.identity.carbon.wso2.org/xsd","enabled").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://script.model.common.application.identity.carbon.wso2.org/xsd","language").equals(reader.getName())){

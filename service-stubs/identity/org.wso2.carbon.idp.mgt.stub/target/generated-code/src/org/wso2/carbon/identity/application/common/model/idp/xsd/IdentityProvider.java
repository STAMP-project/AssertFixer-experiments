                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"IdentityProvider".equals(type)){
                                ...
                                return (IdentityProvider)org.wso2.carbon.identity.application.common.model.idp.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list18 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://model.common.application.identity.carbon.wso2.org/xsd","id").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list14.add(org.wso2.carbon.identity.application.common.model.idp.xsd.IdentityProviderProperty.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list18.add(org.wso2.carbon.identity.application.common.model.idp.xsd.ProvisioningConnectorConfig.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array

 ...
 */
            ...
            /**
            *  RemoveLocalClaim bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RemoveLocalClaim
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":removeLocalClaim",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "removeLocalClaim",
    ...
    public static class Factory{
        ...
        */
        public static RemoveLocalClaim parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveLocalClaim object =
                new RemoveLocalClaim();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"removeLocalClaim".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RemoveLocalClaim)org.wso2.carbon.identity.claim.metadata.mgt.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","localClaimURI").equals(reader.getName())){

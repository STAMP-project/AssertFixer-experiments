...
/**
 * ResendSignUpConfiramtionCode.java
 *
 ...
 */
            ...
            /**
            *  ResendSignUpConfiramtionCode bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ResendSignUpConfiramtionCode
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":resendSignUpConfiramtionCode",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "resendSignUpConfiramtionCode",
    ...
    public static class Factory{
        ...
        */
        public static ResendSignUpConfiramtionCode parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ResendSignUpConfiramtionCode object =
                new ResendSignUpConfiramtionCode();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"resendSignUpConfiramtionCode".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ResendSignUpConfiramtionCode)org.wso2.carbon.captcha.mgt.beans.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for TransportHeaders
                        * This was an Array!
                        */

                        
                                    protected org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader[] localTransportHeaders ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           public boolean isTransportHeadersSpecified(){
                               return localTransportHeadersTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader[]
                           */
                           public  org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader[] getTransportHeaders(){
                               return localTransportHeaders;
                           }
                              ...
                              /**
                               * validate the array for TransportHeaders
                               */
                              protected void validateTransportHeaders(org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param TransportHeaders
                              */
                              public void setTransportHeaders(org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader[] param){
                              
                                   validateTransportHeaders(param);

                               localTransportHeadersTracker = true;
                                      
                                      this.localTransportHeaders=param;
                              }
                             ...
                             * @param param org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader
                             */
                             public void addTransportHeaders(org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader param){
                                   if (localTransportHeaders == null){
                                   localTransportHeaders = new org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localTransportHeaders);
                               list.add(param);
                               this.localTransportHeaders =
                             (org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader[])list.toArray(
                            new org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localDomainNameTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localTransportHeadersTracker){
                                       if (localTransportHeaders!=null){
                                            for (int i = 0;i < localTransportHeaders.length;i++){
                                                if (localTransportHeaders[i] != null){
                                                 localTransportHeaders[i].serialize(new javax.xml.namespace.QName("http://dto.mgt.identity.carbon.wso2.org/xsd","transportHeaders"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://dto.mgt.identity.carbon.wso2.org/xsd", "transportHeaders", xmlWriter);
                             ...
                             if (localTransportHeaders!=null) {
                                 for (int i = 0;i < localTransportHeaders.length;i++){
                                    ...
                                    if (localTransportHeaders[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://dto.mgt.identity.carbon.wso2.org/xsd",
                                                                          "transportHeaders"));
                                         elementList.add(localTransportHeaders[i]);
                                    } else {
                                        ...
                                        elementList.add(new javax.xml.namespace.QName("http://dto.mgt.identity.carbon.wso2.org/xsd",
                                                                          "transportHeaders"));
                                        elementList.add(localTransportHeaders);
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list9 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.mgt.identity.carbon.wso2.org/xsd","transportHeaders").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list9.add(org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone9){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://dto.mgt.identity.carbon.wso2.org/xsd","transportHeaders").equals(reader.getName())){
                                                        ...
                                                        object.setTransportHeaders((org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                org.wso2.carbon.identity.mgt.mail.xsd.TransportHeader.class,
                                                                list9));

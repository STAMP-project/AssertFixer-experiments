...
/**
 * CountUsersInDomainResponse.java
 *
 ...
 */
            ...
            /**
            *  CountUsersInDomainResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CountUsersInDomainResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":countUsersInDomainResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "countUsersInDomainResponse",
    ...
    public static class Factory{
        ...
        */
        public static CountUsersInDomainResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CountUsersInDomainResponse object =
                new CountUsersInDomainResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"countUsersInDomainResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CountUsersInDomainResponse)org.wso2.carbon.identity.user.store.count.stub.dto.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

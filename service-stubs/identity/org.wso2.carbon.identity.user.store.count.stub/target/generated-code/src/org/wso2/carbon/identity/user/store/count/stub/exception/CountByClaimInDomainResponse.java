...
/**
 * CountByClaimInDomainResponse.java
 *
 ...
 */
            ...
            /**
            *  CountByClaimInDomainResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CountByClaimInDomainResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://org.apache.axis2/xsd",
                "countByClaimInDomainResponse",
                "ns3");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":countByClaimInDomainResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "countByClaimInDomainResponse",
    ...
    public static class Factory{
        ...
        */
        public static CountByClaimInDomainResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CountByClaimInDomainResponse object =
                new CountByClaimInDomainResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"countByClaimInDomainResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CountByClaimInDomainResponse)org.wso2.carbon.identity.user.store.count.stub.dto.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

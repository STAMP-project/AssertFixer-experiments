 ...
 */
            ...
            /**
            *  CountRoles bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CountRoles
    ...
    public static class Factory{
        ...
        */
        public static CountRoles parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CountRoles object =
                new CountRoles();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"countRoles".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CountRoles)org.wso2.carbon.identity.user.store.count.stub.dto.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

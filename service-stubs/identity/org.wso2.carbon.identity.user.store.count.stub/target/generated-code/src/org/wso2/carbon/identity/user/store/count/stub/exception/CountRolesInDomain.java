 ...
 */
            ...
            /**
            *  CountRolesInDomain bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CountRolesInDomain
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":countRolesInDomain",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "countRolesInDomain",
    ...
    public static class Factory{
        ...
        */
        public static CountRolesInDomain parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CountRolesInDomain object =
                new CountRolesInDomain();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"countRolesInDomain".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CountRolesInDomain)org.wso2.carbon.identity.user.store.count.stub.dto.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

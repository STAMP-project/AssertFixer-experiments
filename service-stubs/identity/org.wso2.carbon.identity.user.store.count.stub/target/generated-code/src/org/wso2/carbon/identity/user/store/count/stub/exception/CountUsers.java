 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static CountUsers parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CountUsers object =
                new CountUsers();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"countUsers".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CountUsers)org.wso2.carbon.identity.user.store.count.stub.dto.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

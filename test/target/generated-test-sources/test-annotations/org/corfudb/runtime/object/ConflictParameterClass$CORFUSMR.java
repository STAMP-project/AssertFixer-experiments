...
public class ConflictParameterClass$CORFUSMR extends ConflictParameterClass implements ICorfuSMR<ConflictParameterClass> {
  ...
  .put("mutatorAccessorTest", (obj, args) -> { return obj.mutatorAccessorTest((java.lang.String) args[0], (java.lang.String) args[1]);})
  .put("mutatorTest", (obj, args) -> { obj.mutatorTest((int) args[0], (int) args[1]);return null;}).build();

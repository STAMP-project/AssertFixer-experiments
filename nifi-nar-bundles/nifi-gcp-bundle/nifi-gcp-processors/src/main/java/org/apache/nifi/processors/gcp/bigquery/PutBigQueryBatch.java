...
public class PutBigQueryBatch extends AbstractBigQueryProcessor {
    ...
    public void onTrigger(ProcessContext context, ProcessSession session) throws ProcessException {
        ...
        try {
            ...
            long minutes = Long.parseLong(attributes.get(BigQueryAttributes.JOB_READ_TIMEOUT_ATTR));
            Job job = writer.getJob();
            job = job.waitFor(RetryOption.totalTimeout(Duration.ofMinutes(minutes)));

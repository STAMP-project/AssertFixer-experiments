...
public class JettyServer implements NiFiServer {
    ...
    public void start() {
        try {
            ...
            // TODO this should come from the spring context
            final NarLoader narLoader = new NarLoader(props.getExtensionsWorkingDirectory(), props.getComponentDocumentationWorkingDirectory(), extensionMapping);

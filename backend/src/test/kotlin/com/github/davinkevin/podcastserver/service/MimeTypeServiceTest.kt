...
class MimeTypeServiceTest {
    ...
    inner class Service {
        @Mock
        lateinit var tikaProbeContentType: TikaProbeContentType
        @InjectMocks
        lateinit var mimeTypeService: MimeTypeService

        @Test
        fun should_get_mimeType_if_no_extension() {
            /* When */
        ...
        @Test
        fun should_get_mimetype_for_known_extension() {
            /* When */
        ...
        @Test
        fun should_get_mimetype_for_unknown_extension() {
            /* When */
        ...
        @Test
        fun should_get_extension_by_mimeType() {
            /* Given */
        ...
        @Test
        fun should_get_extension_by_Youtube() {
            /* Given */
        ...
        @Test
        fun should_get_extension_by_url() {
            /* Given */
            val item = Item()

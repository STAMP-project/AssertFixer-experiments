 ...
 * @since 4.0.
 */
public abstract class CheckedIntBooleanProcedure implements IntBooleanProcedure
{
    ...
    public final void value(int item1, boolean item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in IntBooleanProcedure", e);
        }
    }

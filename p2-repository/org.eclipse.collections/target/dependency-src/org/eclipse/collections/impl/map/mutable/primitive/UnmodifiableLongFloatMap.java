 ...
 * @since 3.1.
 */
public class UnmodifiableLongFloatMap
        implements MutableLongFloatMap, Serializable
{
    private static final long serialVersionUID = 1L;
    private final MutableLongFloatMap map;

    public UnmodifiableLongFloatMap(MutableLongFloatMap map)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a UnmodifiableLongFloatMap on a null map");
        }

 ...
 */
public class CollectBooleanToDoubleIterable
        extends AbstractLazyDoubleIterable
{
    private final BooleanIterable iterable;
    private final BooleanToDoubleFunction function;

    public CollectBooleanToDoubleIterable(BooleanIterable iterable, BooleanToDoubleFunction function)
    {
    ...
    public DoubleIterator doubleIterator()
    {
        ...
        {
            private final BooleanIterator iterator = CollectBooleanToDoubleIterable.this.iterable.booleanIterator();

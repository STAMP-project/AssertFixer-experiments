...
/**
 * A synchronized view of a {@link MutableLongShortMap}. It is imperative that the user manually synchronize on the collection when iterating over it using the
 * {@link MutableShortIterator} as per {@link Collections#synchronizedCollection(Collection)}.
 * <p>
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMap.stg.
 *
 * @see MutableLongShortMap#asSynchronized()
 * @see MutableMap#asSynchronized()
 * @since 3.1.
 */
public class SynchronizedLongShortMap
        implements MutableLongShortMap, Serializable
{
    private static final long serialVersionUID = 1L;
    private final Object lock;
    private final MutableLongShortMap map;

    public SynchronizedLongShortMap(MutableLongShortMap map)
    {
        this(map, null);
    }
    ...
    public SynchronizedLongShortMap(MutableLongShortMap map, Object newLock)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a SynchronizedLongShortMap on a null map");
        }
    ...
    public ImmutableLongShortMap toImmutable()
    {
        synchronized (this.lock)
        {
            return LongShortMaps.immutable.withAll(this);
        }
    }

 ...
 * @since 3.1.
 */
public class SynchronizedLongObjectMap<V>
        implements MutableLongObjectMap<V>, Serializable
{
    ...
    public SynchronizedLongObjectMap(MutableLongObjectMap<V> map)
    {
        this(map, null);
    }

    public SynchronizedLongObjectMap(MutableLongObjectMap<V> map, Object newLock)
    {
        if (map == null)
        {

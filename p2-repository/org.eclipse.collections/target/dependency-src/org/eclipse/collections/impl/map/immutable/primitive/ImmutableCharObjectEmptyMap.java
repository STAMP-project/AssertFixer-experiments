...
{
    static final ImmutableCharObjectMap<?> INSTANCE = new ImmutableCharObjectEmptyMap<>();
    ...
    {
        return ObjectCharMaps.immutable.empty();
    }
    ...
    {
        CharObjectHashMap<V> map = new CharObjectHashMap<>();
        map.put(key, value);

 ...
 * @since 4.0.
 */
public abstract class CheckedIntLongProcedure implements IntLongProcedure
{
    ...
    public final void value(int item1, long item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in IntLongProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(int item1, long item2) throws Exception;
}

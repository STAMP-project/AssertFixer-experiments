        ...
        implements MutableObjectByteMap<K>, Serializable
{
    ...
    public SynchronizedObjectByteMap(MutableObjectByteMap<K> map)
    {
        this(map, null);
    }

    public SynchronizedObjectByteMap(MutableObjectByteMap<K> map, Object newLock)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a SynchronizedObjectByteMap on a null map");
        }
    ...
    @Override
    public void putPair(ObjectBytePair<K> keyValuePair)
    {
        synchronized (this.lock)
        {

...
/**
 * ImmutableDoubleCharSingletonMap is an optimization for {@link ImmutableDoubleCharMap} of size 1.
 * This file was automatically generated from template file immutablePrimitivePrimitiveSingletonMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableDoubleCharSingletonMap implements ImmutableDoubleCharMap, Serializable
{
    ...
    ImmutableDoubleCharSingletonMap(double key1, char value1)
    {
        this.key1 = key1;
        this.value1 = value1;
    }
    ...
    {
        return CharDoubleMaps.immutable.with(this.value1, this.key1);
    }
    ...
    {
        return new UnmodifiableCharIterator(DoubleCharHashMap.newWithKeysValues(this.key1, this.value1).charIterator());
    }
    ...
    {
        return DoubleCharMaps.immutable.withAll(DoubleCharHashMap.newWithKeysValues(this.key1, this.value1, key, value));
    }

    @Override
    public ImmutableDoubleCharMap newWithoutKey(double key)
    {
        return Double.compare(this.key1, key) == 0 ? DoubleCharMaps.immutable.with() : this;
    }

    @Override
    public ImmutableDoubleCharMap newWithoutAllKeys(DoubleIterable keys)
    {
        return keys.contains(this.key1) ? DoubleCharMaps.immutable.with() : this;
    }

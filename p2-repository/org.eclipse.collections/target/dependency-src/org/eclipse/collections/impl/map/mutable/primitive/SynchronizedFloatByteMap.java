...
/**
 * A synchronized view of a {@link MutableFloatByteMap}. It is imperative that the user manually synchronize on the collection when iterating over it using the
 * {@link MutableByteIterator} as per {@link Collections#synchronizedCollection(Collection)}.
 * <p>
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMap.stg.
 *
 * @see MutableFloatByteMap#asSynchronized()
        ...
        implements MutableFloatByteMap, Serializable
{
    ...
    public SynchronizedFloatByteMap(MutableFloatByteMap map)
    {
        this(map, null);
    }
    ...
    public SynchronizedFloatByteMap(MutableFloatByteMap map, Object newLock)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a SynchronizedFloatByteMap on a null map");
        }

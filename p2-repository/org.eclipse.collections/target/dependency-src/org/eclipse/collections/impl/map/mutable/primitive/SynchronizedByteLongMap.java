...
/**
 * A synchronized view of a {@link MutableByteLongMap}. It is imperative that the user manually synchronize on the collection when iterating over it using the
 * {@link MutableLongIterator} as per {@link Collections#synchronizedCollection(Collection)}.
 * <p>
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMap.stg.
 *
 * @see MutableByteLongMap#asSynchronized()
        ...
        implements MutableByteLongMap, Serializable
{
    ...
    public SynchronizedByteLongMap(MutableByteLongMap map, Object newLock)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a SynchronizedByteLongMap on a null map");
        }

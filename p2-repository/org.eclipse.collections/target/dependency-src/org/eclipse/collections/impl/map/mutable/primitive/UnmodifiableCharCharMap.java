 ...
 * @since 3.1.
 */
public class UnmodifiableCharCharMap
        implements MutableCharCharMap, Serializable
{
    private static final long serialVersionUID = 1L;
    private final MutableCharCharMap map;

    public UnmodifiableCharCharMap(MutableCharCharMap map)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a UnmodifiableCharCharMap on a null map");
        }

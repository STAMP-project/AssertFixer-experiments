...
import org.eclipse.collections.impl.block.procedure.checked.primitive.CheckedDoubleShortProcedure;
...
/**
 * ImmutableDoubleShortHashMap is the non-modifiable equivalent of {@link DoubleShortHashMap}.
 * This file was automatically generated from template file immutablePrimitivePrimitiveHashMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableDoubleShortHashMap implements ImmutableDoubleShortMap, Serializable
{
    ...
    {
        return new ImmutableDoubleShortMapSerializationProxy(this);
    }

    protected static class ImmutableDoubleShortMapSerializationProxy implements Externalizable
    {
        private static final long serialVersionUID = 1L;
        ...
        public void writeExternal(final ObjectOutput out) throws IOException
        {
            ...
            try
            {
                this.map.forEachKeyValue(new CheckedDoubleShortProcedure()
                {
                    @Override
                    public void safeValue(double key, short value) throws IOException
                    {
                        out.writeDouble(key);

 ...
 * @since 4.0.
 */
public abstract class CheckedDoubleIntProcedure implements DoubleIntProcedure
{
    ...
    public final void value(double item1, int item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in DoubleIntProcedure", e);
        }
    }

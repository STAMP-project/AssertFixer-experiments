...
public abstract class CheckedIntFloatProcedure implements IntFloatProcedure
{
    ...
    @Override
    public final void value(int item1, float item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in IntFloatProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(int item1, float item2) throws Exception;
}

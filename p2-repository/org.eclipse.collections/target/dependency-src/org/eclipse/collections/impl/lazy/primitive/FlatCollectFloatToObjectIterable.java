 ...
 */
public class FlatCollectFloatToObjectIterable<V>
        extends AbstractLazyIterable<V>
{
    ...
    public FlatCollectFloatToObjectIterable(FloatIterable iterable, FloatToObjectFunction<? extends Iterable<V>> function)
    {
    ...
    {
        this.iterable.forEach((float each) -> Iterate.forEach(this.function.valueOf(each), procedure));
    }
    ...
    {
        this.iterable.forEach((float each) -> Iterate.forEachWith(this.function.valueOf(each), procedure, parameter));
    }

    @Override
    public Iterator<V> iterator()
    {
        return new FlatCollectFloatIterator<>(this.iterable, this.function);
    }
    ...
    private final class FlatCollectFloatIterator<V> implements Iterator<V>
    {
        private final FloatIterator iterator;
        private final FloatToObjectFunction<? extends Iterable<V>> function;
        private Iterator<V> innerIterator = EmptyIterator.getInstance();

        public FlatCollectFloatIterator(
                FloatIterable iterable,
                FloatToObjectFunction<? extends Iterable<V>> newFunction)
        {
            this(iterable.floatIterator(), newFunction);
        }

        public FlatCollectFloatIterator(
                FloatIterator newIterator,
                FloatToObjectFunction<? extends Iterable<V>> newFunction)
        {

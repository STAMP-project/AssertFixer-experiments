 ...
 */
public class CollectByteToCharIterable
        extends AbstractLazyCharIterable
{
    private final ByteIterable iterable;
    private final ByteToCharFunction function;

    public CollectByteToCharIterable(ByteIterable iterable, ByteToCharFunction function)
    {
    ...
    public CharIterator charIterator()
    {
        ...
        {
            private final ByteIterator iterator = CollectByteToCharIterable.this.iterable.byteIterator();

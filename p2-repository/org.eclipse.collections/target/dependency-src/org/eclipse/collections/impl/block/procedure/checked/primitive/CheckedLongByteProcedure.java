 ...
 * @since 4.0.
 */
public abstract class CheckedLongByteProcedure implements LongByteProcedure
{
    ...
    public final void value(long item1, byte item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in LongByteProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(long item1, byte item2) throws Exception;
}

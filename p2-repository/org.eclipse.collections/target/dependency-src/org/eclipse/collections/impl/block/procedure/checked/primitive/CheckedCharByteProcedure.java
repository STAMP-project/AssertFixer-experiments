 ...
 * @since 4.0.
 */
public abstract class CheckedCharByteProcedure implements CharByteProcedure
{
    ...
    public final void value(char item1, byte item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in CharByteProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(char item1, byte item2) throws Exception;
}

...
public abstract class CheckedObjectShortProcedure<V> implements ObjectShortProcedure<V>
{
    ...
    @Override
    public final void value(V item1, short item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in ObjectShortProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(V item1, short item2) throws Exception;
}

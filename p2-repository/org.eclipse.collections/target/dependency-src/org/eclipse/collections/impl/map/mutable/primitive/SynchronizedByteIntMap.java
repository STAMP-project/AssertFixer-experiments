...
/**
 * A synchronized view of a {@link MutableByteIntMap}. It is imperative that the user manually synchronize on the collection when iterating over it using the
 * {@link MutableIntIterator} as per {@link Collections#synchronizedCollection(Collection)}.
 * <p>
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMap.stg.
 *
 * @see MutableByteIntMap#asSynchronized()
        ...
        implements MutableByteIntMap, Serializable
{
    ...
    public ImmutableByteIntMap toImmutable()
    {
        synchronized (this.lock)
        {
            return ByteIntMaps.immutable.withAll(this);
        }
    }

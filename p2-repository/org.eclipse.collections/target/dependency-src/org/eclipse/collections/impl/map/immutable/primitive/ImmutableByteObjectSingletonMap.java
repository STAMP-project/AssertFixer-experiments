 ...
 * @since 4.0.
 */
final class ImmutableByteObjectSingletonMap<V> extends AbstractImmutableByteObjectMap<V> implements Serializable
{
    ...
    public ImmutableByteObjectMap<V> select(ByteObjectPredicate<? super V> predicate)
    {
        return predicate.accept(this.key1, this.value1) ? ByteObjectHashMap.newWithKeysValues(this.key1, this.value1).toImmutable()
                : (ImmutableByteObjectMap<V>) ImmutableByteObjectEmptyMap.INSTANCE;
    }

    @Override
    public ImmutableByteObjectMap<V> reject(ByteObjectPredicate<? super V> predicate)
    {
        return predicate.accept(this.key1, this.value1) ? (ImmutableByteObjectMap<V>) ImmutableByteObjectEmptyMap.INSTANCE
    ...
    {
        return this.key1 == key ? (ImmutableByteObjectMap<V>) ImmutableByteObjectEmptyMap.INSTANCE : this;
    }

    @Override
    public ImmutableByteObjectMap<V> newWithoutAllKeys(ByteIterable keys)
    {
        return keys.contains(this.key1) ? (ImmutableByteObjectMap<V>) ImmutableByteObjectEmptyMap.INSTANCE : this;
    }
    ...
    {
        return new ImmutableByteObjectMapSerializationProxy<V>(this);
    }
}

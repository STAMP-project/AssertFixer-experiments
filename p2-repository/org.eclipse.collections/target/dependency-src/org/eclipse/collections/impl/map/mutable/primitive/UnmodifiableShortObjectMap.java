 ...
 * @since 3.2.
 */
public class UnmodifiableShortObjectMap<V>
        implements MutableShortObjectMap<V>, Serializable
{
    private static final long serialVersionUID = 1L;
    private final MutableShortObjectMap<V> map;

    public UnmodifiableShortObjectMap(MutableShortObjectMap<V> map)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a UnmodifiableShortObjectMap on a null map");
        }

 ...
 * @since 4.0.
 */
public abstract class CheckedByteByteProcedure implements ByteByteProcedure
{
    ...
    public final void value(byte item1, byte item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in ByteByteProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(byte item1, byte item2) throws Exception;
}

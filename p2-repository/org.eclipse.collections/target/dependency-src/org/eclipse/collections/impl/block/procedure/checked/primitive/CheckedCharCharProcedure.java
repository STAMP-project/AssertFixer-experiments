 ...
 * @since 4.0.
 */
public abstract class CheckedCharCharProcedure implements CharCharProcedure
{
    ...
    public final void value(char item1, char item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in CharCharProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(char item1, char item2) throws Exception;
}

 ...
 * @since 3.1.
 */
public class UnmodifiableDoubleDoubleMap
        implements MutableDoubleDoubleMap, Serializable
{
    private static final long serialVersionUID = 1L;
    private final MutableDoubleDoubleMap map;

    public UnmodifiableDoubleDoubleMap(MutableDoubleDoubleMap map)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a UnmodifiableDoubleDoubleMap on a null map");
        }

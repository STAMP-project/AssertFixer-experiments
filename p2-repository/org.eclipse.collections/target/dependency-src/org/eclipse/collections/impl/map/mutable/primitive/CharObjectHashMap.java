...
public class CharObjectHashMap<V> implements MutableCharObjectMap<V>, Externalizable
{
    ...
    {
        return new CharObjectHashMap<V>(1).withKeyValue(key, value);
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        CharObjectMap<V> other = (CharObjectMap<V>) obj;
    ...
    {
        CharObjectHashMap<V> result = CharObjectHashMap.newMap();
    ...
    {
        map.forEachKeyValue((char key, V value) -> CharObjectHashMap.this.put(key, value));
    }
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException
    {
        ...
        {
            this.put(in.readChar(), (V) in.readObject());
        }
    }
    ...
    private class InternalIterator implements Iterator<V>
    {
        ...
        public V next()
        {
            ...
            if (!this.handledZeroKey)
            {
                ...
                if (CharObjectHashMap.this.containsKey(EMPTY_KEY))
                {
                    this.currentKey = CharObjectHashMap.EMPTY_KEY;
            ...
            if (!this.handledOneKey)
            {
                ...
                if (CharObjectHashMap.this.containsKey(REMOVED_KEY))
                {
                    this.currentKey = CharObjectHashMap.REMOVED_KEY;
                    this.isCurrentKeySet = true;
            ...
            this.isCurrentKeySet = true;
            V result = CharObjectHashMap.this.values[this.position];
            this.position++;
            return result;
        }
    ...
    private class KeySet implements MutableCharSet
    {
        ...
        public boolean retainAll(CharIterable source)
        {
            ...
            CharObjectHashMap<V> retained = CharObjectHashMap.this.select((char key, V value) -> sourceSet.contains(key));
            if (retained.size() != oldSize)
            {
                CharObjectHashMap.this.keys = retained.keys;
                CharObjectHashMap.this.values = retained.values;
                CharObjectHashMap.this.sentinelValues = retained.sentinelValues;
                CharObjectHashMap.this.occupiedWithData = retained.occupiedWithData;
                CharObjectHashMap.this.occupiedWithSentinels = retained.occupiedWithSentinels;
                return true;
            }
            return false;
        }
        ...
        public char max()
        {
            ...
            {
                if (isNonSentinel(CharObjectHashMap.this.keys[i]) && (!isMaxSet || max < CharObjectHashMap.this.keys[i]))
                {
        ...
        public char min()
        {
            ...
            if (CharObjectHashMap.this.sentinelValues != null)
            {
                ...
                if (CharObjectHashMap.this.sentinelValues.containsOneKey && !isMinSet)
                {
                    min = REMOVED_KEY;
                    isMinSet = true;
                }
            ...
            for (int i = 0; i < CharObjectHashMap.this.keys.length; i++)
            {
                if (isNonSentinel(CharObjectHashMap.this.keys[i]) && (!isMinSet || CharObjectHashMap.this.keys[i] < min))
                {
        ...
        public boolean containsAll(char... source)
        {
            for (char item : source)
            {
                if (!CharObjectHashMap.this.containsKey(item))
                {
                    return false;
                }
            }
        ...
        public CharSet freeze()
        {
            ...
            if (CharObjectHashMap.this.sentinelValues != null)
            {
                containsZeroKey = CharObjectHashMap.this.sentinelValues.containsZeroKey;
                containsOneKey = CharObjectHashMap.this.sentinelValues.containsOneKey;
            }
        ...
        public int hashCode()
        {
            ...
            for (int i = 0; i < CharObjectHashMap.this.keys.length; i++)
            {
                if (isNonSentinel(CharObjectHashMap.this.keys[i]))
                {
                    result += (int) CharObjectHashMap.this.keys[i];
                }
            }
    ...
    private class KeysSetIterator implements MutableCharIterator
    {
        private int count;
        private int position;
    ...
    {
        MutableObjectCharMap<V> result = ObjectCharMaps.mutable.empty();
    ...
    private class KeyValuesView extends AbstractLazyIterable<CharObjectPair<V>>
    {
        @Override
        public void each(Procedure<? super CharObjectPair<V>> procedure)
        {
            if (CharObjectHashMap.this.sentinelValues != null)
            {
                if (CharObjectHashMap.this.sentinelValues.containsZeroKey)
                {
                    procedure.value(PrimitiveTuples.pair(EMPTY_KEY, CharObjectHashMap.this.sentinelValues.zeroValue));
                }
                if (CharObjectHashMap.this.sentinelValues.containsOneKey)
                {
                    procedure.value(PrimitiveTuples.pair(REMOVED_KEY, CharObjectHashMap.this.sentinelValues.oneValue));
                }
            }
            for (int i = 0; i < CharObjectHashMap.this.keys.length; i++)
            {
        ...
        public void forEachWithIndex(ObjectIntProcedure<? super CharObjectPair<V>> objectIntProcedure)
        {
            ...
            if (CharObjectHashMap.this.sentinelValues != null)
            {
                if (CharObjectHashMap.this.sentinelValues.containsZeroKey)
                {
                    objectIntProcedure.value(PrimitiveTuples.pair(EMPTY_KEY, CharObjectHashMap.this.sentinelValues.zeroValue), index);
                    index++;
                }
                if (CharObjectHashMap.this.sentinelValues.containsOneKey)
                {
                    objectIntProcedure.value(PrimitiveTuples.pair(REMOVED_KEY, CharObjectHashMap.this.sentinelValues.oneValue), index);
                    index++;
                }
            }
            for (int i = 0; i < CharObjectHashMap.this.keys.length; i++)
        ...
        public <P> void forEachWith(Procedure2<? super CharObjectPair<V>, ? super P> procedure, P parameter)
        {
            if (CharObjectHashMap.this.sentinelValues != null)
            {
                if (CharObjectHashMap.this.sentinelValues.containsZeroKey)
                {
                    procedure.value(PrimitiveTuples.pair(EMPTY_KEY, CharObjectHashMap.this.sentinelValues.zeroValue), parameter);
                }
                if (CharObjectHashMap.this.sentinelValues.containsOneKey)
                {
                    procedure.value(PrimitiveTuples.pair(REMOVED_KEY, CharObjectHashMap.this.sentinelValues.oneValue), parameter);
                }
            }
            for (int i = 0; i < CharObjectHashMap.this.keys.length; i++)
            {
        ...
        public class InternalKeyValuesIterator implements Iterator<CharObjectPair<V>>
        {
            ...
            public CharObjectPair<V> next()
            {
                ...
                if (!this.handledZero)
                {
                    ...
                    if (CharObjectHashMap.this.containsKey(EMPTY_KEY))
                    {
                        return PrimitiveTuples.pair(EMPTY_KEY, CharObjectHashMap.this.sentinelValues.zeroValue);
                    }
                }
                if (!this.handledOne)
                {
                    ...
                    if (CharObjectHashMap.this.containsKey(REMOVED_KEY))
                    {
                        return PrimitiveTuples.pair(REMOVED_KEY, CharObjectHashMap.this.sentinelValues.oneValue);
                    }
                }
                ...
                CharObjectPair<V> result = PrimitiveTuples.pair(keys[this.position], CharObjectHashMap.this.values[this.position]);
                this.position++;
                return result;
            }

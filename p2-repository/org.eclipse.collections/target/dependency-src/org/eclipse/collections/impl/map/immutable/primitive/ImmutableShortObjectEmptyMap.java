...
/**
 * ImmutableShortObjectEmptyMap is an optimization for {@link ImmutableShortObjectMap} of size 0.
 * This file was automatically generated from template file immutablePrimitiveObjectEmptyMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableShortObjectEmptyMap<V> implements ImmutableShortObjectMap<V>, Serializable
{
    static final ImmutableShortObjectMap<?> INSTANCE = new ImmutableShortObjectEmptyMap<>();
    ...
    {
        return UnmodifiableShortSet.of(ShortHashSet.newSetWith());
    }
    ...
    {
        return ObjectShortMaps.immutable.empty();
    }
    ...
    {
        ShortObjectHashMap<V> map = new ShortObjectHashMap<>();
        map.put(key, value);

...
public abstract class CheckedDoubleDoubleProcedure implements DoubleDoubleProcedure
{
    ...
    @Override
    public final void value(double item1, double item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in DoubleDoubleProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(double item1, double item2) throws Exception;
}

...
public abstract class CheckedDoubleObjectProcedure<V> implements DoubleObjectProcedure<V>
{
    ...
    @Override
    public final void value(double item1, V item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in DoubleObjectProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(double item1, V item2) throws Exception;
}

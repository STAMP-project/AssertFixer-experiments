...
/**
 * ImmutableByteIntHashMap is the non-modifiable equivalent of {@link ByteIntHashMap}.
...
final class ImmutableByteIntHashMap implements ImmutableByteIntMap, Serializable
{
    ...
    protected static class ImmutableByteIntMapSerializationProxy implements Externalizable
    {
        ...
        protected ImmutableByteIntMapSerializationProxy(ByteIntMap map)
        {
            this.map = map;
        }
        ...
        {
            int size = in.readInt();
            MutableByteIntMap deserializedMap = new ByteIntHashMap();

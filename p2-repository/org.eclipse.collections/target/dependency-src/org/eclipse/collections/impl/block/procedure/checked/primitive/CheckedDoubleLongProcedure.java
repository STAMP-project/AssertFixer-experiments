...
public abstract class CheckedDoubleLongProcedure implements DoubleLongProcedure
{
    ...
    @Override
    public final void value(double item1, long item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in DoubleLongProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(double item1, long item2) throws Exception;
}

 ...
 * @since 4.0.
 */
final class ImmutableFloatObjectEmptyMap<V> implements ImmutableFloatObjectMap<V>, Serializable
{
    ...
    {
        return ObjectFloatMaps.immutable.empty();
    }
    ...
    {
        FloatObjectHashMap<V> map = new FloatObjectHashMap<>();
        map.put(key, value);

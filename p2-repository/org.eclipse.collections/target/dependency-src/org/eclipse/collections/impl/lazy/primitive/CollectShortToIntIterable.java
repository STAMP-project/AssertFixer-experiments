 ...
 */
public class CollectShortToIntIterable
        extends AbstractLazyIntIterable
{
    private final ShortIterable iterable;
    private final ShortToIntFunction function;

    public CollectShortToIntIterable(ShortIterable iterable, ShortToIntFunction function)
    {
    ...
    public IntIterator intIterator()
    {
        ...
        {
            private final ShortIterator iterator = CollectShortToIntIterable.this.iterable.shortIterator();

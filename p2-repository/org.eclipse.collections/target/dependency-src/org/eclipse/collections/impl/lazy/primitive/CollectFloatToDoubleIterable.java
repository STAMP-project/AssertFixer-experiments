 ...
 */
public class CollectFloatToDoubleIterable
        extends AbstractLazyDoubleIterable
{
    private final FloatIterable iterable;
    private final FloatToDoubleFunction function;

    public CollectFloatToDoubleIterable(FloatIterable iterable, FloatToDoubleFunction function)
    {
    ...
    public DoubleIterator doubleIterator()
    {
        ...
        {
            private final FloatIterator iterator = CollectFloatToDoubleIterable.this.iterable.floatIterator();

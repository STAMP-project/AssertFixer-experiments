...
public abstract class CheckedShortDoubleProcedure implements ShortDoubleProcedure
{
    ...
    @Override
    public final void value(short item1, double item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in ShortDoubleProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(short item1, double item2) throws Exception;
}

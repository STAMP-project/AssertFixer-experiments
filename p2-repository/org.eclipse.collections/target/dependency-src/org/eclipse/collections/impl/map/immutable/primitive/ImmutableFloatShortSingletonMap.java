...
/**
 * ImmutableFloatShortSingletonMap is an optimization for {@link ImmutableFloatShortMap} of size 1.
 * This file was automatically generated from template file immutablePrimitivePrimitiveSingletonMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableFloatShortSingletonMap implements ImmutableFloatShortMap, Serializable
{
    ...
    {
        return new UnmodifiableShortIterator(FloatShortHashMap.newWithKeysValues(this.key1, this.value1).shortIterator());
    }
    ...
    {
        return FloatShortMaps.immutable.withAll(FloatShortHashMap.newWithKeysValues(this.key1, this.value1, key, value));
    }

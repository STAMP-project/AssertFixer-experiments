 ...
 */
public class FlatCollectShortToObjectIterable<V>
        extends AbstractLazyIterable<V>
{
    ...
    public FlatCollectShortToObjectIterable(ShortIterable iterable, ShortToObjectFunction<? extends Iterable<V>> function)
    {
    ...
    {
        this.iterable.forEach((short each) -> Iterate.forEachWith(this.function.valueOf(each), procedure, parameter));
    }

    @Override
    public Iterator<V> iterator()
    {
        return new FlatCollectShortIterator<>(this.iterable, this.function);
    }
    ...
    private final class FlatCollectShortIterator<V> implements Iterator<V>
    {
        private final ShortIterator iterator;
        private final ShortToObjectFunction<? extends Iterable<V>> function;
        private Iterator<V> innerIterator = EmptyIterator.getInstance();

        public FlatCollectShortIterator(
                ShortIterable iterable,
                ShortToObjectFunction<? extends Iterable<V>> newFunction)
        {
            this(iterable.shortIterator(), newFunction);
        }

        public FlatCollectShortIterator(
                ShortIterator newIterator,
                ShortToObjectFunction<? extends Iterable<V>> newFunction)
        {

...
public abstract class CheckedObjectIntProcedure<V> implements ObjectIntProcedure<V>
{
    ...
    @Override
    public final void value(V item1, int item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in ObjectIntProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(V item1, int item2) throws Exception;
}

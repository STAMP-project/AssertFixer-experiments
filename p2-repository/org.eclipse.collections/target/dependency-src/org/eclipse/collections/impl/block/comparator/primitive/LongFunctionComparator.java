        ...
        implements SerializableComparator<T>
{
    ...
    private final LongFunction<T> function;

    public LongFunctionComparator(LongFunction<T> function)
    {
    ...
    {
        long one = this.function.longValueOf(o1);
        long two = this.function.longValueOf(o2);

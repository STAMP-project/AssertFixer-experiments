...
/**
 * A synchronized view of a {@link MutableDoubleLongMap}. It is imperative that the user manually synchronize on the collection when iterating over it using the
 * {@link MutableLongIterator} as per {@link Collections#synchronizedCollection(Collection)}.
 * <p>
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMap.stg.
 *
 * @see MutableDoubleLongMap#asSynchronized()
        ...
        implements MutableDoubleLongMap, Serializable
{
    ...
    public ImmutableDoubleLongMap toImmutable()
    {
        synchronized (this.lock)
        {
            return DoubleLongMaps.immutable.withAll(this);
        }
    }

...
public interface CharByteMap extends ByteValuesMap
{
    ...
    byte getIfAbsent(char key, byte ifAbsent);
     ...
     * from value to key.
     *
     * @throws IllegalStateException if the ByteCharMap contains duplicate values.
     * @since 9.0
     */
     ...
     *
     * @return a string representation of this CharByteMap
     */
    @Override
    String toString();

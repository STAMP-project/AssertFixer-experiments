...
public interface ShortDoubleMap extends DoubleValuesMap
{
    ...
    double getIfAbsent(short key, double ifAbsent);

    double getOrThrow(short key);

    boolean containsKey(short key);

    void forEachKey(ShortProcedure procedure);

    void forEachKeyValue(ShortDoubleProcedure procedure);
     ...
     * from value to key.
     *
     * @throws IllegalStateException if the DoubleShortMap contains duplicate values.
     * @since 9.0
     */
     ...
     *
     * @return a string representation of this ShortDoubleMap
     */
    @Override
    String toString();

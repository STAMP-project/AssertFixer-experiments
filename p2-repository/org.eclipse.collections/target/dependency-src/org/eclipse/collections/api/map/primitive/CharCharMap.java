...
public interface CharCharMap extends CharValuesMap
{
    ...
    char getIfAbsent(char key, char ifAbsent);

    char getOrThrow(char key);

    boolean containsKey(char key);

    void forEachKey(CharProcedure procedure);

    void forEachKeyValue(CharCharProcedure procedure);
     ...
     * from value to key.
     *
     * @throws IllegalStateException if the CharCharMap contains duplicate values.
     * @since 9.0
     */
    CharCharMap flipUniqueValues();

    CharCharMap select(CharCharPredicate predicate);

    CharCharMap reject(CharCharPredicate predicate);
     ...
     *
     * @return a string representation of this CharCharMap
     */
    @Override
    String toString();

...
/**
 * A factory which creates instances of type {@link MutableFloatCharMap}.
...
public interface MutableFloatCharMapFactory
{
     ...
     */
    MutableFloatCharMap ofAll(FloatCharMap map);

    MutableFloatCharMap withAll(FloatCharMap map);
}

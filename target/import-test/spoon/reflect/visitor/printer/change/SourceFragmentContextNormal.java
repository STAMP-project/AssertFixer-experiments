...
import static spoon.reflect.visitor.printer.change.SourcePositionUtils.FragmentKind.LIST;
import static spoon.reflect.visitor.printer.change.SourcePositionUtils.FragmentKind.NORMAL;
...
class SourceFragmentContextNormal extends SourceFragmentContext {
    ...
    private boolean testFagmentDescriptor(SourceFragment sourceFragment, Predicate<SourcePositionUtils.FragmentDescriptor> predicate) {

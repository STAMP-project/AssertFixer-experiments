...
public class JDTBatchCompiler extends org.eclipse.jdt.internal.compiler.batch.Main {
    ...
    public org.eclipse.jdt.internal.compiler.ast.CompilationUnitDeclaration[] getUnits() {
        ...
        spoon.support.compiler.jdt.TreeBuilderCompiler treeBuilderCompiler = new spoon.support.compiler.jdt.TreeBuilderCompiler(environment, errorHandlingPolicy, compilerOptions, this.jdtCompiler.requestor, problemFactory, this.out, null);
        if (jdtCompiler.getEnvironment().getNoClasspath()) {

...
public class TemplateTest {
    ...
    public void testTemplateMatcher() throws java.lang.Exception {
        ...
        spoon.createCompiler(factory, SpoonResourceHelper.resources("./src/test/java/spoon/test/template/testclasses/bounds/CheckBound.java"), SpoonResourceHelper.resources("./src/test/java/spoon/test/template/testclasses/bounds/CheckBoundMatcher.java")).build();
        {
            ...
            org.junit.Assert.assertThat(java.util.Arrays.asList("foo", "fbar"), org.hamcrest.CoreMatchers.is(klass.filterChildren(matcher).map((CtElement e) -> e.getParent(CtMethod.class).getSimpleName()).list()));
        }
        {
            CtClass<?> templateKlass = factory.Class().get(CheckBoundMatcher.class);
            CtClass<?> klass = factory.Class().get(CheckBound.class);
            ...
            org.junit.Assert.assertThat(java.util.Arrays.asList("bov"), org.hamcrest.CoreMatchers.is(klass.filterChildren(matcher).map((CtElement e) -> e.getParent(CtMethod.class).getSimpleName()).list()));
        }
        {
            CtClass<?> templateKlass = factory.Class().get(CheckBoundMatcher.class);
            CtClass<?> klass = factory.Class().get(CheckBound.class);
        ...
        }
        {
            ...
            org.junit.Assert.assertThat(java.util.Arrays.asList("foo", "foo2", "fbar"), org.hamcrest.CoreMatchers.is(klass.filterChildren(matcher).map((CtElement e) -> e.getParent(CtMethod.class).getSimpleName()).list()));
        }
        {
            CtClass<?> templateKlass = factory.Class().get(CheckBoundMatcher.class);
            CtClass<?> klass = factory.Class().get(CheckBound.class);
            ...
            org.junit.Assert.assertThat(java.util.Arrays.asList("foo", "foo2", "fbar", "baz", "bou", "bov"), org.hamcrest.CoreMatchers.is(klass.filterChildren(matcher).map((CtElement e) -> e.getParent(CtMethod.class).getSimpleName()).list()));
        }
        {
            CtClass<?> templateKlass = factory.Class().get(CheckBoundMatcher.class);
            CtClass<?> klass = factory.Class().get(CheckBound.class);
            ...
            TemplateMatcher matcher = new TemplateMatcher(templateRoot);
            org.junit.Assert.assertEquals(2, matcher.find(klass).size());
            org.junit.Assert.assertThat(java.util.Arrays.asList("baz", "bou"), org.hamcrest.CoreMatchers.is(klass.filterChildren(matcher).map((CtElement e) -> e.getParent(CtMethod.class).getSimpleName()).list()));
        }
        {
            CtClass<?> templateKlass = factory.Class().get(CheckBoundMatcher.class);
            CtClass<?> klass = factory.Class().get(CheckBound.class);
    ...
    public void testExtensionDecoupledSubstitutionVisitor() throws java.lang.Exception {
        ...
        final CtClass<?> aTemplateModelType = launcher.getFactory().Class().get(spoon.test.template.testclasses.LoggerModel.class);
        final CtMethod<?> aTemplateModel = aTemplateModelType.getMethod("block");
        final CtClass<?> aTargetType = launcher.getFactory().Class().get(spoon.test.template.testclasses.logger.Logger.class);
        final CtMethod<?> toBeLoggedMethod = aTargetType.getMethodsByName("enter").get(0);
        java.util.Map<String, java.lang.Object> params = new java.util.HashMap<>();
        ...
        final List<CtMethod<?>> aMethods = new spoon.support.template.SubstitutionVisitor(factory, params).substitute(aTemplateModel.clone());
    ...
    public void testExpressionTemplate() throws java.lang.Exception {
        ...
        org.junit.Assert.assertFalse(result.isParentInitialized());

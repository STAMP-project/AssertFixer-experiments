...
public class MethodOverriddingTest {
    ...
    public void testShadowInterfaceMethodsCanOverrideObjectMethods() throws java.lang.Exception {
        ...
        spoon.reflect.declaration.CtType<?> object = f.Interface().get(java.lang.Object.class);
        spoon.reflect.declaration.CtMethod<?> objectEquals = iface.getMethodsByName("equals").get(0);
    ...
    public void testInterfaceMethodsCanOverrideObjectMethods() throws java.lang.Exception {
        ...
        spoon.reflect.declaration.CtMethod<?> comparatorEquals = iface.getMethodsByName("equals").get(0);
        spoon.reflect.declaration.CtType<?> object = iface.getFactory().Interface().get(java.lang.Object.class);
        spoon.reflect.declaration.CtMethod<?> objectEquals = iface.getMethodsByName("equals").get(0);
        org.junit.Assert.assertTrue(comparatorEquals.isOverriding(objectEquals));
    }

    @org.junit.Test
    public void testLambdaInterfaceMethodsCanOverrideObjectMethods() throws java.lang.Exception {
        spoon.Launcher launcher = new spoon.Launcher();
        spoon.reflect.factory.Factory factory = launcher.getFactory();
        spoon.SpoonModelBuilder comp = launcher.createCompiler();
        comp.addInputSources(spoon.compiler.SpoonResourceHelper.resources("./src/test/java/spoon/test/method_overriding/testclasses2"));
        comp.build();
        spoon.reflect.declaration.CtClass<?> fooClass = factory.Class().get(spoon.test.method_overriding.testclasses2.Foo.class);
        spoon.reflect.declaration.CtClass<?> objectClass = factory.Class().get(java.lang.Object.class);
        spoon.reflect.code.CtLambda<?> objectInterfaceLambda = ((spoon.reflect.code.CtLambda<?>) (fooClass.filterChildren(new spoon.reflect.visitor.filter.LambdaFilter(factory.Interface().get(spoon.test.method_overriding.testclasses2.ObjectInterface.class))).list().get(0)));
        spoon.reflect.reference.CtTypeReference<?> lambdaTypeReference = objectInterfaceLambda.getType();
        spoon.reflect.declaration.CtType<?> lambdaType = lambdaTypeReference.getTypeDeclaration();
        spoon.reflect.declaration.CtMethod<?> lambdaTypeEquals = lambdaType.getMethodsByName("equals").get(0);
        spoon.reflect.declaration.CtMethod<?> objectEquals = objectClass.getMethodsByName("equals").get(0);
        org.junit.Assert.assertTrue(lambdaTypeEquals.isOverriding(objectEquals));
    }

...
public class AnnotationTest {
    ...
    public void testModelBuildingAnnotationBoundUsage() throws java.lang.Exception {
        ...
        org.junit.Assert.assertEquals("param2", param2.getSimpleName());
        List<CtAnnotation<? extends java.lang.annotation.Annotation>> annotations2 = param2.getAnnotations();
        org.junit.Assert.assertEquals(1, annotations2.size());
        CtAnnotation<?> annot = annotations2.get(0);
        org.junit.Assert.assertEquals("10", annot.getValue("max").toString());
        spoon.test.annotation.testclasses.Bound actualAnnotation2 = ((spoon.test.annotation.testclasses.Bound) (annot.getActualAnnotation()));
        org.junit.Assert.assertEquals(10, actualAnnotation2.max());
        org.junit.Assert.assertEquals(1, a.getValues().size());
        org.junit.Assert.assertEquals(0, annot.getValues().size());
        org.junit.Assert.assertEquals(1, a.getAllValues().size());
        org.junit.Assert.assertEquals(1, annot.getAllValues().size());
        org.junit.Assert.assertEquals("8", a.getAllValues().get("max").toString());
    }
    ...
    public void testAnnotationParameterTypes() throws java.lang.Exception {
        ...
        org.junit.Assert.assertEquals(1, annotations.size());
        CtAnnotation<?> a = annotations.get(0);
        org.junit.Assert.assertEquals(15, a.getAllValues().size());
        ...
        org.junit.Assert.assertEquals(42, a.getValueAsInt("integer"));
        ...
        org.junit.Assert.assertEquals("Hello World!", a.getValueAsString("string"));
        ...
        org.junit.Assert.assertEquals(java.lang.Integer.class, a.getValueAsObject("clazz"));
    ...
    public void testSpoonManageRecursivelyDefinedAnnotation() {
        ...
        org.junit.Assert.assertEquals(3, type.getTypeMembers().size());
        org.junit.Assert.assertTrue(((type.getTypeMembers().get(0)) instanceof spoon.reflect.declaration.CtAnnotationMethod));
    }

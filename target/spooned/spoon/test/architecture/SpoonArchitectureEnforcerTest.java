...
public class SpoonArchitectureEnforcerTest {
    ...
    public void testInterfacesAreCtScannable() {
        ...
        spoon.metamodel.Metamodel.getInstance().getConcepts().forEach(( mmConcept) -> {
            if (((mmConcept.getKind()) == (spoon.metamodel.ConceptKind.ABSTRACT)) && ((mmConcept.getMetamodelInterface()) != null)) {
                spoon.reflect.declaration.CtInterface abstractIface = mmConcept.getMetamodelInterface();

...
public class TypeFactoryTest {
    ...
    public void reflectionAPIWithTypeParameter() {
        spoon.reflect.declaration.CtType<java.lang.Object> ctType = new spoon.Launcher().getFactory().Type().get(com.mysema.query.types.expr.ComparableExpressionBase.class);
        org.junit.Assert.assertEquals("ComparableExpressionBase", ctType.getSimpleName());
        spoon.reflect.declaration.CtMethod<?> method = ctType.getMethodsByName("castToNum").get(0);
        org.junit.Assert.assertEquals("A extends java.lang.Number & java.lang.Comparable<? super A>", method.getFormalCtTypeParameters().get(0).toString());
    }

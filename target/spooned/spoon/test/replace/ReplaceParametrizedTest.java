...
public class ReplaceParametrizedTest<T extends spoon.reflect.visitor.CtVisitable> {
    private static spoon.metamodel.Metamodel metaModel;

    @org.junit.runners.Parameterized.Parameters(name = "{0}")
    public static java.util.Collection<java.lang.Object[]> data() throws java.lang.Exception {
        spoon.test.replace.ReplaceParametrizedTest.metaModel = spoon.metamodel.Metamodel.getInstance();
        java.util.List<java.lang.Object[]> values = new java.util.ArrayList<>();
        for (spoon.metamodel.MetamodelConcept t : spoon.test.replace.ReplaceParametrizedTest.metaModel.getConcepts()) {
    ...
    public spoon.metamodel.MetamodelConcept typeToTest;

    @org.junit.Test
    public void testContract() throws java.lang.Throwable {
        java.util.List<java.lang.String> problems = new java.util.ArrayList<>();
        spoon.reflect.declaration.CtType<?> toTest = typeToTest.getMetamodelInterface();
        spoon.reflect.factory.Factory factory = toTest.getFactory();
        spoon.reflect.declaration.CtElement o = factory.Core().create(((java.lang.Class<? extends spoon.reflect.declaration.CtElement>) (toTest.getActualClass())));
        java.util.Map<spoon.reflect.path.CtRole, spoon.metamodel.MetamodelProperty> roleToProperty = typeToTest.getRoleToProperty();
        for (spoon.metamodel.MetamodelProperty mmField : roleToProperty.values()) {
            java.lang.Class<?> argType = mmField.getTypeofItems().getActualClass();
            if (!(spoon.reflect.declaration.CtElement.class.isAssignableFrom(argType))) {
                continue;
            }
            spoon.reflect.reference.CtTypeReference<?> itemType = mmField.getTypeofItems();
            if (itemType.getQualifiedName().equals(spoon.reflect.code.CtStatement.class.getName())) {
                itemType = factory.createCtTypeReference(spoon.reflect.code.CtBlock.class);
            }
            if ((o.getClass().getSimpleName().equals("CtAnnotationFieldAccessImpl")) && ((mmField.getRole()) == (spoon.reflect.path.CtRole.VARIABLE))) {
                itemType = factory.createCtTypeReference(spoon.reflect.reference.CtFieldReference.class);
            }else
                if ((spoon.reflect.code.CtFieldAccess.class.isAssignableFrom(o.getClass())) && ((mmField.getRole()) == (spoon.reflect.path.CtRole.VARIABLE))) {
                    itemType = factory.createCtTypeReference(spoon.reflect.reference.CtFieldReference.class);
                }

            spoon.reflect.declaration.CtElement argument = ((spoon.reflect.declaration.CtElement) (spoon.test.parent.ContractOnSettersParametrizedTest.createCompatibleObject(itemType)));

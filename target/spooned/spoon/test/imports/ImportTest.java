...
public class ImportTest {
    ...
    public void testImportOfInvocationOfPrivateClass() throws java.lang.Exception {
        ...
        org.junit.Assert.assertEquals("import spoon.test.imports.testclasses.internal2.Chimichanga;", imports.toArray()[0].toString().trim());
    }
    ...
    public void testImportOfInvocationOfStaticMethod() throws java.lang.Exception {
        ...
        java.util.Collection<CtImport> imports = importContext.getAllImports();
        org.junit.Assert.assertEquals(1, imports.size());
        org.junit.Assert.assertEquals("import spoon.test.imports.testclasses.internal2.Menudo;", imports.toArray()[0].toString().trim());
    }
    ...
    @org.junit.Test
    public void testNullable() throws java.lang.Exception {
        final Launcher launcher = new Launcher();
        launcher.getEnvironment().setNoClasspath(true);
        ...
        comp.build();
        org.junit.Assert.assertNotNull(launcher.getFactory().Type().get("TestNullable"));
    }
}

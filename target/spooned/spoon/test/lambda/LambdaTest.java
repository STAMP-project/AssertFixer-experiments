...
public class LambdaTest {
    ...
    @org.junit.Test
    public void testLambdaComparator() throws java.lang.Exception {
        spoon.reflect.declaration.CtInterface<?> comparatorInterface = factory.Interface().get(java.util.Comparator.class);
        java.util.List<spoon.reflect.code.CtLambda<?>> comparators = foo.filterChildren(new spoon.reflect.visitor.filter.LambdaFilter(comparatorInterface)).list();
        org.junit.Assert.assertEquals(1, comparators.size());
        spoon.reflect.code.CtLambda<?> comparator = comparators.get(0);
        org.junit.Assert.assertEquals(2, comparator.getParameters().size());
        spoon.reflect.declaration.CtMethod<?> method = comparator.getOverriddenMethod();
        org.junit.Assert.assertTrue(comparatorInterface.getMethods().contains(method));
    }

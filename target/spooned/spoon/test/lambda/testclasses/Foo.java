...
public class Foo {
    ...
    public void m10() {
        spoon.test.lambda.testclasses.Foo.sortPersonsWithComparator(persons, ( p1, p2) -> (p1.age) - (p2.age));
    }
    ...
    public static void sortPersonsWithComparator(java.util.List<spoon.test.lambda.testclasses.Foo.Person> roster, java.util.Comparator<spoon.test.lambda.testclasses.Foo.Person> comparator) {

...
public class MavenLauncherTest {
    ...
    public void spoonMavenLauncherTest() {
        ...
        org.junit.Assert.assertEquals(10, launcher.getEnvironment().getSourceClasspath().length);
        org.junit.Assert.assertEquals(58, launcher.getModelBuilder().getInputSources().size());
        launcher = new spoon.MavenLauncher("./", spoon.MavenLauncher.SOURCE_TYPE.ALL_SOURCE);
        org.junit.Assert.assertEquals(17, launcher.getEnvironment().getSourceClasspath().length);

...
public class MavenLauncherTest {
    ...
    public void spoonMavenLauncherTest() {
        ...
        org.junit.Assert.assertEquals(53, launcher.getModelBuilder().getInputSources().size());
        launcher = new spoon.MavenLauncher("./", spoon.MavenLauncher.SOURCE_TYPE.ALL_SOURCE);
        org.junit.Assert.assertEquals(19, launcher.getEnvironment().getSourceClasspath().length);

...
public class CtScannerTest {
    ...
    public void testScannerCallsAllProperties() throws java.lang.Exception {
        ...
        for (spoon.metamodel.MetamodelConcept leafConcept : metaModel.getConcepts()) {
            if ((leafConcept.getKind()) != (spoon.metamodel.ConceptKind.LEAF)) {
                continue;
            }
            ...
            leafConcept.getRoleToProperty().forEach(( role, mmField) -> {
                ...
                spoon.metamodel.MMMethod getter = mmField.getMethod(spoon.metamodel.MMMethodKind.GET);
        ...
        org.junit.Assert.assertTrue(("not enough checks " + (c.nbChecks)), ((c.nbChecks) >= 200));
    }

...
public class StandardEnvironment implements java.io.Serializable , spoon.compiler.Environment {
    ...
    private spoon.processing.FileGenerator<? extends spoon.reflect.declaration.CtElement> defaultFileGenerator;

    private int errorCount = 0;

    spoon.processing.ProcessingManager manager;
    ...
    private org.apache.log4j.Logger logger = spoon.Launcher.LOGGER;
    ...
    private spoon.experimental.modelobs.FineModelChangeListener modelChangeListener = new spoon.experimental.modelobs.EmptyModelChangeListener();

    private java.nio.charset.Charset encoding = java.nio.charset.Charset.defaultCharset();

    private int complianceLevel = spoon.support.StandardEnvironment.DEFAULT_CODE_COMPLIANCE_LEVEL;

    private spoon.support.OutputDestinationHandler outputDestinationHandler = new spoon.support.DefaultOutputDestinationHandler(new java.io.File(spoon.Launcher.OUTPUTDIR), this);

    private spoon.OutputType outputType = spoon.OutputType.CLASSES;

    private java.lang.Boolean noclasspath = null;

    private spoon.support.compiler.SpoonProgress spoonProgress = null;
    ...
    java.util.Map<java.lang.String, spoon.processing.ProcessorProperties> processorProperties = new java.util.TreeMap<>();
    ...
    private java.lang.ClassLoader inputClassloader;
    ...
    @java.lang.Override
    public spoon.support.compiler.SpoonProgress getSpoonProgress() {
        return this.spoonProgress;
    }

    @java.lang.Override
    public void setSpoonProgress(spoon.support.compiler.SpoonProgress spoonProgress) {

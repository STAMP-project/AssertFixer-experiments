...
public class CtClassImpl<T extends java.lang.Object> extends spoon.support.reflect.declaration.CtTypeImpl<T> implements spoon.reflect.declaration.CtClass<T> {
    ...
    public T newInstance() {
        try {
            ...
            spooner.compile(spoon.SpoonModelBuilder.InputType.CTTYPES);
            try (spoon.support.reflect.declaration.CtClassImpl<T>.NewInstanceClassloader classloader = new NewInstanceClassloader(spooner.getBinaryOutputDirectory())) {
                java.lang.Class<?> klass = classloader.loadClass(getQualifiedName());

...
public class JavaReflectionTreeBuilderTest {
    ...
    public void testScannerAnnotation() throws java.lang.Exception {
        ...
        org.junit.Assert.assertTrue(((suppressWarning.getTypeMembers().size()) > 0));
        org.junit.Assert.assertTrue(((suppressWarning.getTypeMembers().get(0)) instanceof spoon.reflect.declaration.CtAnnotationMethod));
    ...
    public void testShadowModelEqualsNormalModel() {
        spoon.metamodel.Metamodel metaModel = new spoon.metamodel.Metamodel(new java.io.File("src/main/java"));
        java.util.List<java.lang.String> allProblems = new java.util.ArrayList<>();
        for (spoon.metamodel.MetamodelConcept concept : metaModel.getConcepts()) {
    ...
    public void testPartialShadow() {
        spoon.reflect.factory.Factory factory = spoon.testing.utils.ModelUtils.createFactory();
        spoon.reflect.declaration.CtType<java.lang.Object> type = factory.Type().get(com.mysema.query.support.ProjectableQuery.class);
        org.junit.Assert.assertEquals("ProjectableQuery", type.getSimpleName());
        org.junit.Assert.assertEquals(0, type.getMethods().size());
    }
}

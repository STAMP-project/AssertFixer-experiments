...
public class JDTBatchCompiler extends org.eclipse.jdt.internal.compiler.batch.Main {
    ...
    public org.eclipse.jdt.internal.compiler.ast.CompilationUnitDeclaration[] getUnits() {
        ...
        org.eclipse.jdt.internal.compiler.IProblemFactory problemFactory = getProblemFactory();
        spoon.support.compiler.jdt.TreeBuilderCompiler treeBuilderCompiler = new spoon.support.compiler.jdt.TreeBuilderCompiler(environment, errorHandlingPolicy, compilerOptions, this.jdtCompiler.requestor, problemFactory, this.out, new org.eclipse.jdt.core.compiler.CompilationProgress() {
            private java.lang.String currentElement = null;
            ...
            public void setTaskName(java.lang.String s) {
                if ((jdtCompiler.getEnvironment().getSpoonProgress()) != null) {
                    java.lang.String strToFind = "Processing ";
            ...
            public void worked(int increment, int remaining) {
                ...
                if ((jdtCompiler.getEnvironment().getSpoonProgress()) != null) {
                    jdtCompiler.getEnvironment().getSpoonProgress().step(spoon.support.compiler.SpoonProgress.STEP.COMPILE, currentElement, ((totalTask) - remaining), totalTask);
                }
            }
        });
        if (jdtCompiler.getEnvironment().getNoClasspath()) {
            treeBuilderCompiler.lookupEnvironment.problemReporter = new org.eclipse.jdt.internal.compiler.problem.ProblemReporter(errorHandlingPolicy, compilerOptions, problemFactory) {
                @java.lang.Override
        ...
        if ((jdtCompiler.getEnvironment().getSpoonProgress()) != null) {
            jdtCompiler.getEnvironment().getSpoonProgress().start(spoon.support.compiler.SpoonProgress.STEP.COMPILE);
        }
        ...
        if ((jdtCompiler.getEnvironment().getSpoonProgress()) != null) {
            jdtCompiler.getEnvironment().getSpoonProgress().end(spoon.support.compiler.SpoonProgress.STEP.COMPILE);
        }
        if (jdtCompiler.getEnvironment().isCommentsEnabled()) {
            if ((jdtCompiler.getEnvironment().getSpoonProgress()) != null) {
                jdtCompiler.getEnvironment().getSpoonProgress().start(spoon.support.compiler.SpoonProgress.STEP.COMMENT);
            }
            for (int i = 0; i < (result.length); i++) {
                ...
                if ((jdtCompiler.getEnvironment().getSpoonProgress()) != null) {
                    jdtCompiler.getEnvironment().getSpoonProgress().step(spoon.support.compiler.SpoonProgress.STEP.COMMENT, new java.lang.String(unit.getFileName()), (i + 1), result.length);
                }
            }
            if ((jdtCompiler.getEnvironment().getSpoonProgress()) != null) {
                jdtCompiler.getEnvironment().getSpoonProgress().end(spoon.support.compiler.SpoonProgress.STEP.COMMENT);
            }
        }
        return result;
    }

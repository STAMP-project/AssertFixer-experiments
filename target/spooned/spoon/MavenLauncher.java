...
public class MavenLauncher extends spoon.Launcher {
    ...
    class TreeDependency {
        ...
        TreeDependency(java.lang.String groupId, java.lang.String artifactId, java.lang.String version) {
            this.groupId = groupId;
            this.artifactId = artifactId;
            this.version = version;
        }

        public void addDependence(spoon.MavenLauncher.TreeDependency dependence) {
            if (dependence != null) {
                dependencies.add(dependence);
            }
        }

        public java.util.List<spoon.MavenLauncher.TreeDependency> getDependencyList() {
            java.util.List<spoon.MavenLauncher.TreeDependency> output = new java.util.ArrayList<>();
        ...
        public java.util.List<java.io.File> toJarList() {
            java.util.List<spoon.MavenLauncher.TreeDependency> deps = getDependencyList();
            ...
            for (int i = 0; i < (deps.size()); i++) {
                spoon.MavenLauncher.TreeDependency dep = deps.get(i);
        ...
        public void removeDependency(java.lang.String groupId, java.lang.String artifactId) {
        ...
        public java.lang.String toString() {
            ...
            if (!(dependencies.isEmpty())) {
                sb.append(" {\n");
                for (int i = 0; i < (dependencies.size()); i++) {
                    spoon.MavenLauncher.TreeDependency dep = dependencies.get(i);
    ...
    class InheritanceModel {
        ...
        private spoon.MavenLauncher.TreeDependency getTreeDependency(org.apache.maven.model.Dependency dependency, boolean isLib, java.util.Set<spoon.MavenLauncher.TreeDependency> hierarchy) {
            ...
            spoon.MavenLauncher.TreeDependency dependence = new spoon.MavenLauncher.TreeDependency(dependency.getGroupId(), dependency.getArtifactId(), version);
            try {
        ...
        private spoon.MavenLauncher.TreeDependency getTreeDependency(boolean isLib, java.util.Set<spoon.MavenLauncher.TreeDependency> hierarchy) {
            spoon.MavenLauncher.TreeDependency dependence = new spoon.MavenLauncher.TreeDependency(model.getGroupId(), model.getArtifactId(), model.getVersion());

...
public class MetamodelGenerator {
    public static void main(java.lang.String[] args) {
        ...
        spoon.reflect.factory.Factory factory = mm.getConcepts().iterator().next().getMetamodelInterface().getFactory();
        factory.getEnvironment().useTabulations(true);
        java.lang.StringBuilder sb = new java.lang.StringBuilder();
        for (spoon.metamodel.MetamodelConcept type : mm.getConcepts()) {
            if ((type.getKind()) == (spoon.metamodel.ConceptKind.LEAF)) {
                sb.append(spoon.generating.MetamodelGenerator.printType(factory, type));
            }
        }
        java.lang.System.out.println(sb.toString());
    }

    private static java.lang.String printType(spoon.reflect.factory.Factory factory, spoon.metamodel.MetamodelConcept type) {
    ...
    private static java.lang.String printFields(spoon.reflect.factory.Factory factory, spoon.metamodel.MetamodelConcept type) {
        java.util.Map<spoon.reflect.path.CtRole, spoon.metamodel.MetamodelProperty> allFields = new java.util.LinkedHashMap<>(type.getRoleToProperty());
        java.util.List<spoon.reflect.path.CtRole> rolesByScanner = spoon.generating.MetamodelGenerator.getRoleScanningOrderOfType(factory, ((java.lang.Class) (type.getMetamodelInterface().getActualClass())));
    ...
    private static java.lang.String printField(spoon.metamodel.MetamodelProperty field) {
        java.util.Map<java.lang.String, java.lang.String> valuesMap = new java.util.HashMap<>();

...
public class CloneVisitorGenerator extends spoon.processing.AbstractManualProcessor {
    ...
    public void process() {
        ...
        new spoon.reflect.visitor.CtScanner() {
            ...
            private final java.util.Set<java.lang.String> collectionClasses = new java.util.HashSet<>(java.util.Arrays.asList(java.util.List.class.getName(), java.util.Collection.class.getName(), java.util.Set.class.getName(), spoon.support.util.ModelList.class.getName(), spoon.support.util.ModelSet.class.getName()));

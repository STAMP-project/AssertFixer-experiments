...
public class RoleHandlersGenerator extends spoon.processing.AbstractManualProcessor {
    ...
    @java.lang.Override
    public void process() {
        spoon.metamodel.Metamodel metaModel = spoon.metamodel.Metamodel.getInstance();
        ...
        superFields.forEach(( mmField) -> {
            concept.write((((mmField.getOwner().getName()) + " CtRole.") + (mmField.getRole().name()))).writeln().incTab().write("ItemType: ").write(mmField.getTypeOfField().toString()).writeln();
    ...
    java.lang.String getHandlerName(spoon.metamodel.MetamodelProperty field) {
        java.lang.String typeName = field.getOwner().getName();
    ...
    public java.lang.String getRoleHandlerSuperTypeQName(spoon.metamodel.MetamodelProperty field) {
        ...
        throw new spoon.SpoonException(("Unexpected value container type: " + (field.getContainerKind().name())));
    }
}

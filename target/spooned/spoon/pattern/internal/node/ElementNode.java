...
public class ElementNode extends spoon.pattern.internal.node.AbstractPrimitiveMatcher {
    public static spoon.pattern.internal.node.ElementNode create(spoon.reflect.declaration.CtElement element, java.util.Map<spoon.reflect.declaration.CtElement, spoon.pattern.internal.node.RootNode> patternElementToSubstRequests) {
        spoon.metamodel.MetamodelConcept mmConcept = spoon.metamodel.Metamodel.getInstance().getConcept(element.getClass());
        ...
        for (spoon.metamodel.MetamodelProperty mmField : mmConcept.getProperties()) {
    ...
    private spoon.metamodel.MetamodelConcept elementType;

    private java.util.Map<spoon.metamodel.MetamodelProperty, spoon.pattern.internal.node.RootNode> roleToNode = new java.util.HashMap<>();

    public ElementNode(spoon.metamodel.MetamodelConcept elementType, spoon.reflect.declaration.CtElement templateElement) {
        super();
    ...
    public boolean replaceNode(spoon.pattern.internal.node.RootNode oldNode, spoon.pattern.internal.node.RootNode newNode) {
        for (java.util.Map.Entry<spoon.metamodel.MetamodelProperty, spoon.pattern.internal.node.RootNode> e : roleToNode.entrySet()) {
    ...
    public java.util.Map<spoon.metamodel.MetamodelProperty, spoon.pattern.internal.node.RootNode> getRoleToNode() {
    ...
    public spoon.pattern.internal.node.RootNode getOrCreateNodeOfRole(spoon.reflect.path.CtRole role, java.util.Map<spoon.reflect.declaration.CtElement, spoon.pattern.internal.node.RootNode> patternElementToSubstRequests) {
        ...
        if (node == null) {
            spoon.metamodel.MetamodelProperty mmField = elementType.getProperty(role);
    ...
    private spoon.metamodel.MetamodelProperty getFieldOfRole(spoon.reflect.path.CtRole role) {
        spoon.metamodel.MetamodelProperty mmField = elementType.getProperty(role);
        if (mmField == null) {
    ...
    public <U> void generateTargets(spoon.pattern.internal.DefaultGenerator generator, spoon.pattern.internal.ResultHolder<U> result, spoon.support.util.ImmutableMap parameters) {
        ...
        spoon.reflect.declaration.CtElement clone = generator.getFactory().Core().create(((java.lang.Class) (elementType.getMetamodelInterface().getActualClass())));
    ...
    protected void generateSingleNodeAttributes(spoon.pattern.internal.DefaultGenerator generator, spoon.reflect.declaration.CtElement clone, spoon.support.util.ImmutableMap parameters) {
        for (java.util.Map.Entry<spoon.metamodel.MetamodelProperty, spoon.pattern.internal.node.RootNode> e : getRoleToNode().entrySet()) {
            spoon.metamodel.MetamodelProperty mmField = e.getKey();
            switch (mmField.getContainerKind()) {
                ...
                case LIST :
                    ...
                    break;
                case SET :
                    mmField.setValue(clone, new java.util.LinkedHashSet<>(generator.generateTargets(e.getValue(), parameters, mmField.getTypeofItems().getActualClass())));
                    break;
                case MAP :
    ...
    protected spoon.support.util.ImmutableMap matchesRole(spoon.support.util.ImmutableMap parameters, spoon.reflect.declaration.CtElement target, spoon.metamodel.MetamodelProperty mmField, spoon.pattern.internal.node.RootNode attrNode) {
        if ((spoon.pattern.internal.node.ElementNode.isMatchingRole(mmField.getRole(), elementType.getMetamodelInterface().getActualClass())) == false) {
            return parameters;
        }
    ...
    public spoon.metamodel.MetamodelConcept getElementType() {
        return elementType;
    }

    public void setElementType(spoon.metamodel.MetamodelConcept elementType) {
        this.elementType = elementType;
    }

...
public class DefaultGenerator implements spoon.pattern.Generator {
    ...
    private spoon.pattern.internal.node.ListOfNodes nodes;

    public DefaultGenerator(spoon.reflect.factory.Factory factory, spoon.pattern.internal.node.ListOfNodes nodes) {
        super();
        this.nodes = nodes;
    ...
    private boolean isMainType(spoon.reflect.declaration.CtTypeMember tm, spoon.reflect.declaration.CtType<?> mainType) {
        if (tm instanceof spoon.reflect.declaration.CtType) {
            return mainType.getQualifiedName().equals(((spoon.reflect.declaration.CtType) (tm)).getQualifiedName());
        }
        return false;
    }

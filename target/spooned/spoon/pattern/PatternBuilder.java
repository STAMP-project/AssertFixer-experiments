...
public class PatternBuilder {
    ...
    protected final spoon.pattern.internal.node.ListOfNodes patternNodes;
    ...
    protected PatternBuilder(java.util.List<spoon.reflect.declaration.CtElement> template) {
    ...
    public spoon.pattern.Pattern build() {
        ...
        return new spoon.pattern.Pattern(getFactory(), new spoon.pattern.internal.node.ListOfNodes(patternNodes.getNodes())).setAddGeneratedBy(isAddGeneratedBy());
    }

...
public class PatternBuilderHelper {
    ...
    private spoon.reflect.declaration.CtType<?> getClonedPatternType() {
        if ((clonedPatternType) == null) {
            ...
            setElements(java.util.Collections.singletonList(clonedPatternType));
        }
    ...
    public spoon.pattern.PatternBuilderHelper setReturnExpressionOfMethod(java.lang.String methodName) {
    ...
    private void setReturnExpressionOfMethod(spoon.reflect.visitor.Filter<spoon.reflect.declaration.CtMethod<?>> filter) {
        ...
        setElements(java.util.Collections.singletonList(((spoon.reflect.code.CtReturn<?>) (firstStatement)).getReturnedExpression()));
    }

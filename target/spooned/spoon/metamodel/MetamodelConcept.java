...
public class MetamodelConcept {
    ...
    public java.util.Collection<spoon.metamodel.MetamodelProperty> getProperties() {
        return java.util.Collections.unmodifiableCollection(role2Property.values());
    }

    public spoon.metamodel.MetamodelProperty getProperty(spoon.reflect.path.CtRole role) {

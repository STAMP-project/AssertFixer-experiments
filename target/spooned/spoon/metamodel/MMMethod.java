...
public class MMMethod {
    ...
    spoon.reflect.declaration.CtMethod<?> getFirstOwnMethod(spoon.metamodel.MetamodelConcept targetType) {
    ...
    public java.util.List<spoon.reflect.declaration.CtMethod<?>> getRelatedMethods() {

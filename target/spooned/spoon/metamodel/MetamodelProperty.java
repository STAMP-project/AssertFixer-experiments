...
public class MetamodelProperty {
    ...
    MetamodelProperty(java.lang.String name, spoon.reflect.path.CtRole role, spoon.metamodel.MetamodelConcept ownerConcept) {
        ...
        roleHandler = spoon.reflect.meta.impl.RoleHandlerHelper.getRoleHandler(((java.lang.Class) (ownerConcept.getMetamodelInterface().getActualClass())), role);
    }
    ...
    public boolean isDerived() {
        if ((derived) == null) {
            if (((getOwner().getKind()) == (spoon.metamodel.ConceptKind.LEAF)) && (isUnsettable())) {

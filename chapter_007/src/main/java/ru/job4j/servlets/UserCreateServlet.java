...
public class UserCreateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        writer.append("<!DOCTYPE html>\n"
                ...
                + "\t\t<td></td>\n"
                + "\t\t<td><input type=\"text\" placeholder=\"Login\" name=\"login\" maxlength=\"255\" /></td>\n"
                + "\t\t<td><input type=\"password\" name=\"password\" maxlength=\"255\" /></td>\n"
                + "\t\t<td><input type=\"text\" placeholder=\"Name\" name=\"name\" maxlength=\"255\" /></td>\n"
                + "\t\t<td><input type=\"text\" placeholder=\"e-mail\" name=\"email\" maxlength=\"255\" \"/></td>\n"
                + "\t\t<td colspan=\"2\">\n"
                + "<input id=\"createForm\" class=\"button\" type=\"submit\" name=\"submit\" value=\"Create\" />\n"
                + "\t\t</td>\n"
                + "\t</form>\n"
                + "</tr>\n"
                + " \t</table>\n"

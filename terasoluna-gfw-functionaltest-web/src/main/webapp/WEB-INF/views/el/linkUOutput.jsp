...
<form:form action="${pageContext.request.contextPath}/el/output_05_04" method="post">
  ...
  <br />
  <c:set var="URLPath"
    value="http://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath}/el/output_05_04" />
        http://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath}/el/output_05_04<br />

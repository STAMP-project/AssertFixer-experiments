...
public class SMRMap$CORFUSMR<K, V> extends SMRMap<K, V> implements ICorfuSMR<SMRMap<K, V>>, ISMRMap<K, V> {
  ...
  .put("put", (obj, args) -> { return ISMRMap.super.undoPutRecord(obj,(K) args[0], (V) args[1]);}).build();
  ...
  .put("put", (obj, undoRecord, args) -> {ISMRMap.super.undoPut(obj, (V) undoRecord, (K) args[0], (V) args[1]);}).build();

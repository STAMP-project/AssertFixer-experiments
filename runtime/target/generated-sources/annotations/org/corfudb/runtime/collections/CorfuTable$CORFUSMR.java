...
public class CorfuTable$CORFUSMR<K, V> extends CorfuTable<K, V> implements ICorfuSMR<CorfuTable<K, V>> {
  ...
  .put("putAll", (obj, args) -> { return this.undoPutAllRecord(obj,(java.util.Map<? extends K,? extends V>) args[0]);}).build();
  ...
  .put("putAll", (obj, undoRecord, args) -> {this.undoPutAll(obj, (java.util.Map<K, V>) undoRecord, (java.util.Map<? extends K,? extends V>) args[0]);}).build();

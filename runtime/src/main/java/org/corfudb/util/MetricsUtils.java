...
public class MetricsUtils {
    ...
    private static final String CORFU_METRICS_METRICS = "corfu.metrics";
    ...
    private static void setupJmxReporting(MetricRegistry metrics) {
        ...
        JmxReporter jmxReporter = JmxReporter.forRegistry(metrics)
                ...
                .inDomain(CORFU_METRICS_METRICS)
    ...
    public static void setupJvmMetrics(@NonNull MetricRegistry metrics) {
    ...
    private static void setupLogAnalysisMetrics(@NonNull MetricRegistry metrics) {
        ...
        try {
            ...
            log.warn("Logger is not logback compatible. Log analysis metrics are not collected.");
        }
    }

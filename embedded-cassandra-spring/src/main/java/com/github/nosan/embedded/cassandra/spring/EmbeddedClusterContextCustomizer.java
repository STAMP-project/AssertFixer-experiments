...
/**
 * {@link ContextCustomizer} to add {@link EmbeddedClusterConfiguration} if
 * {@code Test Class} has an {@link EmbeddedCluster} and {@link EmbeddedCassandra} annotation.
 *
 * @author Dmytro Nosan
 */
class EmbeddedClusterContextCustomizer implements ContextCustomizer {
	...
	public void customizeContext(@Nonnull ConfigurableApplicationContext context,
		...
		registry.registerBeanDefinition("embeddedClusterConfiguration",
				new RootBeanDefinition(EmbeddedClusterConfiguration.class));

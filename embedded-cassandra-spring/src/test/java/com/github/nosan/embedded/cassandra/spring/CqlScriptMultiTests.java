...
import com.github.nosan.embedded.cassandra.testutil.CassandraRule;
...
@ContextConfiguration(classes = {CqlScriptMultiTests.Context.class, CqlScriptMultiTests.Context2.class})
public class CqlScriptMultiTests {

...
public final class StringsUtil
{
	...
	public static SortedSet<String> prefixes(final String input, final Collection<String> validOptions)
	{
		requireNonNull(input);
		return validOptions.stream().filter(a -> a.startsWith(input)).collect(Collectors.toCollection(TreeSet::new));
	}

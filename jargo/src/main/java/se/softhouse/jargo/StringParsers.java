...
public final class StringParsers
{
	...
	private static final class FileParser implements StringParser<File>
	{
		...
		public Iterable<String> complete(String partOfWord)
		{
			...
			// TODO(jontejj): how can this be integrated with complete filenames / dirnames?
			// Otherwise complete paths need to be completed, will be pretty complicated
			List<String> suggestions = new ArrayList<>();
			String[] files = new File(".").list();
			for(String file : files)
			{
				if(file.startsWith(partOfWord))
				{
	...
	static final class HelpParser extends InternalStringParser<String>
	{
		...
		// TODO: test to complete help for a specific command
	}
	...
	static final class KeyValueParser<K, V> extends InternalStringParser<Map<K, V>>
	{
		...
		Iterable<String> complete(Argument<Map<K, V>> arg, String partOfWord, ArgumentIterator iterator)
		{
			try
			{
				String key = getKey(partOfWord, arg);
			...
			catch(ArgumentException noKeySpecified)
			{
				List<String> suggestions = new ArrayList<>();

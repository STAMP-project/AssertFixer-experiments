...
public interface FichierFactureService extends CrudService<FichierFactureSimple>{
    ...
    /**
     * Récupération de tous les fichiers de factures à traiter
     *
     * @return Liste des fichiers de facture
     * @throws TechnicalException Exception technique
     * @throws BusinessException Exception métier
     */
    List<FichierFactureSimple> getAllATraiter() throws TechnicalException, BusinessException;
	...
	/**
	 * Renvoie la liste des fichiers factures ayant le même nom de fichier et le même md5
	 * @param fichierFacture
	 * @return
	 */
	List<FichierFactureSimple> getAllSimilaire(FichierFactureSimple fichierFacture);
}

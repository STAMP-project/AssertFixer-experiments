 ...
 *
 */
public class FichierFacture implements DtoModel {
	...
	public void setDateIntegrationSucces(Date date) {
		this.dateIntegrationSucces = date;
	}

	public Date getDateIntegrationSucces() {
		return this.dateIntegrationSucces;
	}
}

...
//        wait.until(ExpectedConditions.textToBePresentInElementLocated(By.cssSelector("p"),getMessage(MessageKeys.E_TR_FW_0001)));
        
        logger.debug("beforoe assert");
        try {
        assertEquals(getMessage(MessageKeys.E_TR_FW_0001), driver.findElement(By
                .cssSelector("p")).getText());
    ...
    public void tearDown() {
        /*
         * firefox59.2, geckodriver0.14.0の場合
         * ブラウザを閉じる際にクラッシュするため、
         * 設定エディターを開いてからブラウザを閉じる。
         */

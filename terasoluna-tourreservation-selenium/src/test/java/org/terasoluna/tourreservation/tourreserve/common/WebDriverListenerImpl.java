...
/**
 * geckodriver0.14.0のバグで、待機処理が正常に起動しないため、 
 * WebDriverEventListenerを実装
 */
public class WebDriverListenerImpl implements WebDriverEventListener {
    ...
    /**
     * click()後に実行される。 ページが読み込まれるまで待機を行う。 
     * 読み込みが開始するまでラグがあるため、こちらにも待機処理を組み込む。
     */
    @Override
    public void afterClickOn(WebElement element, WebDriver driver) {
        try {
            wait = new WebDriverWait(driver, 1, 100);
            wait.until(

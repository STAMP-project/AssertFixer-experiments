...
public class Driver implements java.sql.Driver {
  ...
  public static Properties parseURL(String url, Properties defaults) {
    ...
    boolean hasDoubleSlashes = l_urlServer.startsWith("//");
    if (hasDoubleSlashes) {
    ...
    if (hasDoubleSlashes && urlProps.containsKey("service")) {
      try {
        Map prefs = PGServiceFile.load(urlProps.getProperty("service"));
        pushServiceInProps(prefs, urlProps);
      } catch (Exception e) {
  ...
  private static void pushServiceInProps(Map<String, String> service, Properties urlProps) throws Exception {

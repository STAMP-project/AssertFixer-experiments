...
public class ReplicationSlotTest {
  ...
  @Test
  public void testCreatePhysicalSlotWithoutTemporaryOptionShouldNeverThrow() throws Exception {
    PGConnection pgConnection = (PGConnection) replConnection;

    slotName = "pgjdbc_test_create_physical_replication_slot_without_temporary_option";
    ...
    assertThat("Slot should not be temporary", result, CoreMatchers.equalTo(false));
  }
  ...
  public void testCreateTemporaryPhysicalSlot() throws Exception {
    ...
    if (baseConnection.haveMinimumServerVersion(ServerVersion.v10)) {
  ...
  @Test
  public void testCreateLogicalSlotWithoutTemporaryOptionShouldNeverThrow() throws Exception {
    PGConnection pgConnection = (PGConnection) replConnection;

    slotName = "pgjdbc_test_create_logical_replication_slot_without_temporary_option";

...
public class OrderByManager extends AbstractManager<ExpressionModifier> {
    ...
    List<OrderByExpression> getOrderByExpressions(boolean requiresNoCollections, Set<ResolvedExpression> groupByClauses) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            boolean unique = joinManager.getRoots().size() == 1
                    ...
                    && (!requiresNoCollections || !joinManager.hasCollections())

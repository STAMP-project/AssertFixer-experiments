...
public class PortTelnetHandlerTest {
    ...
    public void testListClient() throws Exception {
        ExchangeClient client1 = Exchangers.connect("dubbo://127.0.0.1:" + this.availablePort + "/demo");
        ExchangeClient client2 = Exchangers.connect("dubbo://127.0.0.1:" + this.availablePort + "/demo");
        Thread.sleep(5000);
        String result = port.telnet(null, "-l " + this.availablePort);
    ...
    public void testListDetail() throws RemotingException {
        ...
        assertEquals("dubbo://127.0.0.1:" + this.availablePort, result);
    }

    @Test
    public void testListAllPort() throws RemotingException {
        String result = port.telnet(null, "");
        assertEquals(String.valueOf(this.availablePort), result);
    }
    ...
    public void testNoPort() throws RemotingException {
        int anotherPort = NetUtils.getAvailablePort();
        String result = port.telnet(null, "-l " + anotherPort);
        assertEquals("No such port " + anotherPort, result);
    }

...
public class CnigValidatorRegressTest {
	 ...
	 * 
	 * TODO Find why results differs between GDAL 1.11.x and GDAL 2.2.x and improve FileConverter tests
	 * (see 19182_CC_20150517.SECTEUR_CC-1.11.3.csv and 19182_CC_20150517.SECTEUR_CC-2.2.2.csv)
	 * 
	 * @throws Exception
	 */
	@Test
	public void test19182_CC_20150517() throws Exception {
		boolean gdalDestroysCoordinates = FileConverter.getInstance().getVersion().startsWith("GDAL 1.11");
		...
		try {
			...
			if ( gdalDestroysCoordinates ){
				// GDAL 1.11.3 changes coordinates so that it turns invalid geometries to valid geometries...

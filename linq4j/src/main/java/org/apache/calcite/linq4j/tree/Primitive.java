...
public enum Primitive {
  BOOLEAN(Boolean.TYPE, Boolean.class, false, false, false, null, null, true, -1),
  BYTE(Byte.TYPE, Byte.class, true, (byte) 0, Byte.MIN_VALUE, null, null,
      Byte.MAX_VALUE, Byte.SIZE),
  CHAR(Character.TYPE, Character.class, true, (char) 0, Character.MIN_VALUE,
      null, null, Character.MAX_VALUE, Character.SIZE),
  SHORT(Short.TYPE, Short.class, true, (short) 0, Short.MIN_VALUE, null, null,
      Short.MAX_VALUE, Short.SIZE),
  INT(Integer.TYPE, Integer.class, true, 0, Integer.MIN_VALUE, null, null,
      Integer.MAX_VALUE, Integer.SIZE),
  LONG(Long.TYPE, Long.class, true, 0L, Long.MIN_VALUE, null, null,
      Long.MAX_VALUE, Long.SIZE),
  FLOAT(Float.TYPE, Float.class, true, 0F, -Float.MAX_VALUE, -Float.MIN_VALUE,
      Float.MIN_VALUE, Float.MAX_VALUE, Float.SIZE),
  DOUBLE(Double.TYPE, Double.class, true, 0D, -Double.MAX_VALUE, -Double.MIN_VALUE,
      Double.MIN_VALUE, Double.MAX_VALUE, Double.SIZE),
  VOID(Void.TYPE, Void.class, false, null, null, null, null, null, -1),
  OTHER(null, null, false, null, null, null, null, null, -1);
  ...
  Primitive(Class primitiveClass, Class boxClass, boolean number,

...
public class CharCharHashMapTest extends AbstractMutableCharCharMapTestCase
{
    ...
    public void occupiedWithDataAndSentinelsOnUpdateValue() throws Exception
    {
        ...
        hashMap.updateValue((char) 2, (char) 0, function); // putting in a slot marked REMOVED
        Assert.assertEquals(0, occupiedWithSentinels.get(hashMap));
        Assert.assertEquals(4, occupiedWithData.get(hashMap));
    }
    ...
    public void occupiedWithDataAndSentinelsOnPut() throws Exception
    {
        ...
        hashMap.put((char) 2, (char) 9); // putting in a slot marked REMOVED
        Assert.assertEquals(8, occupiedWithData.get(hashMap));
        Assert.assertEquals(0, occupiedWithSentinels.get(hashMap));
    }
    ...
    public void occupiedWithDataAndSentinelsOnGetIfAbsentPut() throws Exception
    {
        ...
        hashMap.getIfAbsentPut((char) 2, (char) 5); //putting in a slot marked REMOVED
        Assert.assertEquals(4, occupiedWithData.get(hashMap));
        Assert.assertEquals(0, occupiedWithSentinels.get(hashMap));
    }
    ...
    public void occupiedWithDataAndSentinelsOnGetIfAbsentPutWith() throws Exception
    {
        ...
        hashMap.getIfAbsentPutWith((char) 2, function, Character.valueOf((char) 5)); //putting in a slot marked REMOVED
        Assert.assertEquals(4, occupiedWithData.get(hashMap));
        Assert.assertEquals(0, occupiedWithSentinels.get(hashMap));
    }
    ...
    public void occupiedWithSentinelsOnPutRemovedSlot() throws Exception
    {
        ...
        hashMap.put((char) 2, (char) 3); //putting in a slot marked as REMOVED

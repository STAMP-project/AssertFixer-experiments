 ...
 */
public abstract class AbstractCharShortMapTestCase
{
    protected final CharShortMap map = this.classUnderTest();

    protected abstract CharShortMap classUnderTest();

    protected abstract CharShortMap newWithKeysValues(char key1, short value1);

    protected abstract CharShortMap newWithKeysValues(char key1, short value1, char key2, short value2);

    protected abstract CharShortMap newWithKeysValues(char key1, short value1, char key2, short value2, char key3, short value3);

    protected abstract CharShortMap newWithKeysValues(char key1, short value1, char key2, short value2, char key3, short value3, char key4, short value4);

    protected abstract CharShortMap getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(CharHashSet.newSetWith((char) 0), this.newWithKeysValues((char) 0, (short) 0).keySet());
        Assert.assertEquals(CharHashSet.newSetWith((char) 0, (char) 31, (char) 32),
                this.newWithKeysValues((char) 0, (short) 0, (char) 31, (short) 31, (char) 32, (short) 32).keySet());
    }
    ...
    public void values()
    {
        ...
        CharShortMap map = this.newWithKeysValues((char) 0, (short) 0);
        Verify.assertSize(1, map.values());
        Assert.assertTrue(map.values().contains((short) 0));

        CharShortMap map1 = this.newWithKeysValues((char) 0, (short) 0, (char) 31, (short) 31, (char) 32, (short) 32);
    ...
    public void isEmpty()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((char) 1, (short) 1).isEmpty());
        Assert.assertFalse(this.newWithKeysValues((char) 0, (short) 0).isEmpty());
        Assert.assertFalse(this.newWithKeysValues((char) 50, (short) 50).isEmpty());
    }
    ...
    public void notEmpty()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((char) 1, (short) 1).notEmpty());
        Assert.assertTrue(this.newWithKeysValues((char) 0, (short) 0).notEmpty());
        Assert.assertTrue(this.newWithKeysValues((char) 50, (short) 50).notEmpty());
    }
    ...
    public void testEquals()
    {
        ...
        CharShortMap map9 = this.newWithKeysValues((char) 0, (short) 0);
        ...
        Assert.assertEquals(map1, CharShortMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, CharShortMaps.immutable.ofAll(map1));
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((char) 0, (short) 0, (char) 1, (short) 1, (char) 32, (short) 32).hashCode(),
                this.newWithKeysValues((char) 32, (short) 32, (char) 0, (short) 0, (char) 1, (short) 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((char) 50, (short) 0, (char) 60, (short) 1, (char) 70, (short) 33).hashCode(),
                this.newWithKeysValues((char) 50, (short) 0, (char) 60, (short) 1, (char) 70, (short) 33).hashCode());
        Assert.assertEquals(UnifiedMap.newMap().hashCode(), this.getEmptyMap().hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues((char) 1, (short) 2).hashCode(), this.newWithKeysValues((char) 1, (short) 2).hashCode());
    }
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{\u0000=0}", this.newWithKeysValues((char) 0, (short) 0).toString());
        Assert.assertEquals("{\u0001=1}", this.newWithKeysValues((char) 1, (short) 1).toString());
        Assert.assertEquals("{\u0005=5}", this.newWithKeysValues((char) 5, (short) 5).toString());

        CharShortMap map1 = this.newWithKeysValues((char) 0, (short) 0, (char) 1, (short) 1);
        Assert.assertTrue(
                map1.toString(),
                "{\u0000=0, \u0001=1}".equals(map1.toString())
                        || "{\u0001=1, \u0000=0}".equals(map1.toString()));

        CharShortMap map2 = this.newWithKeysValues((char) 1, (short) 1, (char) 32, (short) 32);
        Assert.assertTrue(
                map2.toString(),
                "{\u0001=1, \u0020=32}".equals(map2.toString())
                        || "{\u0020=32, \u0001=1}".equals(map2.toString()));

        CharShortMap map3 = this.newWithKeysValues((char) 0, (short) 0, (char) 32, (short) 32);
        Assert.assertTrue(
                map3.toString(),
                "{\u0000=0, \u0020=32}".equals(map3.toString())
                        || "{\u0020=32, \u0000=0}".equals(map3.toString()));

        CharShortMap map4 = this.newWithKeysValues((char) 32, (short) 32, (char) 33, (short) 33);
        Assert.assertTrue(
                map4.toString(),
    ...
    public void forEachKey()
    {
        ...
        CharShortMap map3 = this.newWithKeysValues((char) 1, (short) 1);
    ...
    public void forEachKeyValue()
    {
        ...
        map0.forEachKeyValue((char eachKey, short eachValue) ->
        {
            sumKey0[0] += eachKey;
        ...
        map1.forEachKeyValue((char eachKey, short eachValue) ->
        {
            sumKey1[0] += eachKey;
        ...
        map01.forEachKeyValue((char eachKey, short eachValue) ->
        {
            sumKey01[0] += eachKey;
        ...
        map.forEachKeyValue((char eachKey, short eachValue) ->
        {
            sumKey[0] += eachKey;
        ...
        map2.forEachKeyValue((char eachKey, short eachValue) ->
        {
            sumKey2[0] += eachKey;
        ...
        CharShortMap map3 = this.newWithKeysValues((char) 3, (short) 5);
        char[] sumKey3 = new char[1];
        short[] sumValue3 = new short[1];
        map3.forEachKeyValue((char eachKey, short eachValue) ->
        {
            sumKey3[0] += eachKey;
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("", this.getEmptyMap().makeString(", "));
        Assert.assertEquals("[]", this.getEmptyMap().makeString("[", "/", "]"));
        Assert.assertEquals("0", this.newWithKeysValues((char) 0, (short) 0).makeString());
        Assert.assertEquals("0", this.newWithKeysValues((char) 0, (short) 0).makeString(", "));
        Assert.assertEquals("[0]", this.newWithKeysValues((char) 0, (short) 0).makeString("[", "/", "]"));
        Assert.assertEquals("1", this.newWithKeysValues((char) 1, (short) 1).makeString());
        Assert.assertEquals("5", this.newWithKeysValues((char) 5, (short) 5).makeString());
    ...
    public void appendString()
    {
        ...
        this.newWithKeysValues((char) 0, (short) 0).appendString(appendable0);
        Assert.assertEquals("0", appendable0.toString());

        Appendable appendable01 = new StringBuilder();
        this.newWithKeysValues((char) 0, (short) 0).appendString(appendable01, "/");
        Assert.assertEquals("0", appendable01.toString());

        Appendable appendable02 = new StringBuilder();
        this.newWithKeysValues((char) 0, (short) 0).appendString(appendable02, "{", "/", "}");
        Assert.assertEquals("{0}", appendable02.toString());

        Appendable appendable1 = new StringBuilder();
        this.newWithKeysValues((char) 1, (short) 1).appendString(appendable1);
        Assert.assertEquals("1", appendable1.toString());

        Appendable appendable2 = new StringBuilder();
        this.newWithKeysValues((char) 5, (short) 5).appendString(appendable2);
        ...
        CharShortMap map3 = this.newWithKeysValues((char) 1, (short) 1, (char) 32, (short) 32);
    ...
    public void select()
    {
        CharShortMap map = this.newWithKeysValues((char) 0, (short) 0, (char) 1, (short) 1, (char) 2, (short) 2, (char) 3, (short) 3);
        CharShortMap actual1 = map.select((char key, short value) -> key == (char) 1 || value == (short) 3);
        Assert.assertEquals(CharShortHashMap.newWithKeysValues((char) 1, (short) 1, (char) 3, (short) 3), actual1);
        CharShortMap actual2 = map.select((char key, short value) -> key == (char) 0 || value == (short) 2);
        Assert.assertEquals(CharShortHashMap.newWithKeysValues((char) 0, (short) 0, (char) 2, (short) 2), actual2);
    }
    ...
    {
        CharShortMap map = this.newWithKeysValues((char) 0, (short) 0, (char) 1, (short) 1, (char) 2, (short) 2, (char) 3, (short) 3);
        CharShortMap actual1 = map.reject((char key, short value) -> key == (char) 1 || value == (short) 3);
        Assert.assertEquals(CharShortHashMap.newWithKeysValues((char) 0, (short) 0, (char) 2, (short) 2), actual1);
        CharShortMap actual2 = map.reject((char key, short value)-> key == (char) 0 || value == (short) 2);
        Assert.assertEquals(CharShortHashMap.newWithKeysValues((char) 1, (short) 1, (char) 3, (short) 3), actual2);
    }
    ...
    public void collect()
    {
        ...
        Assert.assertEquals(Bags.immutable.with((short) 2), this.newWithKeysValues((char) 1, (short) 1).collect(function));
    }
    ...
    public void detectIfNone_value()
    {
        ...
        Assert.assertEquals((short) 5, this.newWithKeysValues((char) 1, (short) 1).detectIfNone(ShortPredicates.equal((short) 0), (short) 5));
        Assert.assertEquals((short) 1, this.newWithKeysValues((char) 1, (short) 1).detectIfNone(ShortPredicates.equal((short) 1), (short) 5));
    ...
    public void anySatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((char) 1, (short) 1).anySatisfy(ShortPredicates.equal((short) 0)));
        Assert.assertTrue(this.newWithKeysValues((char) 1, (short) 1).anySatisfy(ShortPredicates.equal((short) 1)));
    ...
    public void allSatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((char) 1, (short) 1).allSatisfy(ShortPredicates.equal((short) 0)));
        Assert.assertTrue(this.newWithKeysValues((char) 1, (short) 1).allSatisfy(ShortPredicates.equal((short) 1)));
        ...
        CharShortMap map1 = this.newWithKeysValues((char) 2, (short) 2, (char) 3, (short) 3);
    ...
    public void noneSatisfy()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((char) 1, (short) 1).noneSatisfy(ShortPredicates.equal((short) 0)));
        Assert.assertFalse(this.newWithKeysValues((char) 1, (short) 1).noneSatisfy(ShortPredicates.equal((short) 1)));
    ...
    public void max()
    {
        ...
        Assert.assertEquals((short) 3, this.newWithKeysValues((char) 3, (short) 3).max());
    }

    @Test
    public void min()
    {
        CharShortMap map = this.newWithKeysValues((char) 1, (short) 1, (char) 2, (short) 2, (char) 3, (short) 3, (char) 0, (short) 0);
        Assert.assertEquals((short) 0, map.min());
        Assert.assertEquals((short) 3, this.newWithKeysValues((char) 3, (short) 3).min());
    }
    ...
    public void minIfEmpty()
    {
        ...
        CharShortMap map = this.newWithKeysValues((char) 1, (short) 1, (char) 0, (short) 0, (char) 9, (short) 9, (char) 7, (short) 7);
        Assert.assertEquals(0L, map.minIfEmpty((short) 5));
        Assert.assertEquals((short) 3, this.newWithKeysValues((char) 3, (short) 3).maxIfEmpty((short) 5));
    }
    ...
    public void maxIfEmpty()
    {
        ...
        Assert.assertEquals((short) 3, this.newWithKeysValues((char) 3, (short) 3).minIfEmpty((short) 5));
    }
    ...
    public void sum()
    {
        ...
        CharShortMap map2 = this.newWithKeysValues((char) 2, (short) 2, (char) 3, (short) 3, (char) 4, (short) 4);
        Assert.assertEquals((short) 9, map2.sum());
        CharShortMap map3 = this.newWithKeysValues((char) 2, (short) 2);
    ...
    public void average()
    {
        ...
        CharShortMap map1 = this.newWithKeysValues((char) 1, (short) 1);
    ...
    public void median()
    {
        ...
        CharShortMap map2 = this.newWithKeysValues((char) 0, (short) 0, (char) 1, (short) 1, (char) 2, (short) 2);
    ...
    public void toList()
    {
        Assert.assertEquals(ShortArrayList.newListWith((short) 0), this.newWithKeysValues((char) 0, (short) 0).toList());
        Assert.assertEquals(ShortArrayList.newListWith((short) 1), this.newWithKeysValues((char) 1, (short) 1).toList());
        Assert.assertEquals(ShortArrayList.newListWith((short) 2), this.newWithKeysValues((char) 2, (short) 2).toList());
        Assert.assertTrue(this.newWithKeysValues((char) 2, (short) 2, (char) 3, (short) 3).toList().equals(ShortArrayList.newListWith((short) 2, (short) 3))
                || this.newWithKeysValues((char) 2, (short) 2, (char) 3, (short) 3).toList().equals(ShortArrayList.newListWith((short) 3, (short) 2)));
    }
    ...
    public void toSortedList()
    {
        ...
        Assert.assertEquals(ShortArrayList.newListWith((short) 1), this.newWithKeysValues((char) 1, (short) 1).toSortedList());
    }
    ...
    public void toSet()
    {
        ...
        Assert.assertEquals(ShortHashSet.newSetWith((short) 1), this.newWithKeysValues((char) 1, (short) 1).toSet());
    }
    ...
    public void toBag()
    {
        ...
        Assert.assertEquals(ShortHashBag.newBagWith((short) 1), this.newWithKeysValues((char) 1, (short) 1).toBag());
    }
    ...
    {
        MutableBag<CharShortPair> expected = Bags.mutable.of();
        this.map.forEachKeyValue((char key, short value) -> expected.add(PrimitiveTuples.pair(key, value)));
    ...
    public void toArray()
    {
        CharShortMap map = this.newWithKeysValues((char) 1, (short) 1, (char) 2, (short) 2);
        ...
        Assert.assertTrue(Arrays.equals(new short[]{(short) 1}, this.newWithKeysValues((char) 1, (short) 1).toArray()));
    }
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableCharShortMap.class, this.classUnderTest().toImmutable());
    }

    @Test
    public void chunk()
    {
        ShortIterable iterable = this.newWithKeysValues((char) 1, (short) 1, (char) 2, (short) 2, (char) 3, (short) 3);
        Assert.assertEquals(
                Lists.mutable.with(
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((char) 1, (short) 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((char) 1, (short) 1).chunk(-1));
    }
}

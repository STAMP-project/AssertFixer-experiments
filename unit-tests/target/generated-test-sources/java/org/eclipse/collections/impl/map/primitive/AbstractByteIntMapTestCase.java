...
public abstract class AbstractByteIntMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 0, (byte) 31, (byte) 32),
                this.newWithKeysValues((byte) 0, 0, (byte) 31, 31, (byte) 32, 32).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 0, 0, (byte) 1, 1, (byte) 32, 32).hashCode(),
                this.newWithKeysValues((byte) 32, 32, (byte) 0, 0, (byte) 1, 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 50, 0, (byte) 60, 1, (byte) 70, 33).hashCode(),
                this.newWithKeysValues((byte) 50, 0, (byte) 60, 1, (byte) 70, 33).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((byte) 2, 2, (byte) 3, 3).toList().equals(IntArrayList.newListWith(2, 3))
                || this.newWithKeysValues((byte) 2, 2, (byte) 3, 3).toList().equals(IntArrayList.newListWith(3, 2)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 1, 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((byte) 1, 1).chunk(-1));
    }
}

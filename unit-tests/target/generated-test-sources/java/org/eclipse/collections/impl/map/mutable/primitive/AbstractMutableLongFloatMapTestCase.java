...
public abstract class AbstractMutableLongFloatMapTestCase extends AbstractLongFloatMapTestCase
{
    ...
    public void getIfAbsentPutWithKey()
    {
        ...
        LongToFloatFunction functionThrows = (long longParameter) -> { throw new AssertionError(); };
    ...
    public void flipUniqueValues()
    {
        ...
        Assert.assertEquals(
                FloatLongHashMap.newWithKeysValues(2.0f, 1L, 3.0f, 2L, 4.0f, 3L, 5.0f, 4L),
                map.flipUniqueValues());
         Verify.assertThrows(
                IllegalStateException.class,
                () -> this.newWithKeysValues(1L, 1.0f, 2L, 1.0f).flipUniqueValues());
    }
}

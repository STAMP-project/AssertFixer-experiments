...
/**
 * JUnit test for {@link DoubleBooleanHashMap#values()}.
 * This file was automatically generated from template file primitiveBooleanHashMapValuesTest.stg.
 */
public class DoubleBooleanHashMapValuesTest extends AbstractMutableBooleanCollectionTestCase
{
    @Override
    protected MutableBooleanCollection classUnderTest()
    {
        return DoubleBooleanHashMap.newWithKeysValues(1.0, true, 2.0, false, 3.0, true).values();
    }
    ...
    public void removeAll()
    {
        ...
        DoubleBooleanHashMap map = DoubleBooleanHashMap.newWithKeysValues(1.0, true, 2.0, false);
        MutableBooleanCollection collection = map.values();
        ...
        DoubleBooleanHashMap map1 = DoubleBooleanHashMap.newWithKeysValues(1.0, true, 2.0, false);
    ...
    public void retainAll()
    {
        ...
        DoubleBooleanHashMap sentinelMap = DoubleBooleanHashMap.newWithKeysValues(1.0, true, 0.0, false);

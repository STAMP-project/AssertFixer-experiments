...
public abstract class AbstractIntLongMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(IntHashSet.newSetWith(0, 31, 32),
                this.newWithKeysValues(0, 0L, 31, 31L, 32, 32L).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0, 0L, 1, 1L, 32, 32L).hashCode(),
                this.newWithKeysValues(32, 32L, 0, 0L, 1, 1L).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50, 0L, 60, 1L, 70, 33L).hashCode(),
                this.newWithKeysValues(50, 0L, 60, 1L, 70, 33L).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(2, 2L, 3, 3L).toList().equals(LongArrayList.newListWith(2L, 3L))
                || this.newWithKeysValues(2, 2L, 3, 3L).toList().equals(LongArrayList.newListWith(3L, 2L)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1, 1L).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1, 1L).chunk(-1));
    }
}

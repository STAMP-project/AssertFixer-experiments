...
public class ImmutableDoubleObjectSingletonMapTest extends AbstractImmutableDoubleObjectMapTestCase
{
    ...
    {
        Assert.assertEquals(
                DoubleObjectHashMap.newWithKeysValues(0.0, "zero"),
                this.classUnderTest().select((double value, String object) -> value == 0));
    ...
    public void collectBoolean()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0, "true").collectBoolean(StringFunctions.toPrimitiveBoolean()));
    }
    ...
    public void collectByte()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0, "0").collectByte(Byte::parseByte));
    }
    ...
    public void collectChar()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0, "0").collectChar(StringFunctions.toPrimitiveChar()));
    }
    ...
    public void collectDouble()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0, "0").collectDouble(Double::parseDouble));
    }
    ...
    public void collectFloat()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0, "0").collectFloat(Float::parseFloat));
    }
    ...
    public void collectInt()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0, "0").collectInt(Integer::parseInt));
    }
    ...
    public void collectLong()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0, "0").collectLong(Long::parseLong));
    }
    ...
    public void collectShort()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0, "0").collectShort(Short::parseShort));
    }

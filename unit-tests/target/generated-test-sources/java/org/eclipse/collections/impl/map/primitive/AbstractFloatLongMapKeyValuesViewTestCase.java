...
public abstract class AbstractFloatLongMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith(1.0f, 2L, 2.0f, 3L, 3.0f, 4L).collect((FloatLongPair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Long> result2 =
            this.newWith(1.0f, 2L, 2.0f, 3L, 3.0f, 4L).collect((FloatLongPair object) -> (long) object.getTwo());
    ...
    public void detectWithIfNoneBlock()
    {
        Function0<FloatLongPair> function = Functions0.value(PrimitiveTuples.pair(5.0f, 6L));
        Assert.assertEquals(
            PrimitiveTuples.pair(2.0f, 3L),
            this.newWith(1.0f, 2L, 2.0f, 3L, 3.0f, 4L).detectWithIfNone(
                    Object::equals,
                    PrimitiveTuples.pair(2.0f, 3L),
                    function));
        Assert.assertEquals(
            PrimitiveTuples.pair(5.0f, 6L),
            this.newWith(1.0f, 2L, 2.0f, 3L, 3.0f, 4L).detectWithIfNone(
                    Object::equals,
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith(1.0f, 2L, 2.0f, 3L, 3.0f, 4L).collectIf(
                        FloatLongPair.class::isInstance,
                        String::valueOf),
                "1.0:2", "2.0:3", "3.0:4");
        Verify.assertContainsAll(
                this.newWith(1.0f, 2L, 2.0f, 3L, 3.0f, 4L).collectIf(
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith(1.0f, 2L, 2.0f, 3L, 3.0f, 4L).collectWith((FloatLongPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(4L, 6L, 8L),
                this.newWith(1.0f, 2L, 2.0f, 3L, 3.0f, 4L).collectWith((FloatLongPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1.0f, 2L).equals(first)
                || PrimitiveTuples.pair(2.0f, 3L).equals(first)
                || PrimitiveTuples.pair(3.0f, 4L).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1.0f, 2L).equals(last)
                || PrimitiveTuples.pair(2.0f, 3L).equals(last)
                || PrimitiveTuples.pair(3.0f, 4L).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair(3.0f, 4L),
                PrimitiveTuples.pair(2.0f, 3L),
                PrimitiveTuples.pair(1.0f, 2L)),
                set);
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1.0f, 2L), 1), Tuples.pair(PrimitiveTuples.pair(2.0f, 3L), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2.0f, 3L), 1), Tuples.pair(PrimitiveTuples.pair(1.0f, 2L), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1.0f, 2L), 0), Tuples.pair(PrimitiveTuples.pair(2.0f, 3L), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2.0f, 3L), 0), Tuples.pair(PrimitiveTuples.pair(1.0f, 2L), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<FloatLongPair> collection = this.newWith(1.0f, 2L, 2.0f, 3L, 3.0f, 4L);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair(1.0f, 2L)),
                FastList.newListWith(PrimitiveTuples.pair(2.0f, 3L)),
                FastList.newListWith(PrimitiveTuples.pair(3.0f, 4L))),

...
public class UnmodifiableObjectDoubleMapTest extends AbstractMutableObjectDoubleMapTestCase
{
    ...
    {
        DoubleFunction0 factory = () -> { throw new AssertionError(); };
    ...
    {
        DoubleFunction<String> functionLength = (String string) -> { throw new AssertionError(); };
    ...
    {
        DoubleFunction<Integer> function = (Integer anObject) -> { throw new AssertionError(); };
    ...
    {
        DoubleToDoubleFunction incrementFunction = (double value) -> { throw new AssertionError(); };

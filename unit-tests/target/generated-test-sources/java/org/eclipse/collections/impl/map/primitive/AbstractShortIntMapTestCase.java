...
public abstract class AbstractShortIntMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(ShortHashSet.newSetWith((short) 0, (short) 31, (short) 32),
                this.newWithKeysValues((short) 0, 0, (short) 31, 31, (short) 32, 32).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((short) 0, 0, (short) 1, 1, (short) 32, 32).hashCode(),
                this.newWithKeysValues((short) 32, 32, (short) 0, 0, (short) 1, 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((short) 50, 0, (short) 60, 1, (short) 70, 33).hashCode(),
                this.newWithKeysValues((short) 50, 0, (short) 60, 1, (short) 70, 33).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((short) 2, 2, (short) 3, 3).toList().equals(IntArrayList.newListWith(2, 3))
                || this.newWithKeysValues((short) 2, 2, (short) 3, 3).toList().equals(IntArrayList.newListWith(3, 2)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((short) 1, 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((short) 1, 1).chunk(-1));
    }
}

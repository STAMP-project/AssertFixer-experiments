...
public class UnmodifiableObjectShortMapTest extends AbstractMutableObjectShortMapTestCase
{
    ...
    {
        ShortFunction0 factory = () -> { throw new AssertionError(); };
    ...
    {
        ShortFunction<String> functionLength = (String string) -> { throw new AssertionError(); };
    ...
    {
        ShortFunction<Integer> function = (Integer anObject) -> { throw new AssertionError(); };
    ...
    {
        ShortToShortFunction incrementFunction = (short value) -> { throw new AssertionError(); };

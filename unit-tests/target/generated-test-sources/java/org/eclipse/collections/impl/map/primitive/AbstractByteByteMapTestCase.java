...
public abstract class AbstractByteByteMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 0, (byte) 31, (byte) 32),
                this.newWithKeysValues((byte) 0, (byte) 0, (byte) 31, (byte) 31, (byte) 32, (byte) 32).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 0, (byte) 0, (byte) 1, (byte) 1, (byte) 32, (byte) 32).hashCode(),
                this.newWithKeysValues((byte) 32, (byte) 32, (byte) 0, (byte) 0, (byte) 1, (byte) 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 50, (byte) 0, (byte) 60, (byte) 1, (byte) 70, (byte) 33).hashCode(),
                this.newWithKeysValues((byte) 50, (byte) 0, (byte) 60, (byte) 1, (byte) 70, (byte) 33).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((byte) 2, (byte) 2, (byte) 3, (byte) 3).toList().equals(ByteArrayList.newListWith((byte) 2, (byte) 3))
                || this.newWithKeysValues((byte) 2, (byte) 2, (byte) 3, (byte) 3).toList().equals(ByteArrayList.newListWith((byte) 3, (byte) 2)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 1, (byte) 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((byte) 1, (byte) 1).chunk(-1));
    }
}

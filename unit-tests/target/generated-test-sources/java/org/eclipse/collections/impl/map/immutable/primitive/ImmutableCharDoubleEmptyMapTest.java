...
/**
 * JUnit test for {@link ImmutableCharDoubleEmptyMap}.
 * This file was automatically generated from template file immutablePrimitivePrimitiveEmptyMapTest.stg.
 */
public class ImmutableCharDoubleEmptyMapTest extends AbstractImmutableCharDoubleMapTestCase
{
    @Override
    ...
    {
        Assert.assertEquals(5.0, this.map.getIfAbsent((char) 0, 5.0), 0.0);
    ...
    public void select()
    {
        Assert.assertEquals(this.classUnderTest(), this.classUnderTest().select((char value1, double value2) -> true));
    }
    ...
    public void reject()
    {
        Assert.assertEquals(this.classUnderTest(), this.classUnderTest().reject((char value1, double value2) -> false));
    }
    ...
    {
        ImmutableCharDoubleEmptyMap iterable = new ImmutableCharDoubleEmptyMap();

...
/**
 * JUnit test for {@link SynchronizedShortBooleanMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitiveBooleanMapValuesTest.stg.
 */
public class SynchronizedShortBooleanMapValuesTest extends AbstractMutableBooleanCollectionTestCase
{
    @Override
    protected MutableBooleanCollection classUnderTest()
    {
        return new SynchronizedShortBooleanMap(ShortBooleanHashMap.newWithKeysValues((short) 1, true, (short) 2, false, (short) 3, true)).values();
    }

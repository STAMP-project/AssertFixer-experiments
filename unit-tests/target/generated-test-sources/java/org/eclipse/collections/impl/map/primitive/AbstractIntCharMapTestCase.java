 ...
 */
public abstract class AbstractIntCharMapTestCase
{
    protected final IntCharMap map = this.classUnderTest();

    protected abstract IntCharMap classUnderTest();

    protected abstract IntCharMap newWithKeysValues(int key1, char value1);

    protected abstract IntCharMap newWithKeysValues(int key1, char value1, int key2, char value2);

    protected abstract IntCharMap newWithKeysValues(int key1, char value1, int key2, char value2, int key3, char value3);

    protected abstract IntCharMap newWithKeysValues(int key1, char value1, int key2, char value2, int key3, char value3, int key4, char value4);

    protected abstract IntCharMap getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(IntHashSet.newSetWith(0), this.newWithKeysValues(0, (char) 0).keySet());
        Assert.assertEquals(IntHashSet.newSetWith(0, 31, 32),
                this.newWithKeysValues(0, (char) 0, 31, (char) 31, 32, (char) 32).keySet());
    }
    ...
    public void values()
    {
        ...
        IntCharMap map = this.newWithKeysValues(0, (char) 0);
        Verify.assertSize(1, map.values());
        Assert.assertTrue(map.values().contains((char) 0));

        IntCharMap map1 = this.newWithKeysValues(0, (char) 0, 31, (char) 31, 32, (char) 32);
    ...
    public void testEquals()
    {
        ...
        IntCharMap map9 = this.newWithKeysValues(0, (char) 0);
        ...
        Assert.assertEquals(map1, IntCharMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, IntCharMaps.immutable.ofAll(map1));
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0, (char) 0, 1, (char) 1, 32, (char) 32).hashCode(),
                this.newWithKeysValues(32, (char) 32, 0, (char) 0, 1, (char) 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50, (char) 0, 60, (char) 1, 70, (char) 33).hashCode(),
                this.newWithKeysValues(50, (char) 0, 60, (char) 1, 70, (char) 33).hashCode());
        Assert.assertEquals(UnifiedMap.newMap().hashCode(), this.getEmptyMap().hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(1, (char) 2).hashCode(), this.newWithKeysValues(1, (char) 2).hashCode());
    }
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{1=\u0001}", this.newWithKeysValues(1, (char) 1).toString());
        Assert.assertEquals("{5=\u0005}", this.newWithKeysValues(5, (char) 5).toString());

        IntCharMap map1 = this.newWithKeysValues(0, (char) 0, 1, (char) 1);
        Assert.assertTrue(
                map1.toString(),
                "{0=\u0000, 1=\u0001}".equals(map1.toString())
                        || "{1=\u0001, 0=\u0000}".equals(map1.toString()));

        IntCharMap map2 = this.newWithKeysValues(1, (char) 1, 32, (char) 32);
        Assert.assertTrue(
                map2.toString(),
                "{1=\u0001, 32=\u0020}".equals(map2.toString())
                        || "{32=\u0020, 1=\u0001}".equals(map2.toString()));

        IntCharMap map3 = this.newWithKeysValues(0, (char) 0, 32, (char) 32);
        Assert.assertTrue(
                map3.toString(),
                "{0=\u0000, 32=\u0020}".equals(map3.toString())
                        || "{32=\u0020, 0=\u0000}".equals(map3.toString()));

        IntCharMap map4 = this.newWithKeysValues(32, (char) 32, 33, (char) 33);
        Assert.assertTrue(
                map4.toString(),
    ...
    public void forEachKey()
    {
        ...
        IntCharMap map3 = this.newWithKeysValues(1, (char) 1);
        int[] sum3 = new int[1];
    ...
    public void forEachKeyValue()
    {
        ...
        map0.forEachKeyValue((int eachKey, char eachValue) ->
        {
            sumKey0[0] += eachKey;
        ...
        map1.forEachKeyValue((int eachKey, char eachValue) ->
        {
            sumKey1[0] += eachKey;
        ...
        map01.forEachKeyValue((int eachKey, char eachValue) ->
        {
            sumKey01[0] += eachKey;
        ...
        map.forEachKeyValue((int eachKey, char eachValue) ->
        {
            sumKey[0] += eachKey;
        ...
        map2.forEachKeyValue((int eachKey, char eachValue) ->
        {
            sumKey2[0] += eachKey;
        ...
        IntCharMap map3 = this.newWithKeysValues(3, (char) 5);
        int[] sumKey3 = new int[1];
        char[] sumValue3 = new char[1];
        map3.forEachKeyValue((int eachKey, char eachValue) ->
        {
            sumKey3[0] += eachKey;
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("\u0005", this.newWithKeysValues(5, (char) 5).makeString());
    ...
    public void appendString()
    {
        ...
        this.newWithKeysValues(0, (char) 0).appendString(appendable01, "/");
        Assert.assertEquals("\u0000", appendable01.toString());

        Appendable appendable02 = new StringBuilder();
        this.newWithKeysValues(0, (char) 0).appendString(appendable02, "{", "/", "}");
        ...
        this.newWithKeysValues(5, (char) 5).appendString(appendable2);
        ...
        IntCharMap map3 = this.newWithKeysValues(1, (char) 1, 32, (char) 32);
    ...
    public void select()
    {
        IntCharMap map = this.newWithKeysValues(0, (char) 0, 1, (char) 1, 2, (char) 2, 3, (char) 3);
        IntCharMap actual1 = map.select((int key, char value) -> key == 1 || value == (char) 3);
        Assert.assertEquals(IntCharHashMap.newWithKeysValues(1, (char) 1, 3, (char) 3), actual1);
        IntCharMap actual2 = map.select((int key, char value) -> key == 0 || value == (char) 2);
        Assert.assertEquals(IntCharHashMap.newWithKeysValues(0, (char) 0, 2, (char) 2), actual2);
    }
    ...
    {
        IntCharMap map = this.newWithKeysValues(0, (char) 0, 1, (char) 1, 2, (char) 2, 3, (char) 3);
        IntCharMap actual1 = map.reject((int key, char value) -> key == 1 || value == (char) 3);
        Assert.assertEquals(IntCharHashMap.newWithKeysValues(0, (char) 0, 2, (char) 2), actual1);
        IntCharMap actual2 = map.reject((int key, char value)-> key == 0 || value == (char) 2);
        Assert.assertEquals(IntCharHashMap.newWithKeysValues(1, (char) 1, 3, (char) 3), actual2);
    }
    ...
    public void collect()
    {
        ...
        Assert.assertEquals(Bags.immutable.with((char) 2), this.newWithKeysValues(1, (char) 1).collect(function));
    }
    ...
    public void detectIfNone_value()
    {
        ...
        Assert.assertEquals((char) 5, this.newWithKeysValues(1, (char) 1).detectIfNone(CharPredicates.equal((char) 0), (char) 5));
        Assert.assertEquals((char) 1, this.newWithKeysValues(1, (char) 1).detectIfNone(CharPredicates.equal((char) 1), (char) 5));
    ...
    public void anySatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1, (char) 1).anySatisfy(CharPredicates.equal((char) 0)));
        Assert.assertTrue(this.newWithKeysValues(1, (char) 1).anySatisfy(CharPredicates.equal((char) 1)));
    ...
    public void allSatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1, (char) 1).allSatisfy(CharPredicates.equal((char) 0)));
        Assert.assertTrue(this.newWithKeysValues(1, (char) 1).allSatisfy(CharPredicates.equal((char) 1)));
        ...
        IntCharMap map1 = this.newWithKeysValues(2, (char) 2, 3, (char) 3);
    ...
    public void noneSatisfy()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(1, (char) 1).noneSatisfy(CharPredicates.equal((char) 0)));
        Assert.assertFalse(this.newWithKeysValues(1, (char) 1).noneSatisfy(CharPredicates.equal((char) 1)));
    ...
    public void max()
    {
        ...
        Assert.assertEquals((char) 3, this.newWithKeysValues(3, (char) 3).max());
    }

    @Test
    public void min()
    {
        IntCharMap map = this.newWithKeysValues(1, (char) 1, 2, (char) 2, 3, (char) 3, 0, (char) 0);
        Assert.assertEquals((char) 0, map.min());
        Assert.assertEquals((char) 3, this.newWithKeysValues(3, (char) 3).min());
    }
    ...
    public void minIfEmpty()
    {
        ...
        IntCharMap map = this.newWithKeysValues(1, (char) 1, 0, (char) 0, 9, (char) 9, 7, (char) 7);
        Assert.assertEquals(0L, map.minIfEmpty((char) 5));
        Assert.assertEquals((char) 3, this.newWithKeysValues(3, (char) 3).maxIfEmpty((char) 5));
    }
    ...
    public void maxIfEmpty()
    {
        ...
        Assert.assertEquals((char) 3, this.newWithKeysValues(3, (char) 3).minIfEmpty((char) 5));
    }
    ...
    public void sum()
    {
        ...
        IntCharMap map2 = this.newWithKeysValues(2, (char) 2, 3, (char) 3, 4, (char) 4);
        Assert.assertEquals((char) 9, map2.sum());
        IntCharMap map3 = this.newWithKeysValues(2, (char) 2);
    ...
    public void average()
    {
        ...
        IntCharMap map1 = this.newWithKeysValues(1, (char) 1);
    ...
    public void median()
    {
        ...
        IntCharMap map2 = this.newWithKeysValues(0, (char) 0, 1, (char) 1, 2, (char) 2);
    ...
    public void toList()
    {
        Assert.assertEquals(CharArrayList.newListWith((char) 0), this.newWithKeysValues(0, (char) 0).toList());
        Assert.assertEquals(CharArrayList.newListWith((char) 1), this.newWithKeysValues(1, (char) 1).toList());
        Assert.assertEquals(CharArrayList.newListWith((char) 2), this.newWithKeysValues(2, (char) 2).toList());
        Assert.assertTrue(this.newWithKeysValues(2, (char) 2, 3, (char) 3).toList().equals(CharArrayList.newListWith((char) 2, (char) 3))
                || this.newWithKeysValues(2, (char) 2, 3, (char) 3).toList().equals(CharArrayList.newListWith((char) 3, (char) 2)));
    }
    ...
    public void toSortedList()
    {
        ...
        Assert.assertEquals(CharArrayList.newListWith((char) 1), this.newWithKeysValues(1, (char) 1).toSortedList());
    }
    ...
    public void toSet()
    {
        ...
        Assert.assertEquals(CharHashSet.newSetWith((char) 1), this.newWithKeysValues(1, (char) 1).toSet());
    }
    ...
    public void toBag()
    {
        ...
        Assert.assertEquals(CharHashBag.newBagWith((char) 1), this.newWithKeysValues(1, (char) 1).toBag());
    }
    ...
    {
        MutableBag<IntCharPair> expected = Bags.mutable.of();
        this.map.forEachKeyValue((int key, char value) -> expected.add(PrimitiveTuples.pair(key, value)));
    ...
    public void toArray()
    {
        IntCharMap map = this.newWithKeysValues(1, (char) 1, 2, (char) 2);
        ...
        Assert.assertTrue(Arrays.equals(new char[]{(char) 1}, this.newWithKeysValues(1, (char) 1).toArray()));
    }
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableIntCharMap.class, this.classUnderTest().toImmutable());
    }

    @Test
    public void chunk()
    {
        CharIterable iterable = this.newWithKeysValues(1, (char) 1, 2, (char) 2, 3, (char) 3);
        Assert.assertEquals(
                Lists.mutable.with(
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1, (char) 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1, (char) 1).chunk(-1));
    }
}

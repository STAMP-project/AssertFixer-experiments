...
/**
 * JUnit test for {@link IntFloatHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class IntFloatHashMapValuesTest extends AbstractMutableFloatCollectionTestCase
{
    @Override
    protected MutableFloatCollection classUnderTest()
    {
        return IntFloatHashMap.newWithKeysValues(1, 1.0f, 2, 2.0f, 3, 3.0f).values();
    }
    ...
    public void remove()
    {
        IntFloatHashMap map = IntFloatHashMap.newWithKeysValues(1, 1.0f, 2, 2.0f, 3, 3.0f);
    ...
    public void retainAll()
    {
        ...
        IntFloatHashMap map = IntFloatHashMap.newWithKeysValues(0, 0.0f, 1, 1.0f, 2, 2.0f, 3, 3.0f);
        MutableFloatCollection collection = map.values();

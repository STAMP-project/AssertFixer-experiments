...
public abstract class ObjectCharHashMapKeySetTestCase
{
    ...
    {
        MutableObjectCharMap<String> map = this.newMapWithKeysValues("One", (char) 1, "Two", (char) 2, "Three", (char) 3, null, (char) 4);
    ...
    public void isEmpty()
    {
        ...
        MutableObjectCharMap<String> map1 = this.newEmptyMap();
    ...
    {
        MutableObjectCharMap<String> map1 = this.newMapWithKeysValues("One", (char) 1, "Two", (char) 2, "Three", (char) 3, null, (char) 4);
        ...
        MutableObjectCharMap<String> map3 = this.newEmptyMap();
    ...
    {
        MutableObjectCharMap<String> map = this.newMapWithKeysValues("One", (char) 1, "Two", (char) 2, "Three", (char) 3);
        Assert.assertFalse(map.keySet().remove("Four"));

        Assert.assertTrue(map.keySet().remove("Two"));
        Assert.assertEquals(this.newMapWithKeysValues("One", (char) 1,  "Three", (char) 3), map);
    ...
    public void removeNullFromKeySet()
    {
        ...
        Assert.assertEquals(this.newMapWithKeysValues("One", (char) 1, "Two", (char) 2, "Three", (char) 3), map);
    ...
    {
        MutableObjectCharMap<String> map = this.newMapWithKeysValues("One", (char) 1, "Two", (char) 2, "Three", (char) 3, null, (char) 0);

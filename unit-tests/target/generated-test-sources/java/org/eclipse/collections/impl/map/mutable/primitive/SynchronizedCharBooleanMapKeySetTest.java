...
/**
 * JUnit test for {@link SynchronizedCharBooleanMap#keySet()}.
 *
 * This file was automatically generated from template file synchronizedPrimitiveBooleanMapKeySetTest.stg.
 */
public class SynchronizedCharBooleanMapKeySetTest extends AbstractCharSetTestCase
{
    @Override
    protected MutableCharSet classUnderTest()
    {
        return new SynchronizedCharBooleanMap(CharBooleanHashMap.newWithKeysValues((char) 1, true, (char) 2, false, (char) 3, true)).keySet();
    }

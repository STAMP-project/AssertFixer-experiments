...
/**
 * JUnit test for {@link IntDoubleHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class IntDoubleHashMapValuesTest extends AbstractMutableDoubleCollectionTestCase
{
    @Override
    protected MutableDoubleCollection classUnderTest()
    {
        return IntDoubleHashMap.newWithKeysValues(1, 1.0, 2, 2.0, 3, 3.0).values();
    }
    ...
    public void retainAll()
    {
        ...
        IntDoubleHashMap map = IntDoubleHashMap.newWithKeysValues(0, 0.0, 1, 1.0, 2, 2.0, 3, 3.0);
        MutableDoubleCollection collection = map.values();

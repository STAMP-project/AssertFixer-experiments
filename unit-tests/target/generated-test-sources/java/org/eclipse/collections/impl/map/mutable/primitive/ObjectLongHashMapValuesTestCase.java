 ...
 */
public abstract class ObjectLongHashMapValuesTestCase extends AbstractMutableLongCollectionTestCase
{
    ...
    {
        return this.newMapWithKeysValues(String.valueOf(1), 1L, String.valueOf(2), 2L, String.valueOf(3), 3L).values();
    }

    @Override
    protected MutableLongCollection newWith(long... elements)
    {
        MutableObjectLongMap map = this.newEmptyMap();
    ...
    public void longIterator()
    {
        ...
        LongIterator iterator1 = bag.longIterator();
        for (int i = 0; i < 4; i++)
        {
        ...
        MutableObjectLongMap<String> map2 = new ObjectLongHashMap<>();
        for (long each = 2L; each < 100L; each++)
        {
            map2.put(String.valueOf(each), each);
        }
        MutableLongIterator iterator2 = map2.longIterator();
    ...
    public void remove()
    {
        MutableObjectLongMap<String> map = this.newMapWithKeysValues(String.valueOf(1), 1L, String.valueOf(2), 2L, String.valueOf(3), 3L);
    ...
    public void retainAll()
    {
        ...
        Assert.assertTrue(collection.retainAll(1L, 0L, 4L));
        Assert.assertTrue(collection.isEmpty());
        Assert.assertFalse(collection.contains(1L));
        Assert.assertFalse(collection.contains(2L));
        Assert.assertFalse(collection.contains(3L));
    ...
    public void retainAll_iterable()
    {
        ...
        MutableObjectLongMap<String> map = this.newMapWithKeysValues(String.valueOf(1), 1L, String.valueOf(2), 2L, String.valueOf(3), 3L);
        MutableLongCollection collection = map.values();
        Assert.assertFalse(collection.retainAll(LongArrayList.newListWith(1L, 2L, 3L)));
        ...
        Assert.assertTrue(collection.retainAll(LongArrayList.newListWith(1L, 0L, 4L)));
        Assert.assertTrue(collection.isEmpty());
        Assert.assertFalse(collection.contains(1L));
        Assert.assertFalse(collection.contains(2L));
        Assert.assertFalse(collection.contains(3L));
    ...
    public void chunk()
    {
        LongIterable iterable = this.newMapWithKeysValues(String.valueOf(1), 1L, String.valueOf(2), 2L, String.valueOf(3), 3L);
        Assert.assertEquals(
                Lists.mutable.with(

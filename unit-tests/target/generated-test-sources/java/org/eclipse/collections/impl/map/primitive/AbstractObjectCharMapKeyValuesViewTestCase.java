...
public abstract class AbstractObjectCharMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith(1, (char) 2, 2, (char) 3, 3, (char) 4).collect((ObjectCharPair<Integer> object) -> (int) object.getTwo());
    ...
    {
        Function0<ObjectCharPair<Integer>> function = Functions0.value(PrimitiveTuples.pair(Integer.valueOf(5), (char) 6));
        Assert.assertEquals(PrimitiveTuples.pair(Integer.valueOf(2), (char) 3), this.newWith(1, (char) 2, 2, (char) 3, 3, (char) 4).detectWithIfNone(
                Object::equals,
                PrimitiveTuples.pair(Integer.valueOf(2), (char) 3),
                function));
        Assert.assertEquals(PrimitiveTuples.pair(Integer.valueOf(5), (char) 6), this.newWith(1, (char) 2, 2, (char) 3, 3, (char) 4).detectWithIfNone(
                Object::equals,
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith(1, (char) 2, 2, (char) 3, 3, (char) 4).collectIf(
                        ObjectCharPair.class::isInstance,
                        String::valueOf),
                "1:\u0002", "2:\u0003", "3:\u0004");
        Verify.assertContainsAll(
                this.newWith(1, (char) 2, 2, (char) 3, 3, (char) 4).collectIf(
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith(1, (char) 2, 2, (char) 3, 3, (char) 4).collectWith((ObjectCharPair<Integer> argument1, Long argument2) -> (long) (argument1.getTwo() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(5L, 7L, 9L),
                this.newWith(1, (char) 2, 2, (char) 3, 3, (char) 4).collectWith((ObjectCharPair<Integer> argument1, Long argument2) -> (long) (argument1.getTwo() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(Integer.valueOf(1), (char) 2).equals(first)
                || PrimitiveTuples.pair(Integer.valueOf(2), (char) 3).equals(first)
                || PrimitiveTuples.pair(Integer.valueOf(3), (char) 4).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(Integer.valueOf(1), (char) 2).equals(last)
                || PrimitiveTuples.pair(Integer.valueOf(2), (char) 3).equals(last)
                || PrimitiveTuples.pair(Integer.valueOf(3), (char) 4).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair(Integer.valueOf(5), (char) 3),
                PrimitiveTuples.pair(Integer.valueOf(2), (char) 4),
                PrimitiveTuples.pair(Integer.valueOf(1), (char) 2)),
                set);
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(Integer.valueOf(1), (char) 2), 1), Tuples.pair(PrimitiveTuples.pair(Integer.valueOf(2), (char) 3), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(Integer.valueOf(2), (char) 3), 1), Tuples.pair(PrimitiveTuples.pair(Integer.valueOf(1), (char) 2), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(Integer.valueOf(1), (char) 2), 0), Tuples.pair(PrimitiveTuples.pair(Integer.valueOf(2), (char) 3), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(Integer.valueOf(2), (char) 3), 0), Tuples.pair(PrimitiveTuples.pair(Integer.valueOf(1), (char) 2), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<ObjectCharPair<Integer>> collection = this.newWith(1, (char) 2, 2, (char) 3, 3, (char) 4);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair(Integer.valueOf(1), (char) 2)),
                FastList.newListWith(PrimitiveTuples.pair(Integer.valueOf(2), (char) 3)),
                FastList.newListWith(PrimitiveTuples.pair(Integer.valueOf(3), (char) 4))),
    ...
    public void aggregateByMutating()
    {
        ...
        Procedure2<AtomicInteger, ObjectCharPair<Integer>> sumAggregator = (aggregate, pair) -> { aggregate.addAndGet((int) pair.getTwo()); };
        RichIterable<ObjectCharPair<Integer>> collection = this.newWith(1, (char) 2, 2, (char) 3, 3, (char) 4);

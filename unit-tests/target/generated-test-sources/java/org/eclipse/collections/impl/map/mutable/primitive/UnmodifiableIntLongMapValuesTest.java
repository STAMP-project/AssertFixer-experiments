...
/**
 * JUnit test for {@link UnmodifiableIntLongMap#values()}.
 * This file was automatically generated from template file unmodifiablePrimitivePrimitiveMapValuesTest.stg.
 */
public class UnmodifiableIntLongMapValuesTest extends AbstractMutableLongCollectionTestCase
{
    @Override
    protected MutableLongCollection classUnderTest()
    {
        return IntLongHashMap.newWithKeysValues(1, 1L, 2, 2L, 3, 3L).values().asUnmodifiable();
    }

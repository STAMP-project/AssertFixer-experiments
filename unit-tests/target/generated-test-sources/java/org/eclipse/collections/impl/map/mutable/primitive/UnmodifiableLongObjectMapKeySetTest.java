...
/**
 * JUnit test for {@link UnmodifiableLongObjectMap#keySet()}.
 *
 * This file was automatically generated from template file unmodifiablePrimitiveObjectMapKeySetTest.stg.
 */
public class UnmodifiableLongObjectMapKeySetTest extends AbstractLongSetTestCase
{
    @Override
    protected MutableLongSet classUnderTest()
    {
        return new UnmodifiableLongObjectMap<>(LongObjectHashMap.newWithKeysValues(1L, 1, 2L, 2, 3L, 3)).keySet();
    }

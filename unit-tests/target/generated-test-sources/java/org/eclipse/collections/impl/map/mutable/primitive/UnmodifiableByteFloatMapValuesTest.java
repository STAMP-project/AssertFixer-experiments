...
/**
 * JUnit test for {@link UnmodifiableByteFloatMap#values()}.
 * This file was automatically generated from template file unmodifiablePrimitivePrimitiveMapValuesTest.stg.
 */
public class UnmodifiableByteFloatMapValuesTest extends AbstractMutableFloatCollectionTestCase
{
    @Override
    protected MutableFloatCollection classUnderTest()
    {
        return ByteFloatHashMap.newWithKeysValues((byte) 1, 1.0f, (byte) 2, 2.0f, (byte) 3, 3.0f).values().asUnmodifiable();
    }

...
public abstract class ObjectByteHashMapKeySetTestCase
{
    ...
    {
        MutableObjectByteMap<String> map = this.newMapWithKeysValues("One", (byte) 1, "Two", (byte) 2, "Three", (byte) 3, null, (byte) 4);
    ...
    public void isEmpty()
    {
        ...
        MutableObjectByteMap<String> map1 = this.newEmptyMap();
    ...
    {
        MutableObjectByteMap<String> map1 = this.newMapWithKeysValues("One", (byte) 1, "Two", (byte) 2, "Three", (byte) 3, null, (byte) 4);
        ...
        MutableObjectByteMap<String> map3 = this.newEmptyMap();
    ...
    {
        MutableObjectByteMap<String> map = this.newMapWithKeysValues("One", (byte) 1, "Two", (byte) 2, "Three", (byte) 3);
        Assert.assertFalse(map.keySet().remove("Four"));

        Assert.assertTrue(map.keySet().remove("Two"));
        Assert.assertEquals(this.newMapWithKeysValues("One", (byte) 1,  "Three", (byte) 3), map);
    ...
    public void removeNullFromKeySet()
    {
        ...
        Assert.assertEquals(this.newMapWithKeysValues("One", (byte) 1, "Two", (byte) 2, "Three", (byte) 3), map);
    ...
    {
        MutableObjectByteMap<String> map = this.newMapWithKeysValues("One", (byte) 1, "Two", (byte) 2, "Three", (byte) 3, null, (byte) 0);

...
/**
 * JUnit test for {@link SynchronizedDoubleCharMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMapValuesTest.stg.
 */
public class SynchronizedDoubleCharMapValuesTest extends AbstractMutableCharCollectionTestCase
{
    @Override
    protected MutableCharCollection classUnderTest()
    {
        return new SynchronizedDoubleCharMap(DoubleCharHashMap.newWithKeysValues(1.0, (char) 1, 2.0, (char) 2, 3.0, (char) 3)).values();
    }

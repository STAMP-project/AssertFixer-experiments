...
public abstract class AbstractCharLongMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith((char) 1, 2L, (char) 2, 3L, (char) 3, 4L).collect((CharLongPair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Long> result2 =
            this.newWith((char) 1, 2L, (char) 2, 3L, (char) 3, 4L).collect((CharLongPair object) -> (long) object.getTwo());
    ...
    public void detectWithIfNoneBlock()
    {
        Function0<CharLongPair> function = Functions0.value(PrimitiveTuples.pair((char) 5, 6L));
        Assert.assertEquals(
            PrimitiveTuples.pair((char) 2, 3L),
            this.newWith((char) 1, 2L, (char) 2, 3L, (char) 3, 4L).detectWithIfNone(
                    Object::equals,
                    PrimitiveTuples.pair((char) 2, 3L),
                    function));
        Assert.assertEquals(
            PrimitiveTuples.pair((char) 5, 6L),
            this.newWith((char) 1, 2L, (char) 2, 3L, (char) 3, 4L).detectWithIfNone(
                    Object::equals,
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith((char) 1, 2L, (char) 2, 3L, (char) 3, 4L).collectIf(
                        CharLongPair.class::isInstance,
                        String::valueOf),
                "\u0001:2", "\u0002:3", "\u0003:4");
        Verify.assertContainsAll(
                this.newWith((char) 1, 2L, (char) 2, 3L, (char) 3, 4L).collectIf(
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith((char) 1, 2L, (char) 2, 3L, (char) 3, 4L).collectWith((CharLongPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(4L, 6L, 8L),
                this.newWith((char) 1, 2L, (char) 2, 3L, (char) 3, 4L).collectWith((CharLongPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair((char) 1, 2L).equals(first)
                || PrimitiveTuples.pair((char) 2, 3L).equals(first)
                || PrimitiveTuples.pair((char) 3, 4L).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair((char) 1, 2L).equals(last)
                || PrimitiveTuples.pair((char) 2, 3L).equals(last)
                || PrimitiveTuples.pair((char) 3, 4L).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair((char) 3, 4L),
                PrimitiveTuples.pair((char) 2, 3L),
                PrimitiveTuples.pair((char) 1, 2L)),
                set);
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((char) 1, 2L), 1), Tuples.pair(PrimitiveTuples.pair((char) 2, 3L), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((char) 2, 3L), 1), Tuples.pair(PrimitiveTuples.pair((char) 1, 2L), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((char) 1, 2L), 0), Tuples.pair(PrimitiveTuples.pair((char) 2, 3L), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((char) 2, 3L), 0), Tuples.pair(PrimitiveTuples.pair((char) 1, 2L), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<CharLongPair> collection = this.newWith((char) 1, 2L, (char) 2, 3L, (char) 3, 4L);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair((char) 1, 2L)),
                FastList.newListWith(PrimitiveTuples.pair((char) 2, 3L)),
                FastList.newListWith(PrimitiveTuples.pair((char) 3, 4L))),

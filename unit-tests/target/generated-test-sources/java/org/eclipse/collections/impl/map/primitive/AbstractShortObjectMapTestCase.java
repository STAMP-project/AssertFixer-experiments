...
import org.eclipse.collections.impl.map.mutable.primitive.ShortObjectHashMapTest;
 ...
 */
public abstract class AbstractShortObjectMapTestCase
{
    protected abstract ShortObjectMap<String> classUnderTest();

    protected abstract <T> ShortObjectMap<T> newWithKeysValues(short key1, T value1);

    protected abstract <T> ShortObjectMap<T> newWithKeysValues(short key1, T value1, short key2, T value2);

    protected abstract <T> ShortObjectMap<T> newWithKeysValues(short key1, T value1, short key2, T value2, short key3, T value3);

    protected abstract <T> ShortObjectMap<T> getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(ShortHashSet.newSetWith((short) 0), this.newWithKeysValues((short) 0, "zero").keySet());
        Assert.assertEquals(ShortHashSet.newSetWith((short) 0, (short) 1, (short) 9),
                this.newWithKeysValues((short) 0, "zero", (short) 1, "one", (short) 9, "nine").keySet());
    }
    ...
    public void values()
    {
        ...
        ShortObjectMap<String> map = this.newWithKeysValues((short) 0, "zero");
        Verify.assertSize(1, map.values());
        Verify.assertContains("zero", map.values());

        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "zero", (short) 1, "one", (short) 9, "nine");
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "zero", (short) 1, "one", (short) 9, "nine");
        ShortObjectMap<String> map2 = this.newWithKeysValues((short) 0, "zero", (short) 9, "nine");
        ShortObjectMap<String> map3 = this.newWithKeysValues((short) 1, "one", (short) 9, "nine");
        ShortObjectMap<String> map4 = this.newWithKeysValues((short) 5, "five", (short) 9, "nine");

        Assert.assertEquals(ShortObjectHashMap.newWithKeysValues((short) 1, "one", (short) 9, "nine"),
            map1.select((short value, String object) -> (value % 2) != 0));

        ShortObjectPredicate<String> keyGreaterThanOrEqualToSeven = (short value, String object) -> value <= 7;

        Assert.assertEquals(ShortObjectHashMap.newWithKeysValues((short) 0, "zero", (short) 1, "one"), map1.select(keyGreaterThanOrEqualToSeven));

        Assert.assertEquals(ShortObjectHashMap.newWithKeysValues((short) 0, "zero"), map2.select(keyGreaterThanOrEqualToSeven));

        Assert.assertEquals(ShortObjectHashMap.newWithKeysValues((short) 1, "one"), map3.select(keyGreaterThanOrEqualToSeven));

        Assert.assertEquals(ShortObjectHashMap.newWithKeysValues((short) 5, "five"), map4.select(keyGreaterThanOrEqualToSeven));

        Assert.assertEquals(ShortObjectHashMap.newWithKeysValues((short) 1, "one", (short) 9, "nine"),
            map1.select((short value, String object) -> object.endsWith("ne")));
    ...
    {
        ShortObjectMap<Number> numbers = this.<Number>newWithKeysValues((short) 0, 0, (short) 1, 1.0, (short) 5, 5.0);
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "true", (short) 1, "false", (short) 2, "nah");
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "0", (short) 1, "1", (short) 2, "9");
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "zero", (short) 9, "nine");
        ShortObjectMap<String> map2 = this.newWithKeysValues((short) 1, "one", (short) 9, "nine");
        ShortObjectMap<String> map3 = this.newWithKeysValues((short) 5, "five", (short) 9, "nine");
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "a", (short) 9, "abcd");
        ShortObjectMap<String> map2 = this.newWithKeysValues((short) 1, "ab", (short) 9, "abcd");
        ShortObjectMap<String> map3 = this.newWithKeysValues((short) 5, "abc", (short) 9, "abcd");
    ...
    public void toSet()
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "zero", (short) 5, "zero", (short) 9, "nine");
        ShortObjectMap<String> map2 = this.newWithKeysValues((short) 1, "one", (short) 5, "one", (short) 9, "nine");
        ShortObjectMap<String> map3 = this.newWithKeysValues((short) 5, "five", (short) 6, "five", (short) 9, "nine");
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "z", (short) 9, "abcd");
        ShortObjectMap<String> map2 = this.newWithKeysValues((short) 1, "ab", (short) 9, "abcd");
        ShortObjectMap<String> map3 = this.newWithKeysValues((short) 5, "zyx", (short) 9, "abcd");
    ...
    {
        ShortObjectHashMap.newMap().min();
    }

    @Test
    public void maxBy()
    {
        ShortObjectMap<Class<?>> map1 = this.newWithKeysValues((short) 0, ShortObjectHashMapTest.class, (short) 9, ShortObjectHashMap.class);
        ShortObjectMap<Class<?>> map2 = this.newWithKeysValues((short) 1, ShortObjectHashMapTest.class, (short) 9, ShortObjectHashMap.class);
        ShortObjectMap<Class<?>> map3 = this.newWithKeysValues((short) 5, ShortObjectHashMap.class, (short) 9, ShortObjectHashMapTest.class);

        Function<Class<?>, Integer> classNameLength = (Class<?> aClass) -> aClass.getName().length();
        Assert.assertEquals(ShortObjectHashMapTest.class, map1.maxBy(classNameLength));
        Assert.assertEquals(ShortObjectHashMapTest.class, map2.maxBy(classNameLength));
        Assert.assertEquals(ShortObjectHashMapTest.class, map3.maxBy(classNameLength));

        Verify.assertThrows(NoSuchElementException.class, () -> ShortObjectHashMap.<Class<?>>newMap().maxBy(classNameLength));
    }
    ...
    public void minBy()
    {
        ...
        Assert.assertEquals(ShortObjectHashMap.class, map1.minBy(classNameLength));
        Assert.assertEquals(ShortObjectHashMap.class, map2.minBy(classNameLength));
        Assert.assertEquals(ShortObjectHashMap.class, map3.minBy(classNameLength));

        Verify.assertThrows(NoSuchElementException.class, () -> ShortObjectHashMap.<Class<?>>newMap().minBy(classNameLength));
    }
    ...
    {
        RichIterable<String> values = this.newWithKeysValues((short) 1, "1", (short) 2, "2", (short) 3, "3");
    ...
    {
        Assert.assertEquals(ShortArrayList.newListWith(), this.getEmptyMap().keysView().toList());
        Assert.assertEquals(ShortArrayList.newListWith((short) 1), this.newWithKeysValues((short) 1, "one").keysView().toList());
    }
    ...
    public void reject()
    {
        ...
        Assert.assertEquals(ShortObjectHashMap.newWithKeysValues((short) 1, "one", (short) 9, "nine"),
            map1.reject((short value, String object) -> (value % 2) == 0));

        ShortObjectPredicate<String> keyLessThanSeven = (short value, String object) -> value > 7;

        Assert.assertEquals(ShortObjectHashMap.newWithKeysValues((short) 0, "zero", (short) 1, "one"), map1.reject(keyLessThanSeven));
        Assert.assertEquals(ShortObjectHashMap.newWithKeysValues((short) 0, "zero"), map2.reject(keyLessThanSeven));
        Assert.assertEquals(ShortObjectHashMap.newWithKeysValues((short) 1, "one"), map3.reject(keyLessThanSeven));
        Assert.assertEquals(ShortObjectHashMap.newWithKeysValues((short) 5, "five"), map4.reject(keyLessThanSeven));

        Assert.assertEquals(ShortObjectHashMap.newWithKeysValues((short) 1, "one", (short) 9, "nine"),
            map1.reject((short value, String object) -> !object.endsWith("ne")));
    ...
    public void get()
    {
        ...
        Assert.assertEquals("thirtyOne", this.classUnderTest().get((short) 31));
        Assert.assertEquals("thirtyTwo", this.classUnderTest().get((short) 32));

        Assert.assertNull(this.classUnderTest().get((short) 1));
        Assert.assertNull(this.classUnderTest().get((short) 33));

        ShortObjectMap<Object> emptyMap = this.getEmptyMap();
        Assert.assertNull(emptyMap.get((short) 0));
        Assert.assertNull(emptyMap.get((short) 1));
        Assert.assertNull(emptyMap.get((short) 33));
    }
    ...
    public void getIfAbsent()
    {
        ...
        Assert.assertEquals("thirtyOne", this.classUnderTest().getIfAbsent((short) 31, ifAbsent));
        Assert.assertEquals("thirtyTwo", this.classUnderTest().getIfAbsent((short) 32, ifAbsent));
        ...
        ShortObjectMap<Object> emptyMap = this.getEmptyMap();
        Assert.assertEquals("ifAbsent", emptyMap.getIfAbsent((short) 0, ifAbsent));
        Assert.assertEquals("ifAbsent", emptyMap.getIfAbsent((short) 1, ifAbsent));
        Assert.assertEquals("ifAbsent", emptyMap.getIfAbsent((short) 33, ifAbsent));
    }
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 1, "one", (short) 5, "five");
        ShortObjectMap<String> map2 = this.newWithKeysValues((short) 1, "one", (short) 0, "zero");
        ShortObjectMap<String> map3 = this.newWithKeysValues((short) 2, "two", (short) 5, "five");
        ShortObjectMap<String> map4 = this.newWithKeysValues((short) 0, "zero", (short) 5, "five");
        String[] concat = {"", "", "", ""};
    ...
    public void forEachKey()
    {
        ...
        map1.forEachKey((short each) -> sum[0] += each);
        map2.forEachKey((short each) -> sum[1] += each);
        map3.forEachKey((short each) -> sum[2] += each);
        map4.forEachKey((short each) -> sum[3] += each);
    ...
    public void forEachKeyValue()
    {
        ...
        map1.forEachKeyValue((short each, String parameter) ->
        {
            concat[0] += each;
            concat[0] += parameter;
        });
        map2.forEachKeyValue((short each, String parameter) ->
        {
            concat[1] += each;
            concat[1] += parameter;
        });
        map3.forEachKeyValue((short each, String parameter) ->
        {
            concat[2] += each;
            concat[2] += parameter;
        });
        map4.forEachKeyValue((short each, String parameter) ->
        {
            concat[3] += each;
            concat[3] += parameter;
        });
    ...
    public void isEmpty()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((short) 1, "one").isEmpty());
        Assert.assertFalse(this.newWithKeysValues((short) 0, "zero").isEmpty());
        Assert.assertFalse(this.newWithKeysValues((short) 50, "fifty").isEmpty());
    }
    ...
    public void notEmpty()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((short) 1, "one").notEmpty());
        Assert.assertTrue(this.newWithKeysValues((short) 0, "zero").notEmpty());
        Assert.assertTrue(this.newWithKeysValues((short) 50, "fifty").notEmpty());
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertNull(ShortObjectHashMap.newMap().getFirst());
    }
    ...
    public void getLast()
    {
        ...
        Assert.assertEquals("zero", this.newWithKeysValues((short) 0, "zero").getLast());
        Assert.assertNull(ShortObjectHashMap.newMap().getLast());
    }

    @Test
    public void getOnly()
    {
        Assert.assertEquals("zero", this.newWithKeysValues((short) 0, "zero").getOnly());
        Assert.assertEquals("one", this.newWithKeysValues((short) 1, "one").getOnly());
        Assert.assertEquals("two", this.newWithKeysValues((short) 2, "two").getOnly());
    }
    ...
    {
        this.newWithKeysValues((short) 1, "one", (short) 5, "five").getOnly();
    }
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "zero", (short) 1, "one", (short) 32, "thirtyTwo");
        ShortObjectMap<String> map2 = this.newWithKeysValues((short) 32, "thirtyTwo", (short) 0, "zero", (short) 1, "one");
        ShortObjectMap<String> map3 = this.newWithKeysValues((short) 0, "zero", (short) 1, "two", (short) 32, "thirtyTwo");
        ShortObjectMap<String> map4 = this.newWithKeysValues((short) 0, "one", (short) 1, "one", (short) 32, "thirtyTwo");
        ShortObjectMap<String> map5 = this.newWithKeysValues((short) 0, "zero", (short) 1, "one", (short) 32, "thirtyThree");
        ShortObjectMap<String> map6 = this.newWithKeysValues((short) 1, "one", (short) 32, "thirtyTwo");
        ShortObjectMap<String> map7 = this.newWithKeysValues((short) 0, "zero", (short) 32, "thirtyTwo");
        ShortObjectMap<String> map8 = this.newWithKeysValues((short) 50, "zero", (short) 60, "one", (short) 70, "thirtyThree");
        ShortObjectMap<String> map9 = this.newWithKeysValues((short) 50, "zero", (short) 60, "one");
        ShortObjectMap<String> map10 = this.newWithKeysValues((short) 50, "zero");
        ...
        Verify.assertPostSerializedEqualsAndHashCode(ShortObjectHashMap.newMap());
        Verify.assertEqualsAndHashCode(map1, map2);
        ...
        Assert.assertNotEquals(this.newWithKeysValues((short) 0, null), this.newWithKeysValues((short) 6, ""));
        Assert.assertNotEquals(this.newWithKeysValues((short) 5, null), this.newWithKeysValues((short) 6, ""));

        Assert.assertEquals(map1, ShortObjectMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, ShortObjectMaps.immutable.ofAll(map1));
    }

    @Test
    public void testHashCode()
    {
        Assert.assertEquals(UnifiedMap.newWithKeysValues((short) 0, "zero", (short) 1, "one", (short) 32, "thirtyTwo").hashCode(), this.newWithKeysValues((short) 32, "thirtyTwo", (short) 0, "zero", (short) 1, "one").hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues((short) 0, null, (short) 1, null).hashCode(), this.newWithKeysValues((short) 0, null, (short) 1, null).hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues((short) 50, "zero", (short) 60, "one", (short) 70, "thirtyThree").hashCode(), this.newWithKeysValues((short) 50, "zero", (short) 60, "one", (short) 70, "thirtyThree").hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues((short) 50, null, (short) 60, null).hashCode(), this.newWithKeysValues((short) 50, null, (short) 60, null).hashCode());
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{0=zero}", this.newWithKeysValues((short) 0, "zero").toString());
        Assert.assertEquals("{1=one}", this.newWithKeysValues((short) 1, "one").toString());
        Assert.assertEquals("{5=five}", this.newWithKeysValues((short) 5, "five").toString());

        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "zero", (short) 1, "one");
        Assert.assertTrue(
                map1.toString(),
                "{0=zero, 1=one}".equals(map1.toString())
                        || "{1=one, 0=zero}".equals(map1.toString()));

        ShortObjectMap<String> map2 = this.newWithKeysValues((short) 1, "one", (short) 32, "thirtyTwo");
        Assert.assertTrue(
                map2.toString(),
                "{1=one, 32=thirtyTwo}".equals(map2.toString())
                        || "{32=thirtyTwo, 1=one}".equals(map2.toString()));

        ShortObjectMap<String> map3 = this.newWithKeysValues((short) 0, "zero", (short) 32, "thirtyTwo");
        Assert.assertTrue(
                map3.toString(),
                "{0=zero, 32=thirtyTwo}".equals(map3.toString())
                        || "{32=thirtyTwo, 0=zero}".equals(map3.toString()));

        ShortObjectMap<String> map4 = this.newWithKeysValues((short) 32, "thirtyTwo", (short) 33, "thirtyThree");
        Assert.assertTrue(
                map4.toString(),
    ...
    public void zip()
    {
        RichIterable<Pair<String, Integer>> zip1 = this.newWithKeysValues((short) 0, "zero", (short) 5, "five")
                .zip(FastList.newListWith(0, 5, 6));
        RichIterable<Pair<String, Integer>> zip2 = this.newWithKeysValues((short) 1, "one", (short) 5, "five")
                .zip(FastList.newListWith(1));
        RichIterable<Pair<String, Integer>> zip3 = this.newWithKeysValues((short) 1, "one", (short) 5, "five")
    ...
    public void chunk()
    {
        RichIterable<RichIterable<String>> chunk1 = this.newWithKeysValues((short) 0, "zero", (short) 5, "five")
                .chunk(1);
        RichIterable<RichIterable<String>> chunk2 = this.newWithKeysValues((short) 1, "one", (short) 5, "five")
                .chunk(1);
    ...
    {
        this.newWithKeysValues((short) 0, "zero", (short) 5, "five")
                .chunk(-1);
    }
    ...
    public void aggregateInPlaceBy()
    {
        ...
        ShortObjectMap<Integer> collection = this.newWithKeysValues((short) 1, 1, (short) 2, 2, (short) 3, 3);
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "zero", (short) 1, "one");
        ShortObjectMap<String> map2 = this.newWithKeysValues((short) 2, "two", (short) 3, "three");
        ShortObjectMap<String> map3 = this.newWithKeysValues((short) 4, "four");
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "zero", (short) 9, "nine");
        ShortObjectMap<String> map2 = this.newWithKeysValues((short) 1, "one");
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "zero", (short) 1, "one", (short) 2, "two");
        ShortObjectMap<String> map2 = this.newWithKeysValues((short) 2, "two");
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "zero", (short) 1, "one");
        ShortObjectMap<String> map2 = this.newWithKeysValues((short) 0, "zero");
        Function<String, Character> firstChar = (String object) -> object.charAt(0);
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 0, "zero");
        Function<String, Character> firstChar = (String object) -> object.charAt(0);
        map1.groupByUniqueKey(firstChar, UnifiedMap.newWithKeysValues('z', "zero"));
    }
    ...
    {
        ShortObjectMap<String> map1 = this.newWithKeysValues((short) 2, "two");
        Function<String, Character> firstChar = (String object) -> object.charAt(0);
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("zero", this.newWithKeysValues((short) 0, "zero").makeString());
        Assert.assertEquals("one", this.newWithKeysValues((short) 1, "one").makeString());
        Assert.assertEquals("five", this.newWithKeysValues((short) 5, "five").makeString());
    ...
    public void appendString()
    {
        ...
        this.newWithKeysValues((short) 0, "zero").appendString(appendable0);
        Assert.assertEquals("zero", appendable0.toString());

        Appendable appendable1 = new StringBuilder();
        this.newWithKeysValues((short) 1, "one").appendString(appendable1);
        Assert.assertEquals("one", appendable1.toString());

        Appendable appendable2 = new StringBuilder();
        this.newWithKeysValues((short) 5, "five").appendString(appendable2);
        ...
        ShortObjectMap<String> map3 = this.newWithKeysValues((short) 1, "one", (short) 32, "thirtyTwo");
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableShortObjectMap.class, this.classUnderTest().toImmutable());
    }
    ...
    public void stream()
    {
        ShortObjectMap<String> map = this.newWithKeysValues((short) 1, "1", (short) 2, "2", (short) 9, "9");

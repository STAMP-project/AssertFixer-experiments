...
/**
 * JUnit test for {@link ShortFloatHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class ShortFloatHashMapValuesTest extends AbstractMutableFloatCollectionTestCase
{
    @Override
    protected MutableFloatCollection classUnderTest()
    {
        return ShortFloatHashMap.newWithKeysValues((short) 1, 1.0f, (short) 2, 2.0f, (short) 3, 3.0f).values();
    }
    ...
    public void retainAll()
    {
        ...
        ShortFloatHashMap map = ShortFloatHashMap.newWithKeysValues((short) 0, 0.0f, (short) 1, 1.0f, (short) 2, 2.0f, (short) 3, 3.0f);
        MutableFloatCollection collection = map.values();

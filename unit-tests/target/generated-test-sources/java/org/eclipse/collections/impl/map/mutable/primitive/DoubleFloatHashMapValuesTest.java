...
/**
 * JUnit test for {@link DoubleFloatHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class DoubleFloatHashMapValuesTest extends AbstractMutableFloatCollectionTestCase
{
    @Override
    protected MutableFloatCollection classUnderTest()
    {
        return DoubleFloatHashMap.newWithKeysValues(1.0, 1.0f, 2.0, 2.0f, 3.0, 3.0f).values();
    }
    ...
    public void remove()
    {
        DoubleFloatHashMap map = DoubleFloatHashMap.newWithKeysValues(1.0, 1.0f, 2.0, 2.0f, 3.0, 3.0f);
    ...
    public void retainAll()
    {
        ...
        DoubleFloatHashMap map = DoubleFloatHashMap.newWithKeysValues(0.0, 0.0f, 1.0, 1.0f, 2.0, 2.0f, 3.0, 3.0f);
        MutableFloatCollection collection = map.values();

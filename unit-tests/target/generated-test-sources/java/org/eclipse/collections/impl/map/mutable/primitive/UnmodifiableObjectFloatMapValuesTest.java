...
/**
 * JUnit test for {@link UnmodifiableObjectFloatMap#values()}.
 * This file was automatically generated from template file unmodifiableObjectPrimitiveMapValuesTest.stg.
 */
public class UnmodifiableObjectFloatMapValuesTest extends AbstractMutableFloatCollectionTestCase
{
    @Override
    protected MutableFloatCollection classUnderTest()
    {
        return new UnmodifiableObjectFloatMap<>(ObjectFloatHashMap.newWithKeysValues(1, 1.0f, 2, 2.0f, 3, 3.0f)).values();
    }
    ...
    {
        this.newWith().removeIf(FloatPredicates.equal(3.0f));
    }

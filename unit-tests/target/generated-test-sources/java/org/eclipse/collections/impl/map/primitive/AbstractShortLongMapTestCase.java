...
public abstract class AbstractShortLongMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(ShortHashSet.newSetWith((short) 0, (short) 31, (short) 32),
                this.newWithKeysValues((short) 0, 0L, (short) 31, 31L, (short) 32, 32L).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((short) 0, 0L, (short) 1, 1L, (short) 32, 32L).hashCode(),
                this.newWithKeysValues((short) 32, 32L, (short) 0, 0L, (short) 1, 1L).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((short) 50, 0L, (short) 60, 1L, (short) 70, 33L).hashCode(),
                this.newWithKeysValues((short) 50, 0L, (short) 60, 1L, (short) 70, 33L).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((short) 2, 2L, (short) 3, 3L).toList().equals(LongArrayList.newListWith(2L, 3L))
                || this.newWithKeysValues((short) 2, 2L, (short) 3, 3L).toList().equals(LongArrayList.newListWith(3L, 2L)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((short) 1, 1L).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((short) 1, 1L).chunk(-1));
    }
}

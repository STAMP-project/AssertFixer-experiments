...
public abstract class AbstractMutableShortCharMapTestCase extends AbstractShortCharMapTestCase
{
    ...
    public void getIfAbsentPutWithKey()
    {
        ...
        ShortToCharFunction functionThrows = (short shortParameter) -> { throw new AssertionError(); };
    ...
    public void flipUniqueValues()
    {
        ...
        Assert.assertEquals(
                CharShortHashMap.newWithKeysValues((char) 2, (short) 1, (char) 3, (short) 2, (char) 4, (short) 3, (char) 5, (short) 4),
                map.flipUniqueValues());
         Verify.assertThrows(
                IllegalStateException.class,
                () -> this.newWithKeysValues((short) 1, (char) 1, (short) 2, (char) 1).flipUniqueValues());
    }
}

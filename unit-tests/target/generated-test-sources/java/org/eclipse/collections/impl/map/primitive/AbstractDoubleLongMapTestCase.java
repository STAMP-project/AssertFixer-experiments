 ...
 */
public abstract class AbstractDoubleLongMapTestCase
{
    protected final DoubleLongMap map = this.classUnderTest();

    protected abstract DoubleLongMap classUnderTest();

    protected abstract DoubleLongMap newWithKeysValues(double key1, long value1);

    protected abstract DoubleLongMap newWithKeysValues(double key1, long value1, double key2, long value2);

    protected abstract DoubleLongMap newWithKeysValues(double key1, long value1, double key2, long value2, double key3, long value3);

    protected abstract DoubleLongMap newWithKeysValues(double key1, long value1, double key2, long value2, double key3, long value3, double key4, long value4);

    protected abstract DoubleLongMap getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(DoubleHashSet.newSetWith(0.0), this.newWithKeysValues(0.0, 0L).keySet());
        Assert.assertEquals(DoubleHashSet.newSetWith(0.0, 31.0, 32.0),
                this.newWithKeysValues(0.0, 0L, 31.0, 31L, 32.0, 32L).keySet());
    }
    ...
    public void values()
    {
        ...
        DoubleLongMap map = this.newWithKeysValues(0.0, 0L);
        Verify.assertSize(1, map.values());
        Assert.assertTrue(map.values().contains(0L));

        DoubleLongMap map1 = this.newWithKeysValues(0.0, 0L, 31.0, 31L, 32.0, 32L);
    ...
    public void isEmpty()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1.0, 1L).isEmpty());
        Assert.assertFalse(this.newWithKeysValues(0.0, 0L).isEmpty());
        Assert.assertFalse(this.newWithKeysValues(50.0, 50L).isEmpty());
    }
    ...
    public void notEmpty()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(1.0, 1L).notEmpty());
        Assert.assertTrue(this.newWithKeysValues(0.0, 0L).notEmpty());
        Assert.assertTrue(this.newWithKeysValues(50.0, 50L).notEmpty());
    }
    ...
    public void testEquals()
    {
        ...
        DoubleLongMap map9 = this.newWithKeysValues(0.0, 0L);
        ...
        Assert.assertEquals(map1, DoubleLongMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, DoubleLongMaps.immutable.ofAll(map1));
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0.0, 0L, 1.0, 1L, 32.0, 32L).hashCode(),
                this.newWithKeysValues(32.0, 32L, 0.0, 0L, 1.0, 1L).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50.0, 0L, 60.0, 1L, 70.0, 33L).hashCode(),
                this.newWithKeysValues(50.0, 0L, 60.0, 1L, 70.0, 33L).hashCode());
        Assert.assertEquals(UnifiedMap.newMap().hashCode(), this.getEmptyMap().hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(1.0, 2L).hashCode(), this.newWithKeysValues(1.0, 2L).hashCode());
    }
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{0.0=0}", this.newWithKeysValues(0.0, 0L).toString());
        Assert.assertEquals("{1.0=1}", this.newWithKeysValues(1.0, 1L).toString());
        Assert.assertEquals("{5.0=5}", this.newWithKeysValues(5.0, 5L).toString());

        DoubleLongMap map1 = this.newWithKeysValues(0.0, 0L, 1.0, 1L);
        Assert.assertTrue(
                map1.toString(),
                "{0.0=0, 1.0=1}".equals(map1.toString())
                        || "{1.0=1, 0.0=0}".equals(map1.toString()));

        DoubleLongMap map2 = this.newWithKeysValues(1.0, 1L, 32.0, 32L);
        Assert.assertTrue(
                map2.toString(),
                "{1.0=1, 32.0=32}".equals(map2.toString())
                        || "{32.0=32, 1.0=1}".equals(map2.toString()));

        DoubleLongMap map3 = this.newWithKeysValues(0.0, 0L, 32.0, 32L);
        Assert.assertTrue(
                map3.toString(),
                "{0.0=0, 32.0=32}".equals(map3.toString())
                        || "{32.0=32, 0.0=0}".equals(map3.toString()));

        DoubleLongMap map4 = this.newWithKeysValues(32.0, 32L, 33.0, 33L);
        Assert.assertTrue(
                map4.toString(),
    ...
    public void forEachKey()
    {
        ...
        DoubleLongMap map3 = this.newWithKeysValues(1.0, 1L);
    ...
    public void forEachKeyValue()
    {
        ...
        map0.forEachKeyValue((double eachKey, long eachValue) ->
        {
            sumKey0[0] += eachKey;
        ...
        map1.forEachKeyValue((double eachKey, long eachValue) ->
        {
            sumKey1[0] += eachKey;
        ...
        map01.forEachKeyValue((double eachKey, long eachValue) ->
        {
            sumKey01[0] += eachKey;
        ...
        map.forEachKeyValue((double eachKey, long eachValue) ->
        {
            sumKey[0] += eachKey;
        ...
        map2.forEachKeyValue((double eachKey, long eachValue) ->
        {
            sumKey2[0] += eachKey;
        ...
        DoubleLongMap map3 = this.newWithKeysValues(3.0, 5L);
        double[] sumKey3 = new double[1];
        long[] sumValue3 = new long[1];
        map3.forEachKeyValue((double eachKey, long eachValue) ->
        {
            sumKey3[0] += eachKey;
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("", this.getEmptyMap().makeString(", "));
        Assert.assertEquals("[]", this.getEmptyMap().makeString("[", "/", "]"));
        Assert.assertEquals("0", this.newWithKeysValues(0.0, 0L).makeString());
        Assert.assertEquals("0", this.newWithKeysValues(0.0, 0L).makeString(", "));
        Assert.assertEquals("[0]", this.newWithKeysValues(0.0, 0L).makeString("[", "/", "]"));
        Assert.assertEquals("1", this.newWithKeysValues(1.0, 1L).makeString());
        Assert.assertEquals("5", this.newWithKeysValues(5.0, 5L).makeString());
    ...
    public void appendString()
    {
        ...
        this.newWithKeysValues(0.0, 0L).appendString(appendable0);
        Assert.assertEquals("0", appendable0.toString());

        Appendable appendable01 = new StringBuilder();
        this.newWithKeysValues(0.0, 0L).appendString(appendable01, "/");
        Assert.assertEquals("0", appendable01.toString());

        Appendable appendable02 = new StringBuilder();
        this.newWithKeysValues(0.0, 0L).appendString(appendable02, "{", "/", "}");
        Assert.assertEquals("{0}", appendable02.toString());

        Appendable appendable1 = new StringBuilder();
        this.newWithKeysValues(1.0, 1L).appendString(appendable1);
        Assert.assertEquals("1", appendable1.toString());

        Appendable appendable2 = new StringBuilder();
        this.newWithKeysValues(5.0, 5L).appendString(appendable2);
        ...
        DoubleLongMap map3 = this.newWithKeysValues(1.0, 1L, 32.0, 32L);
    ...
    public void select()
    {
        DoubleLongMap map = this.newWithKeysValues(0.0, 0L, 1.0, 1L, 2.0, 2L, 3.0, 3L);
        DoubleLongMap actual1 = map.select((double key, long value) -> Double.compare(key, 1.0) == 0 || value == 3L);
        Assert.assertEquals(DoubleLongHashMap.newWithKeysValues(1.0, 1L, 3.0, 3L), actual1);
        DoubleLongMap actual2 = map.select((double key, long value) -> Double.compare(key, 0.0) == 0 || value == 2L);
        Assert.assertEquals(DoubleLongHashMap.newWithKeysValues(0.0, 0L, 2.0, 2L), actual2);
    }
    ...
    {
        DoubleLongMap map = this.newWithKeysValues(0.0, 0L, 1.0, 1L, 2.0, 2L, 3.0, 3L);
        DoubleLongMap actual1 = map.reject((double key, long value) -> Double.compare(key, 1.0) == 0 || value == 3L);
        Assert.assertEquals(DoubleLongHashMap.newWithKeysValues(0.0, 0L, 2.0, 2L), actual1);
        DoubleLongMap actual2 = map.reject((double key, long value)-> Double.compare(key, 0.0) == 0 || value == 2L);
        Assert.assertEquals(DoubleLongHashMap.newWithKeysValues(1.0, 1L, 3.0, 3L), actual2);
    }
    ...
    public void collect()
    {
        ...
        Assert.assertEquals(Bags.immutable.with(2L), this.newWithKeysValues(1.0, 1L).collect(function));
    }
    ...
    public void detectIfNone_value()
    {
        ...
        Assert.assertEquals(5L, this.newWithKeysValues(1.0, 1L).detectIfNone(LongPredicates.equal(0L), 5L));
        Assert.assertEquals(1L, this.newWithKeysValues(1.0, 1L).detectIfNone(LongPredicates.equal(1L), 5L));
    ...
    public void anySatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1.0, 1L).anySatisfy(LongPredicates.equal(0L)));
        Assert.assertTrue(this.newWithKeysValues(1.0, 1L).anySatisfy(LongPredicates.equal(1L)));
    ...
    public void allSatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1.0, 1L).allSatisfy(LongPredicates.equal(0L)));
        Assert.assertTrue(this.newWithKeysValues(1.0, 1L).allSatisfy(LongPredicates.equal(1L)));
        ...
        DoubleLongMap map1 = this.newWithKeysValues(2.0, 2L, 3.0, 3L);
    ...
    public void noneSatisfy()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(1.0, 1L).noneSatisfy(LongPredicates.equal(0L)));
        Assert.assertFalse(this.newWithKeysValues(1.0, 1L).noneSatisfy(LongPredicates.equal(1L)));
    ...
    public void max()
    {
        ...
        Assert.assertEquals(3L, this.newWithKeysValues(3.0, 3L).max());
    }

    @Test
    public void min()
    {
        DoubleLongMap map = this.newWithKeysValues(1.0, 1L, 2.0, 2L, 3.0, 3L, 0.0, 0L);
        Assert.assertEquals(0L, map.min());
        Assert.assertEquals(3L, this.newWithKeysValues(3.0, 3L).min());
    }
    ...
    public void minIfEmpty()
    {
        ...
        DoubleLongMap map = this.newWithKeysValues(1.0, 1L, 0.0, 0L, 9.0, 9L, 7.0, 7L);
        Assert.assertEquals(0L, map.minIfEmpty(5L));
        Assert.assertEquals(3L, this.newWithKeysValues(3.0, 3L).maxIfEmpty(5L));
    }
    ...
    public void maxIfEmpty()
    {
        ...
        Assert.assertEquals(3L, this.newWithKeysValues(3.0, 3L).minIfEmpty(5L));
    }
    ...
    public void sum()
    {
        ...
        DoubleLongMap map2 = this.newWithKeysValues(2.0, 2L, 3.0, 3L, 4.0, 4L);
        Assert.assertEquals(9L, map2.sum());
        DoubleLongMap map3 = this.newWithKeysValues(2.0, 2L);
    ...
    public void average()
    {
        ...
        DoubleLongMap map1 = this.newWithKeysValues(1.0, 1L);
    ...
    public void median()
    {
        ...
        DoubleLongMap map2 = this.newWithKeysValues(0.0, 0L, 1.0, 1L, 2.0, 2L);
    ...
    public void toList()
    {
        Assert.assertEquals(LongArrayList.newListWith(0L), this.newWithKeysValues(0.0, 0L).toList());
        Assert.assertEquals(LongArrayList.newListWith(1L), this.newWithKeysValues(1.0, 1L).toList());
        Assert.assertEquals(LongArrayList.newListWith(2L), this.newWithKeysValues(2.0, 2L).toList());
        Assert.assertTrue(this.newWithKeysValues(2.0, 2L, 3.0, 3L).toList().equals(LongArrayList.newListWith(2L, 3L))
                || this.newWithKeysValues(2.0, 2L, 3.0, 3L).toList().equals(LongArrayList.newListWith(3L, 2L)));
    }
    ...
    public void toSortedList()
    {
        ...
        Assert.assertEquals(LongArrayList.newListWith(1L), this.newWithKeysValues(1.0, 1L).toSortedList());
    }
    ...
    public void toSet()
    {
        ...
        Assert.assertEquals(LongHashSet.newSetWith(1L), this.newWithKeysValues(1.0, 1L).toSet());
    }
    ...
    public void toBag()
    {
        ...
        Assert.assertEquals(LongHashBag.newBagWith(1L), this.newWithKeysValues(1.0, 1L).toBag());
    }
    ...
    {
        MutableBag<DoubleLongPair> expected = Bags.mutable.of();
        this.map.forEachKeyValue((double key, long value) -> expected.add(PrimitiveTuples.pair(key, value)));
    ...
    public void toArray()
    {
        DoubleLongMap map = this.newWithKeysValues(1.0, 1L, 2.0, 2L);
        ...
        Assert.assertTrue(Arrays.equals(new long[]{1L}, this.newWithKeysValues(1.0, 1L).toArray()));
    }
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableDoubleLongMap.class, this.classUnderTest().toImmutable());
    }

    @Test
    public void chunk()
    {
        LongIterable iterable = this.newWithKeysValues(1.0, 1L, 2.0, 2L, 3.0, 3L);
        Assert.assertEquals(
                Lists.mutable.with(
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1.0, 1L).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1.0, 1L).chunk(-1));
    }
}

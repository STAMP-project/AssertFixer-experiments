 ...
 */
public abstract class AbstractCharByteMapTestCase
{
    protected final CharByteMap map = this.classUnderTest();

    protected abstract CharByteMap classUnderTest();

    protected abstract CharByteMap newWithKeysValues(char key1, byte value1);

    protected abstract CharByteMap newWithKeysValues(char key1, byte value1, char key2, byte value2);

    protected abstract CharByteMap newWithKeysValues(char key1, byte value1, char key2, byte value2, char key3, byte value3);

    protected abstract CharByteMap newWithKeysValues(char key1, byte value1, char key2, byte value2, char key3, byte value3, char key4, byte value4);

    protected abstract CharByteMap getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(CharHashSet.newSetWith((char) 0), this.newWithKeysValues((char) 0, (byte) 0).keySet());
        Assert.assertEquals(CharHashSet.newSetWith((char) 0, (char) 31, (char) 32),
                this.newWithKeysValues((char) 0, (byte) 0, (char) 31, (byte) 31, (char) 32, (byte) 32).keySet());
    }
    ...
    public void values()
    {
        ...
        CharByteMap map = this.newWithKeysValues((char) 0, (byte) 0);
        Verify.assertSize(1, map.values());
        Assert.assertTrue(map.values().contains((byte) 0));

        CharByteMap map1 = this.newWithKeysValues((char) 0, (byte) 0, (char) 31, (byte) 31, (char) 32, (byte) 32);
    ...
    public void isEmpty()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((char) 1, (byte) 1).isEmpty());
        Assert.assertFalse(this.newWithKeysValues((char) 0, (byte) 0).isEmpty());
        Assert.assertFalse(this.newWithKeysValues((char) 50, (byte) 50).isEmpty());
    }
    ...
    public void notEmpty()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((char) 1, (byte) 1).notEmpty());
        Assert.assertTrue(this.newWithKeysValues((char) 0, (byte) 0).notEmpty());
        Assert.assertTrue(this.newWithKeysValues((char) 50, (byte) 50).notEmpty());
    }
    ...
    public void testEquals()
    {
        ...
        CharByteMap map9 = this.newWithKeysValues((char) 0, (byte) 0);
        ...
        Assert.assertEquals(map1, CharByteMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, CharByteMaps.immutable.ofAll(map1));
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((char) 0, (byte) 0, (char) 1, (byte) 1, (char) 32, (byte) 32).hashCode(),
                this.newWithKeysValues((char) 32, (byte) 32, (char) 0, (byte) 0, (char) 1, (byte) 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((char) 50, (byte) 0, (char) 60, (byte) 1, (char) 70, (byte) 33).hashCode(),
                this.newWithKeysValues((char) 50, (byte) 0, (char) 60, (byte) 1, (char) 70, (byte) 33).hashCode());
        Assert.assertEquals(UnifiedMap.newMap().hashCode(), this.getEmptyMap().hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues((char) 1, (byte) 2).hashCode(), this.newWithKeysValues((char) 1, (byte) 2).hashCode());
    }
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{\u0000=0}", this.newWithKeysValues((char) 0, (byte) 0).toString());
        Assert.assertEquals("{\u0001=1}", this.newWithKeysValues((char) 1, (byte) 1).toString());
        Assert.assertEquals("{\u0005=5}", this.newWithKeysValues((char) 5, (byte) 5).toString());

        CharByteMap map1 = this.newWithKeysValues((char) 0, (byte) 0, (char) 1, (byte) 1);
        Assert.assertTrue(
                map1.toString(),
                "{\u0000=0, \u0001=1}".equals(map1.toString())
                        || "{\u0001=1, \u0000=0}".equals(map1.toString()));

        CharByteMap map2 = this.newWithKeysValues((char) 1, (byte) 1, (char) 32, (byte) 32);
        Assert.assertTrue(
                map2.toString(),
                "{\u0001=1, \u0020=32}".equals(map2.toString())
                        || "{\u0020=32, \u0001=1}".equals(map2.toString()));

        CharByteMap map3 = this.newWithKeysValues((char) 0, (byte) 0, (char) 32, (byte) 32);
        Assert.assertTrue(
                map3.toString(),
                "{\u0000=0, \u0020=32}".equals(map3.toString())
                        || "{\u0020=32, \u0000=0}".equals(map3.toString()));

        CharByteMap map4 = this.newWithKeysValues((char) 32, (byte) 32, (char) 33, (byte) 33);
        Assert.assertTrue(
                map4.toString(),
    ...
    public void forEach()
    {
        CharByteMap map0 = this.newWithKeysValues((char) 0, (byte) 1, (char) 3, (byte) 4);
        byte[] sum0 = new byte[1];
        map0.forEach(each -> sum0[0] += each);
        Assert.assertEquals(5L, sum0[0]);

        CharByteMap map1 = this.newWithKeysValues((char) 1, (byte) 2, (char) 3, (byte) 4);
        byte[] sum1 = new byte[1];
        map1.forEach(each -> sum1[0] += each);
        Assert.assertEquals(6L, sum1[0]);

        CharByteMap map01 = this.newWithKeysValues((char) 0, (byte) 1, (char) 1, (byte) 2);
        byte[] sum01 = new byte[1];
        map01.forEach(each -> sum01[0] += each);
        Assert.assertEquals(3L, sum01[0]);

        CharByteMap map = this.newWithKeysValues((char) 3, (byte) 4, (char) 4, (byte) 5);
        byte[] sum = new byte[1];
        map.forEach(each -> sum[0] += each);
        Assert.assertEquals(9L, sum[0]);

        CharByteMap map2 = this.getEmptyMap();
        byte[] sum2 = new byte[1];
        map2.forEach(each -> sum2[0] += each);
        Assert.assertEquals(0L, sum2[0]);

        CharByteMap map3 = this.newWithKeysValues((char) 1, (byte) 2);
    ...
    public void forEachKey()
    {
        ...
        CharByteMap map3 = this.newWithKeysValues((char) 1, (byte) 1);
    ...
    public void forEachKeyValue()
    {
        ...
        map0.forEachKeyValue((char eachKey, byte eachValue) ->
        {
            sumKey0[0] += eachKey;
        ...
        map1.forEachKeyValue((char eachKey, byte eachValue) ->
        {
            sumKey1[0] += eachKey;
        ...
        map01.forEachKeyValue((char eachKey, byte eachValue) ->
        {
            sumKey01[0] += eachKey;
        ...
        map.forEachKeyValue((char eachKey, byte eachValue) ->
        {
            sumKey[0] += eachKey;
        ...
        map2.forEachKeyValue((char eachKey, byte eachValue) ->
        {
            sumKey2[0] += eachKey;
        ...
        CharByteMap map3 = this.newWithKeysValues((char) 3, (byte) 5);
        char[] sumKey3 = new char[1];
        byte[] sumValue3 = new byte[1];
        map3.forEachKeyValue((char eachKey, byte eachValue) ->
        {
            sumKey3[0] += eachKey;
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("", this.getEmptyMap().makeString(", "));
        Assert.assertEquals("[]", this.getEmptyMap().makeString("[", "/", "]"));
        Assert.assertEquals("0", this.newWithKeysValues((char) 0, (byte) 0).makeString());
        Assert.assertEquals("0", this.newWithKeysValues((char) 0, (byte) 0).makeString(", "));
        Assert.assertEquals("[0]", this.newWithKeysValues((char) 0, (byte) 0).makeString("[", "/", "]"));
        Assert.assertEquals("1", this.newWithKeysValues((char) 1, (byte) 1).makeString());
        Assert.assertEquals("5", this.newWithKeysValues((char) 5, (byte) 5).makeString());
    ...
    public void appendString()
    {
        ...
        this.newWithKeysValues((char) 0, (byte) 0).appendString(appendable0);
        Assert.assertEquals("0", appendable0.toString());

        Appendable appendable01 = new StringBuilder();
        this.newWithKeysValues((char) 0, (byte) 0).appendString(appendable01, "/");
        Assert.assertEquals("0", appendable01.toString());

        Appendable appendable02 = new StringBuilder();
        this.newWithKeysValues((char) 0, (byte) 0).appendString(appendable02, "{", "/", "}");
        Assert.assertEquals("{0}", appendable02.toString());

        Appendable appendable1 = new StringBuilder();
        this.newWithKeysValues((char) 1, (byte) 1).appendString(appendable1);
        Assert.assertEquals("1", appendable1.toString());

        Appendable appendable2 = new StringBuilder();
        this.newWithKeysValues((char) 5, (byte) 5).appendString(appendable2);
        ...
        CharByteMap map3 = this.newWithKeysValues((char) 1, (byte) 1, (char) 32, (byte) 32);
    ...
    public void select()
    {
        CharByteMap map = this.newWithKeysValues((char) 0, (byte) 0, (char) 1, (byte) 1, (char) 2, (byte) 2, (char) 3, (byte) 3);
        CharByteMap actual1 = map.select((char key, byte value) -> key == (char) 1 || value == (byte) 3);
        Assert.assertEquals(CharByteHashMap.newWithKeysValues((char) 1, (byte) 1, (char) 3, (byte) 3), actual1);
        CharByteMap actual2 = map.select((char key, byte value) -> key == (char) 0 || value == (byte) 2);
        Assert.assertEquals(CharByteHashMap.newWithKeysValues((char) 0, (byte) 0, (char) 2, (byte) 2), actual2);
    }
    ...
    {
        CharByteMap map = this.newWithKeysValues((char) 0, (byte) 0, (char) 1, (byte) 1, (char) 2, (byte) 2, (char) 3, (byte) 3);
        CharByteMap actual1 = map.reject((char key, byte value) -> key == (char) 1 || value == (byte) 3);
        Assert.assertEquals(CharByteHashMap.newWithKeysValues((char) 0, (byte) 0, (char) 2, (byte) 2), actual1);
        CharByteMap actual2 = map.reject((char key, byte value)-> key == (char) 0 || value == (byte) 2);
        Assert.assertEquals(CharByteHashMap.newWithKeysValues((char) 1, (byte) 1, (char) 3, (byte) 3), actual2);
    }
    ...
    public void collect()
    {
        ...
        Assert.assertEquals(Bags.immutable.with((byte) 2), this.newWithKeysValues((char) 1, (byte) 1).collect(function));
    }
    ...
    public void detectIfNone_value()
    {
        ...
        Assert.assertEquals((byte) 5, this.newWithKeysValues((char) 1, (byte) 1).detectIfNone(BytePredicates.equal((byte) 0), (byte) 5));
        Assert.assertEquals((byte) 1, this.newWithKeysValues((char) 1, (byte) 1).detectIfNone(BytePredicates.equal((byte) 1), (byte) 5));
    ...
    public void anySatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((char) 1, (byte) 1).anySatisfy(BytePredicates.equal((byte) 0)));
        Assert.assertTrue(this.newWithKeysValues((char) 1, (byte) 1).anySatisfy(BytePredicates.equal((byte) 1)));
    ...
    public void allSatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((char) 1, (byte) 1).allSatisfy(BytePredicates.equal((byte) 0)));
        Assert.assertTrue(this.newWithKeysValues((char) 1, (byte) 1).allSatisfy(BytePredicates.equal((byte) 1)));
        ...
        CharByteMap map1 = this.newWithKeysValues((char) 2, (byte) 2, (char) 3, (byte) 3);
    ...
    public void noneSatisfy()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((char) 1, (byte) 1).noneSatisfy(BytePredicates.equal((byte) 0)));
        Assert.assertFalse(this.newWithKeysValues((char) 1, (byte) 1).noneSatisfy(BytePredicates.equal((byte) 1)));
    ...
    public void max()
    {
        ...
        Assert.assertEquals((byte) 3, this.newWithKeysValues((char) 3, (byte) 3).max());
    }

    @Test
    public void min()
    {
        CharByteMap map = this.newWithKeysValues((char) 1, (byte) 1, (char) 2, (byte) 2, (char) 3, (byte) 3, (char) 0, (byte) 0);
        Assert.assertEquals((byte) 0, map.min());
        Assert.assertEquals((byte) 3, this.newWithKeysValues((char) 3, (byte) 3).min());
    }
    ...
    public void minIfEmpty()
    {
        ...
        CharByteMap map = this.newWithKeysValues((char) 1, (byte) 1, (char) 0, (byte) 0, (char) 9, (byte) 9, (char) 7, (byte) 7);
        Assert.assertEquals(0L, map.minIfEmpty((byte) 5));
        Assert.assertEquals((byte) 3, this.newWithKeysValues((char) 3, (byte) 3).maxIfEmpty((byte) 5));
    }
    ...
    public void maxIfEmpty()
    {
        ...
        Assert.assertEquals((byte) 3, this.newWithKeysValues((char) 3, (byte) 3).minIfEmpty((byte) 5));
    }
    ...
    public void sum()
    {
        ...
        CharByteMap map2 = this.newWithKeysValues((char) 2, (byte) 2, (char) 3, (byte) 3, (char) 4, (byte) 4);
        Assert.assertEquals((byte) 9, map2.sum());
        CharByteMap map3 = this.newWithKeysValues((char) 2, (byte) 2);
    ...
    public void average()
    {
        ...
        CharByteMap map1 = this.newWithKeysValues((char) 1, (byte) 1);
    ...
    public void median()
    {
        ...
        CharByteMap map2 = this.newWithKeysValues((char) 0, (byte) 0, (char) 1, (byte) 1, (char) 2, (byte) 2);
    ...
    public void toList()
    {
        Assert.assertEquals(ByteArrayList.newListWith((byte) 0), this.newWithKeysValues((char) 0, (byte) 0).toList());
        Assert.assertEquals(ByteArrayList.newListWith((byte) 1), this.newWithKeysValues((char) 1, (byte) 1).toList());
        Assert.assertEquals(ByteArrayList.newListWith((byte) 2), this.newWithKeysValues((char) 2, (byte) 2).toList());
        Assert.assertTrue(this.newWithKeysValues((char) 2, (byte) 2, (char) 3, (byte) 3).toList().equals(ByteArrayList.newListWith((byte) 2, (byte) 3))
                || this.newWithKeysValues((char) 2, (byte) 2, (char) 3, (byte) 3).toList().equals(ByteArrayList.newListWith((byte) 3, (byte) 2)));
    }
    ...
    public void toSortedList()
    {
        ...
        Assert.assertEquals(ByteArrayList.newListWith((byte) 1), this.newWithKeysValues((char) 1, (byte) 1).toSortedList());
    }
    ...
    public void toSet()
    {
        ...
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 1), this.newWithKeysValues((char) 1, (byte) 1).toSet());
    }
    ...
    public void toBag()
    {
        ...
        Assert.assertEquals(ByteHashBag.newBagWith((byte) 1), this.newWithKeysValues((char) 1, (byte) 1).toBag());
    }
    ...
    {
        MutableBag<CharBytePair> expected = Bags.mutable.of();
        this.map.forEachKeyValue((char key, byte value) -> expected.add(PrimitiveTuples.pair(key, value)));
    ...
    public void toArray()
    {
        CharByteMap map = this.newWithKeysValues((char) 1, (byte) 1, (char) 2, (byte) 2);
        ...
        Assert.assertTrue(Arrays.equals(new byte[]{(byte) 1}, this.newWithKeysValues((char) 1, (byte) 1).toArray()));
    }
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableCharByteMap.class, this.classUnderTest().toImmutable());
    }

    @Test
    public void chunk()
    {
        ByteIterable iterable = this.newWithKeysValues((char) 1, (byte) 1, (char) 2, (byte) 2, (char) 3, (byte) 3);
        Assert.assertEquals(
                Lists.mutable.with(
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((char) 1, (byte) 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((char) 1, (byte) 1).chunk(-1));
    }
}

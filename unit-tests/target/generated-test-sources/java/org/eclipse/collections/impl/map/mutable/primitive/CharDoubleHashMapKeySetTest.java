...
/**
 * JUnit test for {@link CharDoubleHashMap#keySet()}.
 *
 * This file was automatically generated from template file primitivePrimitiveHashMapKeySetTest.stg.
 */
public class CharDoubleHashMapKeySetTest extends AbstractCharSetTestCase
{
    @Override
    protected MutableCharSet classUnderTest()
    {
        return CharDoubleHashMap.newWithKeysValues((char) 1, 1.0, (char) 2, 2.0, (char) 3, 3.0).keySet();
    }

...
public abstract class AbstractCharCharMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith((char) 1, (char) 2, (char) 2, (char) 3, (char) 3, (char) 4).collect((CharCharPair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Long> result2 =
            this.newWith((char) 1, (char) 2, (char) 2, (char) 3, (char) 3, (char) 4).collect((CharCharPair object) -> (long) object.getTwo());
    ...
    public void detectWithIfNoneBlock()
    {
        ...
        Assert.assertEquals(
            ...
            this.newWith((char) 1, (char) 2, (char) 2, (char) 3, (char) 3, (char) 4).detectWithIfNone(
                    Object::equals,
                    PrimitiveTuples.pair((char) 2, (char) 3),
                    function));
        Assert.assertEquals(
            PrimitiveTuples.pair((char) 5, (char) 6),
            this.newWith((char) 1, (char) 2, (char) 2, (char) 3, (char) 3, (char) 4).detectWithIfNone(
                    Object::equals,
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith((char) 1, (char) 2, (char) 2, (char) 3, (char) 3, (char) 4).collectIf(
                        CharCharPair.class::isInstance,
                        String::valueOf),
                "\u0001:\u0002", "\u0002:\u0003", "\u0003:\u0004");
        Verify.assertContainsAll(
                this.newWith((char) 1, (char) 2, (char) 2, (char) 3, (char) 3, (char) 4).collectIf(
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith((char) 1, (char) 2, (char) 2, (char) 3, (char) 3, (char) 4).collectWith((CharCharPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(4L, 6L, 8L),
                this.newWith((char) 1, (char) 2, (char) 2, (char) 3, (char) 3, (char) 4).collectWith((CharCharPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair((char) 1, (char) 2).equals(first)
                || PrimitiveTuples.pair((char) 2, (char) 3).equals(first)
                || PrimitiveTuples.pair((char) 3, (char) 4).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair((char) 1, (char) 2).equals(last)
                || PrimitiveTuples.pair((char) 2, (char) 3).equals(last)
                || PrimitiveTuples.pair((char) 3, (char) 4).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair((char) 3, (char) 4),
                PrimitiveTuples.pair((char) 2, (char) 3),
    ...
    public void testToString()
    {
        ...
        Assert.assertTrue("[\u0001:\u0002, \u0002:\u0003]".equals(collection.toString())
                || "[\u0002:\u0003, \u0001:\u0002]".equals(collection.toString()));
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((char) 1, (char) 2), 1), Tuples.pair(PrimitiveTuples.pair((char) 2, (char) 3), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((char) 2, (char) 3), 1), Tuples.pair(PrimitiveTuples.pair((char) 1, (char) 2), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((char) 1, (char) 2), 0), Tuples.pair(PrimitiveTuples.pair((char) 2, (char) 3), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((char) 2, (char) 3), 0), Tuples.pair(PrimitiveTuples.pair((char) 1, (char) 2), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<CharCharPair> collection = this.newWith((char) 1, (char) 2, (char) 2, (char) 3, (char) 3, (char) 4);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair((char) 1, (char) 2)),
                FastList.newListWith(PrimitiveTuples.pair((char) 2, (char) 3)),
                FastList.newListWith(PrimitiveTuples.pair((char) 3, (char) 4))),

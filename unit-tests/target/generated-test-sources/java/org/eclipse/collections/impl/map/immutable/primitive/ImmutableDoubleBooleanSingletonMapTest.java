...
/**
 * JUnit test for {@link ImmutableDoubleBooleanSingletonMap}.
 * This file was automatically generated from template file immutablePrimitiveBooleanSingletonMapTest.stg.
 */
public class ImmutableDoubleBooleanSingletonMapTest extends AbstractImmutableDoubleBooleanMapTestCase
{
    @Override
    protected ImmutableDoubleBooleanMap classUnderTest()
    {
        return DoubleBooleanMaps.immutable.with(0.0, true);
    }
    ...
    public void newWithKeyValue()
    {
        ...
        ImmutableDoubleBooleanMap expected = this.newWithKeysValues(0.0, true, 1.0, true);
        Assert.assertEquals(expected, map1.newWithKeyValue(1.0, true));
        Assert.assertNotSame(map1, map1.newWithKeyValue(1.0, true));
    }
    ...
    public void newWithoutKeyValue()
    {
        ...
        ImmutableDoubleBooleanMap map2 = this.classUnderTest();
    ...
    public void getIfAbsent()
    {
        ...
        Assert.assertTrue(this.classUnderTest().getIfAbsent(31.0, true));
    ...
    public void getOrThrow()
    {
        ...
        Verify.assertThrows(IllegalStateException.class, () -> this.classUnderTest().getOrThrow(31.0));
    ...
    {
        Assert.assertEquals(DoubleArrayList.newListWith(0.0), this.classUnderTest().keysView().toSortedList());
    }
    ...
    public void select()
    {
        DoubleBooleanMap actual1 = this.classUnderTest().select((double key, boolean value) -> Double.compare(key, 0.0) == 0);
        Assert.assertEquals(DoubleBooleanHashMap.newWithKeysValues(0.0, true), actual1);
        DoubleBooleanMap actual2 = this.classUnderTest().select((double key, boolean value) -> Double.compare(key, 1.0) == 0);
    ...
    public void reject()
    {
        DoubleBooleanMap actual1 = this.classUnderTest().reject((double key, boolean value) -> Double.compare(key, 1.0) == 0);
        Assert.assertEquals(DoubleBooleanHashMap.newWithKeysValues(0.0, true), actual1);
        DoubleBooleanMap actual2 = this.classUnderTest().reject((double key, boolean value) -> Double.compare(key, 0.0) == 0);
        Assert.assertEquals(this.getEmptyMap(), actual2);
    }

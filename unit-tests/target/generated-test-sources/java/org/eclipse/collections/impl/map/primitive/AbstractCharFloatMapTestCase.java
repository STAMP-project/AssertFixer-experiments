...
public abstract class AbstractCharFloatMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(CharHashSet.newSetWith((char) 0, (char) 31, (char) 32),
                this.newWithKeysValues((char) 0, 0.0f, (char) 31, 31.0f, (char) 32, 32.0f).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((char) 0, 0.0f, (char) 1, 1.0f, (char) 32, 32.0f).hashCode(),
                this.newWithKeysValues((char) 32, 32.0f, (char) 0, 0.0f, (char) 1, 1.0f).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((char) 50, 0.0f, (char) 60, 1.0f, (char) 70, 33.0f).hashCode(),
                this.newWithKeysValues((char) 50, 0.0f, (char) 60, 1.0f, (char) 70, 33.0f).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((char) 2, 2.0f, (char) 3, 3.0f).toList().equals(FloatArrayList.newListWith(2.0f, 3.0f))
                || this.newWithKeysValues((char) 2, 2.0f, (char) 3, 3.0f).toList().equals(FloatArrayList.newListWith(3.0f, 2.0f)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((char) 1, 1.0f).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((char) 1, 1.0f).chunk(-1));
    }
}

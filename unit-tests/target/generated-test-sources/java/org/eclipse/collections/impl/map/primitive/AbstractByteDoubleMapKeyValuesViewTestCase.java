...
public abstract class AbstractByteDoubleMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith((byte) 1, 2.0, (byte) 2, 3.0, (byte) 3, 4.0).collect((ByteDoublePair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Long> result2 =
            this.newWith((byte) 1, 2.0, (byte) 2, 3.0, (byte) 3, 4.0).collect((ByteDoublePair object) -> (long) object.getTwo());
    ...
    public void detectWithIfNoneBlock()
    {
        Function0<ByteDoublePair> function = Functions0.value(PrimitiveTuples.pair((byte) 5, 6.0));
        Assert.assertEquals(
            PrimitiveTuples.pair((byte) 2, 3.0),
            this.newWith((byte) 1, 2.0, (byte) 2, 3.0, (byte) 3, 4.0).detectWithIfNone(
                    Object::equals,
                    PrimitiveTuples.pair((byte) 2, 3.0),
                    function));
        Assert.assertEquals(
            PrimitiveTuples.pair((byte) 5, 6.0),
            this.newWith((byte) 1, 2.0, (byte) 2, 3.0, (byte) 3, 4.0).detectWithIfNone(
                    Object::equals,
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith((byte) 1, 2.0, (byte) 2, 3.0, (byte) 3, 4.0).collectIf(
                        ByteDoublePair.class::isInstance,
                        String::valueOf),
                "1:2.0", "2:3.0", "3:4.0");
        Verify.assertContainsAll(
                this.newWith((byte) 1, 2.0, (byte) 2, 3.0, (byte) 3, 4.0).collectIf(
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith((byte) 1, 2.0, (byte) 2, 3.0, (byte) 3, 4.0).collectWith((ByteDoublePair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(4L, 6L, 8L),
                this.newWith((byte) 1, 2.0, (byte) 2, 3.0, (byte) 3, 4.0).collectWith((ByteDoublePair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair((byte) 1, 2.0).equals(first)
                || PrimitiveTuples.pair((byte) 2, 3.0).equals(first)
                || PrimitiveTuples.pair((byte) 3, 4.0).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair((byte) 1, 2.0).equals(last)
                || PrimitiveTuples.pair((byte) 2, 3.0).equals(last)
                || PrimitiveTuples.pair((byte) 3, 4.0).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair((byte) 3, 4.0),
                PrimitiveTuples.pair((byte) 2, 3.0),
                PrimitiveTuples.pair((byte) 1, 2.0)),
                set);
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((byte) 1, 2.0), 1), Tuples.pair(PrimitiveTuples.pair((byte) 2, 3.0), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((byte) 2, 3.0), 1), Tuples.pair(PrimitiveTuples.pair((byte) 1, 2.0), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((byte) 1, 2.0), 0), Tuples.pair(PrimitiveTuples.pair((byte) 2, 3.0), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((byte) 2, 3.0), 0), Tuples.pair(PrimitiveTuples.pair((byte) 1, 2.0), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<ByteDoublePair> collection = this.newWith((byte) 1, 2.0, (byte) 2, 3.0, (byte) 3, 4.0);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair((byte) 1, 2.0)),
                FastList.newListWith(PrimitiveTuples.pair((byte) 2, 3.0)),
                FastList.newListWith(PrimitiveTuples.pair((byte) 3, 4.0))),

...
public abstract class AbstractFloatDoubleMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(FloatHashSet.newSetWith(0.0f, 31.0f, 32.0f),
                this.newWithKeysValues(0.0f, 0.0, 31.0f, 31.0, 32.0f, 32.0).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0.0f, 0.0, 1.0f, 1.0, 32.0f, 32.0).hashCode(),
                this.newWithKeysValues(32.0f, 32.0, 0.0f, 0.0, 1.0f, 1.0).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50.0f, 0.0, 60.0f, 1.0, 70.0f, 33.0).hashCode(),
                this.newWithKeysValues(50.0f, 0.0, 60.0f, 1.0, 70.0f, 33.0).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(2.0f, 2.0, 3.0f, 3.0).toList().equals(DoubleArrayList.newListWith(2.0, 3.0))
                || this.newWithKeysValues(2.0f, 2.0, 3.0f, 3.0).toList().equals(DoubleArrayList.newListWith(3.0, 2.0)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1.0f, 1.0).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1.0f, 1.0).chunk(-1));
    }
}

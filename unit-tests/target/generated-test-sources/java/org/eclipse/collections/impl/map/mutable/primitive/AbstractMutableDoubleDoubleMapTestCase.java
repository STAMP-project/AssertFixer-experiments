...
public abstract class AbstractMutableDoubleDoubleMapTestCase extends AbstractDoubleDoubleMapTestCase
{
    ...
    public void getIfAbsentPutWithKey()
    {
        ...
        DoubleToDoubleFunction functionThrows = (double doubleParameter) -> { throw new AssertionError(); };
    ...
    public void flipUniqueValues()
    {
        ...
        Assert.assertEquals(
                DoubleDoubleHashMap.newWithKeysValues(2.0, 1.0, 3.0, 2.0, 4.0, 3.0, 5.0, 4.0),
                map.flipUniqueValues());
         Verify.assertThrows(
                IllegalStateException.class,
                () -> this.newWithKeysValues(1.0, 1.0, 2.0, 1.0).flipUniqueValues());
    }
}

...
/**
 * JUnit test for {@link DoubleObjectHashMap#keySet()}.
 *
 * This file was automatically generated from template file primitiveObjectHashMapKeySetTest.stg.
 */
public class DoubleObjectHashMapKeySetTest extends AbstractDoubleSetTestCase
{
    @Override
    protected MutableDoubleSet classUnderTest()
    {
        return DoubleObjectHashMap.newWithKeysValues(1.0, 1, 2.0, 2, 3.0, 3).keySet();
    }

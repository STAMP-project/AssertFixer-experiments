 ...
 */
public abstract class AbstractShortByteMapTestCase
{
    protected final ShortByteMap map = this.classUnderTest();

    protected abstract ShortByteMap classUnderTest();

    protected abstract ShortByteMap newWithKeysValues(short key1, byte value1);

    protected abstract ShortByteMap newWithKeysValues(short key1, byte value1, short key2, byte value2);

    protected abstract ShortByteMap newWithKeysValues(short key1, byte value1, short key2, byte value2, short key3, byte value3);

    protected abstract ShortByteMap newWithKeysValues(short key1, byte value1, short key2, byte value2, short key3, byte value3, short key4, byte value4);

    protected abstract ShortByteMap getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(ShortHashSet.newSetWith((short) 0), this.newWithKeysValues((short) 0, (byte) 0).keySet());
        Assert.assertEquals(ShortHashSet.newSetWith((short) 0, (short) 31, (short) 32),
                this.newWithKeysValues((short) 0, (byte) 0, (short) 31, (byte) 31, (short) 32, (byte) 32).keySet());
    }
    ...
    public void values()
    {
        ...
        ShortByteMap map = this.newWithKeysValues((short) 0, (byte) 0);
        Verify.assertSize(1, map.values());
        Assert.assertTrue(map.values().contains((byte) 0));

        ShortByteMap map1 = this.newWithKeysValues((short) 0, (byte) 0, (short) 31, (byte) 31, (short) 32, (byte) 32);
    ...
    public void isEmpty()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((short) 1, (byte) 1).isEmpty());
        Assert.assertFalse(this.newWithKeysValues((short) 0, (byte) 0).isEmpty());
        Assert.assertFalse(this.newWithKeysValues((short) 50, (byte) 50).isEmpty());
    }
    ...
    public void notEmpty()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((short) 1, (byte) 1).notEmpty());
        Assert.assertTrue(this.newWithKeysValues((short) 0, (byte) 0).notEmpty());
        Assert.assertTrue(this.newWithKeysValues((short) 50, (byte) 50).notEmpty());
    }
    ...
    public void testEquals()
    {
        ...
        ShortByteMap map9 = this.newWithKeysValues((short) 0, (byte) 0);
        ...
        Assert.assertEquals(map1, ShortByteMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, ShortByteMaps.immutable.ofAll(map1));
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((short) 0, (byte) 0, (short) 1, (byte) 1, (short) 32, (byte) 32).hashCode(),
                this.newWithKeysValues((short) 32, (byte) 32, (short) 0, (byte) 0, (short) 1, (byte) 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((short) 50, (byte) 0, (short) 60, (byte) 1, (short) 70, (byte) 33).hashCode(),
                this.newWithKeysValues((short) 50, (byte) 0, (short) 60, (byte) 1, (short) 70, (byte) 33).hashCode());
        Assert.assertEquals(UnifiedMap.newMap().hashCode(), this.getEmptyMap().hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues((short) 1, (byte) 2).hashCode(), this.newWithKeysValues((short) 1, (byte) 2).hashCode());
    }
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{0=0}", this.newWithKeysValues((short) 0, (byte) 0).toString());
        Assert.assertEquals("{1=1}", this.newWithKeysValues((short) 1, (byte) 1).toString());
        Assert.assertEquals("{5=5}", this.newWithKeysValues((short) 5, (byte) 5).toString());

        ShortByteMap map1 = this.newWithKeysValues((short) 0, (byte) 0, (short) 1, (byte) 1);
        Assert.assertTrue(
                map1.toString(),
                "{0=0, 1=1}".equals(map1.toString())
                        || "{1=1, 0=0}".equals(map1.toString()));

        ShortByteMap map2 = this.newWithKeysValues((short) 1, (byte) 1, (short) 32, (byte) 32);
        Assert.assertTrue(
                map2.toString(),
                "{1=1, 32=32}".equals(map2.toString())
                        || "{32=32, 1=1}".equals(map2.toString()));

        ShortByteMap map3 = this.newWithKeysValues((short) 0, (byte) 0, (short) 32, (byte) 32);
        Assert.assertTrue(
                map3.toString(),
                "{0=0, 32=32}".equals(map3.toString())
                        || "{32=32, 0=0}".equals(map3.toString()));

        ShortByteMap map4 = this.newWithKeysValues((short) 32, (byte) 32, (short) 33, (byte) 33);
        Assert.assertTrue(
                map4.toString(),
    ...
    public void forEach()
    {
        ShortByteMap map0 = this.newWithKeysValues((short) 0, (byte) 1, (short) 3, (byte) 4);
        byte[] sum0 = new byte[1];
        map0.forEach(each -> sum0[0] += each);
        Assert.assertEquals(5L, sum0[0]);

        ShortByteMap map1 = this.newWithKeysValues((short) 1, (byte) 2, (short) 3, (byte) 4);
        byte[] sum1 = new byte[1];
        map1.forEach(each -> sum1[0] += each);
        Assert.assertEquals(6L, sum1[0]);

        ShortByteMap map01 = this.newWithKeysValues((short) 0, (byte) 1, (short) 1, (byte) 2);
        byte[] sum01 = new byte[1];
        map01.forEach(each -> sum01[0] += each);
        Assert.assertEquals(3L, sum01[0]);

        ShortByteMap map = this.newWithKeysValues((short) 3, (byte) 4, (short) 4, (byte) 5);
        byte[] sum = new byte[1];
        map.forEach(each -> sum[0] += each);
        Assert.assertEquals(9L, sum[0]);

        ShortByteMap map2 = this.getEmptyMap();
        byte[] sum2 = new byte[1];
        map2.forEach(each -> sum2[0] += each);
        Assert.assertEquals(0L, sum2[0]);

        ShortByteMap map3 = this.newWithKeysValues((short) 1, (byte) 2);
    ...
    public void forEachKey()
    {
        ...
        ShortByteMap map3 = this.newWithKeysValues((short) 1, (byte) 1);
    ...
    public void forEachKeyValue()
    {
        ...
        map0.forEachKeyValue((short eachKey, byte eachValue) ->
        {
            sumKey0[0] += eachKey;
        ...
        map1.forEachKeyValue((short eachKey, byte eachValue) ->
        {
            sumKey1[0] += eachKey;
        ...
        map01.forEachKeyValue((short eachKey, byte eachValue) ->
        {
            sumKey01[0] += eachKey;
        ...
        map.forEachKeyValue((short eachKey, byte eachValue) ->
        {
            sumKey[0] += eachKey;
        ...
        map2.forEachKeyValue((short eachKey, byte eachValue) ->
        {
            sumKey2[0] += eachKey;
        ...
        ShortByteMap map3 = this.newWithKeysValues((short) 3, (byte) 5);
        short[] sumKey3 = new short[1];
        byte[] sumValue3 = new byte[1];
        map3.forEachKeyValue((short eachKey, byte eachValue) ->
        {
            sumKey3[0] += eachKey;
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("", this.getEmptyMap().makeString(", "));
        Assert.assertEquals("[]", this.getEmptyMap().makeString("[", "/", "]"));
        Assert.assertEquals("0", this.newWithKeysValues((short) 0, (byte) 0).makeString());
        Assert.assertEquals("0", this.newWithKeysValues((short) 0, (byte) 0).makeString(", "));
        Assert.assertEquals("[0]", this.newWithKeysValues((short) 0, (byte) 0).makeString("[", "/", "]"));
        Assert.assertEquals("1", this.newWithKeysValues((short) 1, (byte) 1).makeString());
        Assert.assertEquals("5", this.newWithKeysValues((short) 5, (byte) 5).makeString());
    ...
    public void appendString()
    {
        ...
        this.newWithKeysValues((short) 0, (byte) 0).appendString(appendable0);
        Assert.assertEquals("0", appendable0.toString());

        Appendable appendable01 = new StringBuilder();
        this.newWithKeysValues((short) 0, (byte) 0).appendString(appendable01, "/");
        Assert.assertEquals("0", appendable01.toString());

        Appendable appendable02 = new StringBuilder();
        this.newWithKeysValues((short) 0, (byte) 0).appendString(appendable02, "{", "/", "}");
        Assert.assertEquals("{0}", appendable02.toString());

        Appendable appendable1 = new StringBuilder();
        this.newWithKeysValues((short) 1, (byte) 1).appendString(appendable1);
        Assert.assertEquals("1", appendable1.toString());

        Appendable appendable2 = new StringBuilder();
        this.newWithKeysValues((short) 5, (byte) 5).appendString(appendable2);
        ...
        ShortByteMap map3 = this.newWithKeysValues((short) 1, (byte) 1, (short) 32, (byte) 32);
    ...
    public void select()
    {
        ShortByteMap map = this.newWithKeysValues((short) 0, (byte) 0, (short) 1, (byte) 1, (short) 2, (byte) 2, (short) 3, (byte) 3);
        ShortByteMap actual1 = map.select((short key, byte value) -> key == (short) 1 || value == (byte) 3);
        Assert.assertEquals(ShortByteHashMap.newWithKeysValues((short) 1, (byte) 1, (short) 3, (byte) 3), actual1);
        ShortByteMap actual2 = map.select((short key, byte value) -> key == (short) 0 || value == (byte) 2);
        Assert.assertEquals(ShortByteHashMap.newWithKeysValues((short) 0, (byte) 0, (short) 2, (byte) 2), actual2);
    }
    ...
    {
        ShortByteMap map = this.newWithKeysValues((short) 0, (byte) 0, (short) 1, (byte) 1, (short) 2, (byte) 2, (short) 3, (byte) 3);
        ShortByteMap actual1 = map.reject((short key, byte value) -> key == (short) 1 || value == (byte) 3);
        Assert.assertEquals(ShortByteHashMap.newWithKeysValues((short) 0, (byte) 0, (short) 2, (byte) 2), actual1);
        ShortByteMap actual2 = map.reject((short key, byte value)-> key == (short) 0 || value == (byte) 2);
        Assert.assertEquals(ShortByteHashMap.newWithKeysValues((short) 1, (byte) 1, (short) 3, (byte) 3), actual2);
    }
    ...
    public void collect()
    {
        ...
        Assert.assertEquals(Bags.immutable.with((byte) 2), this.newWithKeysValues((short) 1, (byte) 1).collect(function));
    }
    ...
    public void detectIfNone_value()
    {
        ...
        Assert.assertEquals((byte) 5, this.newWithKeysValues((short) 1, (byte) 1).detectIfNone(BytePredicates.equal((byte) 0), (byte) 5));
        Assert.assertEquals((byte) 1, this.newWithKeysValues((short) 1, (byte) 1).detectIfNone(BytePredicates.equal((byte) 1), (byte) 5));
    ...
    public void anySatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((short) 1, (byte) 1).anySatisfy(BytePredicates.equal((byte) 0)));
        Assert.assertTrue(this.newWithKeysValues((short) 1, (byte) 1).anySatisfy(BytePredicates.equal((byte) 1)));
    ...
    public void allSatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((short) 1, (byte) 1).allSatisfy(BytePredicates.equal((byte) 0)));
        Assert.assertTrue(this.newWithKeysValues((short) 1, (byte) 1).allSatisfy(BytePredicates.equal((byte) 1)));
        ...
        ShortByteMap map1 = this.newWithKeysValues((short) 2, (byte) 2, (short) 3, (byte) 3);
    ...
    public void noneSatisfy()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((short) 1, (byte) 1).noneSatisfy(BytePredicates.equal((byte) 0)));
        Assert.assertFalse(this.newWithKeysValues((short) 1, (byte) 1).noneSatisfy(BytePredicates.equal((byte) 1)));
    ...
    public void max()
    {
        ...
        Assert.assertEquals((byte) 3, this.newWithKeysValues((short) 3, (byte) 3).max());
    }

    @Test
    public void min()
    {
        ShortByteMap map = this.newWithKeysValues((short) 1, (byte) 1, (short) 2, (byte) 2, (short) 3, (byte) 3, (short) 0, (byte) 0);
        Assert.assertEquals((byte) 0, map.min());
        Assert.assertEquals((byte) 3, this.newWithKeysValues((short) 3, (byte) 3).min());
    }
    ...
    public void minIfEmpty()
    {
        ...
        ShortByteMap map = this.newWithKeysValues((short) 1, (byte) 1, (short) 0, (byte) 0, (short) 9, (byte) 9, (short) 7, (byte) 7);
        Assert.assertEquals(0L, map.minIfEmpty((byte) 5));
        Assert.assertEquals((byte) 3, this.newWithKeysValues((short) 3, (byte) 3).maxIfEmpty((byte) 5));
    }
    ...
    public void maxIfEmpty()
    {
        ...
        Assert.assertEquals((byte) 3, this.newWithKeysValues((short) 3, (byte) 3).minIfEmpty((byte) 5));
    }
    ...
    public void sum()
    {
        ...
        ShortByteMap map2 = this.newWithKeysValues((short) 2, (byte) 2, (short) 3, (byte) 3, (short) 4, (byte) 4);
        Assert.assertEquals((byte) 9, map2.sum());
        ShortByteMap map3 = this.newWithKeysValues((short) 2, (byte) 2);
    ...
    public void average()
    {
        ...
        ShortByteMap map1 = this.newWithKeysValues((short) 1, (byte) 1);
    ...
    public void median()
    {
        ...
        ShortByteMap map2 = this.newWithKeysValues((short) 0, (byte) 0, (short) 1, (byte) 1, (short) 2, (byte) 2);
    ...
    public void toList()
    {
        Assert.assertEquals(ByteArrayList.newListWith((byte) 0), this.newWithKeysValues((short) 0, (byte) 0).toList());
        Assert.assertEquals(ByteArrayList.newListWith((byte) 1), this.newWithKeysValues((short) 1, (byte) 1).toList());
        Assert.assertEquals(ByteArrayList.newListWith((byte) 2), this.newWithKeysValues((short) 2, (byte) 2).toList());
        Assert.assertTrue(this.newWithKeysValues((short) 2, (byte) 2, (short) 3, (byte) 3).toList().equals(ByteArrayList.newListWith((byte) 2, (byte) 3))
                || this.newWithKeysValues((short) 2, (byte) 2, (short) 3, (byte) 3).toList().equals(ByteArrayList.newListWith((byte) 3, (byte) 2)));
    }
    ...
    public void toSortedList()
    {
        ...
        Assert.assertEquals(ByteArrayList.newListWith((byte) 1), this.newWithKeysValues((short) 1, (byte) 1).toSortedList());
    }
    ...
    public void toSet()
    {
        ...
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 1), this.newWithKeysValues((short) 1, (byte) 1).toSet());
    }
    ...
    public void toBag()
    {
        ...
        Assert.assertEquals(ByteHashBag.newBagWith((byte) 1), this.newWithKeysValues((short) 1, (byte) 1).toBag());
    }
    ...
    {
        MutableBag<ShortBytePair> expected = Bags.mutable.of();
        this.map.forEachKeyValue((short key, byte value) -> expected.add(PrimitiveTuples.pair(key, value)));
    ...
    public void toArray()
    {
        ShortByteMap map = this.newWithKeysValues((short) 1, (byte) 1, (short) 2, (byte) 2);
        ...
        Assert.assertTrue(Arrays.equals(new byte[]{(byte) 1}, this.newWithKeysValues((short) 1, (byte) 1).toArray()));
    }
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableShortByteMap.class, this.classUnderTest().toImmutable());
    }

    @Test
    public void chunk()
    {
        ByteIterable iterable = this.newWithKeysValues((short) 1, (byte) 1, (short) 2, (byte) 2, (short) 3, (byte) 3);
        Assert.assertEquals(
                Lists.mutable.with(
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((short) 1, (byte) 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((short) 1, (byte) 1).chunk(-1));
    }
}

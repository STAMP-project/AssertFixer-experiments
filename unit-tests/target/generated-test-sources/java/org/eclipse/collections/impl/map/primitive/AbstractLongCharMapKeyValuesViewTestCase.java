...
public abstract class AbstractLongCharMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith(1L, (char) 2, 2L, (char) 3, 3L, (char) 4).collect((LongCharPair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Long> result2 =
            this.newWith(1L, (char) 2, 2L, (char) 3, 3L, (char) 4).collect((LongCharPair object) -> (long) object.getTwo());
    ...
    public void detectWithIfNoneBlock()
    {
        Function0<LongCharPair> function = Functions0.value(PrimitiveTuples.pair(5L, (char) 6));
        Assert.assertEquals(
            PrimitiveTuples.pair(2L, (char) 3),
            this.newWith(1L, (char) 2, 2L, (char) 3, 3L, (char) 4).detectWithIfNone(
                    Object::equals,
                    PrimitiveTuples.pair(2L, (char) 3),
                    function));
        Assert.assertEquals(
            PrimitiveTuples.pair(5L, (char) 6),
            this.newWith(1L, (char) 2, 2L, (char) 3, 3L, (char) 4).detectWithIfNone(
                    Object::equals,
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith(1L, (char) 2, 2L, (char) 3, 3L, (char) 4).collectIf(
                        LongCharPair.class::isInstance,
                        String::valueOf),
                "1:\u0002", "2:\u0003", "3:\u0004");
        Verify.assertContainsAll(
                this.newWith(1L, (char) 2, 2L, (char) 3, 3L, (char) 4).collectIf(
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith(1L, (char) 2, 2L, (char) 3, 3L, (char) 4).collectWith((LongCharPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(4L, 6L, 8L),
                this.newWith(1L, (char) 2, 2L, (char) 3, 3L, (char) 4).collectWith((LongCharPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1L, (char) 2).equals(first)
                || PrimitiveTuples.pair(2L, (char) 3).equals(first)
                || PrimitiveTuples.pair(3L, (char) 4).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1L, (char) 2).equals(last)
                || PrimitiveTuples.pair(2L, (char) 3).equals(last)
                || PrimitiveTuples.pair(3L, (char) 4).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair(3L, (char) 4),
                PrimitiveTuples.pair(2L, (char) 3),
                PrimitiveTuples.pair(1L, (char) 2)),
                set);
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1L, (char) 2), 1), Tuples.pair(PrimitiveTuples.pair(2L, (char) 3), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2L, (char) 3), 1), Tuples.pair(PrimitiveTuples.pair(1L, (char) 2), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1L, (char) 2), 0), Tuples.pair(PrimitiveTuples.pair(2L, (char) 3), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2L, (char) 3), 0), Tuples.pair(PrimitiveTuples.pair(1L, (char) 2), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<LongCharPair> collection = this.newWith(1L, (char) 2, 2L, (char) 3, 3L, (char) 4);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair(1L, (char) 2)),
                FastList.newListWith(PrimitiveTuples.pair(2L, (char) 3)),
                FastList.newListWith(PrimitiveTuples.pair(3L, (char) 4))),

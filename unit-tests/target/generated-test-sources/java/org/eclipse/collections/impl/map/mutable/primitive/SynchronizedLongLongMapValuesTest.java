...
/**
 * JUnit test for {@link SynchronizedLongLongMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMapValuesTest.stg.
 */
public class SynchronizedLongLongMapValuesTest extends AbstractMutableLongCollectionTestCase
{
    @Override
    protected MutableLongCollection classUnderTest()
    {
        return new SynchronizedLongLongMap(LongLongHashMap.newWithKeysValues(1L, 1L, 2L, 2L, 3L, 3L)).values();
    }
    ...
    public void remove()
    {
        LongLongHashMap map = LongLongHashMap.newWithKeysValues(1L, 1L, 2L, 2L, 3L, 3L);

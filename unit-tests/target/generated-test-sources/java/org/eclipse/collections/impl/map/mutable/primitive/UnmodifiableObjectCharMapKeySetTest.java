...
/**
 * JUnit test for {@link UnmodifiableObjectCharMap#keySet()}.
 * This file was automatically generated from template file unmodifiableObjectPrimitiveMapKeySetTest.stg.
 */
public class UnmodifiableObjectCharMapKeySetTest
{
    private UnmodifiableObjectCharMap<String> newMapWithKeysValues(String key1, char value1, String key2, char value2, String key3, char value3)
    {
        return new UnmodifiableObjectCharMap<>(ObjectCharHashMap.newWithKeysValues(key1, value1, key2, value2, key3, value3));
    }

    private UnmodifiableObjectCharMap<String> newMapWithKeysValues(String key1, char value1, String key2, char value2, String key3, char value3, String key4, char value4)
    {
    ...
    {
        UnmodifiableObjectCharMap<String> map = this.newMapWithKeysValues("One", (char) 1, "Two", (char) 2, "Three", (char) 3, null, (char) 4);
    ...
    {
        UnmodifiableObjectCharMap<String> map = this.newMapWithKeysValues("One", (char) 1, "Two", (char) 2, "Three", (char) 3, null, (char) 0);
    ...
    {
        UnmodifiableObjectCharMap<String> map = this.newMapWithKeysValues("One", (char) 1, "Two", (char) 2, "Three", (char) 3);

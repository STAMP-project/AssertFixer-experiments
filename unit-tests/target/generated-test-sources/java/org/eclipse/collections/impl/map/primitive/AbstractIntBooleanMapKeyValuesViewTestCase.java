...
public abstract class AbstractIntBooleanMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith(1, false, 2, true, 3, false).collect((IntBooleanPair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Boolean> result2 =
            this.newWith(1, false, 2, true, 3, false).collect(IntBooleanPair::getTwo);
    ...
    public void collectBoolean()
    {
        BooleanIterable result =
            this.newWith(1, false, 2, true, 3, false).collectBoolean((IntBooleanPair each) -> (each.getOne() % 2) == 0);
    ...
    public void minBy()
    {
        Assert.assertEquals(PrimitiveTuples.pair(2, true),
            this.newWith(1, false, 2, true, 3, false).minBy((IntBooleanPair object) -> (int) object.getOne() & 1));
    }

    @Test
    public void maxBy()
    {
        Assert.assertEquals(PrimitiveTuples.pair(1, false),
            this.newWith(1, false, 2, true, 4, false).maxBy((IntBooleanPair object) ->  (int) object.getOne() & 1));
    }
    ...
    {
        Function0<IntBooleanPair> function = Functions0.value(PrimitiveTuples.pair(5, true));
        Assert.assertEquals(PrimitiveTuples.pair(2, true), this.newWith(1, false, 2, true, 3, false).detectWithIfNone(
                Object::equals,
                PrimitiveTuples.pair(2, true),
                function));
        Assert.assertEquals(PrimitiveTuples.pair(5, true), this.newWith(1, false, 2, true, 3, false).detectWithIfNone(
                Object::equals,
                PrimitiveTuples.pair(2, false),
                function));
    }
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith(1, false, 2, true, 3, false).collectIf(
                        IntBooleanPair.class::isInstance,
                        String::valueOf),
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith(1, false, 2, true, 3, false)
                    .collectWith((IntBooleanPair argument1, String argument2) -> argument1 + argument2, "-")
                    .toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                ...
                this.newWith(1, false, 2, true, 3, false)
                    .collectWith((IntBooleanPair argument1, String argument2) -> argument1 + argument2, "-", HashBag.<String>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1, false).equals(first)
                || PrimitiveTuples.pair(2, true).equals(first)
                || PrimitiveTuples.pair(3, false).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1, false).equals(last)
                || PrimitiveTuples.pair(2, true).equals(last)
                || PrimitiveTuples.pair(3, false).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair(3, false),
                PrimitiveTuples.pair(2, true),
                PrimitiveTuples.pair(1, false)),
                set);
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1, false), 1), Tuples.pair(PrimitiveTuples.pair(2, true), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2, true), 1), Tuples.pair(PrimitiveTuples.pair(1, false), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1, false), 0), Tuples.pair(PrimitiveTuples.pair(2, true), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2, true), 0), Tuples.pair(PrimitiveTuples.pair(1, false), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<IntBooleanPair> collection = this.newWith(1, false, 2, true, 3, false);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair(1, false)),
                FastList.newListWith(PrimitiveTuples.pair(2, true)),
                FastList.newListWith(PrimitiveTuples.pair(3, false))),

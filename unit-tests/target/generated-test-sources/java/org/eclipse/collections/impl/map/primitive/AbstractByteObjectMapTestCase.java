...
public abstract class AbstractByteObjectMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 0, (byte) 1, (byte) 9),
                this.newWithKeysValues((byte) 0, "zero", (byte) 1, "one", (byte) 9, "nine").keySet());
    }
    ...
    public void select()
    {
        ...
        Assert.assertEquals(ByteObjectHashMap.newWithKeysValues((byte) 1, "one", (byte) 9, "nine"),
            map1.select((byte value, String object) -> (value % 2) != 0));
        ...
        Assert.assertEquals(ByteObjectHashMap.newWithKeysValues((byte) 1, "one", (byte) 9, "nine"),
            map1.select((byte value, String object) -> object.endsWith("ne")));
    ...
    public void maxBy()
    {
        ...
        Verify.assertThrows(NoSuchElementException.class, () -> ByteObjectHashMap.<Class<?>>newMap().maxBy(classNameLength));
    }
    ...
    public void minBy()
    {
        ...
        Verify.assertThrows(NoSuchElementException.class, () -> ByteObjectHashMap.<Class<?>>newMap().minBy(classNameLength));
    }
    ...
    public void reject()
    {
        ...
        Assert.assertEquals(ByteObjectHashMap.newWithKeysValues((byte) 1, "one", (byte) 9, "nine"),
            map1.reject((byte value, String object) -> (value % 2) == 0));
        ...
        Assert.assertEquals(ByteObjectHashMap.newWithKeysValues((byte) 1, "one", (byte) 9, "nine"),
            map1.reject((byte value, String object) -> !object.endsWith("ne")));
    ...
    public void zip()
    {
        RichIterable<Pair<String, Integer>> zip1 = this.newWithKeysValues((byte) 0, "zero", (byte) 5, "five")
                .zip(FastList.newListWith(0, 5, 6));
        RichIterable<Pair<String, Integer>> zip2 = this.newWithKeysValues((byte) 1, "one", (byte) 5, "five")
                .zip(FastList.newListWith(1));
        RichIterable<Pair<String, Integer>> zip3 = this.newWithKeysValues((byte) 1, "one", (byte) 5, "five")
    ...
    public void chunk()
    {
        RichIterable<RichIterable<String>> chunk1 = this.newWithKeysValues((byte) 0, "zero", (byte) 5, "five")
                .chunk(1);
        RichIterable<RichIterable<String>> chunk2 = this.newWithKeysValues((byte) 1, "one", (byte) 5, "five")
                .chunk(1);
    ...
    {
        this.newWithKeysValues((byte) 0, "zero", (byte) 5, "five")
                .chunk(-1);
    }

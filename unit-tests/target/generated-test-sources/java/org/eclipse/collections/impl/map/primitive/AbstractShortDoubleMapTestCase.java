...
public abstract class AbstractShortDoubleMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(ShortHashSet.newSetWith((short) 0, (short) 31, (short) 32),
                this.newWithKeysValues((short) 0, 0.0, (short) 31, 31.0, (short) 32, 32.0).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((short) 0, 0.0, (short) 1, 1.0, (short) 32, 32.0).hashCode(),
                this.newWithKeysValues((short) 32, 32.0, (short) 0, 0.0, (short) 1, 1.0).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((short) 50, 0.0, (short) 60, 1.0, (short) 70, 33.0).hashCode(),
                this.newWithKeysValues((short) 50, 0.0, (short) 60, 1.0, (short) 70, 33.0).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((short) 2, 2.0, (short) 3, 3.0).toList().equals(DoubleArrayList.newListWith(2.0, 3.0))
                || this.newWithKeysValues((short) 2, 2.0, (short) 3, 3.0).toList().equals(DoubleArrayList.newListWith(3.0, 2.0)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((short) 1, 1.0).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((short) 1, 1.0).chunk(-1));
    }
}

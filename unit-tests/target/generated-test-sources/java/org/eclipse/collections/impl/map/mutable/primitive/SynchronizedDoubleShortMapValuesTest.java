...
/**
 * JUnit test for {@link SynchronizedDoubleShortMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMapValuesTest.stg.
 */
public class SynchronizedDoubleShortMapValuesTest extends AbstractMutableShortCollectionTestCase
{
    @Override
    protected MutableShortCollection classUnderTest()
    {
        return new SynchronizedDoubleShortMap(DoubleShortHashMap.newWithKeysValues(1.0, (short) 1, 2.0, (short) 2, 3.0, (short) 3)).values();
    }

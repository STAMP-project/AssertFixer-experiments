...
/**
 * JUnit test for {@link SynchronizedIntShortMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMapValuesTest.stg.
 */
public class SynchronizedIntShortMapValuesTest extends AbstractMutableShortCollectionTestCase
{
    @Override
    protected MutableShortCollection classUnderTest()
    {
        return new SynchronizedIntShortMap(IntShortHashMap.newWithKeysValues(1, (short) 1, 2, (short) 2, 3, (short) 3)).values();
    }

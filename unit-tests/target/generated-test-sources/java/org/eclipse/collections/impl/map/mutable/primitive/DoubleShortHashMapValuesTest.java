...
/**
 * JUnit test for {@link DoubleShortHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class DoubleShortHashMapValuesTest extends AbstractMutableShortCollectionTestCase
{
    @Override
    protected MutableShortCollection classUnderTest()
    {
        return DoubleShortHashMap.newWithKeysValues(1.0, (short) 1, 2.0, (short) 2, 3.0, (short) 3).values();
    }
    ...
    public void remove()
    {
        DoubleShortHashMap map = DoubleShortHashMap.newWithKeysValues(1.0, (short) 1, 2.0, (short) 2, 3.0, (short) 3);
    ...
    public void retainAll()
    {
        ...
        DoubleShortHashMap map = DoubleShortHashMap.newWithKeysValues(0.0, (short) 0, 1.0, (short) 1, 2.0, (short) 2, 3.0, (short) 3);
        MutableShortCollection collection = map.values();

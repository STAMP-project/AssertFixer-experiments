...
/**
 * JUnit test for {@link SynchronizedCharByteMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMapValuesTest.stg.
 */
public class SynchronizedCharByteMapValuesTest extends AbstractMutableByteCollectionTestCase
{
    @Override
    protected MutableByteCollection classUnderTest()
    {
        return new SynchronizedCharByteMap(CharByteHashMap.newWithKeysValues((char) 1, (byte) 1, (char) 2, (byte) 2, (char) 3, (byte) 3)).values();
    }

...
public abstract class AbstractFloatObjectMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(FloatHashSet.newSetWith(0.0f, 1.0f, 9.0f),
                this.newWithKeysValues(0.0f, "zero", 1.0f, "one", 9.0f, "nine").keySet());
    }
    ...
    public void select()
    {
        ...
        Assert.assertEquals(FloatObjectHashMap.newWithKeysValues(1.0f, "one", 9.0f, "nine"),
            map1.select((float value, String object) -> (value % 2) != 0));
        ...
        Assert.assertEquals(FloatObjectHashMap.newWithKeysValues(1.0f, "one", 9.0f, "nine"),
            map1.select((float value, String object) -> object.endsWith("ne")));
    ...
    public void maxBy()
    {
        ...
        Verify.assertThrows(NoSuchElementException.class, () -> FloatObjectHashMap.<Class<?>>newMap().maxBy(classNameLength));
    }
    ...
    public void minBy()
    {
        ...
        Verify.assertThrows(NoSuchElementException.class, () -> FloatObjectHashMap.<Class<?>>newMap().minBy(classNameLength));
    }
    ...
    public void reject()
    {
        ...
        Assert.assertEquals(FloatObjectHashMap.newWithKeysValues(1.0f, "one", 9.0f, "nine"),
            map1.reject((float value, String object) -> (value % 2) == 0));
        ...
        Assert.assertEquals(FloatObjectHashMap.newWithKeysValues(1.0f, "one", 9.0f, "nine"),
            map1.reject((float value, String object) -> !object.endsWith("ne")));
    ...
    public void zip()
    {
        RichIterable<Pair<String, Integer>> zip1 = this.newWithKeysValues(0.0f, "zero", 5.0f, "five")
                .zip(FastList.newListWith(0, 5, 6));
        RichIterable<Pair<String, Integer>> zip2 = this.newWithKeysValues(1.0f, "one", 5.0f, "five")
                .zip(FastList.newListWith(1));
        RichIterable<Pair<String, Integer>> zip3 = this.newWithKeysValues(1.0f, "one", 5.0f, "five")
    ...
    public void chunk()
    {
        RichIterable<RichIterable<String>> chunk1 = this.newWithKeysValues(0.0f, "zero", 5.0f, "five")
                .chunk(1);
        RichIterable<RichIterable<String>> chunk2 = this.newWithKeysValues(1.0f, "one", 5.0f, "five")
                .chunk(1);
    ...
    {
        this.newWithKeysValues(0.0f, "zero", 5.0f, "five")
                .chunk(-1);
    }

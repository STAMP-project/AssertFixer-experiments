...
/**
 * JUnit test for {@link ImmutableLongDoubleEmptyMap}.
 * This file was automatically generated from template file immutablePrimitivePrimitiveEmptyMapTest.stg.
 */
public class ImmutableLongDoubleEmptyMapTest extends AbstractImmutableLongDoubleMapTestCase
{
    @Override
    ...
    {
        Assert.assertEquals(5.0, this.map.getIfAbsent(0L, 5.0), 0.0);
    ...
    public void select()
    {
        Assert.assertEquals(this.classUnderTest(), this.classUnderTest().select((long value1, double value2) -> true));
    }
    ...
    public void reject()
    {
        Assert.assertEquals(this.classUnderTest(), this.classUnderTest().reject((long value1, double value2) -> false));
    }
    ...
    {
        ImmutableLongDoubleEmptyMap iterable = new ImmutableLongDoubleEmptyMap();

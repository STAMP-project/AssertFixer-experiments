 ...
 */
public abstract class AbstractIntByteMapTestCase
{
    protected final IntByteMap map = this.classUnderTest();

    protected abstract IntByteMap classUnderTest();

    protected abstract IntByteMap newWithKeysValues(int key1, byte value1);

    protected abstract IntByteMap newWithKeysValues(int key1, byte value1, int key2, byte value2);

    protected abstract IntByteMap newWithKeysValues(int key1, byte value1, int key2, byte value2, int key3, byte value3);

    protected abstract IntByteMap newWithKeysValues(int key1, byte value1, int key2, byte value2, int key3, byte value3, int key4, byte value4);

    protected abstract IntByteMap getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(IntHashSet.newSetWith(0), this.newWithKeysValues(0, (byte) 0).keySet());
        Assert.assertEquals(IntHashSet.newSetWith(0, 31, 32),
                this.newWithKeysValues(0, (byte) 0, 31, (byte) 31, 32, (byte) 32).keySet());
    }
    ...
    public void values()
    {
        ...
        IntByteMap map = this.newWithKeysValues(0, (byte) 0);
        Verify.assertSize(1, map.values());
        Assert.assertTrue(map.values().contains((byte) 0));

        IntByteMap map1 = this.newWithKeysValues(0, (byte) 0, 31, (byte) 31, 32, (byte) 32);
    ...
    public void testEquals()
    {
        ...
        IntByteMap map9 = this.newWithKeysValues(0, (byte) 0);
        ...
        Assert.assertEquals(map1, IntByteMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, IntByteMaps.immutable.ofAll(map1));
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0, (byte) 0, 1, (byte) 1, 32, (byte) 32).hashCode(),
                this.newWithKeysValues(32, (byte) 32, 0, (byte) 0, 1, (byte) 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50, (byte) 0, 60, (byte) 1, 70, (byte) 33).hashCode(),
                this.newWithKeysValues(50, (byte) 0, 60, (byte) 1, 70, (byte) 33).hashCode());
        Assert.assertEquals(UnifiedMap.newMap().hashCode(), this.getEmptyMap().hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(1, (byte) 2).hashCode(), this.newWithKeysValues(1, (byte) 2).hashCode());
    }
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{1=1}", this.newWithKeysValues(1, (byte) 1).toString());
        Assert.assertEquals("{5=5}", this.newWithKeysValues(5, (byte) 5).toString());

        IntByteMap map1 = this.newWithKeysValues(0, (byte) 0, 1, (byte) 1);
        Assert.assertTrue(
                map1.toString(),
                "{0=0, 1=1}".equals(map1.toString())
                        || "{1=1, 0=0}".equals(map1.toString()));

        IntByteMap map2 = this.newWithKeysValues(1, (byte) 1, 32, (byte) 32);
        Assert.assertTrue(
                map2.toString(),
                "{1=1, 32=32}".equals(map2.toString())
                        || "{32=32, 1=1}".equals(map2.toString()));

        IntByteMap map3 = this.newWithKeysValues(0, (byte) 0, 32, (byte) 32);
        Assert.assertTrue(
                map3.toString(),
                "{0=0, 32=32}".equals(map3.toString())
                        || "{32=32, 0=0}".equals(map3.toString()));

        IntByteMap map4 = this.newWithKeysValues(32, (byte) 32, 33, (byte) 33);
        Assert.assertTrue(
                map4.toString(),
    ...
    public void forEachKey()
    {
        ...
        IntByteMap map3 = this.newWithKeysValues(1, (byte) 1);
        int[] sum3 = new int[1];
    ...
    public void forEachKeyValue()
    {
        ...
        map0.forEachKeyValue((int eachKey, byte eachValue) ->
        {
            sumKey0[0] += eachKey;
        ...
        map1.forEachKeyValue((int eachKey, byte eachValue) ->
        {
            sumKey1[0] += eachKey;
        ...
        map01.forEachKeyValue((int eachKey, byte eachValue) ->
        {
            sumKey01[0] += eachKey;
        ...
        map.forEachKeyValue((int eachKey, byte eachValue) ->
        {
            sumKey[0] += eachKey;
        ...
        map2.forEachKeyValue((int eachKey, byte eachValue) ->
        {
            sumKey2[0] += eachKey;
        ...
        IntByteMap map3 = this.newWithKeysValues(3, (byte) 5);
        int[] sumKey3 = new int[1];
        byte[] sumValue3 = new byte[1];
        map3.forEachKeyValue((int eachKey, byte eachValue) ->
        {
            sumKey3[0] += eachKey;
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("5", this.newWithKeysValues(5, (byte) 5).makeString());
    ...
    public void appendString()
    {
        ...
        this.newWithKeysValues(0, (byte) 0).appendString(appendable01, "/");
        Assert.assertEquals("0", appendable01.toString());

        Appendable appendable02 = new StringBuilder();
        this.newWithKeysValues(0, (byte) 0).appendString(appendable02, "{", "/", "}");
        ...
        this.newWithKeysValues(5, (byte) 5).appendString(appendable2);
        ...
        IntByteMap map3 = this.newWithKeysValues(1, (byte) 1, 32, (byte) 32);
    ...
    public void select()
    {
        IntByteMap map = this.newWithKeysValues(0, (byte) 0, 1, (byte) 1, 2, (byte) 2, 3, (byte) 3);
        IntByteMap actual1 = map.select((int key, byte value) -> key == 1 || value == (byte) 3);
        Assert.assertEquals(IntByteHashMap.newWithKeysValues(1, (byte) 1, 3, (byte) 3), actual1);
        IntByteMap actual2 = map.select((int key, byte value) -> key == 0 || value == (byte) 2);
        Assert.assertEquals(IntByteHashMap.newWithKeysValues(0, (byte) 0, 2, (byte) 2), actual2);
    }
    ...
    {
        IntByteMap map = this.newWithKeysValues(0, (byte) 0, 1, (byte) 1, 2, (byte) 2, 3, (byte) 3);
        IntByteMap actual1 = map.reject((int key, byte value) -> key == 1 || value == (byte) 3);
        Assert.assertEquals(IntByteHashMap.newWithKeysValues(0, (byte) 0, 2, (byte) 2), actual1);
        IntByteMap actual2 = map.reject((int key, byte value)-> key == 0 || value == (byte) 2);
        Assert.assertEquals(IntByteHashMap.newWithKeysValues(1, (byte) 1, 3, (byte) 3), actual2);
    }
    ...
    public void collect()
    {
        ...
        Assert.assertEquals(Bags.immutable.with((byte) 2), this.newWithKeysValues(1, (byte) 1).collect(function));
    }
    ...
    public void detectIfNone_value()
    {
        ...
        Assert.assertEquals((byte) 5, this.newWithKeysValues(1, (byte) 1).detectIfNone(BytePredicates.equal((byte) 0), (byte) 5));
        Assert.assertEquals((byte) 1, this.newWithKeysValues(1, (byte) 1).detectIfNone(BytePredicates.equal((byte) 1), (byte) 5));
    ...
    public void anySatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1, (byte) 1).anySatisfy(BytePredicates.equal((byte) 0)));
        Assert.assertTrue(this.newWithKeysValues(1, (byte) 1).anySatisfy(BytePredicates.equal((byte) 1)));
    ...
    public void allSatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1, (byte) 1).allSatisfy(BytePredicates.equal((byte) 0)));
        Assert.assertTrue(this.newWithKeysValues(1, (byte) 1).allSatisfy(BytePredicates.equal((byte) 1)));
        ...
        IntByteMap map1 = this.newWithKeysValues(2, (byte) 2, 3, (byte) 3);
    ...
    public void noneSatisfy()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(1, (byte) 1).noneSatisfy(BytePredicates.equal((byte) 0)));
        Assert.assertFalse(this.newWithKeysValues(1, (byte) 1).noneSatisfy(BytePredicates.equal((byte) 1)));
    ...
    public void max()
    {
        ...
        Assert.assertEquals((byte) 3, this.newWithKeysValues(3, (byte) 3).max());
    }

    @Test
    public void min()
    {
        IntByteMap map = this.newWithKeysValues(1, (byte) 1, 2, (byte) 2, 3, (byte) 3, 0, (byte) 0);
        Assert.assertEquals((byte) 0, map.min());
        Assert.assertEquals((byte) 3, this.newWithKeysValues(3, (byte) 3).min());
    }
    ...
    public void minIfEmpty()
    {
        ...
        IntByteMap map = this.newWithKeysValues(1, (byte) 1, 0, (byte) 0, 9, (byte) 9, 7, (byte) 7);
        Assert.assertEquals(0L, map.minIfEmpty((byte) 5));
        Assert.assertEquals((byte) 3, this.newWithKeysValues(3, (byte) 3).maxIfEmpty((byte) 5));
    }
    ...
    public void maxIfEmpty()
    {
        ...
        Assert.assertEquals((byte) 3, this.newWithKeysValues(3, (byte) 3).minIfEmpty((byte) 5));
    }
    ...
    public void sum()
    {
        ...
        IntByteMap map2 = this.newWithKeysValues(2, (byte) 2, 3, (byte) 3, 4, (byte) 4);
        Assert.assertEquals((byte) 9, map2.sum());
        IntByteMap map3 = this.newWithKeysValues(2, (byte) 2);
    ...
    public void average()
    {
        ...
        IntByteMap map1 = this.newWithKeysValues(1, (byte) 1);
    ...
    public void median()
    {
        ...
        IntByteMap map2 = this.newWithKeysValues(0, (byte) 0, 1, (byte) 1, 2, (byte) 2);
    ...
    public void toList()
    {
        Assert.assertEquals(ByteArrayList.newListWith((byte) 0), this.newWithKeysValues(0, (byte) 0).toList());
        Assert.assertEquals(ByteArrayList.newListWith((byte) 1), this.newWithKeysValues(1, (byte) 1).toList());
        Assert.assertEquals(ByteArrayList.newListWith((byte) 2), this.newWithKeysValues(2, (byte) 2).toList());
        Assert.assertTrue(this.newWithKeysValues(2, (byte) 2, 3, (byte) 3).toList().equals(ByteArrayList.newListWith((byte) 2, (byte) 3))
                || this.newWithKeysValues(2, (byte) 2, 3, (byte) 3).toList().equals(ByteArrayList.newListWith((byte) 3, (byte) 2)));
    }
    ...
    public void toSortedList()
    {
        ...
        Assert.assertEquals(ByteArrayList.newListWith((byte) 1), this.newWithKeysValues(1, (byte) 1).toSortedList());
    }
    ...
    public void toSet()
    {
        ...
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 1), this.newWithKeysValues(1, (byte) 1).toSet());
    }
    ...
    public void toBag()
    {
        ...
        Assert.assertEquals(ByteHashBag.newBagWith((byte) 1), this.newWithKeysValues(1, (byte) 1).toBag());
    }
    ...
    {
        MutableBag<IntBytePair> expected = Bags.mutable.of();
        this.map.forEachKeyValue((int key, byte value) -> expected.add(PrimitiveTuples.pair(key, value)));
    ...
    public void toArray()
    {
        IntByteMap map = this.newWithKeysValues(1, (byte) 1, 2, (byte) 2);
        ...
        Assert.assertTrue(Arrays.equals(new byte[]{(byte) 1}, this.newWithKeysValues(1, (byte) 1).toArray()));
    }
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableIntByteMap.class, this.classUnderTest().toImmutable());
    }

    @Test
    public void chunk()
    {
        ByteIterable iterable = this.newWithKeysValues(1, (byte) 1, 2, (byte) 2, 3, (byte) 3);
        Assert.assertEquals(
                Lists.mutable.with(
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1, (byte) 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1, (byte) 1).chunk(-1));
    }
}

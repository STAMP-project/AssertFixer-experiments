...
/**
 * JUnit test for {@link ByteIntHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class ByteIntHashMapValuesTest extends AbstractMutableIntCollectionTestCase
{
    @Override
    protected MutableIntCollection classUnderTest()
    {
        return ByteIntHashMap.newWithKeysValues((byte) 1, 1, (byte) 2, 2, (byte) 3, 3).values();
    }
    ...
    public void retainAll()
    {
        ...
        ByteIntHashMap map = ByteIntHashMap.newWithKeysValues((byte) 0, 0, (byte) 1, 1, (byte) 2, 2, (byte) 3, 3);
        MutableIntCollection collection = map.values();

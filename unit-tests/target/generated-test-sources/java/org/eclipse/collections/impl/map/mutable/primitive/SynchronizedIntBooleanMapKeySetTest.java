    ...
    public void chunk()
    {
        ...
        Assert.assertTrue(
                Lists.mutable.with(
                        ...
                        IntSets.mutable.with(3)).toSet().equals(chunked)
                || Lists.mutable.with(
                        IntSets.mutable.with(2, 3),
                        IntSets.mutable.with(1)).toSet().equals(chunked)
                || Lists.mutable.with(
                        IntSets.mutable.with(1, 3),
                        IntSets.mutable.with(2)).toSet().equals(chunked));

        Assert.assertEquals(
                Lists.mutable.with(
                        IntSets.mutable.with(1, 2, 3)).toSet(),
                iterable.chunk(3).toSet());
        Assert.assertEquals(
                Lists.mutable.with(IntSets.mutable.with(1, 2, 3)).toSet(),

...
/**
 * JUnit test for {@link ShortLongHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class ShortLongHashMapValuesTest extends AbstractMutableLongCollectionTestCase
{
    @Override
    protected MutableLongCollection classUnderTest()
    {
        return ShortLongHashMap.newWithKeysValues((short) 1, 1L, (short) 2, 2L, (short) 3, 3L).values();
    }
    ...
    public void retainAll()
    {
        ...
        ShortLongHashMap map = ShortLongHashMap.newWithKeysValues((short) 0, 0L, (short) 1, 1L, (short) 2, 2L, (short) 3, 3L);
        MutableLongCollection collection = map.values();

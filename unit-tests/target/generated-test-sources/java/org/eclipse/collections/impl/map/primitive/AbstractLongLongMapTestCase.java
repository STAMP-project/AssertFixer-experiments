...
public abstract class AbstractLongLongMapTestCase
{
    ...
    public void chunk()
    {
        LongIterable iterable = this.newWithKeysValues(1L, 1L, 2L, 2L, 3L, 3L);
        Assert.assertEquals(
                Lists.mutable.with(
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1L, 1L).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1L, 1L).chunk(-1));
    }
}

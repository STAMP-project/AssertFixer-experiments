...
/**
 * JUnit test for {@link LongLongHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class LongLongHashMapValuesTest extends AbstractMutableLongCollectionTestCase
{
    @Override
    protected MutableLongCollection classUnderTest()
    {
        return LongLongHashMap.newWithKeysValues(1L, 1L, 2L, 2L, 3L, 3L).values();
    }
    ...
    public void retainAll()
    {
        ...
        LongLongHashMap map = LongLongHashMap.newWithKeysValues(0L, 0L, 1L, 1L, 2L, 2L, 3L, 3L);
        MutableLongCollection collection = map.values();

...
public abstract class ObjectDoubleHashMapKeySetTestCase
{
    ...
    {
        MutableObjectDoubleMap<String> map = this.newMapWithKeysValues("One", 1.0, "Two", 2.0, "Three", 3.0, null, 4.0);
    ...
    public void isEmpty()
    {
        ...
        MutableObjectDoubleMap<String> map1 = this.newEmptyMap();
    ...
    {
        MutableObjectDoubleMap<String> map1 = this.newMapWithKeysValues("One", 1.0, "Two", 2.0, "Three", 3.0, null, 4.0);
        ...
        MutableObjectDoubleMap<String> map3 = this.newEmptyMap();
    ...
    {
        MutableObjectDoubleMap<String> map = this.newMapWithKeysValues("One", 1.0, "Two", 2.0, "Three", 3.0);
        Assert.assertFalse(map.keySet().remove("Four"));

        Assert.assertTrue(map.keySet().remove("Two"));
        Assert.assertEquals(this.newMapWithKeysValues("One", 1.0,  "Three", 3.0), map);
    ...
    public void removeNullFromKeySet()
    {
        ...
        Assert.assertEquals(this.newMapWithKeysValues("One", 1.0, "Two", 2.0, "Three", 3.0), map);
    ...
    {
        MutableObjectDoubleMap<String> map = this.newMapWithKeysValues("One", 1.0, "Two", 2.0, "Three", 3.0, null, 0.0);

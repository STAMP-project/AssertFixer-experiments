...
/**
 * JUnit test for {@link SynchronizedShortIntMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMapValuesTest.stg.
 */
public class SynchronizedShortIntMapValuesTest extends AbstractMutableIntCollectionTestCase
{
    @Override
    protected MutableIntCollection classUnderTest()
    {
        return new SynchronizedShortIntMap(ShortIntHashMap.newWithKeysValues((short) 1, 1, (short) 2, 2, (short) 3, 3)).values();
    }

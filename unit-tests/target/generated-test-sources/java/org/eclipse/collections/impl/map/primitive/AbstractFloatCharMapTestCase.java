...
public abstract class AbstractFloatCharMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(FloatHashSet.newSetWith(0.0f, 31.0f, 32.0f),
                this.newWithKeysValues(0.0f, (char) 0, 31.0f, (char) 31, 32.0f, (char) 32).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0.0f, (char) 0, 1.0f, (char) 1, 32.0f, (char) 32).hashCode(),
                this.newWithKeysValues(32.0f, (char) 32, 0.0f, (char) 0, 1.0f, (char) 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50.0f, (char) 0, 60.0f, (char) 1, 70.0f, (char) 33).hashCode(),
                this.newWithKeysValues(50.0f, (char) 0, 60.0f, (char) 1, 70.0f, (char) 33).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(2.0f, (char) 2, 3.0f, (char) 3).toList().equals(CharArrayList.newListWith((char) 2, (char) 3))
                || this.newWithKeysValues(2.0f, (char) 2, 3.0f, (char) 3).toList().equals(CharArrayList.newListWith((char) 3, (char) 2)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1.0f, (char) 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1.0f, (char) 1).chunk(-1));
    }
}

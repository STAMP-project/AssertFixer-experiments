...
/**
 * JUnit test for {@link UnmodifiableObjectShortMap#values()}.
 * This file was automatically generated from template file unmodifiableObjectPrimitiveMapValuesTest.stg.
 */
public class UnmodifiableObjectShortMapValuesTest extends AbstractMutableShortCollectionTestCase
{
    @Override
    protected MutableShortCollection classUnderTest()
    {
        return new UnmodifiableObjectShortMap<>(ObjectShortHashMap.newWithKeysValues(1, (short) 1, 2, (short) 2, 3, (short) 3)).values();
    }
    ...
    {
        this.newWith().removeIf(ShortPredicates.equal((short) 3));
    }

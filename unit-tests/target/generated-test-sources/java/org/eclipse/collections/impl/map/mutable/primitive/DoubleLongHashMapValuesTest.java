...
/**
 * JUnit test for {@link DoubleLongHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class DoubleLongHashMapValuesTest extends AbstractMutableLongCollectionTestCase
{
    @Override
    protected MutableLongCollection classUnderTest()
    {
        return DoubleLongHashMap.newWithKeysValues(1.0, 1L, 2.0, 2L, 3.0, 3L).values();
    }
    ...
    public void retainAll()
    {
        ...
        DoubleLongHashMap map = DoubleLongHashMap.newWithKeysValues(0.0, 0L, 1.0, 1L, 2.0, 2L, 3.0, 3L);
        MutableLongCollection collection = map.values();

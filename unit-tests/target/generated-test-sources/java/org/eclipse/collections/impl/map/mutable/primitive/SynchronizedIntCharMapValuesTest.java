...
/**
 * JUnit test for {@link SynchronizedIntCharMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMapValuesTest.stg.
 */
public class SynchronizedIntCharMapValuesTest extends AbstractMutableCharCollectionTestCase
{
    @Override
    protected MutableCharCollection classUnderTest()
    {
        return new SynchronizedIntCharMap(IntCharHashMap.newWithKeysValues(1, (char) 1, 2, (char) 2, 3, (char) 3)).values();
    }

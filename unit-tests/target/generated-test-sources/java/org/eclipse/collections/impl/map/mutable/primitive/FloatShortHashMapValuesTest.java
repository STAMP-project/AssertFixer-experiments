...
/**
 * JUnit test for {@link FloatShortHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class FloatShortHashMapValuesTest extends AbstractMutableShortCollectionTestCase
{
    @Override
    protected MutableShortCollection classUnderTest()
    {
        return FloatShortHashMap.newWithKeysValues(1.0f, (short) 1, 2.0f, (short) 2, 3.0f, (short) 3).values();
    }
    ...
    public void retainAll()
    {
        ...
        FloatShortHashMap map = FloatShortHashMap.newWithKeysValues(0.0f, (short) 0, 1.0f, (short) 1, 2.0f, (short) 2, 3.0f, (short) 3);
        MutableShortCollection collection = map.values();

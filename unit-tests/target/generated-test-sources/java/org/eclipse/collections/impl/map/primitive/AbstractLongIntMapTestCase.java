...
public abstract class AbstractLongIntMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(LongHashSet.newSetWith(0L, 31L, 32L),
                this.newWithKeysValues(0L, 0, 31L, 31, 32L, 32).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0L, 0, 1L, 1, 32L, 32).hashCode(),
                this.newWithKeysValues(32L, 32, 0L, 0, 1L, 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50L, 0, 60L, 1, 70L, 33).hashCode(),
                this.newWithKeysValues(50L, 0, 60L, 1, 70L, 33).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(2L, 2, 3L, 3).toList().equals(IntArrayList.newListWith(2, 3))
                || this.newWithKeysValues(2L, 2, 3L, 3).toList().equals(IntArrayList.newListWith(3, 2)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1L, 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1L, 1).chunk(-1));
    }
}

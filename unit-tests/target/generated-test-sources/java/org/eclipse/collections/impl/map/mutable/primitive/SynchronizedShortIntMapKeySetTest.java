...
/**
 * JUnit test for {@link SynchronizedShortIntMap#keySet()}.
 *
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMapKeySetTest.stg.
 */
public class SynchronizedShortIntMapKeySetTest extends AbstractShortSetTestCase
{
    @Override
    protected MutableShortSet classUnderTest()
    {
        return new SynchronizedShortIntMap(ShortIntHashMap.newWithKeysValues((short) 1, 1, (short) 2, 2, (short) 3, 3)).keySet();
    }

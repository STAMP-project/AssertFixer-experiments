...
/**
 * JUnit test for {@link IntBooleanHashMap#values()}.
 * This file was automatically generated from template file primitiveBooleanHashMapValuesTest.stg.
 */
public class IntBooleanHashMapValuesTest extends AbstractMutableBooleanCollectionTestCase
{
    @Override
    protected MutableBooleanCollection classUnderTest()
    {
        return IntBooleanHashMap.newWithKeysValues(1, true, 2, false, 3, true).values();
    }
    ...
    public void removeAll()
    {
        ...
        IntBooleanHashMap map = IntBooleanHashMap.newWithKeysValues(1, true, 2, false);
        MutableBooleanCollection collection = map.values();
        ...
        IntBooleanHashMap map1 = IntBooleanHashMap.newWithKeysValues(1, true, 2, false);
    ...
    public void retainAll()
    {
        ...
        IntBooleanHashMap sentinelMap = IntBooleanHashMap.newWithKeysValues(1, true, 0, false);

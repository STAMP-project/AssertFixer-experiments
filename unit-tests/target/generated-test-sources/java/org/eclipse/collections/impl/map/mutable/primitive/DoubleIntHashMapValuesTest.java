...
/**
 * JUnit test for {@link DoubleIntHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class DoubleIntHashMapValuesTest extends AbstractMutableIntCollectionTestCase
{
    @Override
    protected MutableIntCollection classUnderTest()
    {
        return DoubleIntHashMap.newWithKeysValues(1.0, 1, 2.0, 2, 3.0, 3).values();
    }
    ...
    public void retainAll()
    {
        ...
        DoubleIntHashMap map = DoubleIntHashMap.newWithKeysValues(0.0, 0, 1.0, 1, 2.0, 2, 3.0, 3);
        MutableIntCollection collection = map.values();

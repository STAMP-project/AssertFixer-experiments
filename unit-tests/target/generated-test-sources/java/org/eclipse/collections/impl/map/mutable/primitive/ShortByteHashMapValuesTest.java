...
/**
 * JUnit test for {@link ShortByteHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class ShortByteHashMapValuesTest extends AbstractMutableByteCollectionTestCase
{
    @Override
    protected MutableByteCollection classUnderTest()
    {
        return ShortByteHashMap.newWithKeysValues((short) 1, (byte) 1, (short) 2, (byte) 2, (short) 3, (byte) 3).values();
    }
    ...
    public void retainAll()
    {
        ...
        ShortByteHashMap map = ShortByteHashMap.newWithKeysValues((short) 0, (byte) 0, (short) 1, (byte) 1, (short) 2, (byte) 2, (short) 3, (byte) 3);
        MutableByteCollection collection = map.values();

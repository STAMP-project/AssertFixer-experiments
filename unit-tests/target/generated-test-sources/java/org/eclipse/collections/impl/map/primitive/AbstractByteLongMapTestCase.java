...
public abstract class AbstractByteLongMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 0, (byte) 31, (byte) 32),
                this.newWithKeysValues((byte) 0, 0L, (byte) 31, 31L, (byte) 32, 32L).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 0, 0L, (byte) 1, 1L, (byte) 32, 32L).hashCode(),
                this.newWithKeysValues((byte) 32, 32L, (byte) 0, 0L, (byte) 1, 1L).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 50, 0L, (byte) 60, 1L, (byte) 70, 33L).hashCode(),
                this.newWithKeysValues((byte) 50, 0L, (byte) 60, 1L, (byte) 70, 33L).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((byte) 2, 2L, (byte) 3, 3L).toList().equals(LongArrayList.newListWith(2L, 3L))
                || this.newWithKeysValues((byte) 2, 2L, (byte) 3, 3L).toList().equals(LongArrayList.newListWith(3L, 2L)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 1, 1L).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((byte) 1, 1L).chunk(-1));
    }
}

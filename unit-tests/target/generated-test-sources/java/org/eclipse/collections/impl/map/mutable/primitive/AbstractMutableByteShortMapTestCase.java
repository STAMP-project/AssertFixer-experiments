...
public abstract class AbstractMutableByteShortMapTestCase extends AbstractByteShortMapTestCase
{
    ...
    public void getIfAbsentPutWithKey()
    {
        ...
        ByteToShortFunction functionThrows = (byte byteParameter) -> { throw new AssertionError(); };
    ...
    public void flipUniqueValues()
    {
        ...
        Assert.assertEquals(
                ShortByteHashMap.newWithKeysValues((short) 2, (byte) 1, (short) 3, (byte) 2, (short) 4, (byte) 3, (short) 5, (byte) 4),
                map.flipUniqueValues());
         Verify.assertThrows(
                IllegalStateException.class,
                () -> this.newWithKeysValues((byte) 1, (short) 1, (byte) 2, (short) 1).flipUniqueValues());
    }
}

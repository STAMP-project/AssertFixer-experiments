...
/**
 * JUnit test for {@link ImmutableDoubleLongEmptyMap}.
 * This file was automatically generated from template file immutablePrimitivePrimitiveEmptyMapTest.stg.
 */
public class ImmutableDoubleLongEmptyMapTest extends AbstractImmutableDoubleLongMapTestCase
{
    @Override
    ...
    {
        Assert.assertEquals(5L, this.map.getIfAbsent(0.0, 5L));
    ...
    public void select()
    {
        Assert.assertEquals(this.classUnderTest(), this.classUnderTest().select((double value1, long value2) -> true));
    }
    ...
    public void reject()
    {
        Assert.assertEquals(this.classUnderTest(), this.classUnderTest().reject((double value1, long value2) -> false));
    }
    ...
    {
        ImmutableDoubleLongEmptyMap iterable = new ImmutableDoubleLongEmptyMap();

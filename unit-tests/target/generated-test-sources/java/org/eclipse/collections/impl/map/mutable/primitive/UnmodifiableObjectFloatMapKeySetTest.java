...
/**
 * JUnit test for {@link UnmodifiableObjectFloatMap#keySet()}.
 * This file was automatically generated from template file unmodifiableObjectPrimitiveMapKeySetTest.stg.
 */
public class UnmodifiableObjectFloatMapKeySetTest
{
    private UnmodifiableObjectFloatMap<String> newMapWithKeysValues(String key1, float value1, String key2, float value2, String key3, float value3)
    {
        return new UnmodifiableObjectFloatMap<>(ObjectFloatHashMap.newWithKeysValues(key1, value1, key2, value2, key3, value3));
    }

    private UnmodifiableObjectFloatMap<String> newMapWithKeysValues(String key1, float value1, String key2, float value2, String key3, float value3, String key4, float value4)
    {
    ...
    {
        UnmodifiableObjectFloatMap<String> map = this.newMapWithKeysValues("One", 1.0f, "Two", 2.0f, "Three", 3.0f, null, 4.0f);
    ...
    {
        UnmodifiableObjectFloatMap<String> map = this.newMapWithKeysValues("One", 1.0f, "Two", 2.0f, "Three", 3.0f, null, 0.0f);
    ...
    {
        UnmodifiableObjectFloatMap<String> map = this.newMapWithKeysValues("One", 1.0f, "Two", 2.0f, "Three", 3.0f);

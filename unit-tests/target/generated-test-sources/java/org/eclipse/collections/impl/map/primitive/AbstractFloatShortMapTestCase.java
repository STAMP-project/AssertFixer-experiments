...
public abstract class AbstractFloatShortMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(FloatHashSet.newSetWith(0.0f, 31.0f, 32.0f),
                this.newWithKeysValues(0.0f, (short) 0, 31.0f, (short) 31, 32.0f, (short) 32).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0.0f, (short) 0, 1.0f, (short) 1, 32.0f, (short) 32).hashCode(),
                this.newWithKeysValues(32.0f, (short) 32, 0.0f, (short) 0, 1.0f, (short) 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50.0f, (short) 0, 60.0f, (short) 1, 70.0f, (short) 33).hashCode(),
                this.newWithKeysValues(50.0f, (short) 0, 60.0f, (short) 1, 70.0f, (short) 33).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(2.0f, (short) 2, 3.0f, (short) 3).toList().equals(ShortArrayList.newListWith((short) 2, (short) 3))
                || this.newWithKeysValues(2.0f, (short) 2, 3.0f, (short) 3).toList().equals(ShortArrayList.newListWith((short) 3, (short) 2)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1.0f, (short) 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1.0f, (short) 1).chunk(-1));
    }
}

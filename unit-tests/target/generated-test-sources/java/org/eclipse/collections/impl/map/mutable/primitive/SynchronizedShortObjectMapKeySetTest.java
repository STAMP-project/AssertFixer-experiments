...
/**
 * JUnit test for {@link SynchronizedShortObjectMap#keySet()}.
 *
 * This file was automatically generated from template file synchronizedPrimitiveObjectMapKeySetTest.stg.
 */
public class SynchronizedShortObjectMapKeySetTest extends AbstractShortSetTestCase
{
    @Override
    protected MutableShortSet classUnderTest()
    {
        return new SynchronizedShortObjectMap<>(ShortObjectHashMap.newWithKeysValues((short) 1, 1, (short) 2, 2, (short) 3, 3)).keySet();
    }

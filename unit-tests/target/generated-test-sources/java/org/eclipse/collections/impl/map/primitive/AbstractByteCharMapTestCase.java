 ...
 */
public abstract class AbstractByteCharMapTestCase
{
    protected final ByteCharMap map = this.classUnderTest();

    protected abstract ByteCharMap classUnderTest();

    protected abstract ByteCharMap newWithKeysValues(byte key1, char value1);

    protected abstract ByteCharMap newWithKeysValues(byte key1, char value1, byte key2, char value2);

    protected abstract ByteCharMap newWithKeysValues(byte key1, char value1, byte key2, char value2, byte key3, char value3);

    protected abstract ByteCharMap newWithKeysValues(byte key1, char value1, byte key2, char value2, byte key3, char value3, byte key4, char value4);

    protected abstract ByteCharMap getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 0), this.newWithKeysValues((byte) 0, (char) 0).keySet());
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 0, (byte) 31, (byte) 32),
                this.newWithKeysValues((byte) 0, (char) 0, (byte) 31, (char) 31, (byte) 32, (char) 32).keySet());
    }
    ...
    public void values()
    {
        ...
        ByteCharMap map = this.newWithKeysValues((byte) 0, (char) 0);
        Verify.assertSize(1, map.values());
        Assert.assertTrue(map.values().contains((char) 0));

        ByteCharMap map1 = this.newWithKeysValues((byte) 0, (char) 0, (byte) 31, (char) 31, (byte) 32, (char) 32);
    ...
    public void isEmpty()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((byte) 1, (char) 1).isEmpty());
        Assert.assertFalse(this.newWithKeysValues((byte) 0, (char) 0).isEmpty());
        Assert.assertFalse(this.newWithKeysValues((byte) 50, (char) 50).isEmpty());
    }
    ...
    public void notEmpty()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((byte) 1, (char) 1).notEmpty());
        Assert.assertTrue(this.newWithKeysValues((byte) 0, (char) 0).notEmpty());
        Assert.assertTrue(this.newWithKeysValues((byte) 50, (char) 50).notEmpty());
    }
    ...
    public void testEquals()
    {
        ...
        ByteCharMap map9 = this.newWithKeysValues((byte) 0, (char) 0);
        ...
        Assert.assertEquals(map1, ByteCharMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, ByteCharMaps.immutable.ofAll(map1));
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 0, (char) 0, (byte) 1, (char) 1, (byte) 32, (char) 32).hashCode(),
                this.newWithKeysValues((byte) 32, (char) 32, (byte) 0, (char) 0, (byte) 1, (char) 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 50, (char) 0, (byte) 60, (char) 1, (byte) 70, (char) 33).hashCode(),
                this.newWithKeysValues((byte) 50, (char) 0, (byte) 60, (char) 1, (byte) 70, (char) 33).hashCode());
        Assert.assertEquals(UnifiedMap.newMap().hashCode(), this.getEmptyMap().hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues((byte) 1, (char) 2).hashCode(), this.newWithKeysValues((byte) 1, (char) 2).hashCode());
    }
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{0=\u0000}", this.newWithKeysValues((byte) 0, (char) 0).toString());
        Assert.assertEquals("{1=\u0001}", this.newWithKeysValues((byte) 1, (char) 1).toString());
        Assert.assertEquals("{5=\u0005}", this.newWithKeysValues((byte) 5, (char) 5).toString());

        ByteCharMap map1 = this.newWithKeysValues((byte) 0, (char) 0, (byte) 1, (char) 1);
        Assert.assertTrue(
                map1.toString(),
                "{0=\u0000, 1=\u0001}".equals(map1.toString())
                        || "{1=\u0001, 0=\u0000}".equals(map1.toString()));

        ByteCharMap map2 = this.newWithKeysValues((byte) 1, (char) 1, (byte) 32, (char) 32);
        Assert.assertTrue(
                map2.toString(),
                "{1=\u0001, 32=\u0020}".equals(map2.toString())
                        || "{32=\u0020, 1=\u0001}".equals(map2.toString()));

        ByteCharMap map3 = this.newWithKeysValues((byte) 0, (char) 0, (byte) 32, (char) 32);
        Assert.assertTrue(
                map3.toString(),
                "{0=\u0000, 32=\u0020}".equals(map3.toString())
                        || "{32=\u0020, 0=\u0000}".equals(map3.toString()));

        ByteCharMap map4 = this.newWithKeysValues((byte) 32, (char) 32, (byte) 33, (char) 33);
        Assert.assertTrue(
                map4.toString(),
    ...
    public void forEach()
    {
        ByteCharMap map0 = this.newWithKeysValues((byte) 0, (char) 1, (byte) 3, (char) 4);
        char[] sum0 = new char[1];
        map0.forEach(each -> sum0[0] += each);
        Assert.assertEquals(5L, sum0[0]);

        ByteCharMap map1 = this.newWithKeysValues((byte) 1, (char) 2, (byte) 3, (char) 4);
        char[] sum1 = new char[1];
        map1.forEach(each -> sum1[0] += each);
        Assert.assertEquals(6L, sum1[0]);

        ByteCharMap map01 = this.newWithKeysValues((byte) 0, (char) 1, (byte) 1, (char) 2);
        char[] sum01 = new char[1];
        map01.forEach(each -> sum01[0] += each);
        Assert.assertEquals(3L, sum01[0]);

        ByteCharMap map = this.newWithKeysValues((byte) 3, (char) 4, (byte) 4, (char) 5);
        char[] sum = new char[1];
        map.forEach(each -> sum[0] += each);
        Assert.assertEquals(9L, sum[0]);

        ByteCharMap map2 = this.getEmptyMap();
        char[] sum2 = new char[1];
        map2.forEach(each -> sum2[0] += each);
        Assert.assertEquals(0L, sum2[0]);

        ByteCharMap map3 = this.newWithKeysValues((byte) 1, (char) 2);
    ...
    public void forEachKey()
    {
        ...
        ByteCharMap map3 = this.newWithKeysValues((byte) 1, (char) 1);
    ...
    public void forEachKeyValue()
    {
        ...
        map0.forEachKeyValue((byte eachKey, char eachValue) ->
        {
            sumKey0[0] += eachKey;
        ...
        map1.forEachKeyValue((byte eachKey, char eachValue) ->
        {
            sumKey1[0] += eachKey;
        ...
        map01.forEachKeyValue((byte eachKey, char eachValue) ->
        {
            sumKey01[0] += eachKey;
        ...
        map.forEachKeyValue((byte eachKey, char eachValue) ->
        {
            sumKey[0] += eachKey;
        ...
        map2.forEachKeyValue((byte eachKey, char eachValue) ->
        {
            sumKey2[0] += eachKey;
        ...
        ByteCharMap map3 = this.newWithKeysValues((byte) 3, (char) 5);
        byte[] sumKey3 = new byte[1];
        char[] sumValue3 = new char[1];
        map3.forEachKeyValue((byte eachKey, char eachValue) ->
        {
            sumKey3[0] += eachKey;
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("", this.getEmptyMap().makeString(", "));
        Assert.assertEquals("[]", this.getEmptyMap().makeString("[", "/", "]"));
        Assert.assertEquals("\u0000", this.newWithKeysValues((byte) 0, (char) 0).makeString());
        Assert.assertEquals("\u0000", this.newWithKeysValues((byte) 0, (char) 0).makeString(", "));
        Assert.assertEquals("[\u0000]", this.newWithKeysValues((byte) 0, (char) 0).makeString("[", "/", "]"));
        Assert.assertEquals("\u0001", this.newWithKeysValues((byte) 1, (char) 1).makeString());
        Assert.assertEquals("\u0005", this.newWithKeysValues((byte) 5, (char) 5).makeString());
    ...
    public void appendString()
    {
        ...
        this.newWithKeysValues((byte) 0, (char) 0).appendString(appendable0);
        Assert.assertEquals("\u0000", appendable0.toString());

        Appendable appendable01 = new StringBuilder();
        this.newWithKeysValues((byte) 0, (char) 0).appendString(appendable01, "/");
        Assert.assertEquals("\u0000", appendable01.toString());

        Appendable appendable02 = new StringBuilder();
        this.newWithKeysValues((byte) 0, (char) 0).appendString(appendable02, "{", "/", "}");
        Assert.assertEquals("{\u0000}", appendable02.toString());

        Appendable appendable1 = new StringBuilder();
        this.newWithKeysValues((byte) 1, (char) 1).appendString(appendable1);
        Assert.assertEquals("\u0001", appendable1.toString());

        Appendable appendable2 = new StringBuilder();
        this.newWithKeysValues((byte) 5, (char) 5).appendString(appendable2);
        ...
        ByteCharMap map3 = this.newWithKeysValues((byte) 1, (char) 1, (byte) 32, (char) 32);
    ...
    public void select()
    {
        ByteCharMap map = this.newWithKeysValues((byte) 0, (char) 0, (byte) 1, (char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3);
        ByteCharMap actual1 = map.select((byte key, char value) -> key == (byte) 1 || value == (char) 3);
        Assert.assertEquals(ByteCharHashMap.newWithKeysValues((byte) 1, (char) 1, (byte) 3, (char) 3), actual1);
        ByteCharMap actual2 = map.select((byte key, char value) -> key == (byte) 0 || value == (char) 2);
        Assert.assertEquals(ByteCharHashMap.newWithKeysValues((byte) 0, (char) 0, (byte) 2, (char) 2), actual2);
    }
    ...
    {
        ByteCharMap map = this.newWithKeysValues((byte) 0, (char) 0, (byte) 1, (char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3);
        ByteCharMap actual1 = map.reject((byte key, char value) -> key == (byte) 1 || value == (char) 3);
        Assert.assertEquals(ByteCharHashMap.newWithKeysValues((byte) 0, (char) 0, (byte) 2, (char) 2), actual1);
        ByteCharMap actual2 = map.reject((byte key, char value)-> key == (byte) 0 || value == (char) 2);
        Assert.assertEquals(ByteCharHashMap.newWithKeysValues((byte) 1, (char) 1, (byte) 3, (char) 3), actual2);
    }
    ...
    public void collect()
    {
        ...
        Assert.assertEquals(Bags.immutable.with((char) 2), this.newWithKeysValues((byte) 1, (char) 1).collect(function));
    }
    ...
    public void detectIfNone_value()
    {
        ...
        Assert.assertEquals((char) 5, this.newWithKeysValues((byte) 1, (char) 1).detectIfNone(CharPredicates.equal((char) 0), (char) 5));
        Assert.assertEquals((char) 1, this.newWithKeysValues((byte) 1, (char) 1).detectIfNone(CharPredicates.equal((char) 1), (char) 5));
    ...
    public void anySatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((byte) 1, (char) 1).anySatisfy(CharPredicates.equal((char) 0)));
        Assert.assertTrue(this.newWithKeysValues((byte) 1, (char) 1).anySatisfy(CharPredicates.equal((char) 1)));
    ...
    public void allSatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((byte) 1, (char) 1).allSatisfy(CharPredicates.equal((char) 0)));
        Assert.assertTrue(this.newWithKeysValues((byte) 1, (char) 1).allSatisfy(CharPredicates.equal((char) 1)));
        ...
        ByteCharMap map1 = this.newWithKeysValues((byte) 2, (char) 2, (byte) 3, (char) 3);
    ...
    public void noneSatisfy()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((byte) 1, (char) 1).noneSatisfy(CharPredicates.equal((char) 0)));
        Assert.assertFalse(this.newWithKeysValues((byte) 1, (char) 1).noneSatisfy(CharPredicates.equal((char) 1)));
    ...
    public void max()
    {
        ...
        Assert.assertEquals((char) 3, this.newWithKeysValues((byte) 3, (char) 3).max());
    }

    @Test
    public void min()
    {
        ByteCharMap map = this.newWithKeysValues((byte) 1, (char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3, (byte) 0, (char) 0);
        Assert.assertEquals((char) 0, map.min());
        Assert.assertEquals((char) 3, this.newWithKeysValues((byte) 3, (char) 3).min());
    }
    ...
    public void minIfEmpty()
    {
        ...
        ByteCharMap map = this.newWithKeysValues((byte) 1, (char) 1, (byte) 0, (char) 0, (byte) 9, (char) 9, (byte) 7, (char) 7);
        Assert.assertEquals(0L, map.minIfEmpty((char) 5));
        Assert.assertEquals((char) 3, this.newWithKeysValues((byte) 3, (char) 3).maxIfEmpty((char) 5));
    }
    ...
    public void maxIfEmpty()
    {
        ...
        Assert.assertEquals((char) 3, this.newWithKeysValues((byte) 3, (char) 3).minIfEmpty((char) 5));
    }
    ...
    public void sum()
    {
        ...
        ByteCharMap map2 = this.newWithKeysValues((byte) 2, (char) 2, (byte) 3, (char) 3, (byte) 4, (char) 4);
        Assert.assertEquals((char) 9, map2.sum());
        ByteCharMap map3 = this.newWithKeysValues((byte) 2, (char) 2);
    ...
    public void average()
    {
        ...
        ByteCharMap map1 = this.newWithKeysValues((byte) 1, (char) 1);
    ...
    public void median()
    {
        ...
        ByteCharMap map2 = this.newWithKeysValues((byte) 0, (char) 0, (byte) 1, (char) 1, (byte) 2, (char) 2);
    ...
    public void toList()
    {
        Assert.assertEquals(CharArrayList.newListWith((char) 0), this.newWithKeysValues((byte) 0, (char) 0).toList());
        Assert.assertEquals(CharArrayList.newListWith((char) 1), this.newWithKeysValues((byte) 1, (char) 1).toList());
        Assert.assertEquals(CharArrayList.newListWith((char) 2), this.newWithKeysValues((byte) 2, (char) 2).toList());
        Assert.assertTrue(this.newWithKeysValues((byte) 2, (char) 2, (byte) 3, (char) 3).toList().equals(CharArrayList.newListWith((char) 2, (char) 3))
                || this.newWithKeysValues((byte) 2, (char) 2, (byte) 3, (char) 3).toList().equals(CharArrayList.newListWith((char) 3, (char) 2)));
    }
    ...
    public void toSortedList()
    {
        ...
        Assert.assertEquals(CharArrayList.newListWith((char) 1), this.newWithKeysValues((byte) 1, (char) 1).toSortedList());
    }
    ...
    public void toSet()
    {
        ...
        Assert.assertEquals(CharHashSet.newSetWith((char) 1), this.newWithKeysValues((byte) 1, (char) 1).toSet());
    }
    ...
    public void toBag()
    {
        ...
        Assert.assertEquals(CharHashBag.newBagWith((char) 1), this.newWithKeysValues((byte) 1, (char) 1).toBag());
    }
    ...
    {
        MutableBag<ByteCharPair> expected = Bags.mutable.of();
        this.map.forEachKeyValue((byte key, char value) -> expected.add(PrimitiveTuples.pair(key, value)));
    ...
    public void toArray()
    {
        ByteCharMap map = this.newWithKeysValues((byte) 1, (char) 1, (byte) 2, (char) 2);
        ...
        Assert.assertTrue(Arrays.equals(new char[]{(char) 1}, this.newWithKeysValues((byte) 1, (char) 1).toArray()));
    }
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableByteCharMap.class, this.classUnderTest().toImmutable());
    }

    @Test
    public void chunk()
    {
        CharIterable iterable = this.newWithKeysValues((byte) 1, (char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3);
        Assert.assertEquals(
                Lists.mutable.with(
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 1, (char) 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((byte) 1, (char) 1).chunk(-1));
    }
}

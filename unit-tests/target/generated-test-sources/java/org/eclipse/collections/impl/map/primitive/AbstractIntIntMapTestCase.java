 ...
 */
public abstract class AbstractIntIntMapTestCase
{
    protected final IntIntMap map = this.classUnderTest();

    protected abstract IntIntMap classUnderTest();

    protected abstract IntIntMap newWithKeysValues(int key1, int value1);

    protected abstract IntIntMap newWithKeysValues(int key1, int value1, int key2, int value2);

    protected abstract IntIntMap newWithKeysValues(int key1, int value1, int key2, int value2, int key3, int value3);

    protected abstract IntIntMap newWithKeysValues(int key1, int value1, int key2, int value2, int key3, int value3, int key4, int value4);

    protected abstract IntIntMap getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(IntHashSet.newSetWith(0), this.newWithKeysValues(0, 0).keySet());
        Assert.assertEquals(IntHashSet.newSetWith(0, 31, 32),
                this.newWithKeysValues(0, 0, 31, 31, 32, 32).keySet());
    }
    ...
    public void values()
    {
        ...
        IntIntMap map = this.newWithKeysValues(0, 0);
        Verify.assertSize(1, map.values());
        Assert.assertTrue(map.values().contains(0));

        IntIntMap map1 = this.newWithKeysValues(0, 0, 31, 31, 32, 32);
    ...
    public void testEquals()
    {
        ...
        IntIntMap map9 = this.newWithKeysValues(0, 0);
        ...
        Assert.assertEquals(map1, IntIntMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, IntIntMaps.immutable.ofAll(map1));
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0, 0, 1, 1, 32, 32).hashCode(),
                this.newWithKeysValues(32, 32, 0, 0, 1, 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50, 0, 60, 1, 70, 33).hashCode(),
                this.newWithKeysValues(50, 0, 60, 1, 70, 33).hashCode());
        Assert.assertEquals(UnifiedMap.newMap().hashCode(), this.getEmptyMap().hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(1, 2).hashCode(), this.newWithKeysValues(1, 2).hashCode());
    }
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{1=1}", this.newWithKeysValues(1, 1).toString());
        Assert.assertEquals("{5=5}", this.newWithKeysValues(5, 5).toString());

        IntIntMap map1 = this.newWithKeysValues(0, 0, 1, 1);
        Assert.assertTrue(
                map1.toString(),
                "{0=0, 1=1}".equals(map1.toString())
                        || "{1=1, 0=0}".equals(map1.toString()));

        IntIntMap map2 = this.newWithKeysValues(1, 1, 32, 32);
        Assert.assertTrue(
                map2.toString(),
                "{1=1, 32=32}".equals(map2.toString())
                        || "{32=32, 1=1}".equals(map2.toString()));

        IntIntMap map3 = this.newWithKeysValues(0, 0, 32, 32);
        Assert.assertTrue(
                map3.toString(),
                "{0=0, 32=32}".equals(map3.toString())
                        || "{32=32, 0=0}".equals(map3.toString()));

        IntIntMap map4 = this.newWithKeysValues(32, 32, 33, 33);
        Assert.assertTrue(
                map4.toString(),
    ...
    public void forEachKey()
    {
        ...
        IntIntMap map3 = this.newWithKeysValues(1, 1);
        int[] sum3 = new int[1];
    ...
    public void forEachKeyValue()
    {
        ...
        map0.forEachKeyValue((int eachKey, int eachValue) ->
        {
            sumKey0[0] += eachKey;
        ...
        map1.forEachKeyValue((int eachKey, int eachValue) ->
        {
            sumKey1[0] += eachKey;
        ...
        map01.forEachKeyValue((int eachKey, int eachValue) ->
        {
            sumKey01[0] += eachKey;
        ...
        map.forEachKeyValue((int eachKey, int eachValue) ->
        {
            sumKey[0] += eachKey;
        ...
        map2.forEachKeyValue((int eachKey, int eachValue) ->
        {
            sumKey2[0] += eachKey;
        ...
        IntIntMap map3 = this.newWithKeysValues(3, 5);
        int[] sumKey3 = new int[1];
        int[] sumValue3 = new int[1];
        map3.forEachKeyValue((int eachKey, int eachValue) ->
        {
            sumKey3[0] += eachKey;
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("5", this.newWithKeysValues(5, 5).makeString());
    ...
    public void appendString()
    {
        ...
        this.newWithKeysValues(0, 0).appendString(appendable01, "/");
        Assert.assertEquals("0", appendable01.toString());

        Appendable appendable02 = new StringBuilder();
        this.newWithKeysValues(0, 0).appendString(appendable02, "{", "/", "}");
        ...
        this.newWithKeysValues(5, 5).appendString(appendable2);
        ...
        IntIntMap map3 = this.newWithKeysValues(1, 1, 32, 32);
    ...
    public void select()
    {
        IntIntMap map = this.newWithKeysValues(0, 0, 1, 1, 2, 2, 3, 3);
        IntIntMap actual1 = map.select((int key, int value) -> key == 1 || value == 3);
        Assert.assertEquals(IntIntHashMap.newWithKeysValues(1, 1, 3, 3), actual1);
        IntIntMap actual2 = map.select((int key, int value) -> key == 0 || value == 2);
        Assert.assertEquals(IntIntHashMap.newWithKeysValues(0, 0, 2, 2), actual2);
    }
    ...
    {
        IntIntMap map = this.newWithKeysValues(0, 0, 1, 1, 2, 2, 3, 3);
        IntIntMap actual1 = map.reject((int key, int value) -> key == 1 || value == 3);
        Assert.assertEquals(IntIntHashMap.newWithKeysValues(0, 0, 2, 2), actual1);
        IntIntMap actual2 = map.reject((int key, int value)-> key == 0 || value == 2);
        Assert.assertEquals(IntIntHashMap.newWithKeysValues(1, 1, 3, 3), actual2);
    }
    ...
    public void collect()
    {
        ...
        Assert.assertEquals(Bags.immutable.with(2), this.newWithKeysValues(1, 1).collect(function));
    }
    ...
    public void detectIfNone_value()
    {
        ...
        Assert.assertEquals(5, this.newWithKeysValues(1, 1).detectIfNone(IntPredicates.equal(0), 5));
        Assert.assertEquals(1, this.newWithKeysValues(1, 1).detectIfNone(IntPredicates.equal(1), 5));
    ...
    public void anySatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1, 1).anySatisfy(IntPredicates.equal(0)));
        Assert.assertTrue(this.newWithKeysValues(1, 1).anySatisfy(IntPredicates.equal(1)));
    ...
    public void allSatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1, 1).allSatisfy(IntPredicates.equal(0)));
        Assert.assertTrue(this.newWithKeysValues(1, 1).allSatisfy(IntPredicates.equal(1)));
        ...
        IntIntMap map1 = this.newWithKeysValues(2, 2, 3, 3);
    ...
    public void noneSatisfy()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(1, 1).noneSatisfy(IntPredicates.equal(0)));
        Assert.assertFalse(this.newWithKeysValues(1, 1).noneSatisfy(IntPredicates.equal(1)));
    ...
    public void max()
    {
        ...
        Assert.assertEquals(3, this.newWithKeysValues(3, 3).max());
    }

    @Test
    public void min()
    {
        IntIntMap map = this.newWithKeysValues(1, 1, 2, 2, 3, 3, 0, 0);
        Assert.assertEquals(0, map.min());
        Assert.assertEquals(3, this.newWithKeysValues(3, 3).min());
    }
    ...
    public void minIfEmpty()
    {
        ...
        IntIntMap map = this.newWithKeysValues(1, 1, 0, 0, 9, 9, 7, 7);
        Assert.assertEquals(0L, map.minIfEmpty(5));
        Assert.assertEquals(3, this.newWithKeysValues(3, 3).maxIfEmpty(5));
    }
    ...
    public void maxIfEmpty()
    {
        ...
        Assert.assertEquals(3, this.newWithKeysValues(3, 3).minIfEmpty(5));
    }
    ...
    public void sum()
    {
        ...
        IntIntMap map2 = this.newWithKeysValues(2, 2, 3, 3, 4, 4);
        Assert.assertEquals(9, map2.sum());
        IntIntMap map3 = this.newWithKeysValues(2, 2);
    ...
    public void average()
    {
        ...
        IntIntMap map1 = this.newWithKeysValues(1, 1);
    ...
    public void median()
    {
        ...
        IntIntMap map2 = this.newWithKeysValues(0, 0, 1, 1, 2, 2);
    ...
    public void toList()
    {
        Assert.assertEquals(IntArrayList.newListWith(0), this.newWithKeysValues(0, 0).toList());
        Assert.assertEquals(IntArrayList.newListWith(1), this.newWithKeysValues(1, 1).toList());
        Assert.assertEquals(IntArrayList.newListWith(2), this.newWithKeysValues(2, 2).toList());
        Assert.assertTrue(this.newWithKeysValues(2, 2, 3, 3).toList().equals(IntArrayList.newListWith(2, 3))
                || this.newWithKeysValues(2, 2, 3, 3).toList().equals(IntArrayList.newListWith(3, 2)));
    }
    ...
    public void toSortedList()
    {
        ...
        Assert.assertEquals(IntArrayList.newListWith(1), this.newWithKeysValues(1, 1).toSortedList());
    }
    ...
    public void toSet()
    {
        ...
        Assert.assertEquals(IntHashSet.newSetWith(1), this.newWithKeysValues(1, 1).toSet());
    }
    ...
    public void toBag()
    {
        ...
        Assert.assertEquals(IntHashBag.newBagWith(1), this.newWithKeysValues(1, 1).toBag());
    }
    ...
    {
        MutableBag<IntIntPair> expected = Bags.mutable.of();
        this.map.forEachKeyValue((int key, int value) -> expected.add(PrimitiveTuples.pair(key, value)));
    ...
    public void toArray()
    {
        IntIntMap map = this.newWithKeysValues(1, 1, 2, 2);
        ...
        Assert.assertTrue(Arrays.equals(new int[]{1}, this.newWithKeysValues(1, 1).toArray()));
    }
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableIntIntMap.class, this.classUnderTest().toImmutable());
    }

    @Test
    public void chunk()
    {
        IntIterable iterable = this.newWithKeysValues(1, 1, 2, 2, 3, 3);
        Assert.assertEquals(
                Lists.mutable.with(
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1, 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1, 1).chunk(-1));
    }
}

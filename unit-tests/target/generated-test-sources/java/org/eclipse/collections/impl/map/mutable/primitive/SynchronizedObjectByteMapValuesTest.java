...
/**
 * JUnit test for {@link SynchronizedObjectByteMap#values()}.
 * This file was automatically generated from template file synchronizedObjectPrimitiveMapValuesTest.stg.
 */
public class SynchronizedObjectByteMapValuesTest extends AbstractMutableByteCollectionTestCase
{
    @Override
    protected MutableByteCollection classUnderTest()
    {
        return new SynchronizedObjectByteMap<>(ObjectByteHashMap.newWithKeysValues(1, (byte) 1, 2, (byte) 2, 3, (byte) 3)).values();
    }
    ...
    public void remove()
    {
        ObjectByteHashMap<Integer> map = ObjectByteHashMap.newWithKeysValues(1, (byte) 1, 2, (byte) 2, 3, (byte) 3);

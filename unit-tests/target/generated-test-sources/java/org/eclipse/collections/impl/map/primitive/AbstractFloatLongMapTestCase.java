...
public abstract class AbstractFloatLongMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(FloatHashSet.newSetWith(0.0f, 31.0f, 32.0f),
                this.newWithKeysValues(0.0f, 0L, 31.0f, 31L, 32.0f, 32L).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0.0f, 0L, 1.0f, 1L, 32.0f, 32L).hashCode(),
                this.newWithKeysValues(32.0f, 32L, 0.0f, 0L, 1.0f, 1L).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50.0f, 0L, 60.0f, 1L, 70.0f, 33L).hashCode(),
                this.newWithKeysValues(50.0f, 0L, 60.0f, 1L, 70.0f, 33L).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(2.0f, 2L, 3.0f, 3L).toList().equals(LongArrayList.newListWith(2L, 3L))
                || this.newWithKeysValues(2.0f, 2L, 3.0f, 3L).toList().equals(LongArrayList.newListWith(3L, 2L)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1.0f, 1L).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1.0f, 1L).chunk(-1));
    }
}

...
public class ImmutableFloatObjectSingletonMapTest extends AbstractImmutableFloatObjectMapTestCase
{
    ...
    {
        Assert.assertEquals(
                FloatObjectHashMap.newWithKeysValues(0.0f, "zero"),
                this.classUnderTest().select((float value, String object) -> value == 0));
    ...
    public void collectBoolean()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0f, "true").collectBoolean(StringFunctions.toPrimitiveBoolean()));
    }
    ...
    public void collectByte()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0f, "0").collectByte(Byte::parseByte));
    }
    ...
    public void collectChar()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0f, "0").collectChar(StringFunctions.toPrimitiveChar()));
    }
    ...
    public void collectDouble()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0f, "0").collectDouble(Double::parseDouble));
    }
    ...
    public void collectFloat()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0f, "0").collectFloat(Float::parseFloat));
    }
    ...
    public void collectInt()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0f, "0").collectInt(Integer::parseInt));
    }
    ...
    public void collectLong()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0f, "0").collectLong(Long::parseLong));
    }
    ...
    public void collectShort()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues(0.0f, "0").collectShort(Short::parseShort));
    }

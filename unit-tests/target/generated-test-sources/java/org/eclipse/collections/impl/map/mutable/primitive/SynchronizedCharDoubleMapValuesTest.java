...
/**
 * JUnit test for {@link SynchronizedCharDoubleMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMapValuesTest.stg.
 */
public class SynchronizedCharDoubleMapValuesTest extends AbstractMutableDoubleCollectionTestCase
{
    @Override
    protected MutableDoubleCollection classUnderTest()
    {
        return new SynchronizedCharDoubleMap(CharDoubleHashMap.newWithKeysValues((char) 1, 1.0, (char) 2, 2.0, (char) 3, 3.0)).values();
    }

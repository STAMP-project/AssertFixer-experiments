...
/**
 * JUnit test for {@link UnmodifiableByteBooleanMap#values()}.
 * This file was automatically generated from template file unmodifiablePrimitiveBooleanMapValuesTest.stg.
 */
public class UnmodifiableByteBooleanMapValuesTest extends AbstractMutableBooleanCollectionTestCase
{
    @Override
    protected MutableBooleanCollection classUnderTest()
    {
        return new UnmodifiableByteBooleanMap(ByteBooleanHashMap.newWithKeysValues((byte) 1, true, (byte) 2, false, (byte) 3, true)).values();
    }

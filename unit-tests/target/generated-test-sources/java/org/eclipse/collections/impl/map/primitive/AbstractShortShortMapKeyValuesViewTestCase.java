...
public abstract class AbstractShortShortMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith((short) 1, (short) 2, (short) 2, (short) 3, (short) 3, (short) 4).collect((ShortShortPair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Long> result2 =
            this.newWith((short) 1, (short) 2, (short) 2, (short) 3, (short) 3, (short) 4).collect((ShortShortPair object) -> (long) object.getTwo());
    ...
    public void detectWithIfNoneBlock()
    {
        ...
        Assert.assertEquals(
            ...
            this.newWith((short) 1, (short) 2, (short) 2, (short) 3, (short) 3, (short) 4).detectWithIfNone(
                    Object::equals,
                    PrimitiveTuples.pair((short) 2, (short) 3),
                    function));
        Assert.assertEquals(
            PrimitiveTuples.pair((short) 5, (short) 6),
            this.newWith((short) 1, (short) 2, (short) 2, (short) 3, (short) 3, (short) 4).detectWithIfNone(
                    Object::equals,
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith((short) 1, (short) 2, (short) 2, (short) 3, (short) 3, (short) 4).collectIf(
                        ShortShortPair.class::isInstance,
                        String::valueOf),
                "1:2", "2:3", "3:4");
        Verify.assertContainsAll(
                this.newWith((short) 1, (short) 2, (short) 2, (short) 3, (short) 3, (short) 4).collectIf(
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith((short) 1, (short) 2, (short) 2, (short) 3, (short) 3, (short) 4).collectWith((ShortShortPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(4L, 6L, 8L),
                this.newWith((short) 1, (short) 2, (short) 2, (short) 3, (short) 3, (short) 4).collectWith((ShortShortPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair((short) 1, (short) 2).equals(first)
                || PrimitiveTuples.pair((short) 2, (short) 3).equals(first)
                || PrimitiveTuples.pair((short) 3, (short) 4).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair((short) 1, (short) 2).equals(last)
                || PrimitiveTuples.pair((short) 2, (short) 3).equals(last)
                || PrimitiveTuples.pair((short) 3, (short) 4).equals(last));
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((short) 1, (short) 2), 1), Tuples.pair(PrimitiveTuples.pair((short) 2, (short) 3), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((short) 2, (short) 3), 1), Tuples.pair(PrimitiveTuples.pair((short) 1, (short) 2), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((short) 1, (short) 2), 0), Tuples.pair(PrimitiveTuples.pair((short) 2, (short) 3), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((short) 2, (short) 3), 0), Tuples.pair(PrimitiveTuples.pair((short) 1, (short) 2), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<ShortShortPair> collection = this.newWith((short) 1, (short) 2, (short) 2, (short) 3, (short) 3, (short) 4);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair((short) 1, (short) 2)),
                FastList.newListWith(PrimitiveTuples.pair((short) 2, (short) 3)),
                FastList.newListWith(PrimitiveTuples.pair((short) 3, (short) 4))),

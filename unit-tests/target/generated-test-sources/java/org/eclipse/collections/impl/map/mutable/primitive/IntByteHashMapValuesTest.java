...
/**
 * JUnit test for {@link IntByteHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class IntByteHashMapValuesTest extends AbstractMutableByteCollectionTestCase
{
    @Override
    protected MutableByteCollection classUnderTest()
    {
        return IntByteHashMap.newWithKeysValues(1, (byte) 1, 2, (byte) 2, 3, (byte) 3).values();
    }
    ...
    public void retainAll()
    {
        ...
        IntByteHashMap map = IntByteHashMap.newWithKeysValues(0, (byte) 0, 1, (byte) 1, 2, (byte) 2, 3, (byte) 3);
        MutableByteCollection collection = map.values();

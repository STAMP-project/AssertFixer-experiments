...
public abstract class AbstractFloatIntMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(FloatHashSet.newSetWith(0.0f, 31.0f, 32.0f),
                this.newWithKeysValues(0.0f, 0, 31.0f, 31, 32.0f, 32).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0.0f, 0, 1.0f, 1, 32.0f, 32).hashCode(),
                this.newWithKeysValues(32.0f, 32, 0.0f, 0, 1.0f, 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50.0f, 0, 60.0f, 1, 70.0f, 33).hashCode(),
                this.newWithKeysValues(50.0f, 0, 60.0f, 1, 70.0f, 33).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(2.0f, 2, 3.0f, 3).toList().equals(IntArrayList.newListWith(2, 3))
                || this.newWithKeysValues(2.0f, 2, 3.0f, 3).toList().equals(IntArrayList.newListWith(3, 2)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1.0f, 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1.0f, 1).chunk(-1));
    }
}

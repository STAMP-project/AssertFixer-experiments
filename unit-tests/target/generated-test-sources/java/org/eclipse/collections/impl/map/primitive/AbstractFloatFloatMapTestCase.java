...
public abstract class AbstractFloatFloatMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(FloatHashSet.newSetWith(0.0f, 31.0f, 32.0f),
                this.newWithKeysValues(0.0f, 0.0f, 31.0f, 31.0f, 32.0f, 32.0f).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0.0f, 0.0f, 1.0f, 1.0f, 32.0f, 32.0f).hashCode(),
                this.newWithKeysValues(32.0f, 32.0f, 0.0f, 0.0f, 1.0f, 1.0f).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50.0f, 0.0f, 60.0f, 1.0f, 70.0f, 33.0f).hashCode(),
                this.newWithKeysValues(50.0f, 0.0f, 60.0f, 1.0f, 70.0f, 33.0f).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(2.0f, 2.0f, 3.0f, 3.0f).toList().equals(FloatArrayList.newListWith(2.0f, 3.0f))
                || this.newWithKeysValues(2.0f, 2.0f, 3.0f, 3.0f).toList().equals(FloatArrayList.newListWith(3.0f, 2.0f)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1.0f, 1.0f).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1.0f, 1.0f).chunk(-1));
    }
}

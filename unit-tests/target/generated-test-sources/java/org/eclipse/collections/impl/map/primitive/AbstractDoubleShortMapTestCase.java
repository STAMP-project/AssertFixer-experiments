...
public abstract class AbstractDoubleShortMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(DoubleHashSet.newSetWith(0.0, 31.0, 32.0),
                this.newWithKeysValues(0.0, (short) 0, 31.0, (short) 31, 32.0, (short) 32).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0.0, (short) 0, 1.0, (short) 1, 32.0, (short) 32).hashCode(),
                this.newWithKeysValues(32.0, (short) 32, 0.0, (short) 0, 1.0, (short) 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50.0, (short) 0, 60.0, (short) 1, 70.0, (short) 33).hashCode(),
                this.newWithKeysValues(50.0, (short) 0, 60.0, (short) 1, 70.0, (short) 33).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(2.0, (short) 2, 3.0, (short) 3).toList().equals(ShortArrayList.newListWith((short) 2, (short) 3))
                || this.newWithKeysValues(2.0, (short) 2, 3.0, (short) 3).toList().equals(ShortArrayList.newListWith((short) 3, (short) 2)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1.0, (short) 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1.0, (short) 1).chunk(-1));
    }
}

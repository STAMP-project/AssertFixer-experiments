...
public abstract class AbstractByteDoubleMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 0, (byte) 31, (byte) 32),
                this.newWithKeysValues((byte) 0, 0.0, (byte) 31, 31.0, (byte) 32, 32.0).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 0, 0.0, (byte) 1, 1.0, (byte) 32, 32.0).hashCode(),
                this.newWithKeysValues((byte) 32, 32.0, (byte) 0, 0.0, (byte) 1, 1.0).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 50, 0.0, (byte) 60, 1.0, (byte) 70, 33.0).hashCode(),
                this.newWithKeysValues((byte) 50, 0.0, (byte) 60, 1.0, (byte) 70, 33.0).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((byte) 2, 2.0, (byte) 3, 3.0).toList().equals(DoubleArrayList.newListWith(2.0, 3.0))
                || this.newWithKeysValues((byte) 2, 2.0, (byte) 3, 3.0).toList().equals(DoubleArrayList.newListWith(3.0, 2.0)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 1, 1.0).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((byte) 1, 1.0).chunk(-1));
    }
}

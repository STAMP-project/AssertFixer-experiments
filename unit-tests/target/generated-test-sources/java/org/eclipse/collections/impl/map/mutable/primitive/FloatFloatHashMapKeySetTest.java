...
/**
 * JUnit test for {@link FloatFloatHashMap#keySet()}.
 *
 * This file was automatically generated from template file primitivePrimitiveHashMapKeySetTest.stg.
 */
public class FloatFloatHashMapKeySetTest extends AbstractFloatSetTestCase
{
    @Override
    protected MutableFloatSet classUnderTest()
    {
        return FloatFloatHashMap.newWithKeysValues(1.0f, 1.0f, 2.0f, 2.0f, 3.0f, 3.0f).keySet();
    }

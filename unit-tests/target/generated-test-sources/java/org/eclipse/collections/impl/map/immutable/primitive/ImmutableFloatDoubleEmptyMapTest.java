...
/**
 * JUnit test for {@link ImmutableFloatDoubleEmptyMap}.
 * This file was automatically generated from template file immutablePrimitivePrimitiveEmptyMapTest.stg.
 */
public class ImmutableFloatDoubleEmptyMapTest extends AbstractImmutableFloatDoubleMapTestCase
{
    @Override
    ...
    {
        Assert.assertEquals(5.0, this.map.getIfAbsent(0.0f, 5.0), 0.0);
    ...
    public void select()
    {
        Assert.assertEquals(this.classUnderTest(), this.classUnderTest().select((float value1, double value2) -> true));
    }
    ...
    public void reject()
    {
        Assert.assertEquals(this.classUnderTest(), this.classUnderTest().reject((float value1, double value2) -> false));
    }
    ...
    {
        ImmutableFloatDoubleEmptyMap iterable = new ImmutableFloatDoubleEmptyMap();

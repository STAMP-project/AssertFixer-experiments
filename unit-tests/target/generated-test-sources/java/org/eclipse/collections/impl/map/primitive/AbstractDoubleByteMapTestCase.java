...
public abstract class AbstractDoubleByteMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(DoubleHashSet.newSetWith(0.0, 31.0, 32.0),
                this.newWithKeysValues(0.0, (byte) 0, 31.0, (byte) 31, 32.0, (byte) 32).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0.0, (byte) 0, 1.0, (byte) 1, 32.0, (byte) 32).hashCode(),
                this.newWithKeysValues(32.0, (byte) 32, 0.0, (byte) 0, 1.0, (byte) 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50.0, (byte) 0, 60.0, (byte) 1, 70.0, (byte) 33).hashCode(),
                this.newWithKeysValues(50.0, (byte) 0, 60.0, (byte) 1, 70.0, (byte) 33).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(2.0, (byte) 2, 3.0, (byte) 3).toList().equals(ByteArrayList.newListWith((byte) 2, (byte) 3))
                || this.newWithKeysValues(2.0, (byte) 2, 3.0, (byte) 3).toList().equals(ByteArrayList.newListWith((byte) 3, (byte) 2)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1.0, (byte) 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1.0, (byte) 1).chunk(-1));
    }
}

 ...
 */
public abstract class AbstractByteShortMapTestCase
{
    protected final ByteShortMap map = this.classUnderTest();

    protected abstract ByteShortMap classUnderTest();

    protected abstract ByteShortMap newWithKeysValues(byte key1, short value1);

    protected abstract ByteShortMap newWithKeysValues(byte key1, short value1, byte key2, short value2);

    protected abstract ByteShortMap newWithKeysValues(byte key1, short value1, byte key2, short value2, byte key3, short value3);

    protected abstract ByteShortMap newWithKeysValues(byte key1, short value1, byte key2, short value2, byte key3, short value3, byte key4, short value4);

    protected abstract ByteShortMap getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 0), this.newWithKeysValues((byte) 0, (short) 0).keySet());
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 0, (byte) 31, (byte) 32),
                this.newWithKeysValues((byte) 0, (short) 0, (byte) 31, (short) 31, (byte) 32, (short) 32).keySet());
    }
    ...
    public void values()
    {
        ...
        ByteShortMap map = this.newWithKeysValues((byte) 0, (short) 0);
        Verify.assertSize(1, map.values());
        Assert.assertTrue(map.values().contains((short) 0));

        ByteShortMap map1 = this.newWithKeysValues((byte) 0, (short) 0, (byte) 31, (short) 31, (byte) 32, (short) 32);
    ...
    public void isEmpty()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((byte) 1, (short) 1).isEmpty());
        Assert.assertFalse(this.newWithKeysValues((byte) 0, (short) 0).isEmpty());
        Assert.assertFalse(this.newWithKeysValues((byte) 50, (short) 50).isEmpty());
    }
    ...
    public void notEmpty()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((byte) 1, (short) 1).notEmpty());
        Assert.assertTrue(this.newWithKeysValues((byte) 0, (short) 0).notEmpty());
        Assert.assertTrue(this.newWithKeysValues((byte) 50, (short) 50).notEmpty());
    }
    ...
    public void testEquals()
    {
        ...
        ByteShortMap map9 = this.newWithKeysValues((byte) 0, (short) 0);
        ...
        Assert.assertEquals(map1, ByteShortMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, ByteShortMaps.immutable.ofAll(map1));
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 0, (short) 0, (byte) 1, (short) 1, (byte) 32, (short) 32).hashCode(),
                this.newWithKeysValues((byte) 32, (short) 32, (byte) 0, (short) 0, (byte) 1, (short) 1).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 50, (short) 0, (byte) 60, (short) 1, (byte) 70, (short) 33).hashCode(),
                this.newWithKeysValues((byte) 50, (short) 0, (byte) 60, (short) 1, (byte) 70, (short) 33).hashCode());
        Assert.assertEquals(UnifiedMap.newMap().hashCode(), this.getEmptyMap().hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues((byte) 1, (short) 2).hashCode(), this.newWithKeysValues((byte) 1, (short) 2).hashCode());
    }
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{0=0}", this.newWithKeysValues((byte) 0, (short) 0).toString());
        Assert.assertEquals("{1=1}", this.newWithKeysValues((byte) 1, (short) 1).toString());
        Assert.assertEquals("{5=5}", this.newWithKeysValues((byte) 5, (short) 5).toString());

        ByteShortMap map1 = this.newWithKeysValues((byte) 0, (short) 0, (byte) 1, (short) 1);
        Assert.assertTrue(
                map1.toString(),
                "{0=0, 1=1}".equals(map1.toString())
                        || "{1=1, 0=0}".equals(map1.toString()));

        ByteShortMap map2 = this.newWithKeysValues((byte) 1, (short) 1, (byte) 32, (short) 32);
        Assert.assertTrue(
                map2.toString(),
                "{1=1, 32=32}".equals(map2.toString())
                        || "{32=32, 1=1}".equals(map2.toString()));

        ByteShortMap map3 = this.newWithKeysValues((byte) 0, (short) 0, (byte) 32, (short) 32);
        Assert.assertTrue(
                map3.toString(),
                "{0=0, 32=32}".equals(map3.toString())
                        || "{32=32, 0=0}".equals(map3.toString()));

        ByteShortMap map4 = this.newWithKeysValues((byte) 32, (short) 32, (byte) 33, (short) 33);
        Assert.assertTrue(
                map4.toString(),
    ...
    public void forEachKey()
    {
        ...
        ByteShortMap map3 = this.newWithKeysValues((byte) 1, (short) 1);
    ...
    public void forEachKeyValue()
    {
        ...
        map0.forEachKeyValue((byte eachKey, short eachValue) ->
        {
            sumKey0[0] += eachKey;
        ...
        map1.forEachKeyValue((byte eachKey, short eachValue) ->
        {
            sumKey1[0] += eachKey;
        ...
        map01.forEachKeyValue((byte eachKey, short eachValue) ->
        {
            sumKey01[0] += eachKey;
        ...
        map.forEachKeyValue((byte eachKey, short eachValue) ->
        {
            sumKey[0] += eachKey;
        ...
        map2.forEachKeyValue((byte eachKey, short eachValue) ->
        {
            sumKey2[0] += eachKey;
        ...
        ByteShortMap map3 = this.newWithKeysValues((byte) 3, (short) 5);
        byte[] sumKey3 = new byte[1];
        short[] sumValue3 = new short[1];
        map3.forEachKeyValue((byte eachKey, short eachValue) ->
        {
            sumKey3[0] += eachKey;
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("", this.getEmptyMap().makeString(", "));
        Assert.assertEquals("[]", this.getEmptyMap().makeString("[", "/", "]"));
        Assert.assertEquals("0", this.newWithKeysValues((byte) 0, (short) 0).makeString());
        Assert.assertEquals("0", this.newWithKeysValues((byte) 0, (short) 0).makeString(", "));
        Assert.assertEquals("[0]", this.newWithKeysValues((byte) 0, (short) 0).makeString("[", "/", "]"));
        Assert.assertEquals("1", this.newWithKeysValues((byte) 1, (short) 1).makeString());
        Assert.assertEquals("5", this.newWithKeysValues((byte) 5, (short) 5).makeString());
    ...
    public void appendString()
    {
        ...
        this.newWithKeysValues((byte) 0, (short) 0).appendString(appendable0);
        Assert.assertEquals("0", appendable0.toString());

        Appendable appendable01 = new StringBuilder();
        this.newWithKeysValues((byte) 0, (short) 0).appendString(appendable01, "/");
        Assert.assertEquals("0", appendable01.toString());

        Appendable appendable02 = new StringBuilder();
        this.newWithKeysValues((byte) 0, (short) 0).appendString(appendable02, "{", "/", "}");
        Assert.assertEquals("{0}", appendable02.toString());

        Appendable appendable1 = new StringBuilder();
        this.newWithKeysValues((byte) 1, (short) 1).appendString(appendable1);
        Assert.assertEquals("1", appendable1.toString());

        Appendable appendable2 = new StringBuilder();
        this.newWithKeysValues((byte) 5, (short) 5).appendString(appendable2);
        ...
        ByteShortMap map3 = this.newWithKeysValues((byte) 1, (short) 1, (byte) 32, (short) 32);
    ...
    public void select()
    {
        ByteShortMap map = this.newWithKeysValues((byte) 0, (short) 0, (byte) 1, (short) 1, (byte) 2, (short) 2, (byte) 3, (short) 3);
        ByteShortMap actual1 = map.select((byte key, short value) -> key == (byte) 1 || value == (short) 3);
        Assert.assertEquals(ByteShortHashMap.newWithKeysValues((byte) 1, (short) 1, (byte) 3, (short) 3), actual1);
        ByteShortMap actual2 = map.select((byte key, short value) -> key == (byte) 0 || value == (short) 2);
        Assert.assertEquals(ByteShortHashMap.newWithKeysValues((byte) 0, (short) 0, (byte) 2, (short) 2), actual2);
    }
    ...
    {
        ByteShortMap map = this.newWithKeysValues((byte) 0, (short) 0, (byte) 1, (short) 1, (byte) 2, (short) 2, (byte) 3, (short) 3);
        ByteShortMap actual1 = map.reject((byte key, short value) -> key == (byte) 1 || value == (short) 3);
        Assert.assertEquals(ByteShortHashMap.newWithKeysValues((byte) 0, (short) 0, (byte) 2, (short) 2), actual1);
        ByteShortMap actual2 = map.reject((byte key, short value)-> key == (byte) 0 || value == (short) 2);
        Assert.assertEquals(ByteShortHashMap.newWithKeysValues((byte) 1, (short) 1, (byte) 3, (short) 3), actual2);
    }
    ...
    public void collect()
    {
        ...
        Assert.assertEquals(Bags.immutable.with((short) 2), this.newWithKeysValues((byte) 1, (short) 1).collect(function));
    }
    ...
    public void detectIfNone_value()
    {
        ...
        Assert.assertEquals((short) 5, this.newWithKeysValues((byte) 1, (short) 1).detectIfNone(ShortPredicates.equal((short) 0), (short) 5));
        Assert.assertEquals((short) 1, this.newWithKeysValues((byte) 1, (short) 1).detectIfNone(ShortPredicates.equal((short) 1), (short) 5));
    ...
    public void anySatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((byte) 1, (short) 1).anySatisfy(ShortPredicates.equal((short) 0)));
        Assert.assertTrue(this.newWithKeysValues((byte) 1, (short) 1).anySatisfy(ShortPredicates.equal((short) 1)));
    ...
    public void allSatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues((byte) 1, (short) 1).allSatisfy(ShortPredicates.equal((short) 0)));
        Assert.assertTrue(this.newWithKeysValues((byte) 1, (short) 1).allSatisfy(ShortPredicates.equal((short) 1)));
        ...
        ByteShortMap map1 = this.newWithKeysValues((byte) 2, (short) 2, (byte) 3, (short) 3);
    ...
    public void noneSatisfy()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((byte) 1, (short) 1).noneSatisfy(ShortPredicates.equal((short) 0)));
        Assert.assertFalse(this.newWithKeysValues((byte) 1, (short) 1).noneSatisfy(ShortPredicates.equal((short) 1)));
    ...
    public void max()
    {
        ...
        Assert.assertEquals((short) 3, this.newWithKeysValues((byte) 3, (short) 3).max());
    }

    @Test
    public void min()
    {
        ByteShortMap map = this.newWithKeysValues((byte) 1, (short) 1, (byte) 2, (short) 2, (byte) 3, (short) 3, (byte) 0, (short) 0);
        Assert.assertEquals((short) 0, map.min());
        Assert.assertEquals((short) 3, this.newWithKeysValues((byte) 3, (short) 3).min());
    }
    ...
    public void minIfEmpty()
    {
        ...
        ByteShortMap map = this.newWithKeysValues((byte) 1, (short) 1, (byte) 0, (short) 0, (byte) 9, (short) 9, (byte) 7, (short) 7);
        Assert.assertEquals(0L, map.minIfEmpty((short) 5));
        Assert.assertEquals((short) 3, this.newWithKeysValues((byte) 3, (short) 3).maxIfEmpty((short) 5));
    }
    ...
    public void maxIfEmpty()
    {
        ...
        Assert.assertEquals((short) 3, this.newWithKeysValues((byte) 3, (short) 3).minIfEmpty((short) 5));
    }
    ...
    public void sum()
    {
        ...
        ByteShortMap map2 = this.newWithKeysValues((byte) 2, (short) 2, (byte) 3, (short) 3, (byte) 4, (short) 4);
        Assert.assertEquals((short) 9, map2.sum());
        ByteShortMap map3 = this.newWithKeysValues((byte) 2, (short) 2);
    ...
    public void average()
    {
        ...
        ByteShortMap map1 = this.newWithKeysValues((byte) 1, (short) 1);
    ...
    public void median()
    {
        ...
        ByteShortMap map2 = this.newWithKeysValues((byte) 0, (short) 0, (byte) 1, (short) 1, (byte) 2, (short) 2);
    ...
    public void toList()
    {
        Assert.assertEquals(ShortArrayList.newListWith((short) 0), this.newWithKeysValues((byte) 0, (short) 0).toList());
        Assert.assertEquals(ShortArrayList.newListWith((short) 1), this.newWithKeysValues((byte) 1, (short) 1).toList());
        Assert.assertEquals(ShortArrayList.newListWith((short) 2), this.newWithKeysValues((byte) 2, (short) 2).toList());
        Assert.assertTrue(this.newWithKeysValues((byte) 2, (short) 2, (byte) 3, (short) 3).toList().equals(ShortArrayList.newListWith((short) 2, (short) 3))
                || this.newWithKeysValues((byte) 2, (short) 2, (byte) 3, (short) 3).toList().equals(ShortArrayList.newListWith((short) 3, (short) 2)));
    }
    ...
    public void toSortedList()
    {
        ...
        Assert.assertEquals(ShortArrayList.newListWith((short) 1), this.newWithKeysValues((byte) 1, (short) 1).toSortedList());
    }
    ...
    public void toSet()
    {
        ...
        Assert.assertEquals(ShortHashSet.newSetWith((short) 1), this.newWithKeysValues((byte) 1, (short) 1).toSet());
    }
    ...
    public void toBag()
    {
        ...
        Assert.assertEquals(ShortHashBag.newBagWith((short) 1), this.newWithKeysValues((byte) 1, (short) 1).toBag());
    }
    ...
    {
        MutableBag<ByteShortPair> expected = Bags.mutable.of();
        this.map.forEachKeyValue((byte key, short value) -> expected.add(PrimitiveTuples.pair(key, value)));
    ...
    public void toArray()
    {
        ByteShortMap map = this.newWithKeysValues((byte) 1, (short) 1, (byte) 2, (short) 2);
        ...
        Assert.assertTrue(Arrays.equals(new short[]{(short) 1}, this.newWithKeysValues((byte) 1, (short) 1).toArray()));
    }
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableByteShortMap.class, this.classUnderTest().toImmutable());
    }

    @Test
    public void chunk()
    {
        ShortIterable iterable = this.newWithKeysValues((byte) 1, (short) 1, (byte) 2, (short) 2, (byte) 3, (short) 3);
        Assert.assertEquals(
                Lists.mutable.with(
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 1, (short) 1).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((byte) 1, (short) 1).chunk(-1));
    }
}

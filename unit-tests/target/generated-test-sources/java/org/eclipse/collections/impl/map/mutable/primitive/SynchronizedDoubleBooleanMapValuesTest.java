...
/**
 * JUnit test for {@link SynchronizedDoubleBooleanMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitiveBooleanMapValuesTest.stg.
 */
public class SynchronizedDoubleBooleanMapValuesTest extends AbstractMutableBooleanCollectionTestCase
{
    @Override
    protected MutableBooleanCollection classUnderTest()
    {
        return new SynchronizedDoubleBooleanMap(DoubleBooleanHashMap.newWithKeysValues(1.0, true, 2.0, false, 3.0, true)).values();
    }

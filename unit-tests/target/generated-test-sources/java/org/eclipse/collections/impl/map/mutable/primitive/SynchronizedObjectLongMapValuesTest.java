...
/**
 * JUnit test for {@link SynchronizedObjectLongMap#values()}.
 * This file was automatically generated from template file synchronizedObjectPrimitiveMapValuesTest.stg.
 */
public class SynchronizedObjectLongMapValuesTest extends AbstractMutableLongCollectionTestCase
{
    @Override
    protected MutableLongCollection classUnderTest()
    {
        return new SynchronizedObjectLongMap<>(ObjectLongHashMap.newWithKeysValues(1, 1L, 2, 2L, 3, 3L)).values();
    }
    ...
    public void without()
    {
        MutableLongCollection collection = this.newWith(1L, 2L, 3L);
        MutableLongCollection collectionWithout = collection.without(2L);
        Assert.assertSame(collection, collectionWithout);
        MutableLongCollection expectedCollection = this.newWith(1L, 3L);
        Assert.assertEquals(expectedCollection.toList(), collectionWithout.toList());
        Assert.assertEquals(expectedCollection.toList(), collectionWithout.without(4L).toList());
    }
    ...
    {
        MutableLongCollection collection = this.newWith(1L, 2L, 3L);
        MutableLongCollection collectionWithout = collection.withoutAll(new LongArrayList(2L, 4L));
        Assert.assertSame(collection, collectionWithout);
        MutableLongCollection expectedCollection = this.newWith(1L, 3L);
        Assert.assertEquals(expectedCollection.toList(), collectionWithout.toList());
    }
    ...
    public void remove()
    {
        ObjectLongHashMap<Integer> map = ObjectLongHashMap.newWithKeysValues(1, 1L, 2, 2L, 3, 3L);
    ...
    public void retainAll()
    {
        ...
        Assert.assertTrue(collection.retainAll(1L, 5L));
        Assert.assertTrue(collection.contains(1L));
        Assert.assertFalse(collection.contains(2L));
        Assert.assertFalse(collection.contains(3L));
        Assert.assertTrue(map.contains(1L));
        ...
        Assert.assertTrue(collection.retainAll(3L, 2L));
        Assert.assertTrue(collection.isEmpty());
        Assert.assertFalse(collection.contains(1L));
        Assert.assertFalse(collection.contains(2L));
        Assert.assertFalse(collection.contains(3L));
    ...
    public void retainAll_iterable()
    {
        ...
        Assert.assertTrue(collection.retainAll(LongArrayList.newListWith(1L, 5L)));
        Assert.assertTrue(collection.contains(1L));
        Assert.assertFalse(collection.contains(2L));
        Assert.assertFalse(collection.contains(3L));
        Assert.assertTrue(map.contains(1L));
        ...
        Assert.assertTrue(collection.retainAll(LongArrayList.newListWith(3L, 2L)));
        Assert.assertTrue(collection.isEmpty());
        Assert.assertFalse(collection.contains(1L));
        Assert.assertFalse(collection.contains(2L));
        Assert.assertFalse(collection.contains(3L));
    ...
    public void asSynchronized()
    {
        ...
        Verify.assertInstanceOf(SynchronizedLongCollection.class, this.classUnderTest().asSynchronized());

...
public abstract class AbstractByteByteMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith((byte) 1, (byte) 2, (byte) 2, (byte) 3, (byte) 3, (byte) 4).collect((ByteBytePair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Long> result2 =
            this.newWith((byte) 1, (byte) 2, (byte) 2, (byte) 3, (byte) 3, (byte) 4).collect((ByteBytePair object) -> (long) object.getTwo());
    ...
    public void detectWithIfNoneBlock()
    {
        ...
        Assert.assertEquals(
            ...
            this.newWith((byte) 1, (byte) 2, (byte) 2, (byte) 3, (byte) 3, (byte) 4).detectWithIfNone(
                    Object::equals,
                    PrimitiveTuples.pair((byte) 2, (byte) 3),
                    function));
        Assert.assertEquals(
            PrimitiveTuples.pair((byte) 5, (byte) 6),
            this.newWith((byte) 1, (byte) 2, (byte) 2, (byte) 3, (byte) 3, (byte) 4).detectWithIfNone(
                    Object::equals,
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith((byte) 1, (byte) 2, (byte) 2, (byte) 3, (byte) 3, (byte) 4).collectIf(
                        ByteBytePair.class::isInstance,
                        String::valueOf),
                "1:2", "2:3", "3:4");
        Verify.assertContainsAll(
                this.newWith((byte) 1, (byte) 2, (byte) 2, (byte) 3, (byte) 3, (byte) 4).collectIf(
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith((byte) 1, (byte) 2, (byte) 2, (byte) 3, (byte) 3, (byte) 4).collectWith((ByteBytePair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(4L, 6L, 8L),
                this.newWith((byte) 1, (byte) 2, (byte) 2, (byte) 3, (byte) 3, (byte) 4).collectWith((ByteBytePair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair((byte) 1, (byte) 2).equals(first)
                || PrimitiveTuples.pair((byte) 2, (byte) 3).equals(first)
                || PrimitiveTuples.pair((byte) 3, (byte) 4).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair((byte) 1, (byte) 2).equals(last)
                || PrimitiveTuples.pair((byte) 2, (byte) 3).equals(last)
                || PrimitiveTuples.pair((byte) 3, (byte) 4).equals(last));
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((byte) 1, (byte) 2), 1), Tuples.pair(PrimitiveTuples.pair((byte) 2, (byte) 3), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((byte) 2, (byte) 3), 1), Tuples.pair(PrimitiveTuples.pair((byte) 1, (byte) 2), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((byte) 1, (byte) 2), 0), Tuples.pair(PrimitiveTuples.pair((byte) 2, (byte) 3), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((byte) 2, (byte) 3), 0), Tuples.pair(PrimitiveTuples.pair((byte) 1, (byte) 2), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<ByteBytePair> collection = this.newWith((byte) 1, (byte) 2, (byte) 2, (byte) 3, (byte) 3, (byte) 4);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair((byte) 1, (byte) 2)),
                FastList.newListWith(PrimitiveTuples.pair((byte) 2, (byte) 3)),
                FastList.newListWith(PrimitiveTuples.pair((byte) 3, (byte) 4))),

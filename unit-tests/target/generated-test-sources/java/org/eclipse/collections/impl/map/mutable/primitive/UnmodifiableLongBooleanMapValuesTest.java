...
/**
 * JUnit test for {@link UnmodifiableLongBooleanMap#values()}.
 * This file was automatically generated from template file unmodifiablePrimitiveBooleanMapValuesTest.stg.
 */
public class UnmodifiableLongBooleanMapValuesTest extends AbstractMutableBooleanCollectionTestCase
{
    @Override
    protected MutableBooleanCollection classUnderTest()
    {
        return new UnmodifiableLongBooleanMap(LongBooleanHashMap.newWithKeysValues(1L, true, 2L, false, 3L, true)).values();
    }

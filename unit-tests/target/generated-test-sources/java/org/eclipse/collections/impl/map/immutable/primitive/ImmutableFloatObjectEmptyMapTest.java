...
/**
 * JUnit test for {@link ImmutableFloatObjectEmptyMap}.
 * This file was automatically generated from template file immutablePrimitiveObjectEmptyMapTest.stg.
 */
public class ImmutableFloatObjectEmptyMapTest extends AbstractImmutableFloatObjectMapTestCase
{
    ...
    {
        return (ImmutableFloatObjectMap<String>) ImmutableFloatObjectEmptyMap.INSTANCE;
    }
    ...
    public void getIfAbsent()
    {
        ...
        Assert.assertEquals("ifAbsent", this.classUnderTest().getIfAbsent(0.0f, ifAbsent));
    ...
    public void get()
    {
        Assert.assertNull(this.classUnderTest().get(0.0f));
    ...
    {
        this.classUnderTest().forEachKey((float each) -> Assert.fail());
    }
    ...
    {
        this.classUnderTest().forEachKeyValue((float eachKey, String eachValue) -> Assert.fail());
    }
    ...
    public void select()
    {
        ...
        Verify.assertIterableEmpty(this.classUnderTest().select((float value, String object) -> true));
    ...
    public void reject()
    {
        ...
        Verify.assertIterableEmpty(this.classUnderTest().reject((float value, String object) -> false));
    ...
    public void minBy()
    {
        Verify.assertThrows(NoSuchElementException.class, () -> this.classUnderTest().minBy(String::valueOf));
    }
    ...
    public void maxBy()
    {
        Verify.assertThrows(NoSuchElementException.class, () -> this.classUnderTest().maxBy(String::valueOf));
    }
    ...
    {
        ImmutableFloatObjectMap<Integer> map = new ImmutableFloatObjectEmptyMap<>();

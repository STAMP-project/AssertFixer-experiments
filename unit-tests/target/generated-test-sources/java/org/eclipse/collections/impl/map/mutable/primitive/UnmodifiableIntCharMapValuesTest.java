...
/**
 * JUnit test for {@link UnmodifiableIntCharMap#values()}.
 * This file was automatically generated from template file unmodifiablePrimitivePrimitiveMapValuesTest.stg.
 */
public class UnmodifiableIntCharMapValuesTest extends AbstractMutableCharCollectionTestCase
{
    @Override
    protected MutableCharCollection classUnderTest()
    {
        return IntCharHashMap.newWithKeysValues(1, (char) 1, 2, (char) 2, 3, (char) 3).values().asUnmodifiable();
    }

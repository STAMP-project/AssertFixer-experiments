...
/**
 * JUnit test for {@link ImmutableByteObjectSingletonMap}.
 * This file was automatically generated from template file immutablePrimitiveObjectSingletonMapTest.stg.
 */
public class ImmutableByteObjectSingletonMapTest extends AbstractImmutableByteObjectMapTestCase
{
    @Override
    protected ImmutableByteObjectMap<String> classUnderTest()
    {
        return ByteObjectHashMap.newWithKeysValues((byte) 0, "zero").toImmutable();
    }
    ...
    public void forEachKey()
    {
        ...
        this.classUnderTest().forEachKey((byte each) -> sum[0] += each);
    ...
    public void forEachKeyValue()
    {
        ...
        this.classUnderTest().forEachKeyValue((byte each, String parameter) ->
            {
                concat[0] += each;
                concat[0] += parameter;
            });
    ...
    {
        Assert.assertEquals(
                ByteObjectHashMap.newWithKeysValues((byte) 0, "zero"),
                this.classUnderTest().select((byte value, String object) -> value == 0));

        Verify.assertIterableEmpty(this.classUnderTest().select((byte value, String object) -> value != 0));
    ...
    public void collectBoolean()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 0, "true").collectBoolean(StringFunctions.toPrimitiveBoolean()));
    }
    ...
    public void collectBoolean_withTarget()
    {
        ...
        Assert.assertSame(target, this.newWithKeysValues((byte) 0, "true").collectBoolean(StringFunctions.toPrimitiveBoolean(), target));
    ...
    public void collectByte()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 0, "0").collectByte(Byte::parseByte));
    }
    ...
    public void collectByte_withTarget()
    {
        ...
        Assert.assertSame(target, this.newWithKeysValues((byte) 0, "0").collectByte(Byte::parseByte, target));
    ...
    public void collectChar()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 0, "0").collectChar(StringFunctions.toPrimitiveChar()));
    }
    ...
    public void collectChar_withTarget()
    {
        ...
        Assert.assertSame(target, this.newWithKeysValues((byte) 0, "0").collectChar(StringFunctions.toPrimitiveChar(), target));
    ...
    public void collectDouble()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 0, "0").collectDouble(Double::parseDouble));
    }
    ...
    public void collectDouble_withTarget()
    {
        ...
        Assert.assertSame(target, this.newWithKeysValues((byte) 0, "0").collectDouble(Double::parseDouble, target));
    ...
    public void collectFloat()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 0, "0").collectFloat(Float::parseFloat));
    }
    ...
    public void collectFloat_withTarget()
    {
        ...
        Assert.assertSame(target, this.newWithKeysValues((byte) 0, "0").collectFloat(Float::parseFloat, target));
    ...
    public void collectInt()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 0, "0").collectInt(Integer::parseInt));
    }
    ...
    public void collectInt_withTarget()
    {
        ...
        Assert.assertSame(target, this.newWithKeysValues((byte) 0, "0").collectInt(Integer::parseInt, target));
    ...
    public void collectLong()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 0, "0").collectLong(Long::parseLong));
    }
    ...
    public void collectLong_withTarget()
    {
        ...
        Assert.assertSame(target, this.newWithKeysValues((byte) 0, "0").collectLong(Long::parseLong, target));
    ...
    public void collectShort()
    {
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 0, "0").collectShort(Short::parseShort));
    }
    ...
    public void collectShort_withTarget()
    {
        ...
        Assert.assertSame(target, this.newWithKeysValues((byte) 0, "0").collectShort(Short::parseShort, target));

...
public abstract class AbstractLongFloatMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith(1L, 2.0f, 2L, 3.0f, 3L, 4.0f).collect((LongFloatPair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Long> result2 =
            this.newWith(1L, 2.0f, 2L, 3.0f, 3L, 4.0f).collect((LongFloatPair object) -> (long) object.getTwo());
    ...
    public void detectWithIfNoneBlock()
    {
        Function0<LongFloatPair> function = Functions0.value(PrimitiveTuples.pair(5L, 6.0f));
        Assert.assertEquals(
            PrimitiveTuples.pair(2L, 3.0f),
            this.newWith(1L, 2.0f, 2L, 3.0f, 3L, 4.0f).detectWithIfNone(
                    Object::equals,
                    PrimitiveTuples.pair(2L, 3.0f),
                    function));
        Assert.assertEquals(
            PrimitiveTuples.pair(5L, 6.0f),
            this.newWith(1L, 2.0f, 2L, 3.0f, 3L, 4.0f).detectWithIfNone(
                    Object::equals,
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith(1L, 2.0f, 2L, 3.0f, 3L, 4.0f).collectIf(
                        LongFloatPair.class::isInstance,
                        String::valueOf),
                "1:2.0", "2:3.0", "3:4.0");
        Verify.assertContainsAll(
                this.newWith(1L, 2.0f, 2L, 3.0f, 3L, 4.0f).collectIf(
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith(1L, 2.0f, 2L, 3.0f, 3L, 4.0f).collectWith((LongFloatPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(4L, 6L, 8L),
                this.newWith(1L, 2.0f, 2L, 3.0f, 3L, 4.0f).collectWith((LongFloatPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1L, 2.0f).equals(first)
                || PrimitiveTuples.pair(2L, 3.0f).equals(first)
                || PrimitiveTuples.pair(3L, 4.0f).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1L, 2.0f).equals(last)
                || PrimitiveTuples.pair(2L, 3.0f).equals(last)
                || PrimitiveTuples.pair(3L, 4.0f).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair(3L, 4.0f),
                PrimitiveTuples.pair(2L, 3.0f),
                PrimitiveTuples.pair(1L, 2.0f)),
                set);
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1L, 2.0f), 1), Tuples.pair(PrimitiveTuples.pair(2L, 3.0f), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2L, 3.0f), 1), Tuples.pair(PrimitiveTuples.pair(1L, 2.0f), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1L, 2.0f), 0), Tuples.pair(PrimitiveTuples.pair(2L, 3.0f), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2L, 3.0f), 0), Tuples.pair(PrimitiveTuples.pair(1L, 2.0f), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<LongFloatPair> collection = this.newWith(1L, 2.0f, 2L, 3.0f, 3L, 4.0f);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair(1L, 2.0f)),
                FastList.newListWith(PrimitiveTuples.pair(2L, 3.0f)),
                FastList.newListWith(PrimitiveTuples.pair(3L, 4.0f))),

...
public abstract class AbstractDoubleIntMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith(1.0, 2, 2.0, 3, 3.0, 4).collect((DoubleIntPair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Long> result2 =
            this.newWith(1.0, 2, 2.0, 3, 3.0, 4).collect((DoubleIntPair object) -> (long) object.getTwo());
    ...
    public void detectWithIfNoneBlock()
    {
        Function0<DoubleIntPair> function = Functions0.value(PrimitiveTuples.pair(5.0, 6));
        Assert.assertEquals(
            PrimitiveTuples.pair(2.0, 3),
            this.newWith(1.0, 2, 2.0, 3, 3.0, 4).detectWithIfNone(
                    Object::equals,
                    PrimitiveTuples.pair(2.0, 3),
                    function));
        Assert.assertEquals(
            PrimitiveTuples.pair(5.0, 6),
            this.newWith(1.0, 2, 2.0, 3, 3.0, 4).detectWithIfNone(
                    Object::equals,
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith(1.0, 2, 2.0, 3, 3.0, 4).collectIf(
                        DoubleIntPair.class::isInstance,
                        String::valueOf),
                "1.0:2", "2.0:3", "3.0:4");
        Verify.assertContainsAll(
                this.newWith(1.0, 2, 2.0, 3, 3.0, 4).collectIf(
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith(1.0, 2, 2.0, 3, 3.0, 4).collectWith((DoubleIntPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(4L, 6L, 8L),
                this.newWith(1.0, 2, 2.0, 3, 3.0, 4).collectWith((DoubleIntPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1.0, 2).equals(first)
                || PrimitiveTuples.pair(2.0, 3).equals(first)
                || PrimitiveTuples.pair(3.0, 4).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1.0, 2).equals(last)
                || PrimitiveTuples.pair(2.0, 3).equals(last)
                || PrimitiveTuples.pair(3.0, 4).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair(3.0, 4),
                PrimitiveTuples.pair(2.0, 3),
                PrimitiveTuples.pair(1.0, 2)),
                set);
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1.0, 2), 1), Tuples.pair(PrimitiveTuples.pair(2.0, 3), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2.0, 3), 1), Tuples.pair(PrimitiveTuples.pair(1.0, 2), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1.0, 2), 0), Tuples.pair(PrimitiveTuples.pair(2.0, 3), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2.0, 3), 0), Tuples.pair(PrimitiveTuples.pair(1.0, 2), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<DoubleIntPair> collection = this.newWith(1.0, 2, 2.0, 3, 3.0, 4);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair(1.0, 2)),
                FastList.newListWith(PrimitiveTuples.pair(2.0, 3)),
                FastList.newListWith(PrimitiveTuples.pair(3.0, 4))),

...
/**
 * JUnit test for {@link SynchronizedFloatBooleanMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitiveBooleanMapValuesTest.stg.
 */
public class SynchronizedFloatBooleanMapValuesTest extends AbstractMutableBooleanCollectionTestCase
{
    @Override
    protected MutableBooleanCollection classUnderTest()
    {
        return new SynchronizedFloatBooleanMap(FloatBooleanHashMap.newWithKeysValues(1.0f, true, 2.0f, false, 3.0f, true)).values();
    }

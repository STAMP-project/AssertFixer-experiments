...
/**
 * JUnit test for {@link FloatLongHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class FloatLongHashMapValuesTest extends AbstractMutableLongCollectionTestCase
{
    @Override
    protected MutableLongCollection classUnderTest()
    {
        return FloatLongHashMap.newWithKeysValues(1.0f, 1L, 2.0f, 2L, 3.0f, 3L).values();
    }
    ...
    public void retainAll()
    {
        ...
        FloatLongHashMap map = FloatLongHashMap.newWithKeysValues(0.0f, 0L, 1.0f, 1L, 2.0f, 2L, 3.0f, 3L);
        MutableLongCollection collection = map.values();

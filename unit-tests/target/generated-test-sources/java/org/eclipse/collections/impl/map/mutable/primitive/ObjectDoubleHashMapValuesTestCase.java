 ...
 */
public abstract class ObjectDoubleHashMapValuesTestCase extends AbstractMutableDoubleCollectionTestCase
{
    public abstract MutableObjectDoubleMap<String> newMapWithKeysValues(String key1, double value1);

    public abstract MutableObjectDoubleMap<String> newMapWithKeysValues(String key1, double value1, String key2, double value2);

    public abstract MutableObjectDoubleMap<String> newMapWithKeysValues(String key1, double value1, String key2, double value2, String key3, double value3);

    public abstract MutableObjectDoubleMap<String> newMapWithKeysValues(String key1, double value1, String key2, double value2, String key3, double value3, String key4, double value4);

    public abstract MutableObjectDoubleMap<String> newEmptyMap();

    @Override
    protected MutableDoubleCollection classUnderTest()
    {
        return this.newMapWithKeysValues(String.valueOf(1), 1.0, String.valueOf(2), 2.0, String.valueOf(3), 3.0).values();
    }

    @Override
    protected MutableDoubleCollection newWith(double... elements)
    {
        MutableObjectDoubleMap map = this.newEmptyMap();
    ...
    public void doubleIterator()
    {
        ...
        DoubleIterator iterator1 = bag.doubleIterator();
        for (int i = 0; i < 4; i++)
        {
        ...
        MutableObjectDoubleMap<String> map2 = new ObjectDoubleHashMap<>();
        for (double each = 2.0; each < 100.0; each++)
        {
            map2.put(String.valueOf(each), each);
        }
        MutableDoubleIterator iterator2 = map2.doubleIterator();
    ...
    public void remove()
    {
        MutableObjectDoubleMap<String> map = this.newMapWithKeysValues(String.valueOf(1), 1.0, String.valueOf(2), 2.0, String.valueOf(3), 3.0);
    ...
    public void retainAll()
    {
        ...
        Assert.assertTrue(collection.retainAll(1.0, 0.0, 4.0));
        Assert.assertTrue(collection.isEmpty());
        Assert.assertFalse(collection.contains(1.0));
        Assert.assertFalse(collection.contains(2.0));
        Assert.assertFalse(collection.contains(3.0));
    ...
    public void retainAll_iterable()
    {
        ...
        MutableObjectDoubleMap<String> map = this.newMapWithKeysValues(String.valueOf(1), 1.0, String.valueOf(2), 2.0, String.valueOf(3), 3.0);
        MutableDoubleCollection collection = map.values();
        Assert.assertFalse(collection.retainAll(DoubleArrayList.newListWith(1.0, 2.0, 3.0)));
        ...
        Assert.assertTrue(collection.retainAll(DoubleArrayList.newListWith(1.0, 0.0, 4.0)));
        Assert.assertTrue(collection.isEmpty());
        Assert.assertFalse(collection.contains(1.0));
        Assert.assertFalse(collection.contains(2.0));
        Assert.assertFalse(collection.contains(3.0));
    ...
    public void chunk()
    {
        DoubleIterable iterable = this.newMapWithKeysValues(String.valueOf(1), 1.0, String.valueOf(2), 2.0, String.valueOf(3), 3.0);
        Assert.assertEquals(
                Lists.mutable.with(

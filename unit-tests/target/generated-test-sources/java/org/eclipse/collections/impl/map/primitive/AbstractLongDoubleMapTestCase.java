 ...
 */
public abstract class AbstractLongDoubleMapTestCase
{
    protected final LongDoubleMap map = this.classUnderTest();

    protected abstract LongDoubleMap classUnderTest();

    protected abstract LongDoubleMap newWithKeysValues(long key1, double value1);

    protected abstract LongDoubleMap newWithKeysValues(long key1, double value1, long key2, double value2);

    protected abstract LongDoubleMap newWithKeysValues(long key1, double value1, long key2, double value2, long key3, double value3);

    protected abstract LongDoubleMap newWithKeysValues(long key1, double value1, long key2, double value2, long key3, double value3, long key4, double value4);

    protected abstract LongDoubleMap getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(LongHashSet.newSetWith(0L), this.newWithKeysValues(0L, 0.0).keySet());
        Assert.assertEquals(LongHashSet.newSetWith(0L, 31L, 32L),
                this.newWithKeysValues(0L, 0.0, 31L, 31.0, 32L, 32.0).keySet());
    }
    ...
    public void values()
    {
        ...
        LongDoubleMap map = this.newWithKeysValues(0L, 0.0);
        Verify.assertSize(1, map.values());
        Assert.assertTrue(map.values().contains(0.0));

        LongDoubleMap map1 = this.newWithKeysValues(0L, 0.0, 31L, 31.0, 32L, 32.0);
    ...
    public void isEmpty()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1L, 1.0).isEmpty());
        Assert.assertFalse(this.newWithKeysValues(0L, 0.0).isEmpty());
        Assert.assertFalse(this.newWithKeysValues(50L, 50.0).isEmpty());
    }
    ...
    public void notEmpty()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(1L, 1.0).notEmpty());
        Assert.assertTrue(this.newWithKeysValues(0L, 0.0).notEmpty());
        Assert.assertTrue(this.newWithKeysValues(50L, 50.0).notEmpty());
    }
    ...
    public void testEquals()
    {
        ...
        LongDoubleMap map9 = this.newWithKeysValues(0L, 0.0);
        ...
        Assert.assertEquals(map1, LongDoubleMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, LongDoubleMaps.immutable.ofAll(map1));
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0L, 0.0, 1L, 1.0, 32L, 32.0).hashCode(),
                this.newWithKeysValues(32L, 32.0, 0L, 0.0, 1L, 1.0).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50L, 0.0, 60L, 1.0, 70L, 33.0).hashCode(),
                this.newWithKeysValues(50L, 0.0, 60L, 1.0, 70L, 33.0).hashCode());
        Assert.assertEquals(UnifiedMap.newMap().hashCode(), this.getEmptyMap().hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(1L, 2.0).hashCode(), this.newWithKeysValues(1L, 2.0).hashCode());
    }
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{0=0.0}", this.newWithKeysValues(0L, 0.0).toString());
        Assert.assertEquals("{1=1.0}", this.newWithKeysValues(1L, 1.0).toString());
        Assert.assertEquals("{5=5.0}", this.newWithKeysValues(5L, 5.0).toString());

        LongDoubleMap map1 = this.newWithKeysValues(0L, 0.0, 1L, 1.0);
        Assert.assertTrue(
                map1.toString(),
                "{0=0.0, 1=1.0}".equals(map1.toString())
                        || "{1=1.0, 0=0.0}".equals(map1.toString()));

        LongDoubleMap map2 = this.newWithKeysValues(1L, 1.0, 32L, 32.0);
        Assert.assertTrue(
                map2.toString(),
                "{1=1.0, 32=32.0}".equals(map2.toString())
                        || "{32=32.0, 1=1.0}".equals(map2.toString()));

        LongDoubleMap map3 = this.newWithKeysValues(0L, 0.0, 32L, 32.0);
        Assert.assertTrue(
                map3.toString(),
                "{0=0.0, 32=32.0}".equals(map3.toString())
                        || "{32=32.0, 0=0.0}".equals(map3.toString()));

        LongDoubleMap map4 = this.newWithKeysValues(32L, 32.0, 33L, 33.0);
        Assert.assertTrue(
                map4.toString(),
    ...
    public void forEachKey()
    {
        ...
        LongDoubleMap map3 = this.newWithKeysValues(1L, 1.0);
    ...
    public void forEachKeyValue()
    {
        ...
        map0.forEachKeyValue((long eachKey, double eachValue) ->
        {
            sumKey0[0] += eachKey;
        ...
        map1.forEachKeyValue((long eachKey, double eachValue) ->
        {
            sumKey1[0] += eachKey;
        ...
        map01.forEachKeyValue((long eachKey, double eachValue) ->
        {
            sumKey01[0] += eachKey;
        ...
        map.forEachKeyValue((long eachKey, double eachValue) ->
        {
            sumKey[0] += eachKey;
        ...
        map2.forEachKeyValue((long eachKey, double eachValue) ->
        {
            sumKey2[0] += eachKey;
        ...
        LongDoubleMap map3 = this.newWithKeysValues(3L, 5.0);
        long[] sumKey3 = new long[1];
        double[] sumValue3 = new double[1];
        map3.forEachKeyValue((long eachKey, double eachValue) ->
        {
            sumKey3[0] += eachKey;
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("", this.getEmptyMap().makeString(", "));
        Assert.assertEquals("[]", this.getEmptyMap().makeString("[", "/", "]"));
        Assert.assertEquals("0.0", this.newWithKeysValues(0L, 0.0).makeString());
        Assert.assertEquals("0.0", this.newWithKeysValues(0L, 0.0).makeString(", "));
        Assert.assertEquals("[0.0]", this.newWithKeysValues(0L, 0.0).makeString("[", "/", "]"));
        Assert.assertEquals("1.0", this.newWithKeysValues(1L, 1.0).makeString());
        Assert.assertEquals("5.0", this.newWithKeysValues(5L, 5.0).makeString());
    ...
    public void appendString()
    {
        ...
        LongDoubleMap map3 = this.newWithKeysValues(1L, 1.0, 32L, 32.0);
    ...
    public void select()
    {
        LongDoubleMap map = this.newWithKeysValues(0L, 0.0, 1L, 1.0, 2L, 2.0, 3L, 3.0);
        LongDoubleMap actual1 = map.select((long key, double value) -> key == 1L || Double.compare(value, 3.0) == 0);
        Assert.assertEquals(LongDoubleHashMap.newWithKeysValues(1L, 1.0, 3L, 3.0), actual1);
        LongDoubleMap actual2 = map.select((long key, double value) -> key == 0L || Double.compare(value, 2.0) == 0);
        Assert.assertEquals(LongDoubleHashMap.newWithKeysValues(0L, 0.0, 2L, 2.0), actual2);
    }
    ...
    {
        LongDoubleMap map = this.newWithKeysValues(0L, 0.0, 1L, 1.0, 2L, 2.0, 3L, 3.0);
        LongDoubleMap actual1 = map.reject((long key, double value) -> key == 1L || Double.compare(value, 3.0) == 0);
        Assert.assertEquals(LongDoubleHashMap.newWithKeysValues(0L, 0.0, 2L, 2.0), actual1);
        LongDoubleMap actual2 = map.reject((long key, double value)-> key == 0L || Double.compare(value, 2.0) == 0);
        Assert.assertEquals(LongDoubleHashMap.newWithKeysValues(1L, 1.0, 3L, 3.0), actual2);
    }
    ...
    public void collect()
    {
        ...
        Assert.assertEquals(Bags.immutable.with(2.0), this.newWithKeysValues(1L, 1.0).collect(function));
    }
    ...
    public void detectIfNone_value()
    {
        ...
        Assert.assertEquals(5.0, this.newWithKeysValues(1L, 1.0).detectIfNone(DoublePredicates.equal(0.0), 5.0), 0.0);
        Assert.assertEquals(1.0, this.newWithKeysValues(1L, 1.0).detectIfNone(DoublePredicates.equal(1.0), 5.0), 0.0);
    ...
    public void anySatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1L, 1.0).anySatisfy(DoublePredicates.equal(0.0)));
        Assert.assertTrue(this.newWithKeysValues(1L, 1.0).anySatisfy(DoublePredicates.equal(1.0)));
    ...
    public void allSatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1L, 1.0).allSatisfy(DoublePredicates.equal(0.0)));
        Assert.assertTrue(this.newWithKeysValues(1L, 1.0).allSatisfy(DoublePredicates.equal(1.0)));
        ...
        LongDoubleMap map1 = this.newWithKeysValues(2L, 2.0, 3L, 3.0);
    ...
    public void noneSatisfy()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(1L, 1.0).noneSatisfy(DoublePredicates.equal(0.0)));
        Assert.assertFalse(this.newWithKeysValues(1L, 1.0).noneSatisfy(DoublePredicates.equal(1.0)));
    ...
    public void max()
    {
        ...
        Assert.assertEquals(3.0, this.newWithKeysValues(3L, 3.0).max(), 0.0);
    }

    @Test
    public void min()
    {
        LongDoubleMap map = this.newWithKeysValues(1L, 1.0, 2L, 2.0, 3L, 3.0, 0L, 0.0);
        Assert.assertEquals(0.0, map.min(), 0.0);
        Assert.assertEquals(3.0, this.newWithKeysValues(3L, 3.0).min(), 0.0);
    }
    ...
    public void minIfEmpty()
    {
        ...
        LongDoubleMap map = this.newWithKeysValues(1L, 1.0, 0L, 0.0, 9L, 9.0, 7L, 7.0);
        Assert.assertEquals(0.0, map.minIfEmpty(5.0), 0.0);
        Assert.assertEquals(3.0, this.newWithKeysValues(3L, 3.0).maxIfEmpty(5.0), 0.0);
    }
    ...
    public void maxIfEmpty()
    {
        ...
        Assert.assertEquals(3.0, this.newWithKeysValues(3L, 3.0).minIfEmpty(5.0), 0.0);
    }
    ...
    public void sum()
    {
        ...
        LongDoubleMap map2 = this.newWithKeysValues(2L, 2.0, 3L, 3.0, 4L, 4.0);
        Assert.assertEquals(9.0, map2.sum(), 0.0);
        LongDoubleMap map3 = this.newWithKeysValues(2L, 2.0);
    ...
    public void average()
    {
        ...
        LongDoubleMap map1 = this.newWithKeysValues(1L, 1.0);
    ...
    public void median()
    {
        ...
        LongDoubleMap map2 = this.newWithKeysValues(0L, 0.0, 1L, 1.0, 2L, 2.0);
    ...
    public void toList()
    {
        Assert.assertEquals(DoubleArrayList.newListWith(0.0), this.newWithKeysValues(0L, 0.0).toList());
        Assert.assertEquals(DoubleArrayList.newListWith(1.0), this.newWithKeysValues(1L, 1.0).toList());
        Assert.assertEquals(DoubleArrayList.newListWith(2.0), this.newWithKeysValues(2L, 2.0).toList());
        Assert.assertTrue(this.newWithKeysValues(2L, 2.0, 3L, 3.0).toList().equals(DoubleArrayList.newListWith(2.0, 3.0))
                || this.newWithKeysValues(2L, 2.0, 3L, 3.0).toList().equals(DoubleArrayList.newListWith(3.0, 2.0)));
    }
    ...
    public void toSortedList()
    {
        ...
        Assert.assertEquals(DoubleArrayList.newListWith(1.0), this.newWithKeysValues(1L, 1.0).toSortedList());
    }
    ...
    public void toSet()
    {
        ...
        Assert.assertEquals(DoubleHashSet.newSetWith(1.0), this.newWithKeysValues(1L, 1.0).toSet());
    }
    ...
    public void toBag()
    {
        ...
        Assert.assertEquals(DoubleHashBag.newBagWith(1.0), this.newWithKeysValues(1L, 1.0).toBag());
    }
    ...
    {
        MutableBag<LongDoublePair> expected = Bags.mutable.of();
        this.map.forEachKeyValue((long key, double value) -> expected.add(PrimitiveTuples.pair(key, value)));
    ...
    public void toArray()
    {
        LongDoubleMap map = this.newWithKeysValues(1L, 1.0, 2L, 2.0);
        ...
        Assert.assertTrue(Arrays.equals(new double[]{1.0}, this.newWithKeysValues(1L, 1.0).toArray()));
    }
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableLongDoubleMap.class, this.classUnderTest().toImmutable());
    }

    @Test
    public void chunk()
    {
        DoubleIterable iterable = this.newWithKeysValues(1L, 1.0, 2L, 2.0, 3L, 3.0);
        Assert.assertEquals(
                Lists.mutable.with(
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1L, 1.0).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1L, 1.0).chunk(-1));
    }
}

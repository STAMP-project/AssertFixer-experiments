...
/**
 * JUnit test for {@link UnmodifiableDoubleCharMap#keySet()}.
 *
 * This file was automatically generated from template file unmodifiablePrimitivePrimitiveMapKeySetTest.stg.
 */
public class UnmodifiableDoubleCharMapKeySetTest extends AbstractDoubleSetTestCase
{
    @Override
    protected MutableDoubleSet classUnderTest()
    {
        return new UnmodifiableDoubleCharMap(DoubleCharHashMap.newWithKeysValues(1.0, (char) 1, 2.0, (char) 2, 3.0, (char) 3)).keySet();
    }

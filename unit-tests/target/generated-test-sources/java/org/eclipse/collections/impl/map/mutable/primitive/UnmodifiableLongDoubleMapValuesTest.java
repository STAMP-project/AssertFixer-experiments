...
/**
 * JUnit test for {@link UnmodifiableLongDoubleMap#values()}.
 * This file was automatically generated from template file unmodifiablePrimitivePrimitiveMapValuesTest.stg.
 */
public class UnmodifiableLongDoubleMapValuesTest extends AbstractMutableDoubleCollectionTestCase
{
    @Override
    protected MutableDoubleCollection classUnderTest()
    {
        return LongDoubleHashMap.newWithKeysValues(1L, 1.0, 2L, 2.0, 3L, 3.0).values().asUnmodifiable();
    }

...
/**
 * JUnit test for {@link SynchronizedIntLongMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMapValuesTest.stg.
 */
public class SynchronizedIntLongMapValuesTest extends AbstractMutableLongCollectionTestCase
{
    @Override
    protected MutableLongCollection classUnderTest()
    {
        return new SynchronizedIntLongMap(IntLongHashMap.newWithKeysValues(1, 1L, 2, 2L, 3, 3L)).values();
    }

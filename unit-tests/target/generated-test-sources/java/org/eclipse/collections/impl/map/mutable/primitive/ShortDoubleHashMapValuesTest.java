...
/**
 * JUnit test for {@link ShortDoubleHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class ShortDoubleHashMapValuesTest extends AbstractMutableDoubleCollectionTestCase
{
    @Override
    protected MutableDoubleCollection classUnderTest()
    {
        return ShortDoubleHashMap.newWithKeysValues((short) 1, 1.0, (short) 2, 2.0, (short) 3, 3.0).values();
    }
    ...
    public void retainAll()
    {
        ...
        ShortDoubleHashMap map = ShortDoubleHashMap.newWithKeysValues((short) 0, 0.0, (short) 1, 1.0, (short) 2, 2.0, (short) 3, 3.0);
        MutableDoubleCollection collection = map.values();

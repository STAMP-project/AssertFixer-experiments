...
/**
 * JUnit test for {@link SynchronizedIntBooleanMap#values()}.
 * This file was automatically generated from template file synchronizedPrimitiveBooleanMapValuesTest.stg.
 */
public class SynchronizedIntBooleanMapValuesTest extends AbstractMutableBooleanCollectionTestCase
{
    @Override
    protected MutableBooleanCollection classUnderTest()
    {
        return new SynchronizedIntBooleanMap(IntBooleanHashMap.newWithKeysValues(1, true, 2, false, 3, true)).values();
    }

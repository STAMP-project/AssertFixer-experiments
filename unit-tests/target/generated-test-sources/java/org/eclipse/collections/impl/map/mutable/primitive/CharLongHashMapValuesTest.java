...
/**
 * JUnit test for {@link CharLongHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class CharLongHashMapValuesTest extends AbstractMutableLongCollectionTestCase
{
    @Override
    protected MutableLongCollection classUnderTest()
    {
        return CharLongHashMap.newWithKeysValues((char) 1, 1L, (char) 2, 2L, (char) 3, 3L).values();
    }
    ...
    public void retainAll()
    {
        ...
        CharLongHashMap map = CharLongHashMap.newWithKeysValues((char) 0, 0L, (char) 1, 1L, (char) 2, 2L, (char) 3, 3L);
        MutableLongCollection collection = map.values();

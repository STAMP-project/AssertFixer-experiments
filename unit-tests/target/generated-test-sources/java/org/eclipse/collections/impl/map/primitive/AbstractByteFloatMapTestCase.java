...
public abstract class AbstractByteFloatMapTestCase
{
    ...
    public void keySet()
    {
        ...
        Assert.assertEquals(ByteHashSet.newSetWith((byte) 0, (byte) 31, (byte) 32),
                this.newWithKeysValues((byte) 0, 0.0f, (byte) 31, 31.0f, (byte) 32, 32.0f).keySet());
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 0, 0.0f, (byte) 1, 1.0f, (byte) 32, 32.0f).hashCode(),
                this.newWithKeysValues((byte) 32, 32.0f, (byte) 0, 0.0f, (byte) 1, 1.0f).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues((byte) 50, 0.0f, (byte) 60, 1.0f, (byte) 70, 33.0f).hashCode(),
                this.newWithKeysValues((byte) 50, 0.0f, (byte) 60, 1.0f, (byte) 70, 33.0f).hashCode());
    ...
    public void toList()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues((byte) 2, 2.0f, (byte) 3, 3.0f).toList().equals(FloatArrayList.newListWith(2.0f, 3.0f))
                || this.newWithKeysValues((byte) 2, 2.0f, (byte) 3, 3.0f).toList().equals(FloatArrayList.newListWith(3.0f, 2.0f)));
    }
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues((byte) 1, 1.0f).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((byte) 1, 1.0f).chunk(-1));
    }
}

...
public abstract class AbstractFloatIntMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith(1.0f, 2, 2.0f, 3, 3.0f, 4).collect((FloatIntPair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Long> result2 =
            this.newWith(1.0f, 2, 2.0f, 3, 3.0f, 4).collect((FloatIntPair object) -> (long) object.getTwo());
    ...
    public void detectWithIfNoneBlock()
    {
        Function0<FloatIntPair> function = Functions0.value(PrimitiveTuples.pair(5.0f, 6));
        Assert.assertEquals(
            PrimitiveTuples.pair(2.0f, 3),
            this.newWith(1.0f, 2, 2.0f, 3, 3.0f, 4).detectWithIfNone(
                    Object::equals,
                    PrimitiveTuples.pair(2.0f, 3),
                    function));
        Assert.assertEquals(
            PrimitiveTuples.pair(5.0f, 6),
            this.newWith(1.0f, 2, 2.0f, 3, 3.0f, 4).detectWithIfNone(
                    Object::equals,
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith(1.0f, 2, 2.0f, 3, 3.0f, 4).collectWith((FloatIntPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(4L, 6L, 8L),
                this.newWith(1.0f, 2, 2.0f, 3, 3.0f, 4).collectWith((FloatIntPair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1.0f, 2).equals(first)
                || PrimitiveTuples.pair(2.0f, 3).equals(first)
                || PrimitiveTuples.pair(3.0f, 4).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1.0f, 2).equals(last)
                || PrimitiveTuples.pair(2.0f, 3).equals(last)
                || PrimitiveTuples.pair(3.0f, 4).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair(3.0f, 4),
                PrimitiveTuples.pair(2.0f, 3),
                PrimitiveTuples.pair(1.0f, 2)),
                set);
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1.0f, 2), 1), Tuples.pair(PrimitiveTuples.pair(2.0f, 3), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2.0f, 3), 1), Tuples.pair(PrimitiveTuples.pair(1.0f, 2), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1.0f, 2), 0), Tuples.pair(PrimitiveTuples.pair(2.0f, 3), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2.0f, 3), 0), Tuples.pair(PrimitiveTuples.pair(1.0f, 2), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<FloatIntPair> collection = this.newWith(1.0f, 2, 2.0f, 3, 3.0f, 4);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair(1.0f, 2)),
                FastList.newListWith(PrimitiveTuples.pair(2.0f, 3)),
                FastList.newListWith(PrimitiveTuples.pair(3.0f, 4))),

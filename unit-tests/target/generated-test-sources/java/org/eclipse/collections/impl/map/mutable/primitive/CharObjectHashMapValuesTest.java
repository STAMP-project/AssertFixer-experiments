...
/**
 * JUnit test for {@link CharObjectHashMap#values()}.
 *
 * This file was automatically generated from template file primitiveObjectHashMapValuesTest.stg.
 */
public class CharObjectHashMapValuesTest
{
    private CharObjectHashMap<String> newMapWithKeysValues(char key1, String value1, char key2, String value2)
    {
        return CharObjectHashMap.newWithKeysValues(key1, value1, key2, value2);
    }

    private CharObjectHashMap<Integer> newMapWithKeysValues(char key1, Integer value1, char key2, Integer value2, char key3, Integer value3)
    {
        return CharObjectHashMap.newWithKeysValues(key1, value1, key2, value2, key3, value3);
    }

    private CharObjectHashMap<Integer> newMapWithKeysValues(char key1, Integer value1, char key2, Integer value2, char key3, Integer value3, char key4, Integer value4)
    {
        return CharObjectHashMap.newWithKeysValues(key1, value1, key2, value2, key3, value3).withKeyValue(key4, value4);
    }
    ...
    public void clear()
    {
        CharObjectHashMap<Integer> map = this.newMapWithKeysValues((char) 1, 1, (char) 2, 2, (char) 3, 3);
        map.values().clear();
    ...
    {
        CharObjectHashMap<Integer> map = this.newMapWithKeysValues((char) 1, 1, (char) 2, 2, (char) 3, null);
    ...
    public void isEmpty()
    {
        CharObjectHashMap<Integer> map = this.newMapWithKeysValues((char) 1, 1, (char) 2, 2, (char) 3, 3, (char) 1, null);
        Collection<Integer> values = map.values();
    ...
    public void size()
    {
        CharObjectHashMap<Integer> map = this.newMapWithKeysValues((char) 1, 1, (char) 2, 2, (char) 3, 3, (char) 4, null);
        Collection<Integer> values = map.values();

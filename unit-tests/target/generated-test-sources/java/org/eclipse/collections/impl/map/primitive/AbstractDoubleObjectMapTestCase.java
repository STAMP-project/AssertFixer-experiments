...
import org.eclipse.collections.impl.map.mutable.primitive.DoubleObjectHashMapTest;
 ...
 */
public abstract class AbstractDoubleObjectMapTestCase
{
    protected abstract DoubleObjectMap<String> classUnderTest();

    protected abstract <T> DoubleObjectMap<T> newWithKeysValues(double key1, T value1);

    protected abstract <T> DoubleObjectMap<T> newWithKeysValues(double key1, T value1, double key2, T value2);

    protected abstract <T> DoubleObjectMap<T> newWithKeysValues(double key1, T value1, double key2, T value2, double key3, T value3);

    protected abstract <T> DoubleObjectMap<T> getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(DoubleHashSet.newSetWith(0.0), this.newWithKeysValues(0.0, "zero").keySet());
        Assert.assertEquals(DoubleHashSet.newSetWith(0.0, 1.0, 9.0),
                this.newWithKeysValues(0.0, "zero", 1.0, "one", 9.0, "nine").keySet());
    }
    ...
    public void values()
    {
        ...
        DoubleObjectMap<String> map = this.newWithKeysValues(0.0, "zero");
        Verify.assertSize(1, map.values());
        Verify.assertContains("zero", map.values());

        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "zero", 1.0, "one", 9.0, "nine");
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "zero", 1.0, "one", 9.0, "nine");
        DoubleObjectMap<String> map2 = this.newWithKeysValues(0.0, "zero", 9.0, "nine");
        DoubleObjectMap<String> map3 = this.newWithKeysValues(1.0, "one", 9.0, "nine");
        DoubleObjectMap<String> map4 = this.newWithKeysValues(5.0, "five", 9.0, "nine");

        Assert.assertEquals(DoubleObjectHashMap.newWithKeysValues(1.0, "one", 9.0, "nine"),
            map1.select((double value, String object) -> (value % 2) != 0));

        DoubleObjectPredicate<String> keyGreaterThanOrEqualToSeven = (double value, String object) -> value <= 7;

        Assert.assertEquals(DoubleObjectHashMap.newWithKeysValues(0.0, "zero", 1.0, "one"), map1.select(keyGreaterThanOrEqualToSeven));

        Assert.assertEquals(DoubleObjectHashMap.newWithKeysValues(0.0, "zero"), map2.select(keyGreaterThanOrEqualToSeven));

        Assert.assertEquals(DoubleObjectHashMap.newWithKeysValues(1.0, "one"), map3.select(keyGreaterThanOrEqualToSeven));

        Assert.assertEquals(DoubleObjectHashMap.newWithKeysValues(5.0, "five"), map4.select(keyGreaterThanOrEqualToSeven));

        Assert.assertEquals(DoubleObjectHashMap.newWithKeysValues(1.0, "one", 9.0, "nine"),
            map1.select((double value, String object) -> object.endsWith("ne")));
    ...
    {
        DoubleObjectMap<Number> numbers = this.<Number>newWithKeysValues(0.0, 0, 1.0, 1.0, 5.0, 5.0);
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "true", 1.0, "false", 2.0, "nah");
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "0", 1.0, "1", 2.0, "9");
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "zero", 9.0, "nine");
        DoubleObjectMap<String> map2 = this.newWithKeysValues(1.0, "one", 9.0, "nine");
        DoubleObjectMap<String> map3 = this.newWithKeysValues(5.0, "five", 9.0, "nine");
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "a", 9.0, "abcd");
        DoubleObjectMap<String> map2 = this.newWithKeysValues(1.0, "ab", 9.0, "abcd");
        DoubleObjectMap<String> map3 = this.newWithKeysValues(5.0, "abc", 9.0, "abcd");
    ...
    public void toSet()
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "zero", 5.0, "zero", 9.0, "nine");
        DoubleObjectMap<String> map2 = this.newWithKeysValues(1.0, "one", 5.0, "one", 9.0, "nine");
        DoubleObjectMap<String> map3 = this.newWithKeysValues(5.0, "five", 6.0, "five", 9.0, "nine");
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "z", 9.0, "abcd");
        DoubleObjectMap<String> map2 = this.newWithKeysValues(1.0, "ab", 9.0, "abcd");
        DoubleObjectMap<String> map3 = this.newWithKeysValues(5.0, "zyx", 9.0, "abcd");
    ...
    {
        DoubleObjectHashMap.newMap().min();
    }

    @Test
    public void maxBy()
    {
        DoubleObjectMap<Class<?>> map1 = this.newWithKeysValues(0.0, DoubleObjectHashMapTest.class, 9.0, DoubleObjectHashMap.class);
        DoubleObjectMap<Class<?>> map2 = this.newWithKeysValues(1.0, DoubleObjectHashMapTest.class, 9.0, DoubleObjectHashMap.class);
        DoubleObjectMap<Class<?>> map3 = this.newWithKeysValues(5.0, DoubleObjectHashMap.class, 9.0, DoubleObjectHashMapTest.class);

        Function<Class<?>, Integer> classNameLength = (Class<?> aClass) -> aClass.getName().length();
        Assert.assertEquals(DoubleObjectHashMapTest.class, map1.maxBy(classNameLength));
        Assert.assertEquals(DoubleObjectHashMapTest.class, map2.maxBy(classNameLength));
        Assert.assertEquals(DoubleObjectHashMapTest.class, map3.maxBy(classNameLength));

        Verify.assertThrows(NoSuchElementException.class, () -> DoubleObjectHashMap.<Class<?>>newMap().maxBy(classNameLength));
    }
    ...
    {
        DoubleObjectHashMap.newMap().max();
    }
    ...
    public void minBy()
    {
        ...
        Assert.assertEquals(DoubleObjectHashMap.class, map1.minBy(classNameLength));
        Assert.assertEquals(DoubleObjectHashMap.class, map2.minBy(classNameLength));
        Assert.assertEquals(DoubleObjectHashMap.class, map3.minBy(classNameLength));

        Verify.assertThrows(NoSuchElementException.class, () -> DoubleObjectHashMap.<Class<?>>newMap().minBy(classNameLength));
    }
    ...
    {
        RichIterable<String> values = this.newWithKeysValues(1.0, "1", 2.0, "2", 3.0, "3");
    ...
    {
        Assert.assertEquals(DoubleArrayList.newListWith(), this.getEmptyMap().keysView().toList());
        Assert.assertEquals(DoubleArrayList.newListWith(1.0), this.newWithKeysValues(1.0, "one").keysView().toList());
    }
    ...
    public void reject()
    {
        ...
        Assert.assertEquals(DoubleObjectHashMap.newWithKeysValues(1.0, "one", 9.0, "nine"),
            map1.reject((double value, String object) -> (value % 2) == 0));

        DoubleObjectPredicate<String> keyLessThanSeven = (double value, String object) -> value > 7;

        Assert.assertEquals(DoubleObjectHashMap.newWithKeysValues(0.0, "zero", 1.0, "one"), map1.reject(keyLessThanSeven));
        Assert.assertEquals(DoubleObjectHashMap.newWithKeysValues(0.0, "zero"), map2.reject(keyLessThanSeven));
        Assert.assertEquals(DoubleObjectHashMap.newWithKeysValues(1.0, "one"), map3.reject(keyLessThanSeven));
        Assert.assertEquals(DoubleObjectHashMap.newWithKeysValues(5.0, "five"), map4.reject(keyLessThanSeven));

        Assert.assertEquals(DoubleObjectHashMap.newWithKeysValues(1.0, "one", 9.0, "nine"),
            map1.reject((double value, String object) -> !object.endsWith("ne")));
    ...
    public void get()
    {
        ...
        Assert.assertEquals("thirtyOne", this.classUnderTest().get(31.0));
        Assert.assertEquals("thirtyTwo", this.classUnderTest().get(32.0));

        Assert.assertNull(this.classUnderTest().get(1.0));
        Assert.assertNull(this.classUnderTest().get(33.0));

        DoubleObjectMap<Object> emptyMap = this.getEmptyMap();
        Assert.assertNull(emptyMap.get(0.0));
        Assert.assertNull(emptyMap.get(1.0));
        Assert.assertNull(emptyMap.get(33.0));
    }
    ...
    public void getIfAbsent()
    {
        ...
        Assert.assertEquals("thirtyOne", this.classUnderTest().getIfAbsent(31.0, ifAbsent));
        Assert.assertEquals("thirtyTwo", this.classUnderTest().getIfAbsent(32.0, ifAbsent));
        ...
        DoubleObjectMap<Object> emptyMap = this.getEmptyMap();
        Assert.assertEquals("ifAbsent", emptyMap.getIfAbsent(0.0, ifAbsent));
        Assert.assertEquals("ifAbsent", emptyMap.getIfAbsent(1.0, ifAbsent));
        Assert.assertEquals("ifAbsent", emptyMap.getIfAbsent(33.0, ifAbsent));
    }
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(1.0, "one", 5.0, "five");
        DoubleObjectMap<String> map2 = this.newWithKeysValues(1.0, "one", 0.0, "zero");
        DoubleObjectMap<String> map3 = this.newWithKeysValues(2.0, "two", 5.0, "five");
        DoubleObjectMap<String> map4 = this.newWithKeysValues(0.0, "zero", 5.0, "five");
        String[] concat = {"", "", "", ""};
    ...
    public void forEachKey()
    {
        ...
        map1.forEachKey((double each) -> sum[0] += each);
        map2.forEachKey((double each) -> sum[1] += each);
        map3.forEachKey((double each) -> sum[2] += each);
        map4.forEachKey((double each) -> sum[3] += each);
    ...
    public void forEachKeyValue()
    {
        ...
        map1.forEachKeyValue((double each, String parameter) ->
        {
            concat[0] += each;
            concat[0] += parameter;
        });
        map2.forEachKeyValue((double each, String parameter) ->
        {
            concat[1] += each;
            concat[1] += parameter;
        });
        map3.forEachKeyValue((double each, String parameter) ->
        {
            concat[2] += each;
            concat[2] += parameter;
        });
        map4.forEachKeyValue((double each, String parameter) ->
        {
            concat[3] += each;
            concat[3] += parameter;
        });
    ...
    public void isEmpty()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1.0, "one").isEmpty());
        Assert.assertFalse(this.newWithKeysValues(0.0, "zero").isEmpty());
        Assert.assertFalse(this.newWithKeysValues(50.0, "fifty").isEmpty());
    }
    ...
    public void notEmpty()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(1.0, "one").notEmpty());
        Assert.assertTrue(this.newWithKeysValues(0.0, "zero").notEmpty());
        Assert.assertTrue(this.newWithKeysValues(50.0, "fifty").notEmpty());
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertNull(DoubleObjectHashMap.newMap().getFirst());
    }
    ...
    public void getLast()
    {
        ...
        Assert.assertEquals("zero", this.newWithKeysValues(0.0, "zero").getLast());
        Assert.assertNull(DoubleObjectHashMap.newMap().getLast());
    }

    @Test
    public void getOnly()
    {
        Assert.assertEquals("zero", this.newWithKeysValues(0.0, "zero").getOnly());
        Assert.assertEquals("one", this.newWithKeysValues(1.0, "one").getOnly());
        Assert.assertEquals("two", this.newWithKeysValues(2.0, "two").getOnly());
    }
    ...
    {
        this.newWithKeysValues(1.0, "one", 5.0, "five").getOnly();
    }
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "zero", 1.0, "one", 32.0, "thirtyTwo");
        DoubleObjectMap<String> map2 = this.newWithKeysValues(32.0, "thirtyTwo", 0.0, "zero", 1.0, "one");
        DoubleObjectMap<String> map3 = this.newWithKeysValues(0.0, "zero", 1.0, "two", 32.0, "thirtyTwo");
        DoubleObjectMap<String> map4 = this.newWithKeysValues(0.0, "one", 1.0, "one", 32.0, "thirtyTwo");
        DoubleObjectMap<String> map5 = this.newWithKeysValues(0.0, "zero", 1.0, "one", 32.0, "thirtyThree");
        DoubleObjectMap<String> map6 = this.newWithKeysValues(1.0, "one", 32.0, "thirtyTwo");
        DoubleObjectMap<String> map7 = this.newWithKeysValues(0.0, "zero", 32.0, "thirtyTwo");
        DoubleObjectMap<String> map8 = this.newWithKeysValues(50.0, "zero", 60.0, "one", 70.0, "thirtyThree");
        DoubleObjectMap<String> map9 = this.newWithKeysValues(50.0, "zero", 60.0, "one");
        DoubleObjectMap<String> map10 = this.newWithKeysValues(50.0, "zero");
        ...
        Verify.assertPostSerializedEqualsAndHashCode(DoubleObjectHashMap.newMap());
        Verify.assertEqualsAndHashCode(map1, map2);
        ...
        Assert.assertNotEquals(this.newWithKeysValues(0.0, null), this.newWithKeysValues(6.0, ""));
        Assert.assertNotEquals(this.newWithKeysValues(5.0, null), this.newWithKeysValues(6.0, ""));

        Assert.assertEquals(map1, DoubleObjectMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, DoubleObjectMaps.immutable.ofAll(map1));
    }

    @Test
    public void testHashCode()
    {
        Assert.assertEquals(UnifiedMap.newWithKeysValues(0.0, "zero", 1.0, "one", 32.0, "thirtyTwo").hashCode(), this.newWithKeysValues(32.0, "thirtyTwo", 0.0, "zero", 1.0, "one").hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(0.0, null, 1.0, null).hashCode(), this.newWithKeysValues(0.0, null, 1.0, null).hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(50.0, "zero", 60.0, "one", 70.0, "thirtyThree").hashCode(), this.newWithKeysValues(50.0, "zero", 60.0, "one", 70.0, "thirtyThree").hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(50.0, null, 60.0, null).hashCode(), this.newWithKeysValues(50.0, null, 60.0, null).hashCode());
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{0.0=zero}", this.newWithKeysValues(0.0, "zero").toString());
        Assert.assertEquals("{1.0=one}", this.newWithKeysValues(1.0, "one").toString());
        Assert.assertEquals("{5.0=five}", this.newWithKeysValues(5.0, "five").toString());

        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "zero", 1.0, "one");
        Assert.assertTrue(
                map1.toString(),
                "{0.0=zero, 1.0=one}".equals(map1.toString())
                        || "{1.0=one, 0.0=zero}".equals(map1.toString()));

        DoubleObjectMap<String> map2 = this.newWithKeysValues(1.0, "one", 32.0, "thirtyTwo");
        Assert.assertTrue(
                map2.toString(),
                "{1.0=one, 32.0=thirtyTwo}".equals(map2.toString())
                        || "{32.0=thirtyTwo, 1.0=one}".equals(map2.toString()));

        DoubleObjectMap<String> map3 = this.newWithKeysValues(0.0, "zero", 32.0, "thirtyTwo");
        Assert.assertTrue(
                map3.toString(),
                "{0.0=zero, 32.0=thirtyTwo}".equals(map3.toString())
                        || "{32.0=thirtyTwo, 0.0=zero}".equals(map3.toString()));

        DoubleObjectMap<String> map4 = this.newWithKeysValues(32.0, "thirtyTwo", 33.0, "thirtyThree");
        Assert.assertTrue(
                map4.toString(),
                "{32.0=thirtyTwo, 33.0=thirtyThree}".equals(map4.toString())
                        || "{33.0=thirtyThree, 32.0=thirtyTwo}".equals(map4.toString()));
    }

    @Test
    public void zip()
    {
        RichIterable<Pair<String, Integer>> zip1 = this.newWithKeysValues(0.0, "zero", 5.0, "five")
                .zip(FastList.newListWith(0, 5, 6));
        RichIterable<Pair<String, Integer>> zip2 = this.newWithKeysValues(1.0, "one", 5.0, "five")
                .zip(FastList.newListWith(1));
        RichIterable<Pair<String, Integer>> zip3 = this.newWithKeysValues(1.0, "one", 5.0, "five")
    ...
    public void chunk()
    {
        RichIterable<RichIterable<String>> chunk1 = this.newWithKeysValues(0.0, "zero", 5.0, "five")
                .chunk(1);
        RichIterable<RichIterable<String>> chunk2 = this.newWithKeysValues(1.0, "one", 5.0, "five")
                .chunk(1);
    ...
    {
        this.newWithKeysValues(0.0, "zero", 5.0, "five")
                .chunk(-1);
    }
    ...
    public void aggregateInPlaceBy()
    {
        ...
        DoubleObjectMap<Integer> collection = this.newWithKeysValues(1.0, 1, 2.0, 2, 3.0, 3);
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "zero", 1.0, "one");
        DoubleObjectMap<String> map2 = this.newWithKeysValues(2.0, "two", 3.0, "three");
        DoubleObjectMap<String> map3 = this.newWithKeysValues(4.0, "four");
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "zero", 9.0, "nine");
        DoubleObjectMap<String> map2 = this.newWithKeysValues(1.0, "one");
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "zero", 1.0, "one", 2.0, "two");
        DoubleObjectMap<String> map2 = this.newWithKeysValues(2.0, "two");
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "zero", 1.0, "one");
        DoubleObjectMap<String> map2 = this.newWithKeysValues(0.0, "zero");
        Function<String, Character> firstChar = (String object) -> object.charAt(0);
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(0.0, "zero");
        Function<String, Character> firstChar = (String object) -> object.charAt(0);
        map1.groupByUniqueKey(firstChar, UnifiedMap.newWithKeysValues('z', "zero"));
    }
    ...
    {
        DoubleObjectMap<String> map1 = this.newWithKeysValues(2.0, "two");
        Function<String, Character> firstChar = (String object) -> object.charAt(0);
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("zero", this.newWithKeysValues(0.0, "zero").makeString());
        Assert.assertEquals("one", this.newWithKeysValues(1.0, "one").makeString());
        Assert.assertEquals("five", this.newWithKeysValues(5.0, "five").makeString());
    ...
    public void appendString()
    {
        ...
        this.newWithKeysValues(0.0, "zero").appendString(appendable0);
        Assert.assertEquals("zero", appendable0.toString());

        Appendable appendable1 = new StringBuilder();
        this.newWithKeysValues(1.0, "one").appendString(appendable1);
        Assert.assertEquals("one", appendable1.toString());

        Appendable appendable2 = new StringBuilder();
        this.newWithKeysValues(5.0, "five").appendString(appendable2);
        ...
        DoubleObjectMap<String> map3 = this.newWithKeysValues(1.0, "one", 32.0, "thirtyTwo");
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableDoubleObjectMap.class, this.classUnderTest().toImmutable());
    }
    ...
    public void stream()
    {
        DoubleObjectMap<String> map = this.newWithKeysValues(1.0, "1", 2.0, "2", 9.0, "9");

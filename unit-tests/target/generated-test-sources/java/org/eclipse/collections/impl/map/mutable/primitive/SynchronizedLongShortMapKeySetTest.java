...
/**
 * JUnit test for {@link SynchronizedLongShortMap#keySet()}.
 *
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMapKeySetTest.stg.
 */
public class SynchronizedLongShortMapKeySetTest extends AbstractLongSetTestCase
{
    @Override
    protected MutableLongSet classUnderTest()
    {
        return new SynchronizedLongShortMap(LongShortHashMap.newWithKeysValues(1L, (short) 1, 2L, (short) 2, 3L, (short) 3)).keySet();
    }

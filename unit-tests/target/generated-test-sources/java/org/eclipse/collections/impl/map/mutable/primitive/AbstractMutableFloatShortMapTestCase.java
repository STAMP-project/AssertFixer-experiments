...
public abstract class AbstractMutableFloatShortMapTestCase extends AbstractFloatShortMapTestCase
{
    ...
    public void getIfAbsentPutWithKey()
    {
        ...
        FloatToShortFunction functionThrows = (float floatParameter) -> { throw new AssertionError(); };
    ...
    public void flipUniqueValues()
    {
        ...
        Assert.assertEquals(
                ShortFloatHashMap.newWithKeysValues((short) 2, 1.0f, (short) 3, 2.0f, (short) 4, 3.0f, (short) 5, 4.0f),
                map.flipUniqueValues());
         Verify.assertThrows(
                IllegalStateException.class,
                () -> this.newWithKeysValues(1.0f, (short) 1, 2.0f, (short) 1).flipUniqueValues());
    }
}

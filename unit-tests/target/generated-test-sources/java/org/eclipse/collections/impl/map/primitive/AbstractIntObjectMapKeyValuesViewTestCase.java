...
public abstract class AbstractIntObjectMapKeyValuesViewTestCase
{
    ...
    public void collectBoolean()
    {
        BooleanIterable result =
                this.newWith(1, 2, 2, 3, 3, 4).collectBoolean((IntObjectPair<Integer> each) -> (each.getOne() % 2) == 0);
    ...
    {
        ByteIterable result =
                this.newWith(1, 2, 2, 3, 3, 4).collectByte((IntObjectPair<Integer> anObject) -> (byte) anObject.getOne());
    ...
    {
        CharIterable result =
                this.newWith(1, 2, 2, 3, 3, 4).collectChar((IntObjectPair<Integer> anObject) -> (char) anObject.getOne());
    ...
    public void collectDouble()
    {
        DoubleIterable result =
                this.newWith(1, 2, 2, 3, 3, 4).collectDouble((IntObjectPair<Integer> anObject) -> (double) anObject.getOne());
    ...
    public void collectFloat()
    {
        FloatIterable result =
                this.newWith(1, 2, 2, 3, 3, 4).collectFloat((IntObjectPair<Integer> anObject) -> (float) anObject.getOne());
    ...
    {
        IntIterable result =
                this.newWith(1, 2, 2, 3, 3, 4).collectInt((IntObjectPair<Integer> anObject) -> (int) anObject.getOne());
    ...
    {
        LongIterable result =
                this.newWith(1, 2, 2, 3, 3, 4).collectLong((IntObjectPair<Integer> anObject) -> (long) anObject.getOne());
    ...
    public void collectShort()
    {
        ShortIterable result =
                this.newWith(1, 2, 2, 3, 3, 4).collectShort((IntObjectPair<Integer> anObject) -> (short) anObject.getOne());
    ...
    {
        Assert.assertEquals(
                PrimitiveTuples.pair(2, Integer.valueOf(3)),
                this.newWith(1, 2, 2, 3, 3, 4).minBy((IntObjectPair<Integer> object) -> (int) object.getOne() & 1));
    }
    ...
    {
        Assert.assertEquals(
                PrimitiveTuples.pair(1, Integer.valueOf(2)),
                this.newWith(1, 2, 2, 3, 4, 5).maxBy((IntObjectPair<Integer> object) -> (int) object.getOne() & 1));
    }
    ...
    {
        Function0<IntObjectPair<Integer>> function = Functions0.value(PrimitiveTuples.pair(5, Integer.valueOf(6)));
        Assert.assertEquals(PrimitiveTuples.pair(2, Integer.valueOf(3)), this.newWith(1, 2, 2, 3, 3, 4).detectWithIfNone(
                Object::equals,
                PrimitiveTuples.pair(2, Integer.valueOf(3)),
                function));
        Assert.assertEquals(PrimitiveTuples.pair(5, Integer.valueOf(6)), this.newWith(1, 2, 2, 3, 3, 4).detectWithIfNone(
                Object::equals,
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith(1, 2, 2, 3, 3, 4).collectIf(
                        IntObjectPair.class::isInstance,
                        String::valueOf),
                "1:2", "2:3", "3:4");
        Verify.assertContainsAll(
                this.newWith(1, 2, 2, 3, 3, 4).collectIf(
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith(1, 2, 2, 3, 3, 4)
                    .collectWith((IntObjectPair<Integer> argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(4L, 6L, 8L),
                this.newWith(1, 2, 2, 3, 3, 4)
                    .collectWith((IntObjectPair<Integer> argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1, Integer.valueOf(2)).equals(first)
                || PrimitiveTuples.pair(2, Integer.valueOf(3)).equals(first)
                || PrimitiveTuples.pair(3, Integer.valueOf(4)).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1, Integer.valueOf(2)).equals(last)
                || PrimitiveTuples.pair(2, Integer.valueOf(3)).equals(last)
                || PrimitiveTuples.pair(3, Integer.valueOf(4)).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair(3, Integer.valueOf(4)),
                PrimitiveTuples.pair(2, Integer.valueOf(3)),
                PrimitiveTuples.pair(1, Integer.valueOf(2))),
                set);
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1, Integer.valueOf(2)), 1), Tuples.pair(PrimitiveTuples.pair(2, Integer.valueOf(3)), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2, Integer.valueOf(3)), 1), Tuples.pair(PrimitiveTuples.pair(1, Integer.valueOf(2)), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1, Integer.valueOf(2)), 0), Tuples.pair(PrimitiveTuples.pair(2, Integer.valueOf(3)), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2, Integer.valueOf(3)), 0), Tuples.pair(PrimitiveTuples.pair(1, Integer.valueOf(2)), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<IntObjectPair<Integer>> collection = this.newWith(1, 2, 2, 3, 3, 4);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair(1, Integer.valueOf(2))),
                FastList.newListWith(PrimitiveTuples.pair(2, Integer.valueOf(3))),
                FastList.newListWith(PrimitiveTuples.pair(3, Integer.valueOf(4)))),

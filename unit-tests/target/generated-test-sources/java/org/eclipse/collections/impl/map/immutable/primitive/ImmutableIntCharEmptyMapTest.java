...
/**
 * JUnit test for {@link ImmutableIntCharEmptyMap}.
 * This file was automatically generated from template file immutablePrimitivePrimitiveEmptyMapTest.stg.
 */
public class ImmutableIntCharEmptyMapTest extends AbstractImmutableIntCharMapTestCase
{
    @Override
    ...
    {
        Assert.assertEquals(5L, this.map.getIfAbsent(0, (char) 5));
    ...
    public void select()
    {
        Assert.assertEquals(this.classUnderTest(), this.classUnderTest().select((int value1, char value2) -> true));
    }
    ...
    public void reject()
    {
        Assert.assertEquals(this.classUnderTest(), this.classUnderTest().reject((int value1, char value2) -> false));
    }
    ...
    {
        ImmutableIntCharEmptyMap iterable = new ImmutableIntCharEmptyMap();

...
/**
 * JUnit test for {@link ByteFloatHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class ByteFloatHashMapValuesTest extends AbstractMutableFloatCollectionTestCase
{
    @Override
    protected MutableFloatCollection classUnderTest()
    {
        return ByteFloatHashMap.newWithKeysValues((byte) 1, 1.0f, (byte) 2, 2.0f, (byte) 3, 3.0f).values();
    }
    ...
    public void retainAll()
    {
        ...
        ByteFloatHashMap map = ByteFloatHashMap.newWithKeysValues((byte) 0, 0.0f, (byte) 1, 1.0f, (byte) 2, 2.0f, (byte) 3, 3.0f);
        MutableFloatCollection collection = map.values();

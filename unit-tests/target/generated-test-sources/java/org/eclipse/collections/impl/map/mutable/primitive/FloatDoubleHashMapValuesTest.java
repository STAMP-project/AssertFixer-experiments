...
/**
 * JUnit test for {@link FloatDoubleHashMap#values()}.
 * This file was automatically generated from template file primitivePrimitiveHashMapValuesTest.stg.
 */
public class FloatDoubleHashMapValuesTest extends AbstractMutableDoubleCollectionTestCase
{
    @Override
    protected MutableDoubleCollection classUnderTest()
    {
        return FloatDoubleHashMap.newWithKeysValues(1.0f, 1.0, 2.0f, 2.0, 3.0f, 3.0).values();
    }
    ...
    public void remove()
    {
        FloatDoubleHashMap map = FloatDoubleHashMap.newWithKeysValues(1.0f, 1.0, 2.0f, 2.0, 3.0f, 3.0);
    ...
    public void retainAll()
    {
        ...
        FloatDoubleHashMap map = FloatDoubleHashMap.newWithKeysValues(0.0f, 0.0, 1.0f, 1.0, 2.0f, 2.0, 3.0f, 3.0);
        MutableDoubleCollection collection = map.values();

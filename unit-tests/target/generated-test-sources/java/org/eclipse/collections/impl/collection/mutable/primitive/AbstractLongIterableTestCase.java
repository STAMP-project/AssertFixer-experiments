...
public abstract class AbstractLongIterableTestCase
{
    ...
    public void chunk()
    {
        ...
        Assert.assertEquals(
                Lists.mutable.with(
                        this.newMutableCollectionWith(0L),
                        this.newMutableCollectionWith(1L),
                        this.newMutableCollectionWith(2L),
                        this.newMutableCollectionWith(3L),
                        this.newMutableCollectionWith(4L),
                        this.newMutableCollectionWith(5L)).toSet(),
                iterable.chunk(1).toSet());
        Assert.assertEquals(
                Lists.mutable.with(
                        this.newMutableCollectionWith(0L, 1L),
                        this.newMutableCollectionWith(2L, 3L),
                        this.newMutableCollectionWith(4L, 5L)).toSet(),
                iterable.chunk(2).toSet());
        Assert.assertEquals(
                Lists.mutable.with(
                        this.newMutableCollectionWith(0L, 1L, 2L),
                        this.newMutableCollectionWith(3L, 4L, 5L)).toSet(),
                iterable.chunk(3).toSet());
        Assert.assertEquals(
                Lists.mutable.with(
                        this.newMutableCollectionWith(0L, 1L, 2L, 3L),
                        this.newMutableCollectionWith(4L, 5L)).toSet(),
                iterable.chunk(4).toSet());
        Assert.assertEquals(
                Lists.mutable.with(this.newMutableCollectionWith(0L, 1L, 2L, 3L, 4L, 5L)).toSet(),

 ...
 */
public abstract class AbstractLongFloatMapTestCase
{
    protected final LongFloatMap map = this.classUnderTest();

    protected abstract LongFloatMap classUnderTest();

    protected abstract LongFloatMap newWithKeysValues(long key1, float value1);

    protected abstract LongFloatMap newWithKeysValues(long key1, float value1, long key2, float value2);

    protected abstract LongFloatMap newWithKeysValues(long key1, float value1, long key2, float value2, long key3, float value3);

    protected abstract LongFloatMap newWithKeysValues(long key1, float value1, long key2, float value2, long key3, float value3, long key4, float value4);

    protected abstract LongFloatMap getEmptyMap();

    @Test
    public void keySet()
    {
        Verify.assertEmpty(this.getEmptyMap().keySet());
        Assert.assertEquals(LongHashSet.newSetWith(0L), this.newWithKeysValues(0L, 0.0f).keySet());
        Assert.assertEquals(LongHashSet.newSetWith(0L, 31L, 32L),
                this.newWithKeysValues(0L, 0.0f, 31L, 31.0f, 32L, 32.0f).keySet());
    }
    ...
    public void values()
    {
        ...
        LongFloatMap map = this.newWithKeysValues(0L, 0.0f);
        Verify.assertSize(1, map.values());
        Assert.assertTrue(map.values().contains(0.0f));

        LongFloatMap map1 = this.newWithKeysValues(0L, 0.0f, 31L, 31.0f, 32L, 32.0f);
    ...
    public void isEmpty()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1L, 1.0f).isEmpty());
        Assert.assertFalse(this.newWithKeysValues(0L, 0.0f).isEmpty());
        Assert.assertFalse(this.newWithKeysValues(50L, 50.0f).isEmpty());
    }
    ...
    public void notEmpty()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(1L, 1.0f).notEmpty());
        Assert.assertTrue(this.newWithKeysValues(0L, 0.0f).notEmpty());
        Assert.assertTrue(this.newWithKeysValues(50L, 50.0f).notEmpty());
    }
    ...
    public void testEquals()
    {
        ...
        LongFloatMap map9 = this.newWithKeysValues(0L, 0.0f);
        ...
        Assert.assertEquals(map1, LongFloatMaps.mutable.ofAll(map1));
        Assert.assertEquals(map1, LongFloatMaps.immutable.ofAll(map1));
    }
    ...
    {
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(0L, 0.0f, 1L, 1.0f, 32L, 32.0f).hashCode(),
                this.newWithKeysValues(32L, 32.0f, 0L, 0.0f, 1L, 1.0f).hashCode());
        Assert.assertEquals(
                UnifiedMap.newWithKeysValues(50L, 0.0f, 60L, 1.0f, 70L, 33.0f).hashCode(),
                this.newWithKeysValues(50L, 0.0f, 60L, 1.0f, 70L, 33.0f).hashCode());
        Assert.assertEquals(UnifiedMap.newMap().hashCode(), this.getEmptyMap().hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(1L, 2.0f).hashCode(), this.newWithKeysValues(1L, 2.0f).hashCode());
    }
    ...
    public void testToString()
    {
        ...
        Assert.assertEquals("{0=0.0}", this.newWithKeysValues(0L, 0.0f).toString());
        Assert.assertEquals("{1=1.0}", this.newWithKeysValues(1L, 1.0f).toString());
        Assert.assertEquals("{5=5.0}", this.newWithKeysValues(5L, 5.0f).toString());

        LongFloatMap map1 = this.newWithKeysValues(0L, 0.0f, 1L, 1.0f);
        Assert.assertTrue(
                map1.toString(),
                "{0=0.0, 1=1.0}".equals(map1.toString())
                        || "{1=1.0, 0=0.0}".equals(map1.toString()));

        LongFloatMap map2 = this.newWithKeysValues(1L, 1.0f, 32L, 32.0f);
        Assert.assertTrue(
                map2.toString(),
                "{1=1.0, 32=32.0}".equals(map2.toString())
                        || "{32=32.0, 1=1.0}".equals(map2.toString()));

        LongFloatMap map3 = this.newWithKeysValues(0L, 0.0f, 32L, 32.0f);
        Assert.assertTrue(
                map3.toString(),
                "{0=0.0, 32=32.0}".equals(map3.toString())
                        || "{32=32.0, 0=0.0}".equals(map3.toString()));

        LongFloatMap map4 = this.newWithKeysValues(32L, 32.0f, 33L, 33.0f);
        Assert.assertTrue(
                map4.toString(),
    ...
    public void forEachKey()
    {
        ...
        LongFloatMap map3 = this.newWithKeysValues(1L, 1.0f);
    ...
    public void forEachKeyValue()
    {
        ...
        map0.forEachKeyValue((long eachKey, float eachValue) ->
        {
            sumKey0[0] += eachKey;
        ...
        map1.forEachKeyValue((long eachKey, float eachValue) ->
        {
            sumKey1[0] += eachKey;
        ...
        map01.forEachKeyValue((long eachKey, float eachValue) ->
        {
            sumKey01[0] += eachKey;
        ...
        map.forEachKeyValue((long eachKey, float eachValue) ->
        {
            sumKey[0] += eachKey;
        ...
        map2.forEachKeyValue((long eachKey, float eachValue) ->
        {
            sumKey2[0] += eachKey;
        ...
        LongFloatMap map3 = this.newWithKeysValues(3L, 5.0f);
        long[] sumKey3 = new long[1];
        float[] sumValue3 = new float[1];
        map3.forEachKeyValue((long eachKey, float eachValue) ->
        {
            sumKey3[0] += eachKey;
    ...
    public void makeString()
    {
        ...
        Assert.assertEquals("", this.getEmptyMap().makeString(", "));
        Assert.assertEquals("[]", this.getEmptyMap().makeString("[", "/", "]"));
        Assert.assertEquals("0.0", this.newWithKeysValues(0L, 0.0f).makeString());
        Assert.assertEquals("0.0", this.newWithKeysValues(0L, 0.0f).makeString(", "));
        Assert.assertEquals("[0.0]", this.newWithKeysValues(0L, 0.0f).makeString("[", "/", "]"));
        Assert.assertEquals("1.0", this.newWithKeysValues(1L, 1.0f).makeString());
        Assert.assertEquals("5.0", this.newWithKeysValues(5L, 5.0f).makeString());
    ...
    public void appendString()
    {
        ...
        this.newWithKeysValues(0L, 0.0f).appendString(appendable0);
        Assert.assertEquals("0.0", appendable0.toString());

        Appendable appendable01 = new StringBuilder();
        this.newWithKeysValues(0L, 0.0f).appendString(appendable01, "/");
        Assert.assertEquals("0.0", appendable01.toString());

        Appendable appendable02 = new StringBuilder();
        this.newWithKeysValues(0L, 0.0f).appendString(appendable02, "{", "/", "}");
        Assert.assertEquals("{0.0}", appendable02.toString());

        Appendable appendable1 = new StringBuilder();
        this.newWithKeysValues(1L, 1.0f).appendString(appendable1);
        Assert.assertEquals("1.0", appendable1.toString());

        Appendable appendable2 = new StringBuilder();
        this.newWithKeysValues(5L, 5.0f).appendString(appendable2);
        ...
        LongFloatMap map3 = this.newWithKeysValues(1L, 1.0f, 32L, 32.0f);
    ...
    public void select()
    {
        LongFloatMap map = this.newWithKeysValues(0L, 0.0f, 1L, 1.0f, 2L, 2.0f, 3L, 3.0f);
        LongFloatMap actual1 = map.select((long key, float value) -> key == 1L || Float.compare(value, 3.0f) == 0);
        Assert.assertEquals(LongFloatHashMap.newWithKeysValues(1L, 1.0f, 3L, 3.0f), actual1);
        LongFloatMap actual2 = map.select((long key, float value) -> key == 0L || Float.compare(value, 2.0f) == 0);
        Assert.assertEquals(LongFloatHashMap.newWithKeysValues(0L, 0.0f, 2L, 2.0f), actual2);
    }
    ...
    {
        LongFloatMap map = this.newWithKeysValues(0L, 0.0f, 1L, 1.0f, 2L, 2.0f, 3L, 3.0f);
        LongFloatMap actual1 = map.reject((long key, float value) -> key == 1L || Float.compare(value, 3.0f) == 0);
        Assert.assertEquals(LongFloatHashMap.newWithKeysValues(0L, 0.0f, 2L, 2.0f), actual1);
        LongFloatMap actual2 = map.reject((long key, float value)-> key == 0L || Float.compare(value, 2.0f) == 0);
        Assert.assertEquals(LongFloatHashMap.newWithKeysValues(1L, 1.0f, 3L, 3.0f), actual2);
    }
    ...
    public void collect()
    {
        ...
        Assert.assertEquals(Bags.immutable.with(2.0f), this.newWithKeysValues(1L, 1.0f).collect(function));
    }
    ...
    public void detectIfNone_value()
    {
        ...
        Assert.assertEquals(5.0f, this.newWithKeysValues(1L, 1.0f).detectIfNone(FloatPredicates.equal(0.0f), 5.0f), 0.0);
        Assert.assertEquals(1.0f, this.newWithKeysValues(1L, 1.0f).detectIfNone(FloatPredicates.equal(1.0f), 5.0f), 0.0);
    ...
    public void anySatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1L, 1.0f).anySatisfy(FloatPredicates.equal(0.0f)));
        Assert.assertTrue(this.newWithKeysValues(1L, 1.0f).anySatisfy(FloatPredicates.equal(1.0f)));
    ...
    public void allSatisfy()
    {
        ...
        Assert.assertFalse(this.newWithKeysValues(1L, 1.0f).allSatisfy(FloatPredicates.equal(0.0f)));
        Assert.assertTrue(this.newWithKeysValues(1L, 1.0f).allSatisfy(FloatPredicates.equal(1.0f)));
        ...
        LongFloatMap map1 = this.newWithKeysValues(2L, 2.0f, 3L, 3.0f);
    ...
    public void noneSatisfy()
    {
        ...
        Assert.assertTrue(this.newWithKeysValues(1L, 1.0f).noneSatisfy(FloatPredicates.equal(0.0f)));
        Assert.assertFalse(this.newWithKeysValues(1L, 1.0f).noneSatisfy(FloatPredicates.equal(1.0f)));
    ...
    public void max()
    {
        ...
        Assert.assertEquals(3.0f, this.newWithKeysValues(3L, 3.0f).max(), 0.0);
    }

    @Test
    public void min()
    {
        LongFloatMap map = this.newWithKeysValues(1L, 1.0f, 2L, 2.0f, 3L, 3.0f, 0L, 0.0f);
        Assert.assertEquals(0.0f, map.min(), 0.0);
        Assert.assertEquals(3.0f, this.newWithKeysValues(3L, 3.0f).min(), 0.0);
    }
    ...
    public void minIfEmpty()
    {
        ...
        LongFloatMap map = this.newWithKeysValues(1L, 1.0f, 0L, 0.0f, 9L, 9.0f, 7L, 7.0f);
        Assert.assertEquals(0.0, map.minIfEmpty(5.0f), 0.0);
        Assert.assertEquals(3.0f, this.newWithKeysValues(3L, 3.0f).maxIfEmpty(5.0f), 0.0);
    }
    ...
    public void maxIfEmpty()
    {
        ...
        Assert.assertEquals(3.0f, this.newWithKeysValues(3L, 3.0f).minIfEmpty(5.0f), 0.0);
    }
    ...
    public void sum()
    {
        ...
        LongFloatMap map2 = this.newWithKeysValues(2L, 2.0f, 3L, 3.0f, 4L, 4.0f);
        Assert.assertEquals(9.0f, map2.sum(), 0.0);
        LongFloatMap map3 = this.newWithKeysValues(2L, 2.0f);
    ...
    public void average()
    {
        ...
        LongFloatMap map1 = this.newWithKeysValues(1L, 1.0f);
    ...
    public void median()
    {
        ...
        LongFloatMap map2 = this.newWithKeysValues(0L, 0.0f, 1L, 1.0f, 2L, 2.0f);
    ...
    public void toList()
    {
        Assert.assertEquals(FloatArrayList.newListWith(0.0f), this.newWithKeysValues(0L, 0.0f).toList());
        Assert.assertEquals(FloatArrayList.newListWith(1.0f), this.newWithKeysValues(1L, 1.0f).toList());
        Assert.assertEquals(FloatArrayList.newListWith(2.0f), this.newWithKeysValues(2L, 2.0f).toList());
        Assert.assertTrue(this.newWithKeysValues(2L, 2.0f, 3L, 3.0f).toList().equals(FloatArrayList.newListWith(2.0f, 3.0f))
                || this.newWithKeysValues(2L, 2.0f, 3L, 3.0f).toList().equals(FloatArrayList.newListWith(3.0f, 2.0f)));
    }
    ...
    public void toSortedList()
    {
        ...
        Assert.assertEquals(FloatArrayList.newListWith(1.0f), this.newWithKeysValues(1L, 1.0f).toSortedList());
    }
    ...
    public void toSet()
    {
        ...
        Assert.assertEquals(FloatHashSet.newSetWith(1.0f), this.newWithKeysValues(1L, 1.0f).toSet());
    }
    ...
    public void toBag()
    {
        ...
        Assert.assertEquals(FloatHashBag.newBagWith(1.0f), this.newWithKeysValues(1L, 1.0f).toBag());
    }
    ...
    {
        MutableBag<LongFloatPair> expected = Bags.mutable.of();
        this.map.forEachKeyValue((long key, float value) -> expected.add(PrimitiveTuples.pair(key, value)));
    ...
    public void toArray()
    {
        LongFloatMap map = this.newWithKeysValues(1L, 1.0f, 2L, 2.0f);
        ...
        Assert.assertTrue(Arrays.equals(new float[]{1.0f}, this.newWithKeysValues(1L, 1.0f).toArray()));
    }
    ...
    public void toImmutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableLongFloatMap.class, this.classUnderTest().toImmutable());
    }

    @Test
    public void chunk()
    {
        FloatIterable iterable = this.newWithKeysValues(1L, 1.0f, 2L, 2.0f, 3L, 3.0f);
        Assert.assertEquals(
                Lists.mutable.with(
        ...
        Assert.assertEquals(
                ...
                this.newWithKeysValues(1L, 1.0f).chunk(1).toSet());
        ...
        Verify.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1L, 1.0f).chunk(-1));
    }
}

...
public abstract class AbstractCharByteMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith((char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3, (byte) 4).collect((CharBytePair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Long> result2 =
            this.newWith((char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3, (byte) 4).collect((CharBytePair object) -> (long) object.getTwo());
    ...
    public void detectWithIfNoneBlock()
    {
        Function0<CharBytePair> function = Functions0.value(PrimitiveTuples.pair((char) 5, (byte) 6));
        Assert.assertEquals(
            PrimitiveTuples.pair((char) 2, (byte) 3),
            this.newWith((char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3, (byte) 4).detectWithIfNone(
                    Object::equals,
                    PrimitiveTuples.pair((char) 2, (byte) 3),
                    function));
        Assert.assertEquals(
            PrimitiveTuples.pair((char) 5, (byte) 6),
            this.newWith((char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3, (byte) 4).detectWithIfNone(
                    Object::equals,
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith((char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3, (byte) 4).collectIf(
                        CharBytePair.class::isInstance,
                        String::valueOf),
                "\u0001:2", "\u0002:3", "\u0003:4");
        Verify.assertContainsAll(
                this.newWith((char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3, (byte) 4).collectIf(
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith((char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3, (byte) 4).collectWith((CharBytePair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L).toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                Bags.mutable.of(4L, 6L, 8L),
                this.newWith((char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3, (byte) 4).collectWith((CharBytePair argument1, Long argument2) -> (long) (argument1.getOne() + argument1.getTwo() + argument2), 1L, HashBag.<Long>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair((char) 1, (byte) 2).equals(first)
                || PrimitiveTuples.pair((char) 2, (byte) 3).equals(first)
                || PrimitiveTuples.pair((char) 3, (byte) 4).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair((char) 1, (byte) 2).equals(last)
                || PrimitiveTuples.pair((char) 2, (byte) 3).equals(last)
                || PrimitiveTuples.pair((char) 3, (byte) 4).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair((char) 3, (byte) 4),
                PrimitiveTuples.pair((char) 2, (byte) 3),
                PrimitiveTuples.pair((char) 1, (byte) 2)),
                set);
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((char) 1, (byte) 2), 1), Tuples.pair(PrimitiveTuples.pair((char) 2, (byte) 3), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((char) 2, (byte) 3), 1), Tuples.pair(PrimitiveTuples.pair((char) 1, (byte) 2), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((char) 1, (byte) 2), 0), Tuples.pair(PrimitiveTuples.pair((char) 2, (byte) 3), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair((char) 2, (byte) 3), 0), Tuples.pair(PrimitiveTuples.pair((char) 1, (byte) 2), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<CharBytePair> collection = this.newWith((char) 1, (byte) 2, (char) 2, (byte) 3, (char) 3, (byte) 4);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair((char) 1, (byte) 2)),
                FastList.newListWith(PrimitiveTuples.pair((char) 2, (byte) 3)),
                FastList.newListWith(PrimitiveTuples.pair((char) 3, (byte) 4))),

...
/**
 * JUnit test for {@link SynchronizedObjectIntMap#keySet()}.
 * This file was automatically generated from template file synchronizedObjectPrimitiveMapKeySetTest.stg.
 */
public class SynchronizedObjectIntMapKeySetTest
{
    private SynchronizedObjectIntMap<String> newMapWithKeysValues(String key1, int value1, String key2, int value2, String key3, int value3)
    {
        return new SynchronizedObjectIntMap<>(ObjectIntHashMap.newWithKeysValues(key1, value1, key2, value2, key3, value3));
    }

    private SynchronizedObjectIntMap<String> newMapWithKeysValues(String key1, int value1, String key2, int value2, String key3, int value3, String key4, int value4)
    {
    ...
    {
        SynchronizedObjectIntMap<String> map = this.newMapWithKeysValues("One", 1, "Two", 2, "Three", 3, null, 4);
    ...
    {
        SynchronizedObjectIntMap<String> map = this.newMapWithKeysValues("One", 1, "Two", 2, "Three", 3);
        Assert.assertFalse(map.keySet().remove("Four"));

        Assert.assertTrue(map.keySet().remove("Two"));
        Assert.assertEquals(ObjectIntHashMap.newWithKeysValues("One", 1,  "Three", 3), map);
    ...
    public void removeNullFromKeySet()
    {
        ...
        Assert.assertEquals(ObjectIntHashMap.newWithKeysValues("One", 1, "Two", 2, "Three", 3), map);
    ...
    {
        SynchronizedObjectIntMap<String> map = this.newMapWithKeysValues("One", 1, "Two", 2, "Three", 3, null, 0);

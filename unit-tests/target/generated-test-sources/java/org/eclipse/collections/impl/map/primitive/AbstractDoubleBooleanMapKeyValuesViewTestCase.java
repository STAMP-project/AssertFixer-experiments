...
public abstract class AbstractDoubleBooleanMapKeyValuesViewTestCase
{
    ...
    public void collect()
    {
        RichIterable<Integer> result1 =
            this.newWith(1.0, false, 2.0, true, 3.0, false).collect((DoubleBooleanPair object) -> (int) object.getOne());
        Assert.assertEquals(Bags.immutable.of(1, 2, 3), result1.toBag());
        RichIterable<Boolean> result2 =
            this.newWith(1.0, false, 2.0, true, 3.0, false).collect(DoubleBooleanPair::getTwo);
    ...
    public void collectBoolean()
    {
        BooleanIterable result =
            this.newWith(1.0, false, 2.0, true, 3.0, false).collectBoolean((DoubleBooleanPair each) -> (each.getOne() % 2) == 0);
    ...
    public void minBy()
    {
        Assert.assertEquals(PrimitiveTuples.pair(2.0, true),
            this.newWith(1.0, false, 2.0, true, 3.0, false).minBy((DoubleBooleanPair object) -> (int) object.getOne() & 1));
    }

    @Test
    public void maxBy()
    {
        Assert.assertEquals(PrimitiveTuples.pair(1.0, false),
            this.newWith(1.0, false, 2.0, true, 4.0, false).maxBy((DoubleBooleanPair object) ->  (int) object.getOne() & 1));
    }
    ...
    {
        Function0<DoubleBooleanPair> function = Functions0.value(PrimitiveTuples.pair(5.0, true));
        Assert.assertEquals(PrimitiveTuples.pair(2.0, true), this.newWith(1.0, false, 2.0, true, 3.0, false).detectWithIfNone(
                Object::equals,
                PrimitiveTuples.pair(2.0, true),
                function));
        Assert.assertEquals(PrimitiveTuples.pair(5.0, true), this.newWith(1.0, false, 2.0, true, 3.0, false).detectWithIfNone(
                Object::equals,
                PrimitiveTuples.pair(2.0, false),
                function));
    }
    ...
    public void collectIf()
    {
        Verify.assertContainsAll(
                this.newWith(1.0, false, 2.0, true, 3.0, false).collectIf(
                        DoubleBooleanPair.class::isInstance,
                        String::valueOf),
    ...
    public void collectWith()
    {
        Assert.assertEquals(
                ...
                this.newWith(1.0, false, 2.0, true, 3.0, false)
                    .collectWith((DoubleBooleanPair argument1, String argument2) -> argument1 + argument2, "-")
                    .toBag());
    }
    ...
    public void collectWith_target()
    {
        Assert.assertEquals(
                ...
                this.newWith(1.0, false, 2.0, true, 3.0, false)
                    .collectWith((DoubleBooleanPair argument1, String argument2) -> argument1 + argument2, "-", HashBag.<String>newBag()));
    }
    ...
    public void getFirst()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1.0, false).equals(first)
                || PrimitiveTuples.pair(2.0, true).equals(first)
                || PrimitiveTuples.pair(3.0, false).equals(first));
    ...
    public void getLast()
    {
        ...
        Assert.assertTrue(PrimitiveTuples.pair(1.0, false).equals(last)
                || PrimitiveTuples.pair(2.0, true).equals(last)
                || PrimitiveTuples.pair(3.0, false).equals(last));
    ...
    public void toSortedSet_with_comparator()
    {
        ...
        Verify.assertSortedSetsEqual(TreeSortedSet.newSetWith(Comparators.reverseNaturalOrder(),
                PrimitiveTuples.pair(3.0, false),
                PrimitiveTuples.pair(2.0, true),
                PrimitiveTuples.pair(1.0, false)),
                set);
    }
    ...
    public void zip()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1.0, false), 1), Tuples.pair(PrimitiveTuples.pair(2.0, true), 2)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2.0, true), 1), Tuples.pair(PrimitiveTuples.pair(1.0, false), 2)).equals(result.toBag()));
    }
    ...
    public void zipWithIndex()
    {
        ...
        Assert.assertTrue(Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(1.0, false), 0), Tuples.pair(PrimitiveTuples.pair(2.0, true), 1)).equals(result.toBag())
                || Bags.mutable.of(Tuples.pair(PrimitiveTuples.pair(2.0, true), 0), Tuples.pair(PrimitiveTuples.pair(1.0, false), 1)).equals(result.toBag()));
    }
    ...
    {
        RichIterable<DoubleBooleanPair> collection = this.newWith(1.0, false, 2.0, true, 3.0, false);
        Assert.assertEquals(Bags.immutable.of(FastList.newListWith(PrimitiveTuples.pair(1.0, false)),
                FastList.newListWith(PrimitiveTuples.pair(2.0, true)),
                FastList.newListWith(PrimitiveTuples.pair(3.0, false))),

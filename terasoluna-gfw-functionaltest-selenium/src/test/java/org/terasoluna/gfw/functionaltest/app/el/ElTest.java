...
public class ElTest extends FunctionTestSupport {
    ...
    public void test05_URL_Link() {
        ...
        assertThat(driver.findElement(By.id("linkUOutput")).getText(), is(
                applicationContextUrl + "/el/output_05_04?name=tera%261"));
        // output link
        assertThat(driver.findElement(By.linkText(applicationContextUrl
                + "/el/output_05_04?name=tera%261")).getText(), is(

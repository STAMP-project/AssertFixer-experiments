...
import org.terasoluna.gfw.functionaltest.app.PageLoadWaitWebDriverEventListener;
...
public class FunctionTestSupport extends ApplicationObjectSupport {
    ...
    protected static PageLoadWaitWebDriverEventListener eventListenerAdapter;
    ...
    protected void bootDefaultWebDriver() {
        if (driver == null) {
            ...
            eventListenerAdapter = new PageLoadWaitWebDriverEventListener();
            driver = eventFiringDriver.register(eventListenerAdapter);
        }

...
public final class Mappers {
    ...
    public static <S, T> Mapper<S, T> forEntityAttributeMapping(EntityViewManagerImpl evm, EntityMetamodel metamodel, Class<S> sourceEntityClass, Class<T> targetEntityClass, Map<String, String> mapping) {
        ...
        for (Map.Entry<String, String> entry : mapping.entrySet()) {
            source.add(Accessors.forEntityMapping(evm, metamodel, sourceEntityClass, entry.getKey()));
            target.add(Accessors.forEntityMapping(evm, metamodel, targetEntityClass, entry.getValue()));
        }

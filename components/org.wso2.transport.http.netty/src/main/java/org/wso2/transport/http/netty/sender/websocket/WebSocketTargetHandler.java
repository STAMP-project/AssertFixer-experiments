...
public class WebSocketTargetHandler extends WebSocketInboundFrameHandler {
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws ServerConnectorException {
        if (webSocketConnection != null && !webSocketConnection.closeFrameReceived() && closePromise == null) {
        ...
        } else if (closePromise != null && !closePromise.isDone()) {
            String errMsg = "Connection is closed by remote endpoint without close frame";

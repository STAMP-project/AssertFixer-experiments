...
public class TypedProperties extends StampedLock {
   ...
   public boolean containsProperty(final SimpleString key) {
      return withReadLock(() -> containsPropertyThreadUnsafe(key));
   }
   ...
   public Set<SimpleString> getPropertyNames() {
      return withReadLock(() -> getPropertyNamesThreadUnsafe());
   }
   ...
   public void forEachKey(Consumer<SimpleString> action) {
      withReadLock(() -> forEachKeyThreadUnsafe(action));
   }
   ...
   public void forEach(BiConsumer<SimpleString, Object> action) {
      withReadLock(() -> forEachThreadUnsafe(action));
   }
   ...
   public void decode(final ByteBuf buffer, TypedPropertiesDecoderPools keyValuePools) {
      withWriteLock(() -> decodeThreadUnsafe(buffer, keyValuePools));
   }
   ...
   public void encode(final ByteBuf buffer) {
      withReadLock(() -> encodeThreadUnsafe(buffer));
   }
   ...
   public void clear() {
      withWriteLock(() -> clearThreadUnsafe());
   }
   ...
   public String toString() {
      return withReadLock(() -> toStringThreadUnsafe());
   }
   ...
   private void checkCreateProperties() {
      withWriteLock(() -> checkCreatePropertiesThreadUnsafe());
   }
   ...
   private void doPutValue(final SimpleString key, final PropertyValue value) {
      withWriteLock(() -> doPutValueThreadUnsafe(key, value));
   }
   ...
   private Object doRemoveProperty(final SimpleString key) {
      return withWriteLock(() -> doRemovePropertyThreadUnsafe(key));
   }
   ...
   private Object doGetProperty(final Object key) {
      return withReadLock(() -> doGetPropertyThreadUnsafe(key));
   }

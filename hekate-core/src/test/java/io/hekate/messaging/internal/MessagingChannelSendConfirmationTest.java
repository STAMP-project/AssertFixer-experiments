...
public class MessagingChannelSendConfirmationTest extends MessagingServiceTestBase {
    ...
    public void test() throws Exception {
        ...
        for (TestChannel from : channels) {
            for (TestChannel to : channels) {
                ...
                channel.newSend(msg).sync(3, TimeUnit.SECONDS);
    ...
    public void testIdleTimeout() throws Exception {
        repeat(3, j -> {
            ...
            repeat(5, i -> {
                ...
                sender.get().withConfirmReceive(true).forNode(receiver.nodeId()).newSend("test" + i).sync();
    ...
    public void testNoFailuresWithSmallIdleTimeout() throws Exception {
        ...
        runParallel(4, 1000, s ->
            sender.get().withConfirmReceive(true).forNode(receiver.nodeId()).newSend("test").sync()
        );
    ...
    public void testIdleTimeoutWithInFlightMessage() throws Exception {
        repeat(3, j -> {
            ...
            repeat(5, i -> {
                ...
                try {
                    // Send message.
                    sent = sender.get().withConfirmReceive(true).forNode(receiver.nodeId()).newSend("test" + i).execute();
    ...
    public void testReceiveFailure() throws Throwable {
        ...
        repeat(5, i -> {
            ...
            try {
                sender.get().withConfirmReceive(true).forNode(receiver.nodeId()).newSend(msg).sync();
    ...
    public void testNetworkDisconnectWhileSending() throws Throwable {
        ...
        repeat(5, i -> {
            try {
                sender.get().withConfirmReceive(true).forNode(receiver.nodeId()).newSend("request" + i).sync();

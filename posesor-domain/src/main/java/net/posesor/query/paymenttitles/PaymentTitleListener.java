...
public class PaymentTitleListener {
    ...
    private final PaymentTitleRepository repository;

    public PaymentTitleListener(PaymentTitleRepository repository) {
        this.repository = repository;
    }

    @EventHandler
    public void when(UnallocatedChargeDocumentCreatedEvent evt) {
        addOrUpdate(evt.getPrincipalName(), evt.getPaymentTitle());
    }

    @EventHandler
    public void when(UnallocatedChargeDocumentDeletedEvent evt) {
        deleteOrUpdate(evt.getPrincipalName(), evt.getPaymentTitle());
    }

    @EventHandler
    public void when(UnallocatedChargeDocument.ContentChanged evt) {

 ...
 */
@FrameworkEndpoint
@SessionAttributes({"authorizationRequest", "authorizationRequestMap"})
public class AuthorizationEndpoint extends AbstractEndpoint {
	...
	public ModelAndView authorize(Map<String, Object> model, @RequestParam Map<String, String> parameters,
		...
		try {
			...
			// Store an immutable Map of the Authorization Request in session
			// which will be used to validate the authorizationRequest in approveOrDeny()
			model.put("authorizationRequestMap", unmodifiableMap(authorizationRequest));
	...
	public View approveOrDeny(@RequestParam Map<String, String> approvalParameters, Map<String, ?> model,
		...
		Map<String, Object> originalAuthorizationRequest = (Map<String, Object>) model.get("authorizationRequestMap");

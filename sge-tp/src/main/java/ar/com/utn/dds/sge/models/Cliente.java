...
import ar.com.utn.dds.sge.util.PosicionUtil;
...
public class Cliente extends Usuario {
	...
	public void asignarTransformador(List<Transformador> transformadores) {
		...
		Comparator <Transformador> comparator = (t1, t2) -> Double.compare(PosicionUtil.getDistancia(x, y, t1.getX(), t1.getY()), 
																		   PosicionUtil.getDistancia(x, y, t2.getX(), t2.getY()));

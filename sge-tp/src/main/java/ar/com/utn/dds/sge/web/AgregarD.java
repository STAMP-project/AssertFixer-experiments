...
public class AgregarD extends HttpServlet {
	...
	DispositivoEstandar dispositivo = new DispositivoEstandar(null, null, null, 0.0, 0.0, true);
    DispositivoInteligente dispositivo1 =  new DispositivoInteligente(null, null, null, 0.0, 0.0, true); 
    /**

...
public class WebBuilder {
	...
	public void crearDatosDePrueba() throws ParseException {
		...
		dispositivos.add(new Dispositivo("Estandar", "Heladera", "Patrick", 106.00f, true , 0.0, 0.0,0.0));
		dispositivos.add(new Dispositivo("Estandar", "Televisor", "Lg", 10.00f, false, 0.0, 0.0,0.0));
		dispositivos.add(new Dispositivo("Estandar", "Home", "Sony", 7.00f, true, 0.0, 0.0,0.0));
		...
		dispositivos.add(new Dispositivo("Estandar", "PC", "Intel core i7", 160.00f, true, 0.0, 0.0,0.0));
		...
		dispositivos.add(new Dispositivo("Estandar", "Lavarropa", "Whirlpool", 90.00f, false, 0.0, 0.0,0.0));

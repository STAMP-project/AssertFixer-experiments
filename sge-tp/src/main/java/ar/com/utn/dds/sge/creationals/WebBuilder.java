...
public class WebBuilder {
	...
	public void crearDatosDePrueba() throws ParseException {
		...
		dispositivoInteligente = new DispositivoInteligente("PlayStation", "Sony", 100.00f, 0.0, 0.0, true);
		...
		dispositivoEstandar = new DispositivoEstandar("XBOX", "Microsoft", 40.00f, 0.0, 0.0, true);

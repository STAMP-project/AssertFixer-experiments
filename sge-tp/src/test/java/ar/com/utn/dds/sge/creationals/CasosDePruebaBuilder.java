...
public class CasosDePruebaBuilder {
	...
	public void crearDatosDePrueba() throws ParseException {
		...
		dispositivoInteligente = new DispositivoInteligente("PlayStation", "Sony", 10.00f, 0.0, 0.0, true);
		dispositivoInteligente.setTemperatura(25.00f);
		dispositivoInteligente.setIntesidadLuminica(75);
		dispositivoInteligente.setMensualMin(60);
		dispositivoInteligente.setMensualMax(360);
		dispositivoInteligente.setEstado(new Encendido());;

		// Creación dispositivo Estandar
		dispositivoEstandar = new DispositivoEstandar("XBOX", "Microsoft", 4.00f, 0.0, 0.0, true);
		dispositivoEstandar.setMensualMax(360);
		dispositivoEstandar.setMensualMin(60);
		...
		dispositivos.add(new DispositivoInteligente("Heladera", "Patrick", 1.00f, 6.0, 30.0, true));
		dispositivos.get(0).setEstado(new Encendido());
		dispositivos.add(new DispositivoInteligente("Televisor", "Lg", 100.00f, 90.0, 360.0, true));
		dispositivos.get(1).setEstado(new Apagado());
		dispositivos.add(new DispositivoInteligente("Home", "Sony", 7.00f, 90.0, 360.0, true));
		dispositivos.get(2).setEstado(new Encendido());
		dispositivos.add(new DispositivoInteligente("Heladera", "Patrick", 106.00f, 6.0, 30.0,true));
		dispositivos.get(3).setEstado(new Encendido());
		dispositivos.add(new DispositivoInteligente("Televisor", "Lg", 10.00f, 90.0, 360.0, true));
		dispositivos.get(4).setEstado(new Encendido());
		dispositivos.add(new DispositivoInteligente("Home", "Sony", 7.00f, 90.0, 360.0, true));
		dispositivos.get(5).setEstado(new Encendido());
		...
		cliente2 = new Cliente("user2", "987654", "Pedro", "Peposo", "Alberti 654", fechaCliente2, "DNI", 23765452,
							   46354691, categorias.get("R2"), 4.8, 3.4);
		
		// Se crea nueva lista de dipositivos para el segundo cliente
		dispositivos = new ArrayList<Dispositivo>();

		// Se agrega dispositivo para segundo cliente
		dispositivos.add(new DispositivoInteligente("PC", "Intel core i7", 160.00f, 60.0, 360.0, true));
		dispositivos.get(0).setEstado(new Encendido());
		...
		dispositivos.add(new DispositivoInteligente("Lavarropa", "Whirlpool", 90.00f, 6.0, 30.0, true));
		dispositivos.get(0).setEstado(new Apagado());
		...
		//Creacion Zonas
		zona1 = new Zona(5.5, 2.5, 5.0);
		zona2 = new Zona(21.4, 14.0, 3.7);
		
		//Creacion Transformadores
		transformador1 = new Transformador(5.6, 2.7);
		transformador2 = new Transformador(4.0, 0.5);
		transformador3 = new Transformador(22.5, 12.0);
		transformador4 = new Transformador(30.4, 25.2);
	}
}

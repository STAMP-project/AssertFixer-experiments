...
import ar.com.utn.dds.sge.models.Posicion;
import ar.com.utn.dds.sge.models.Transformador;
import ar.com.utn.dds.sge.models.Zona;
...
public class CasosDePruebaBuilder {
	...
	public Zona zona1;
	public Zona zona2;
	public Transformador transformador1;
	public Transformador transformador2;
	public Transformador transformador3;
	public Transformador transformador4;
	...
	public void crearDatosDePrueba() throws ParseException {
		...
		dispositivoInteligente = new DispositivoInteligente("PlayStation", "Sony", 10.00f);
		dispositivoInteligente.setTemperatura(25.00f);
		dispositivoInteligente.setIntesidadLuminica(75);
		dispositivoInteligente.set_mensualMin(60);
		dispositivoInteligente.set_mensualMax(360);
		dispositivoInteligente.prender();

		// Creación dispositivo Estandar
		dispositivoEstandar = new DispositivoEstandar("XBOX", "Microsoft", 4.00f);
		dispositivoEstandar.set_mensualMax(360);
		dispositivoEstandar.set_mensualMin(60);
		
		// Se agregan dispositivos del primer cliente
		dispositivos.add(new Dispositivo("Estandar", "Heladera", "Patrick", 1.00f, true, 6.0, 30.0,0.0));
		dispositivos.add(new Dispositivo("Estandar", "Televisor", "Lg", 100.00f, false, 90.0, 360.0,0.0));
		dispositivos.add(new Dispositivo("Estandar", "Home", "Sony", 7.00f, true, 90.0, 360.0,0.0));

		// Se crea primer cliente
		cliente1 = new Cliente("user1", "12345", "Juan", "Perez", "calle falsa 1234", fechaCliente1, "DNI", 34567890,
				123456, 200.0 , categorias.get("R1"), dispositivos, 106.00f);

		dispositivos = new ArrayList<Dispositivo>();
		dispositivos.add(dispositivoEstandar);
		dispositivos.add(new Dispositivo("Estandar", "Heladera", "Patrick", 106.00f, true, 6.0, 30.0,0.0));
		dispositivos.add(new Dispositivo("Estandar", "Televisor", "Lg", 10.00f, false, 90.0, 360.0,0.0));
		dispositivos.add(new Dispositivo("Estandar", "Home", "Sony", 7.00f, true, 90.0, 360.0,0.0));
		cliente1.setDispositivosInteligentes(dispositivos);

		// Se crea nueva lista de dipositivos para el segundo cliente
		dispositivos = new ArrayList<Dispositivo>();

		// Se agrega dispositivo para segundo cliente
		dispositivos.add(new Dispositivo("Estandar", "PC", "Intel core i7", 160.00f, true, 60.0, 360.0,0.0));

		// Se crea segundo cliente
		cliente2 = new Cliente("user2", "987654", "Pedro", "Peposo", "Alberti 654", fechaCliente2, "DNI", 23765452,
				46354691, 600.0, categorias.get("R2"), dispositivos, 430.00f);

		// Se crea nueva lista de dipositivos para el tercer cliente
		dispositivos = new ArrayList<Dispositivo>();

		// Se agrega dispositivo para tercer cliente
		dispositivos.add(new Dispositivo("Estandar", "Lavarropa", "Whirlpool", 90.00f, false, 6.0, 30.0,0.0));

		// Se crea tercer cliente
		cliente3 = new Cliente("user3", "qwerty", "Esteban", "Quito", "Medrano 950", fechaCliente3, "DNI", 23456789,
				43218765, 150.0, categorias.get("R3"), dispositivos, 90.00f);

		// Se crea cuarto cliente
		cliente4 = new Cliente("user4", "0", "Maria", "Magdalena", " ", fechaCliente4, "DNI", 0, 0,0.0,
				categorias.get("R4"), dispositivosVacios, 0.00f);
		...
		//Creacion Zonas
		zona1 = new Zona(new Posicion(5.5, 2.5), 5.0);
		zona2 = new Zona(new Posicion(21.4, 14.0), 3.7);
		
		//Creacion Transformadores
		transformador1 = new Transformador(new Posicion(5.6, 2.7));
		transformador2 = new Transformador(new Posicion(4.0, 0.5));
		transformador3 = new Transformador(new Posicion(22.5, 12.0));
		transformador4 = new Transformador(new Posicion(30.4, 25.2));

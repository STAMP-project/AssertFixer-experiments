...
public class OptimoTest {
	...
	@Test
	public void calcularSimplex_PasadoConsumoTest() {
		...
		for (int i = 0; i<prueba.cliente1.getDispositivos().size(); i++){
			...
			System.out.println(prueba.cliente1.getDispositivos().get(i).get_hsRestantes());
			   
			  }
	}
		@Test
		public void calcularSimplex_Consumo_okTest() {
			System.out.println("Se correra la funcionalidad de Consumo optimo:");
			...
			for (int i = 0; i<prueba.cliente3.getDispositivos().size(); i++){
				...
				System.out.println("Horas Restantes:");
				System.out.println(prueba.cliente3.getDispositivos().get(i).get_hsRestantes());

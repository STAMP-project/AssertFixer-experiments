...
Metadata <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`prefix`, `mzTab-version`, `mzTab-ID`, `title`, `description`, `sample_processing`, `instrument`, `software`, `publication`, `contact`, `uri`, `external_study_uri`, `quantification_method`, `study_variable`, `assay`, `ms_run`, `custom`, `sample`, `cv`, `database`, `derivatization_agent`, `small_molecule-quantification_unit`, `small_molecule_feature-quantification_unit`, `small_molecule-identification_reliability`, `id_confidence_measure`, `colunit-small_molecule`, `colunit-small_molecule_feature`, `colunit-small_molecule_evidence`){
      if (!missing(`prefix`)) {

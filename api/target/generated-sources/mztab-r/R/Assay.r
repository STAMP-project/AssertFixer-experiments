  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`ms_run_ref`)) {
        AssayObject[['ms_run_ref']] <- self$`ms_run_ref`$toJSON()
      }
    ...
    fromJSON = function(AssayJson) {
      ...
      if (!is.null(AssayObject$`ms_run_ref`)) {
        ...
        `ms_run_refObject`$fromJSON(jsonlite::toJSON(AssayObject$ms_run_ref, auto_unbox = TRUE))
        self$`ms_run_ref` <- `ms_run_refObject`
      }
    },
    ...
    fromJSONString = function(AssayJson) {
      ...
      self$`ms_run_ref` <- MsRunObject$fromJSON(jsonlite::toJSON(AssayObject$ms_run_ref, auto_unbox = TRUE))
    }
  )
)

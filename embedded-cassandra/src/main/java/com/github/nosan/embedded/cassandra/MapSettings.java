...
public final class MapSettings implements Settings {
	 ...
	 */
	public MapSettings(@Nonnull Map<?, ?> source) {
		Objects.requireNonNull(source, "Settings must not be null");
	...
	public boolean equals(@Nullable Object other) {
		...
		MapSettings settings = (MapSettings) other;
		return this.port == settings.port &&
				this.rpcPort == settings.rpcPort &&
				this.storagePort == settings.storagePort &&
				this.sslStoragePort == settings.sslStoragePort &&
				this.startNativeTransport == settings.startNativeTransport &&
				this.startRpc == settings.startRpc &&
				Objects.equals(this.clusterName, settings.clusterName) &&
				Objects.equals(this.sslPort, settings.sslPort) &&
				Objects.equals(this.address, settings.address) &&
				Objects.equals(this.listenAddress, settings.listenAddress) &&
				Objects.equals(this.listenInterface, settings.listenInterface) &&
				Objects.equals(this.broadcastAddress, settings.broadcastAddress) &&
				Objects.equals(this.rpcInterface, settings.rpcInterface) &&
				Objects.equals(this.broadcastRpcAddress, settings.broadcastRpcAddress);
	}

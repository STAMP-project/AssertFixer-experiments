...
import com.github.nosan.embedded.cassandra.utils.StringUtils;
...
public abstract class CqlScriptParser {
	...
	/**
	 * Parsing script into the statements.
	 *
	 * @param cqlScript CQL script.
	 * @return CQL statements
	 */
	@Nonnull
	public static List<String> parse(@Nonnull String cqlScript) {

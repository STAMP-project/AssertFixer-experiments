...
public interface RequestSchedulerOptions {
	...
	interface Builder {
		 ...
		 *
		 * @param throttleLimit The value for throttleLimit (can be {@code null})
		 * @return {@code this} builder for use in a chained invocation
		 */
		Builder setThrottleLimit(Integer throttleLimit);

		/**
		 * Initializes the value for the {@link RequestSchedulerOptions#getDefaultWeight() defaultWeight} attribute.
		 *
		 * @param defaultWeight The value for defaultWeight (can be {@code null})
		 * @return {@code this} builder for use in a chained invocation
		 */
		Builder setDefaultWeight(Integer defaultWeight);
		 ...
		 * @return {@code this} builder for use in a chained invocation
		 */
		Builder putWeights(String key, Integer value);
		 ...
		 *
		 * @param entries The entries that will be added to the weights map
		 * @return {@code this} builder for use in a chained invocation
		 */
		Builder setWeights(Map<String, ? extends Integer> entries);
		 ...
		 * @return {@code this} builder for use in a chained invocation
		 */
		Builder putWeights(Map<String, ? extends Integer> entries);

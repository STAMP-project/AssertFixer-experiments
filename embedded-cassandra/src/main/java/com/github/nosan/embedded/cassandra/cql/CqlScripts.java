...
public final class CqlScripts implements CqlScript {
	...
	/**
	 * Create a new CqlScripts based on scripts.
	 *
	 * @param scripts CQL scripts
	 */
	public CqlScripts(@Nullable CqlScript... scripts) {
		this.scripts = Collections.
				unmodifiableList((scripts != null) ? Arrays.asList(scripts) : Collections.emptyList());
	}
	...
	public String toString() {
		return String.format("CQL Scripts (%s)", this.scripts.size());
	}
}

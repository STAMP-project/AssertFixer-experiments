...
public class BaseDirectoryTests {
	...
	@Test
	public void shouldInitializeDirectoryArchiveWithFolder() throws Exception {
	...
	@Test
	public void shouldInitializeDirectoryPlainArchive() throws Exception {
	...
	@Test
	public void binCassandraDoesNotExist() throws Exception {
	...
	public void impossibleToDetermineBaseDirectory() throws Exception {
		...
		ArchiveUtils.extract(root, workingDirectory, (p) -> true);
		BaseDirectory baseDirectory = new BaseDirectory(workingDirectory);

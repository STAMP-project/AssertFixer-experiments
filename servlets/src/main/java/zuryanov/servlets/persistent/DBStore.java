...
//                BasicDataSource dataSource = DBStore.getDataSource();
    ...
    public void init() {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            statement.execute(prop.getProperty("dropcountry"));
            statement.execute(prop.getProperty("dropcity"));
            statement.execute(prop.getProperty("createcountry"));
            statement.execute(prop.getProperty("createcity"));
            statement.execute(prop.getProperty("insertcountryone"));
            statement.execute(prop.getProperty("insertcountrytwo"));
            statement.execute(prop.getProperty("insertcityone"));
            statement.execute(prop.getProperty("insertcitytwo"));
    ...
    public  void add(String name, String country, String city) {
        BasicDataSource dataSource = DBStore.getDataSource();
        try (Connection connection = dataSource.getConnection();
             PreparedStatement statement = connection.prepareStatement(prop.getProperty("add"));) {
            statement.setString(1, name);
    ...
    public List<String> findCountry() {
        ...
        BasicDataSource dataSource = DBStore.getDataSource();
        try (Connection connection = dataSource.getConnection();
             PreparedStatement statement = connection.prepareStatement(prop.getProperty("findallcountry"));
             ResultSet rs = statement.executeQuery();) {
            while (rs.next()) {
                result.add(rs.getString(1));
            }
    ...
    public List<String> findCity() {
        ...
        BasicDataSource dataSource = DBStore.getDataSource();
        try (Connection connection = dataSource.getConnection();
             PreparedStatement statement = connection.prepareStatement(prop.getProperty("findallcity"));
             ResultSet rs = statement.executeQuery();) {
            while (rs.next()) {
                result.add(rs.getString(1));
            }
    ...
    public String findCityById(int id) {
        ...
        BasicDataSource dataSource = DBStore.getDataSource();
        try (Connection connection = dataSource.getConnection();
             PreparedStatement statement = connection.prepareStatement(prop.getProperty("findcitybyid"));) {
            statement.setInt(1, id);
            ResultSet rs = statement.executeQuery();
            while (rs.next()) {
                result = rs.getString(1);
    ...
    public String findCountryById(int id) {
        ...
        BasicDataSource dataSource = DBStore.getDataSource();
        try (Connection connection = dataSource.getConnection();
             PreparedStatement statement = connection.prepareStatement(prop.getProperty("findcountrybyid"));) {
            statement.setInt(1, id);
            ResultSet rs = statement.executeQuery();
            while (rs.next()) {
                result = rs.getString(1);

...
public class UserServlet extends HttpServlet {
        ...
        while (parameterNames.hasMoreElements()) {
            if ("user".equals(parameterNames.nextElement())) {
                ...
                for (String user : userArray) {
                    writer.append("" + logic.add(user, "RUSSIA", "MOSCOW"));
                }
    ...
    class DispatchAction {
        ...
        public Function<HttpServletRequest, Boolean> toAdd(HttpServletRequest req) {
            return userServlet -> {
                logic.add(req.getParameter("name"), req.getParameter("country"), req.getParameter("city"));
                return true;
            };
        }
        ...
        public Function<HttpServletRequest, Boolean> toUpdate(HttpServletRequest req) {
            return userServlet -> {
                logic.update(Integer.parseInt(req.getParameter("id")), req.getParameter("name"), req.getParameter("countryname"), req.getParameter("cityname"));
                return true;
            };
        }

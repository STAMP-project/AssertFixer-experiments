...
/**
 * A factory which creates instances of type {@link MutableShortFloatMap}.
...
public interface MutableShortFloatMapFactory
{
     ...
     */
    MutableShortFloatMap ofAll(ShortFloatMap map);

    MutableShortFloatMap withAll(ShortFloatMap map);
}

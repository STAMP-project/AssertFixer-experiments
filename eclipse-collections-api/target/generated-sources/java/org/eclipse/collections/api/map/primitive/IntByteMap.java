...
public interface IntByteMap extends ByteValuesMap
{
    ...
    byte getIfAbsent(int key, byte ifAbsent);

    byte getOrThrow(int key);

    boolean containsKey(int key);

    void forEachKey(IntProcedure procedure);

    void forEachKeyValue(IntByteProcedure procedure);
     ...
     * from value to key.
     *
     * @throws IllegalStateException if the ByteIntMap contains duplicate values.
     * @since 9.0
     */
     ...
     *
     * @return a string representation of this IntByteMap
     */
    @Override
    String toString();

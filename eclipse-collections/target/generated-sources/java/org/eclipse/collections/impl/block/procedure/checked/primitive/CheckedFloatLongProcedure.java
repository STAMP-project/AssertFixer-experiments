...
public abstract class CheckedFloatLongProcedure implements FloatLongProcedure
{
    ...
    @Override
    public final void value(float item1, long item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in FloatLongProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(float item1, long item2) throws Exception;
}

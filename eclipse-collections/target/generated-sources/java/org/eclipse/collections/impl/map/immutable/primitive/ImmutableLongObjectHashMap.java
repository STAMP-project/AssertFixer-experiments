...
/**
 * ImmutableLongObjectHashMap is the non-modifiable equivalent of {@link LongObjectHashMap}.
 * This file was automatically generated from template file immutablePrimitiveObjectHashMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableLongObjectHashMap<V> extends AbstractImmutableLongObjectMap<V> implements Serializable
{
    private static final long serialVersionUID = 1L;
    private final MutableLongObjectMap<V> delegate;

    ImmutableLongObjectHashMap(LongObjectMap<? extends V> delegate)
    {
        this.delegate = new LongObjectHashMap<>(delegate);
    }
    ...
    {
        LongObjectHashMap<V> map = new LongObjectHashMap<>(this);
        map.put(key, value);
        return map.toImmutable();
    }

 ...
 * @since 4.0.
 */
public abstract class CheckedByteFloatProcedure implements ByteFloatProcedure
{
    ...
    public final void value(byte item1, float item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in ByteFloatProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(byte item1, float item2) throws Exception;
}

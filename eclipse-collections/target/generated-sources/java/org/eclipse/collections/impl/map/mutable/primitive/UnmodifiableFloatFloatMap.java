 ...
 * @since 3.1.
 */
public class UnmodifiableFloatFloatMap
        implements MutableFloatFloatMap, Serializable
{
    private static final long serialVersionUID = 1L;
    private final MutableFloatFloatMap map;

    public UnmodifiableFloatFloatMap(MutableFloatFloatMap map)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a UnmodifiableFloatFloatMap on a null map");
        }

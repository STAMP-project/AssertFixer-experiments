 ...
 */
public class BooleanCharPairImpl implements BooleanCharPair
{
    ...
    BooleanCharPairImpl(boolean newOne, char newTwo)
    {
        this.one = newOne;
        this.two = newTwo;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof BooleanCharPair))
        {
            return false;
        }

        BooleanCharPair that = (BooleanCharPair) o;
    ...
    @Override
    public int compareTo(BooleanCharPair that)
    {

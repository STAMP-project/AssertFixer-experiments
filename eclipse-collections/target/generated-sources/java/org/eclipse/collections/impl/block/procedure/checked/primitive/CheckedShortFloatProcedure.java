...
public abstract class CheckedShortFloatProcedure implements ShortFloatProcedure
{
    ...
    @Override
    public final void value(short item1, float item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in ShortFloatProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(short item1, float item2) throws Exception;
}

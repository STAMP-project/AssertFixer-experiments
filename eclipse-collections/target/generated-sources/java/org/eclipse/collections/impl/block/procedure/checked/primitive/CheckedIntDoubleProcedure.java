 ...
 * @since 4.0.
 */
public abstract class CheckedIntDoubleProcedure implements IntDoubleProcedure
{
    ...
    public final void value(int item1, double item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in IntDoubleProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(int item1, double item2) throws Exception;
}

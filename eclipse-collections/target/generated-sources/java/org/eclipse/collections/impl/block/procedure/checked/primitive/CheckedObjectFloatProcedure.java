...
public abstract class CheckedObjectFloatProcedure<V> implements ObjectFloatProcedure<V>
{
    ...
    @Override
    public final void value(V item1, float item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in ObjectFloatProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(V item1, float item2) throws Exception;
}

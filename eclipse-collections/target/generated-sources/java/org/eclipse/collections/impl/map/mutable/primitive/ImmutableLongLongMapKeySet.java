 ...
 * @since 6.0.
 */
class ImmutableLongLongMapKeySet extends AbstractImmutableLongSet implements Serializable
{
    ...
    private class InternalLongIterator implements LongIterator
    {
        ...
        public long next()
        {
            ...
            if (!this.handledZero)
            {
                ...
                {
                    return ImmutableLongLongMapKeySet.EMPTY_KEY;
                }
            }
            if (!this.handledOne)
            {
                ...
                {
                    return ImmutableLongLongMapKeySet.REMOVED_KEY;
                }
            }

...
/**
 * A synchronized view of a {@link MutableShortObjectMap}. It is imperative that the user manually synchronize on the collection when iterating over it using the
 * standard JDK iterator or JDK 5 for loop, as per {@link Collections#synchronizedCollection(Collection)}.
 * <p>
 * This file was automatically generated from template file synchronizedPrimitiveObjectMap.stg.
 *
 * @see MutableShortObjectMap#asSynchronized()
 * @see MutableMap#asSynchronized()
 * @since 3.1.
 */
public class SynchronizedShortObjectMap<V>
        implements MutableShortObjectMap<V>, Serializable
{
    private static final long serialVersionUID = 1L;
    private final Object lock;
    private final MutableShortObjectMap<V> map;

    public SynchronizedShortObjectMap(MutableShortObjectMap<V> map)
    {
        this(map, null);
    }

    public SynchronizedShortObjectMap(MutableShortObjectMap<V> map, Object newLock)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a SynchronizedShortObjectMap on a null map");
        }
    ...
    @Override
    public V putPair(ShortObjectPair<V> keyValuePair)
    {
        synchronized (this.lock)
        {
    ...
    @Override
    public MutableShortObjectMap<V> tap(Procedure<? super V> procedure)
    {
        synchronized (this.lock)
        {
    ...
    @Override
    public MutableShortObjectMap<V> select(ShortObjectPredicate<? super V> predicate)
    {
        synchronized (this.lock)
        {
    ...
    @Override
    public MutableShortObjectMap<V> reject(ShortObjectPredicate<? super V> predicate)
    {
        synchronized (this.lock)
        {
    ...
    public LazyShortIterable keysView()
    {
        synchronized (this.lock)
        {
            return SynchronizedShortIterable.of(this.map.keysView(), this.lock).asLazy();
        }
    }
    ...
    @Override
    public MutableShortObjectMap<V> withKeyValue(short key, V value)
    {
        synchronized (this.lock)
        {

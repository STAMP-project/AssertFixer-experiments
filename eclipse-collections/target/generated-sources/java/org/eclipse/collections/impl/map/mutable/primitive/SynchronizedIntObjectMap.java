...
/**
 * A synchronized view of a {@link MutableIntObjectMap}. It is imperative that the user manually synchronize on the collection when iterating over it using the
 * standard JDK iterator or JDK 5 for loop, as per {@link Collections#synchronizedCollection(Collection)}.
 * <p>
 * This file was automatically generated from template file synchronizedPrimitiveObjectMap.stg.
 *
 * @see MutableIntObjectMap#asSynchronized()
        ...
        implements MutableIntObjectMap<V>, Serializable
{
    ...
    private final MutableIntObjectMap<V> map;

    public SynchronizedIntObjectMap(MutableIntObjectMap<V> map)
    {
        this(map, null);
    }

    public SynchronizedIntObjectMap(MutableIntObjectMap<V> map, Object newLock)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a SynchronizedIntObjectMap on a null map");
        }
    ...
    public LazyIntIterable keysView()
    {
        synchronized (this.lock)
        {
            return SynchronizedIntIterable.of(this.map.keysView(), this.lock).asLazy();
        }
    }

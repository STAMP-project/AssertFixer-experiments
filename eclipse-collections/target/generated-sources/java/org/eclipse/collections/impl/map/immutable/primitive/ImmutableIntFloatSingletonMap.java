...
/**
 * ImmutableIntFloatSingletonMap is an optimization for {@link ImmutableIntFloatMap} of size 1.
 * This file was automatically generated from template file immutablePrimitivePrimitiveSingletonMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableIntFloatSingletonMap implements ImmutableIntFloatMap, Serializable
{
    ...
    ImmutableIntFloatSingletonMap(int key1, float value1)
    {
        this.key1 = key1;
        this.value1 = value1;
    }
    ...
    {
        return FloatIntMaps.immutable.with(this.value1, this.key1);
    }

    @Override
    public ImmutableIntFloatMap select(IntFloatPredicate predicate)
    {
        return predicate.accept(this.key1, this.value1) ? IntFloatHashMap.newWithKeysValues(this.key1, this.value1).toImmutable()
                : new IntFloatHashMap().toImmutable();
    }

    @Override
    public ImmutableIntFloatMap reject(IntFloatPredicate predicate)
    {
        return predicate.accept(this.key1, this.value1) ? new IntFloatHashMap().toImmutable()
                : IntFloatHashMap.newWithKeysValues(this.key1, this.value1).toImmutable();
    }
    ...
    {
        return new UnmodifiableFloatIterator(IntFloatHashMap.newWithKeysValues(this.key1, this.value1).floatIterator());
    }
    ...
    {
        return IntFloatMaps.immutable.withAll(IntFloatHashMap.newWithKeysValues(this.key1, this.value1, key, value));
    }

    @Override
    public ImmutableIntFloatMap newWithoutKey(int key)
    {
        return this.key1 == key ? IntFloatMaps.immutable.with() : this;
    }

    @Override
    public ImmutableIntFloatMap newWithoutAllKeys(IntIterable keys)
    {
        return keys.contains(this.key1) ? IntFloatMaps.immutable.with() : this;
    }

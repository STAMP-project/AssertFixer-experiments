...
public abstract class CheckedByteObjectProcedure<V> implements ByteObjectProcedure<V>
{
    ...
    @Override
    public final void value(byte item1, V item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in ByteObjectProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(byte item1, V item2) throws Exception;
}

...
/**
 * ImmutableShortFloatSingletonMap is an optimization for {@link ImmutableShortFloatMap} of size 1.
 * This file was automatically generated from template file immutablePrimitivePrimitiveSingletonMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableShortFloatSingletonMap implements ImmutableShortFloatMap, Serializable
{
    ...
    {
        return predicate.accept(this.key1, this.value1) ? ShortFloatHashMap.newWithKeysValues(this.key1, this.value1).toImmutable()
                : new ShortFloatHashMap().toImmutable();
    }

    @Override
    public ImmutableShortFloatMap reject(ShortFloatPredicate predicate)
    {
        return predicate.accept(this.key1, this.value1) ? new ShortFloatHashMap().toImmutable()
                : ShortFloatHashMap.newWithKeysValues(this.key1, this.value1).toImmutable();
    }

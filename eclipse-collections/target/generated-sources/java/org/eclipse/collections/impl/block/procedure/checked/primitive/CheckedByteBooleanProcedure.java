 ...
 * @since 4.0.
 */
public abstract class CheckedByteBooleanProcedure implements ByteBooleanProcedure
{
    ...
    public final void value(byte item1, boolean item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in ByteBooleanProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(byte item1, boolean item2) throws Exception;
}

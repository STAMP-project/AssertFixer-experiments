 ...
 */
public class ShortIntPairImpl implements ShortIntPair
{
    ...
    ShortIntPairImpl(short newOne, int newTwo)
    {
        this.one = newOne;
        this.two = newTwo;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof ShortIntPair))
        {
            return false;
        }

        ShortIntPair that = (ShortIntPair) o;
    ...
    public int hashCode()
    {
        return 29 * (int) this.one + this.two;
    }

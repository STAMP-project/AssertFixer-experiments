 ...
 */
public class CollectDoubleToByteIterable
        extends AbstractLazyByteIterable
{
    private final DoubleIterable iterable;
    private final DoubleToByteFunction function;

    public CollectDoubleToByteIterable(DoubleIterable iterable, DoubleToByteFunction function)
    {
    ...
    public ByteIterator byteIterator()
    {
        ...
        {
            private final DoubleIterator iterator = CollectDoubleToByteIterable.this.iterable.doubleIterator();
            ...
            public byte next()
            {
                return CollectDoubleToByteIterable.this.function.valueOf(this.iterator.next());
            }
        };
    }

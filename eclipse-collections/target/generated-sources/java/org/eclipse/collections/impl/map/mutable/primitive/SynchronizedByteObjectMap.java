 ...
 * @since 3.1.
 */
public class SynchronizedByteObjectMap<V>
        implements MutableByteObjectMap<V>, Serializable
{
    ...
    public SynchronizedByteObjectMap(MutableByteObjectMap<V> map)
    {
        this(map, null);
    }

    public SynchronizedByteObjectMap(MutableByteObjectMap<V> map, Object newLock)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a SynchronizedByteObjectMap on a null map");
        }

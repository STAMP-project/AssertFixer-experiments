...
/**
 * ImmutableIntObjectSingletonMap is an optimization for {@link ImmutableIntObjectMap} of size 1.
 * This file was automatically generated from template file immutablePrimitiveObjectSingletonMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableIntObjectSingletonMap<V> extends AbstractImmutableIntObjectMap<V> implements Serializable
{
    private static final long serialVersionUID = 1L;
    private final int key1;
    private final V value1;

    ImmutableIntObjectSingletonMap(int key1, V value1)
    {
        this.key1 = key1;
        this.value1 = value1;
    }
    ...
    @Override
    public ImmutableIntObjectMap<V> tap(Procedure<? super V> procedure)
    {
    ...
    {
        return predicate.accept(this.key1, this.value1) ? IntObjectHashMap.newWithKeysValues(this.key1, this.value1).toImmutable()
                : (ImmutableIntObjectMap<V>) ImmutableIntObjectEmptyMap.INSTANCE;
    }

    @Override
    public ImmutableIntObjectMap<V> reject(IntObjectPredicate<? super V> predicate)
    {
        return predicate.accept(this.key1, this.value1) ? (ImmutableIntObjectMap<V>) ImmutableIntObjectEmptyMap.INSTANCE
                : IntObjectHashMap.newWithKeysValues(this.key1, this.value1).toImmutable();
    }
    ...
    @Override
    public ImmutableObjectIntMap<V> flipUniqueValues()
    {
        return ObjectIntMaps.immutable.with(this.value1, this.key1);
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        IntObjectMap<V> map = (IntObjectMap<V>) obj;
        if (map.size() != 1)
        {
            return false;
        }
    ...
    {
        return IntObjectHashMap.newWithKeysValues(this.key1, this.value1, key, value).toImmutable();
    }

    @Override
    public ImmutableIntObjectMap<V> newWithoutKey(int key)
    {
        return this.key1 == key ? (ImmutableIntObjectMap<V>) ImmutableIntObjectEmptyMap.INSTANCE : this;
    }

    @Override
    public ImmutableIntObjectMap<V> newWithoutAllKeys(IntIterable keys)
    {
        return keys.contains(this.key1) ? (ImmutableIntObjectMap<V>) ImmutableIntObjectEmptyMap.INSTANCE : this;
    }
    ...
    {
        return new UnmodifiableIteratorAdapter<>(IntObjectHashMap.newWithKeysValues(this.key1, this.value1).iterator());
    }

...
import org.eclipse.collections.impl.block.procedure.checked.primitive.CheckedIntFloatProcedure;
...
/**
 * ImmutableIntFloatHashMap is the non-modifiable equivalent of {@link IntFloatHashMap}.
 * This file was automatically generated from template file immutablePrimitivePrimitiveHashMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableIntFloatHashMap implements ImmutableIntFloatMap, Serializable
{
    ...
    protected static class ImmutableIntFloatMapSerializationProxy implements Externalizable
    {
        private static final long serialVersionUID = 1L;
        ...
        {
            int size = in.readInt();
            MutableIntFloatMap deserializedMap = new IntFloatHashMap();

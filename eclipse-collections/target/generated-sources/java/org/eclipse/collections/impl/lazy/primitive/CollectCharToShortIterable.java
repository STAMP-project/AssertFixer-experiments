 ...
 */
public class CollectCharToShortIterable
        extends AbstractLazyShortIterable
{
    private final CharIterable iterable;
    private final CharToShortFunction function;

    public CollectCharToShortIterable(CharIterable iterable, CharToShortFunction function)
    {
    ...
    public ShortIterator shortIterator()
    {
        ...
        {
            private final CharIterator iterator = CollectCharToShortIterable.this.iterable.charIterator();
            ...
            public short next()
            {
                return CollectCharToShortIterable.this.function.valueOf(this.iterator.next());
            }
        };
    }

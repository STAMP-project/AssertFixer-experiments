...
public abstract class CheckedBooleanObjectProcedure<V> implements BooleanObjectProcedure<V>
{
    ...
    @Override
    public final void value(boolean item1, V item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in BooleanObjectProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(boolean item1, V item2) throws Exception;
}

 ...
 * @since 4.0.
 */
public abstract class CheckedShortLongProcedure implements ShortLongProcedure
{
    ...
    public final void value(short item1, long item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in ShortLongProcedure", e);
        }
    }

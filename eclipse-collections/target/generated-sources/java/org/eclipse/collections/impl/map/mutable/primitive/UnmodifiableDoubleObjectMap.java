 ...
 * @since 3.2.
 */
public class UnmodifiableDoubleObjectMap<V>
        implements MutableDoubleObjectMap<V>, Serializable
{
    private static final long serialVersionUID = 1L;
    private final MutableDoubleObjectMap<V> map;

    public UnmodifiableDoubleObjectMap(MutableDoubleObjectMap<V> map)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a UnmodifiableDoubleObjectMap on a null map");
        }

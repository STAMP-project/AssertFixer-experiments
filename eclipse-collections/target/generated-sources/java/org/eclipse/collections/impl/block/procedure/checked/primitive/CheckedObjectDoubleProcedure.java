...
public abstract class CheckedObjectDoubleProcedure<V> implements ObjectDoubleProcedure<V>
{
    ...
    @Override
    public final void value(V item1, double item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in ObjectDoubleProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(V item1, double item2) throws Exception;
}

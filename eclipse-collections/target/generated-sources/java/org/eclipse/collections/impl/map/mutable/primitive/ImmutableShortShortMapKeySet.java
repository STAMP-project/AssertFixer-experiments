 ...
 * @since 6.0.
 */
class ImmutableShortShortMapKeySet extends AbstractImmutableShortSet implements Serializable
{
    ...
    private class InternalShortIterator implements ShortIterator
    {
        ...
        public short next()
        {
            ...
            if (!this.handledZero)
            {
                ...
                {
                    return ImmutableShortShortMapKeySet.EMPTY_KEY;
                }
            }
            if (!this.handledOne)
            {
                ...
                {
                    return ImmutableShortShortMapKeySet.REMOVED_KEY;
                }
            }

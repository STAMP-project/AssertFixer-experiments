...
/**
 * A synchronized view of a {@link MutableShortLongMap}. It is imperative that the user manually synchronize on the collection when iterating over it using the
 * {@link MutableLongIterator} as per {@link Collections#synchronizedCollection(Collection)}.
 * <p>
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMap.stg.
 *
 * @see MutableShortLongMap#asSynchronized()
        ...
        implements MutableShortLongMap, Serializable
{
    ...
    public SynchronizedShortLongMap(MutableShortLongMap map, Object newLock)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a SynchronizedShortLongMap on a null map");
        }
    ...
    public ImmutableShortLongMap toImmutable()
    {
        synchronized (this.lock)
        {
            return ShortLongMaps.immutable.withAll(this);
        }
    }

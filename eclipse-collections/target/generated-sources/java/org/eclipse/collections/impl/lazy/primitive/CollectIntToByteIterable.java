 ...
 */
public class CollectIntToByteIterable
        extends AbstractLazyByteIterable
{
    private final IntIterable iterable;
    private final IntToByteFunction function;

    public CollectIntToByteIterable(IntIterable iterable, IntToByteFunction function)
    {
    ...
    public ByteIterator byteIterator()
    {
        ...
        {
            private final IntIterator iterator = CollectIntToByteIterable.this.iterable.intIterator();
            ...
            public byte next()
            {
                return CollectIntToByteIterable.this.function.valueOf(this.iterator.next());
            }
        };
    }

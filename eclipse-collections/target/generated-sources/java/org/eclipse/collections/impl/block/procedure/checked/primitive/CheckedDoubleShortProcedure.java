 ...
 * @since 4.0.
 */
public abstract class CheckedDoubleShortProcedure implements DoubleShortProcedure
{
    ...
    public final void value(double item1, short item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in DoubleShortProcedure", e);
        }
    }

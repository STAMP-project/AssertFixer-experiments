...
/**
 * ImmutableLongDoubleSingletonMap is an optimization for {@link ImmutableLongDoubleMap} of size 1.
 * This file was automatically generated from template file immutablePrimitivePrimitiveSingletonMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableLongDoubleSingletonMap implements ImmutableLongDoubleMap, Serializable
{
    ...
    ImmutableLongDoubleSingletonMap(long key1, double value1)
    {
        this.key1 = key1;
        this.value1 = value1;
    }
    ...
    {
        return DoubleLongMaps.immutable.with(this.value1, this.key1);
    }
    ...
    {
        return new UnmodifiableDoubleIterator(LongDoubleHashMap.newWithKeysValues(this.key1, this.value1).doubleIterator());
    }
    ...
    {
        return LongDoubleMaps.immutable.withAll(LongDoubleHashMap.newWithKeysValues(this.key1, this.value1, key, value));
    }

    @Override
    public ImmutableLongDoubleMap newWithoutKey(long key)
    {
        return this.key1 == key ? LongDoubleMaps.immutable.with() : this;
    }

    @Override
    public ImmutableLongDoubleMap newWithoutAllKeys(LongIterable keys)
    {
        return keys.contains(this.key1) ? LongDoubleMaps.immutable.with() : this;
    }
    ...
    public int hashCode()
    {
        return (int) (this.key1 ^ this.key1 >>> 32) ^ (int) (Double.doubleToLongBits(this.value1) ^ Double.doubleToLongBits(this.value1) >>> 32);
    }

 ...
 * @since 4.0.
 */
public abstract class CheckedShortByteProcedure implements ShortByteProcedure
{
    ...
    public final void value(short item1, byte item2)
    {
        ...
        {
            throw new RuntimeException("Checked exception caught in ShortByteProcedure", e);
        }
    }

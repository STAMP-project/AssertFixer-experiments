 ...
 */
public class CollectCharToDoubleIterable
        extends AbstractLazyDoubleIterable
{
    private final CharIterable iterable;
    private final CharToDoubleFunction function;

    public CollectCharToDoubleIterable(CharIterable iterable, CharToDoubleFunction function)
    {
    ...
    public DoubleIterator doubleIterator()
    {
        ...
        {
            private final CharIterator iterator = CollectCharToDoubleIterable.this.iterable.charIterator();

...
/**
 * ImmutableShortObjectHashMap is the non-modifiable equivalent of {@link ShortObjectHashMap}.
...
final class ImmutableShortObjectHashMap<V> extends AbstractImmutableShortObjectMap<V> implements Serializable
{
    ...
    ImmutableShortObjectHashMap(ShortObjectMap<? extends V> delegate)
    {
        this.delegate = new ShortObjectHashMap<>(delegate);
    }
    ...
    {
        ShortObjectHashMap<V> map = new ShortObjectHashMap<>(this);
        map.put(key, value);
        return map.toImmutable();
    }

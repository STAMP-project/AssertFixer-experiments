 ...
 */
public class CollectIntToLongIterable
        extends AbstractLazyLongIterable
{
    private final IntIterable iterable;
    private final IntToLongFunction function;

    public CollectIntToLongIterable(IntIterable iterable, IntToLongFunction function)
    {
    ...
    public LongIterator longIterator()
    {
        ...
        {
            private final IntIterator iterator = CollectIntToLongIterable.this.iterable.intIterator();

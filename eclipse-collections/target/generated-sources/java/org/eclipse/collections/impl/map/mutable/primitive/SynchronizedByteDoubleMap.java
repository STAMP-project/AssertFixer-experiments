...
/**
 * A synchronized view of a {@link MutableByteDoubleMap}. It is imperative that the user manually synchronize on the collection when iterating over it using the
 * {@link MutableDoubleIterator} as per {@link Collections#synchronizedCollection(Collection)}.
 * <p>
 * This file was automatically generated from template file synchronizedPrimitivePrimitiveMap.stg.
 *
 * @see MutableByteDoubleMap#asSynchronized()
 * @see MutableMap#asSynchronized()
 * @since 3.1.
 */
public class SynchronizedByteDoubleMap
        implements MutableByteDoubleMap, Serializable
{
    ...
    public SynchronizedByteDoubleMap(MutableByteDoubleMap map)
    {
        this(map, null);
    }

    public SynchronizedByteDoubleMap(MutableByteDoubleMap map, Object newLock)
    {
        if (map == null)
        {

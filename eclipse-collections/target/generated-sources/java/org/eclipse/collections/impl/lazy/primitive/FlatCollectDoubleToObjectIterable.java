 ...
 */
public class FlatCollectDoubleToObjectIterable<V>
        extends AbstractLazyIterable<V>
{
    ...
    public FlatCollectDoubleToObjectIterable(DoubleIterable iterable, DoubleToObjectFunction<? extends Iterable<V>> function)
    {
    ...
    {
        this.iterable.forEach((double each) -> Iterate.forEach(this.function.valueOf(each), procedure));
    }
    ...
    {
        this.iterable.forEach((double each) -> Iterate.forEachWith(this.function.valueOf(each), procedure, parameter));
    }

    @Override
    public Iterator<V> iterator()
    {
        return new FlatCollectDoubleIterator<>(this.iterable, this.function);
    }
    ...
    private final class FlatCollectDoubleIterator<V> implements Iterator<V>
    {
        ...
        public FlatCollectDoubleIterator(
                DoubleIterable iterable,
                DoubleToObjectFunction<? extends Iterable<V>> newFunction)
        {
            this(iterable.doubleIterator(), newFunction);
        }

        public FlatCollectDoubleIterator(
                DoubleIterator newIterator,
                DoubleToObjectFunction<? extends Iterable<V>> newFunction)
        {

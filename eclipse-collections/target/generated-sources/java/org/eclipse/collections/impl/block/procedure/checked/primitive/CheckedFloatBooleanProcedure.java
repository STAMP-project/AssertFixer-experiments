...
public abstract class CheckedFloatBooleanProcedure implements FloatBooleanProcedure
{
    ...
    @Override
    public final void value(float item1, boolean item2)
    {
        try
        {
        ...
        {
            throw new RuntimeException("Checked exception caught in FloatBooleanProcedure", e);
        }
    }

    @SuppressWarnings("ProhibitedExceptionDeclared")
    public abstract void safeValue(float item1, boolean item2) throws Exception;
}

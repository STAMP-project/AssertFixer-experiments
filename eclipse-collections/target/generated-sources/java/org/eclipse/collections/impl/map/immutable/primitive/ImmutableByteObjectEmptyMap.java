...
{
    static final ImmutableByteObjectMap<?> INSTANCE = new ImmutableByteObjectEmptyMap<>();
    ...
    {
        return UnmodifiableByteSet.of(ByteHashSet.newSetWith());
    }
    ...
    {
        return ObjectByteMaps.immutable.empty();
    }
    ...
    {
        ByteObjectHashMap<V> map = new ByteObjectHashMap<>();
        map.put(key, value);

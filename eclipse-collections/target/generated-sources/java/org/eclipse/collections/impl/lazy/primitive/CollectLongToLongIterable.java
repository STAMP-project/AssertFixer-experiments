 ...
 */
public class CollectLongToLongIterable
        extends AbstractLazyLongIterable
{
    private final LongIterable iterable;
    private final LongToLongFunction function;

    public CollectLongToLongIterable(LongIterable iterable, LongToLongFunction function)
    {
    ...
    public LongIterator longIterator()
    {
        ...
        {
            private final LongIterator iterator = CollectLongToLongIterable.this.iterable.longIterator();

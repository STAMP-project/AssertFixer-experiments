 ...
 * @since 3.0.
 */
public class IntObjectHashMap<V> implements MutableIntObjectMap<V>, Externalizable
{
    ...
    public static <V> IntObjectHashMap<V> newMap()
    {
        return new IntObjectHashMap<>();
    }

    public static <V> IntObjectHashMap<V> newMap(IntObjectMap<? extends V> map)
    {
        return new IntObjectHashMap<>(map);
    }

    public static <V> IntObjectHashMap<V> newWithKeysValues(int key, V value)
    {
        return new IntObjectHashMap<V>(1).withKeyValue(key, value);
    }

    public static <V> IntObjectHashMap<V> newWithKeysValues(int key1, V value1, int key2, V value2)
    {
        return new IntObjectHashMap<V>(2).withKeysValues(key1, value1, key2, value2);
    }

    public static <V> IntObjectHashMap<V> newWithKeysValues(int key1, V value1, int key2, V value2, int key3, V value3)
    {
        return new IntObjectHashMap<V>(3).withKeysValues(key1, value1, key2, value2, key3, value3);
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        IntObjectMap<V> other = (IntObjectMap<V>) obj;
    ...
    public int hashCode()
    {
        ...
        if (this.sentinelValues != null)
        {
            ...
            {
                result += EMPTY_KEY ^ (this.sentinelValues.zeroValue == null ? 0 : this.sentinelValues.zeroValue.hashCode());
            }

            if (this.sentinelValues.containsOneKey)
            {
                result += REMOVED_KEY ^ (this.sentinelValues.oneValue == null ? 0 : this.sentinelValues.oneValue.hashCode());
            }
        }
    ...
    @Override
    public IntObjectHashMap<V> tap(Procedure<? super V> procedure)
    {
    ...
    {
        IntObjectHashMap<V> result = IntObjectHashMap.newMap();
    ...
    public void clear()
    {
        ...
        {
            this.keys = new int[this.keys.length];
    ...
    {
        map.forEachKeyValue((int key, V value) -> IntObjectHashMap.this.put(key, value));
    }
    ...
    @Override
    public IntObjectHashMap<V> withKeyValue(int key, V value)
    {
        this.put(key, value);
        return this;
    }
    ...
    public IntObjectHashMap<V> withKeysValues(int key1, V value1, int key2, V value2)
    {
    ...
    public IntObjectHashMap<V> withKeysValues(int key1, V value1, int key2, V value2, int key3, V value3)
    {
        this.put(key1, value1);
        this.put(key2, value2);
    ...
    public IntObjectHashMap<V> withKeysValues(int key1, V value1, int key2, V value2, int key3, V value3, int key4, V value4)
    {
        this.put(key1, value1);
        this.put(key2, value2);
        this.put(key3, value3);
    ...
    {
        return new UnmodifiableIntObjectMap<>(this);
    }
    ...
    private void addKeyValueAtIndex(int key, V value, int index)
    {
    ...
    private class InternalIterator implements Iterator<V>
    {
        ...
        {
            return this.count != IntObjectHashMap.this.size();
        }
        ...
        public V next()
        {
            ...
            if (!this.handledZeroKey)
            {
                ...
                if (IntObjectHashMap.this.containsKey(EMPTY_KEY))
                {
                    this.currentKey = IntObjectHashMap.EMPTY_KEY;
                    this.isCurrentKeySet = true;
                    return IntObjectHashMap.this.sentinelValues.zeroValue;
                }
            }
            if (!this.handledOneKey)
            {
                this.handledOneKey = true;
                if (IntObjectHashMap.this.containsKey(REMOVED_KEY))
                {
                    this.currentKey = IntObjectHashMap.REMOVED_KEY;
                    this.isCurrentKeySet = true;
                    return IntObjectHashMap.this.sentinelValues.oneValue;
                }
            }
            int[] keys = IntObjectHashMap.this.keys;
            while (!isNonSentinel(keys[this.position]))
            {
                this.position++;
            }
            this.currentKey = IntObjectHashMap.this.keys[this.position];
            this.isCurrentKeySet = true;
            V result = IntObjectHashMap.this.values[this.position];
            this.position++;
            return result;
        }
        ...
        public void remove()
        {
            ...
            if (isNonSentinel(this.currentKey))
            {
                ...
                IntObjectHashMap.this.removeKeyAtIndex(index);
            }
            else
            {
                IntObjectHashMap.this.removeKey(this.currentKey);
            }
        }
    }
    ...
    private class KeySet implements MutableIntSet
    {
        ...
        {
            IntObjectHashMap.this.forEachKey(procedure);
        }
        ...
        {
            int count = 0;
            if (IntObjectHashMap.this.sentinelValues != null)
            {
                if (IntObjectHashMap.this.sentinelValues.containsZeroKey && predicate.accept(EMPTY_KEY))
                {
                    count++;
                }
                if (IntObjectHashMap.this.sentinelValues.containsOneKey && predicate.accept(REMOVED_KEY))
                {
                    count++;
                }
            }
            for (int key : IntObjectHashMap.this.keys)
            {
        ...
        public <T> T injectInto(T injectedValue, ObjectIntToObjectFunction<? super T, ? extends T> function)
        {
            ...
            if (IntObjectHashMap.this.sentinelValues != null)
            {
                if (IntObjectHashMap.this.sentinelValues.containsZeroKey)
                {
                    result = function.valueOf(result, EMPTY_KEY);
                }
                if (IntObjectHashMap.this.sentinelValues.containsOneKey)
                {
        ...
        public boolean remove(int key)
        {
            ...
            IntObjectHashMap.this.removeKey(key);
        ...
        public boolean removeAll(int... source)
        {
            ...
            for (int item : source)
            {
                IntObjectHashMap.this.removeKey(item);
            }
            return oldSize != IntObjectHashMap.this.size();
        }
        ...
        public boolean retainAll(IntIterable source)
        {
            ...
            IntObjectHashMap<V> retained = IntObjectHashMap.this.select((int key, V value) -> sourceSet.contains(key));
            if (retained.size() != oldSize)
            {
                IntObjectHashMap.this.keys = retained.keys;
                IntObjectHashMap.this.values = retained.values;
                IntObjectHashMap.this.sentinelValues = retained.sentinelValues;
                IntObjectHashMap.this.occupiedWithData = retained.occupiedWithData;
                IntObjectHashMap.this.occupiedWithSentinels = retained.occupiedWithSentinels;
                return true;
            }
            return false;
        }
        ...
        public int max()
        {
            if (IntObjectHashMap.this.isEmpty())
            {
                throw new NoSuchElementException();
            }
            ...
            for (int i = 0; i < IntObjectHashMap.this.keys.length; i++)
            {
                if (isNonSentinel(IntObjectHashMap.this.keys[i]) && (!isMaxSet || max < IntObjectHashMap.this.keys[i]))
                {
                    max = IntObjectHashMap.this.keys[i];
                    isMaxSet = true;
                }
            }
            return max;
        ...
        public int min()
        {
            ...
            if (IntObjectHashMap.this.sentinelValues != null)
            {
                ...
                if (IntObjectHashMap.this.sentinelValues.containsOneKey && !isMinSet)
                {
                    min = REMOVED_KEY;
                    isMinSet = true;
                }
            ...
            for (int i = 0; i < IntObjectHashMap.this.keys.length; i++)
            {
                if (isNonSentinel(IntObjectHashMap.this.keys[i]) && (!isMinSet || IntObjectHashMap.this.keys[i] < min))
                {
                    min = IntObjectHashMap.this.keys[i];
                    isMinSet = true;
                }
            }
            return min;
        ...
        {
            return IntObjectHashMap.this.containsKey(value);
        }
        ...
        public boolean containsAll(int... source)
        {
            for (int item : source)
            {
                if (!IntObjectHashMap.this.containsKey(item))
                {
                    return false;
                }
            }
        ...
        {
            IntObjectHashMap.this.copyKeysOnWrite = true;
            boolean containsZeroKey = false;
            boolean containsOneKey = false;
            if (IntObjectHashMap.this.sentinelValues != null)
            {
                containsZeroKey = IntObjectHashMap.this.sentinelValues.containsZeroKey;
                containsOneKey = IntObjectHashMap.this.sentinelValues.containsOneKey;
            }
            return new ImmutableIntMapKeySet(IntObjectHashMap.this.keys, IntObjectHashMap.this.occupiedWithData, containsZeroKey, containsOneKey);
        }
        ...
        public boolean isEmpty()
        {
            return IntObjectHashMap.this.isEmpty();
        }

        @Override
        public boolean notEmpty()
        {
            return IntObjectHashMap.this.notEmpty();
        }
        ...
        public int hashCode()
        {
            ...
            for (int i = 0; i < IntObjectHashMap.this.keys.length; i++)
            {
                if (isNonSentinel(IntObjectHashMap.this.keys[i]))
                {
                    result += IntObjectHashMap.this.keys[i];
                }
            }
    ...
    private class KeysSetIterator implements MutableIntIterator
    {
        private int count;
        private int position;
        private int lastKey;
        ...
        public void remove()
        {
            ...
            IntObjectHashMap.this.removeKey(this.lastKey);
            this.count--;
    ...
    {
        MutableObjectIntMap<V> result = ObjectIntMaps.mutable.empty();
    ...
    protected class ValuesCollection implements Collection<V>
    {
        ...
        {
            return IntObjectHashMap.this.containsValue(o);
        }
        ...
        public Iterator<V> iterator()
        {
            return IntObjectHashMap.this.iterator();
        }
        ...
        public Object[] toArray()
        {
            return IntObjectHashMap.this.toArray();
        }

        @Override
        public <T> T[] toArray(T[] result)
        {
            return IntObjectHashMap.this.toArray(result);
        }
    }
    ...
    private class KeysView extends AbstractLazyIntIterable
    {
        ...
        {
            return new UnmodifiableIntIterator(new KeysSetIterator());
        }
    ...
    private class KeyValuesView extends AbstractLazyIterable<IntObjectPair<V>>
    {
        @Override
        public void each(Procedure<? super IntObjectPair<V>> procedure)
        {
            if (IntObjectHashMap.this.sentinelValues != null)
            {
                if (IntObjectHashMap.this.sentinelValues.containsZeroKey)
                {
                    procedure.value(PrimitiveTuples.pair(EMPTY_KEY, IntObjectHashMap.this.sentinelValues.zeroValue));
                }
                if (IntObjectHashMap.this.sentinelValues.containsOneKey)
                {
                    procedure.value(PrimitiveTuples.pair(REMOVED_KEY, IntObjectHashMap.this.sentinelValues.oneValue));
                }
            }
            for (int i = 0; i < IntObjectHashMap.this.keys.length; i++)
            {
                if (isNonSentinel(IntObjectHashMap.this.keys[i]))
                {
                    procedure.value(PrimitiveTuples.pair(IntObjectHashMap.this.keys[i], IntObjectHashMap.this.values[i]));
                }
            }
        }

        @Override
        public void forEachWithIndex(ObjectIntProcedure<? super IntObjectPair<V>> objectIntProcedure)
        {
            int index = 0;
            if (IntObjectHashMap.this.sentinelValues != null)
            {
                if (IntObjectHashMap.this.sentinelValues.containsZeroKey)
                {
                    objectIntProcedure.value(PrimitiveTuples.pair(EMPTY_KEY, IntObjectHashMap.this.sentinelValues.zeroValue), index);
                    index++;
                }
                if (IntObjectHashMap.this.sentinelValues.containsOneKey)
                {
                    objectIntProcedure.value(PrimitiveTuples.pair(REMOVED_KEY, IntObjectHashMap.this.sentinelValues.oneValue), index);
                    index++;
                }
            }
            for (int i = 0; i < IntObjectHashMap.this.keys.length; i++)
            {
                if (isNonSentinel(IntObjectHashMap.this.keys[i]))
                {
                    objectIntProcedure.value(PrimitiveTuples.pair(IntObjectHashMap.this.keys[i], IntObjectHashMap.this.values[i]), index);
                    index++;
                }
            }
        }
        ...
        @Override
        public <P> void forEachWith(Procedure2<? super IntObjectPair<V>, ? super P> procedure, P parameter)
        {
            if (IntObjectHashMap.this.sentinelValues != null)
            {
                if (IntObjectHashMap.this.sentinelValues.containsZeroKey)
                {
                    procedure.value(PrimitiveTuples.pair(EMPTY_KEY, IntObjectHashMap.this.sentinelValues.zeroValue), parameter);
                }
                if (IntObjectHashMap.this.sentinelValues.containsOneKey)
                {
                    procedure.value(PrimitiveTuples.pair(REMOVED_KEY, IntObjectHashMap.this.sentinelValues.oneValue), parameter);
                }
            }
            for (int i = 0; i < IntObjectHashMap.this.keys.length; i++)
            {
                if (isNonSentinel(IntObjectHashMap.this.keys[i]))
                {
                    procedure.value(PrimitiveTuples.pair(IntObjectHashMap.this.keys[i], IntObjectHashMap.this.values[i]), parameter);
                }
            }
        }
        ...
        public class InternalKeyValuesIterator implements Iterator<IntObjectPair<V>>
        {
            private int count;
            private int position;
            ...
            public IntObjectPair<V> next()
            {
                ...
                if (!this.handledZero)
                {
                    ...
                    if (IntObjectHashMap.this.containsKey(EMPTY_KEY))
                    {
                        return PrimitiveTuples.pair(EMPTY_KEY, IntObjectHashMap.this.sentinelValues.zeroValue);
                    }
                }
                if (!this.handledOne)
                {
                    ...
                    if (IntObjectHashMap.this.containsKey(REMOVED_KEY))
                    {
                        return PrimitiveTuples.pair(REMOVED_KEY, IntObjectHashMap.this.sentinelValues.oneValue);
                    }
                }
                ...
                IntObjectPair<V> result = PrimitiveTuples.pair(keys[this.position], IntObjectHashMap.this.values[this.position]);
                this.position++;
                return result;
            }

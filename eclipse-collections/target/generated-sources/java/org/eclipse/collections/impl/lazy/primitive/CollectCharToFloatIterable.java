 ...
 */
public class CollectCharToFloatIterable
        extends AbstractLazyFloatIterable
{
    private final CharIterable iterable;
    private final CharToFloatFunction function;

    public CollectCharToFloatIterable(CharIterable iterable, CharToFloatFunction function)
    {
    ...
    public FloatIterator floatIterator()
    {
        ...
        {
            private final CharIterator iterator = CollectCharToFloatIterable.this.iterable.charIterator();

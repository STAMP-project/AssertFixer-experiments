 ...
 */
public class CollectDoubleToShortIterable
        extends AbstractLazyShortIterable
{
    private final DoubleIterable iterable;
    private final DoubleToShortFunction function;

    public CollectDoubleToShortIterable(DoubleIterable iterable, DoubleToShortFunction function)
    {
    ...
    public ShortIterator shortIterator()
    {
        ...
        {
            private final DoubleIterator iterator = CollectDoubleToShortIterable.this.iterable.doubleIterator();

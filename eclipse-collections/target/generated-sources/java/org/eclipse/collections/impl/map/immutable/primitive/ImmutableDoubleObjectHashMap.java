...
/**
 * ImmutableDoubleObjectHashMap is the non-modifiable equivalent of {@link DoubleObjectHashMap}.
 * This file was automatically generated from template file immutablePrimitiveObjectHashMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableDoubleObjectHashMap<V> extends AbstractImmutableDoubleObjectMap<V> implements Serializable
{
    ...
    {
        this.delegate = new DoubleObjectHashMap<>(delegate);
    }
    ...
    {
        DoubleObjectHashMap<V> map = new DoubleObjectHashMap<>(this);
        map.put(key, value);
        return map.toImmutable();
    }

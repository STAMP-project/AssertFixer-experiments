 ...
 * @since 3.1.
 */
public class SynchronizedFloatObjectMap<V>
        implements MutableFloatObjectMap<V>, Serializable
{
    private static final long serialVersionUID = 1L;
    private final Object lock;
    private final MutableFloatObjectMap<V> map;

    public SynchronizedFloatObjectMap(MutableFloatObjectMap<V> map)
    {
        this(map, null);
    }

    public SynchronizedFloatObjectMap(MutableFloatObjectMap<V> map, Object newLock)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a SynchronizedFloatObjectMap on a null map");
        }

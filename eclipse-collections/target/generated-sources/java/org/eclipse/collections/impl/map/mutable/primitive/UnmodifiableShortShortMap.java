 ...
 * @since 3.1.
 */
public class UnmodifiableShortShortMap
        implements MutableShortShortMap, Serializable
{
    private static final long serialVersionUID = 1L;
    private final MutableShortShortMap map;

    public UnmodifiableShortShortMap(MutableShortShortMap map)
    {
        if (map == null)
        {
            throw new IllegalArgumentException("Cannot create a UnmodifiableShortShortMap on a null map");
        }

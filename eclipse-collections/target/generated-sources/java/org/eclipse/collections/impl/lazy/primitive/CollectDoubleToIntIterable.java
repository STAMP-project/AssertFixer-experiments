 ...
 */
public class CollectDoubleToIntIterable
        extends AbstractLazyIntIterable
{
    ...
    public IntIterator intIterator()
    {
        ...
        {
            private final DoubleIterator iterator = CollectDoubleToIntIterable.this.iterable.doubleIterator();
            ...
            public int next()
            {
                return CollectDoubleToIntIterable.this.function.valueOf(this.iterator.next());
            }
        };
    }

 ...
 */
public class CollectCharToLongIterable
        extends AbstractLazyLongIterable
{
    private final CharIterable iterable;
    private final CharToLongFunction function;

    public CollectCharToLongIterable(CharIterable iterable, CharToLongFunction function)
    {
    ...
    public LongIterator longIterator()
    {
        ...
        {
            private final CharIterator iterator = CollectCharToLongIterable.this.iterable.charIterator();

...
/**
 * ImmutableShortDoubleSingletonMap is an optimization for {@link ImmutableShortDoubleMap} of size 1.
 * This file was automatically generated from template file immutablePrimitivePrimitiveSingletonMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableShortDoubleSingletonMap implements ImmutableShortDoubleMap, Serializable
{
    ...
    {
        return DoubleShortMaps.immutable.with(this.value1, this.key1);
    }

    @Override
    public ImmutableShortDoubleMap select(ShortDoublePredicate predicate)
    {
        return predicate.accept(this.key1, this.value1) ? ShortDoubleHashMap.newWithKeysValues(this.key1, this.value1).toImmutable()
                : new ShortDoubleHashMap().toImmutable();
    }

    @Override
    public ImmutableShortDoubleMap reject(ShortDoublePredicate predicate)
    {
        return predicate.accept(this.key1, this.value1) ? new ShortDoubleHashMap().toImmutable()
                : ShortDoubleHashMap.newWithKeysValues(this.key1, this.value1).toImmutable();
    }
    ...
    {
        return new UnmodifiableDoubleIterator(ShortDoubleHashMap.newWithKeysValues(this.key1, this.value1).doubleIterator());
    }
    ...
    {
        return ShortDoubleMaps.immutable.withAll(ShortDoubleHashMap.newWithKeysValues(this.key1, this.value1, key, value));
    }

...
/**
 * ImmutableFloatObjectSingletonMap is an optimization for {@link ImmutableFloatObjectMap} of size 1.
 * This file was automatically generated from template file immutablePrimitiveObjectSingletonMap.stg.
 *
 * @since 4.0.
 */
final class ImmutableFloatObjectSingletonMap<V> extends AbstractImmutableFloatObjectMap<V> implements Serializable
{
    private static final long serialVersionUID = 1L;
    private final float key1;
    private final V value1;

    ImmutableFloatObjectSingletonMap(float key1, V value1)
    {
        this.key1 = key1;
        this.value1 = value1;
    }
    ...
    {
        return Float.compare(this.key1, key) == 0 ? this.value1 : null;
    }

    @Override
    public V getIfAbsent(float key, Function0<? extends V> ifAbsent)
    {
        return Float.compare(this.key1, key) == 0 ? this.value1 : ifAbsent.value();
    }
    ...
    @Override
    public ImmutableFloatObjectMap<V> tap(Procedure<? super V> procedure)
    {
    ...
    {
        return predicate.accept(this.key1, this.value1) ? FloatObjectHashMap.newWithKeysValues(this.key1, this.value1).toImmutable()
                : (ImmutableFloatObjectMap<V>) ImmutableFloatObjectEmptyMap.INSTANCE;
    }

    @Override
    public ImmutableFloatObjectMap<V> reject(FloatObjectPredicate<? super V> predicate)
    {
        return predicate.accept(this.key1, this.value1) ? (ImmutableFloatObjectMap<V>) ImmutableFloatObjectEmptyMap.INSTANCE
                : FloatObjectHashMap.newWithKeysValues(this.key1, this.value1).toImmutable();
    }
    ...
    @Override
    public ImmutableObjectFloatMap<V> flipUniqueValues()
    {
        return ObjectFloatMaps.immutable.with(this.value1, this.key1);
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        FloatObjectMap<V> map = (FloatObjectMap<V>) obj;
        if (map.size() != 1)
        {
            return false;
        }
    ...
    public int hashCode()
    {
        return Float.floatToIntBits(this.key1) ^ (this.value1 == null ? 0 : this.value1.hashCode());
    }
    ...
    {
        return FloatObjectHashMap.newWithKeysValues(this.key1, this.value1, key, value).toImmutable();
    }

    @Override
    public ImmutableFloatObjectMap<V> newWithoutKey(float key)
    {
        return Float.compare(this.key1, key) == 0 ? (ImmutableFloatObjectMap<V>) ImmutableFloatObjectEmptyMap.INSTANCE : this;
    }

    @Override
    public ImmutableFloatObjectMap<V> newWithoutAllKeys(FloatIterable keys)
    {
        return keys.contains(this.key1) ? (ImmutableFloatObjectMap<V>) ImmutableFloatObjectEmptyMap.INSTANCE : this;
    }
    ...
    {
        return new UnmodifiableIteratorAdapter<>(FloatObjectHashMap.newWithKeysValues(this.key1, this.value1).iterator());
    }

...
Have npm, yarn, angular-cli (ng), jdk1.8 and maven installed.

Before you start: Read and understand https://danielkummer.github.io/git-flow-cheatsheet/ and install gitflow (also see post installation setup at https://github.com/petervanderdoes/gitflow-avh/wiki/Installing-on-Mac-OS-X)

Install the jhipster generator: https://www.jhipster.tech/2018/07/05/jhipster-release-5.0.2.html

Clone the project.

`yarn install` to download all frontend dependencies

`./mvnw` to download all backend dependencies

`yarn serve` to run the frontend, access it at localhost:9000

`mvn spring-boot:run` to run the backend, it will be available at localhost:8080. better run it from your IDE for debugging.
...
To optimize the tradebravely application for production, run:
